...
- **Use nested-relation helpers** such as [`connectOrCreate`](/6.0/orm/reference/prisma-client-reference#connectorcreate) or [`set`](/6.0/orm/reference/prisma-client-reference#set) to create or link related records in a single operation.
