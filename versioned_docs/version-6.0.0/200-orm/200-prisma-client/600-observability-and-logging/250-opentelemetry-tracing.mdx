...
By default, tracing does not output spans for [Prisma Client middleware](/6.0/orm/prisma-client/client-extensions/middleware). To include your middleware in your traces, set `middleware` to `true` in your `registerInstrumentations` statement, as follows:
...
- `prisma:client:middleware`: Represents how long the operation spent in your [middleware](/6.0/orm/prisma-client/client-extensions/middleware).
