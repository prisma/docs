...
- [`string_contains`](/6.0/orm/reference/prisma-client-reference#string_contains)
- [`string_starts_with`](/6.0/orm/reference/prisma-client-reference#string_starts_with)
- [`string_ends_with`](/6.0/orm/reference/prisma-client-reference#string_ends_with) .

To use case insensitive filter with these, you can use the [`mode`](/6.0/orm/reference/prisma-client-reference#mode) option:
...
- [`array_contains`](/6.0/orm/reference/prisma-client-reference#array_contains)
- [`array_starts_with`](/6.0/orm/reference/prisma-client-reference#array_starts_with)
- [`array_ends_with`](/6.0/orm/reference/prisma-client-reference#array_ends_with)
