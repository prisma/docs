...
If you are particularly focused on monitoring query duration, consider using [logging middleware](/6.0/orm/prisma-client/client-extensions/middleware/logging-middleware).
...
- Use nested reads ([`include`](/6.0/orm/reference/prisma-client-reference#include) ) to return users and related posts
- Use the [`in`](/6.0/orm/reference/prisma-client-reference#in) filter
