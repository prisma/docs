...
- [Nested reads](#nested-reads) (sometimes referred to as _eager loading_) via [`select`](/6.0/orm/reference/prisma-client-reference#select) and [`include`](/6.0/orm/reference/prisma-client-reference#include)
...
- Use [`include`](/6.0/orm/reference/prisma-client-reference#include) to include related records, such as a user's posts or profile, in the query response.
- Use a nested [`select`](/6.0/orm/reference/prisma-client-reference#select) to include specific fields from a related record. You can also nest `select` inside an `include`.
...
- Use a nested [`create`](/6.0/orm/reference/prisma-client-reference#create-1) query
- Use a nested [`createMany`](/6.0/orm/reference/prisma-client-reference#createmany-1) query

In most cases, a nested `create` will be preferable unless the [`skipDuplicates` query option](/6.0/orm/reference/prisma-client-reference#nested-createmany-options) is required. Here's a quick table describing the differences between the two options:
...
The following query uses nested [`create`](/6.0/orm/reference/prisma-client-reference#create-1) to create:
...
The following query uses a nested [`createMany`](/6.0/orm/reference/prisma-client-reference#create-1) to create:
...
The following query creates ([`create`](/6.0/orm/reference/prisma-client-reference#create) ) a new `User` record and connects that record ([`connect`](/6.0/orm/reference/prisma-client-reference#connect) ) to three existing posts:
...
You can [`connect`](/6.0/orm/reference/prisma-client-reference#connect) an existing record to a new or existing user. The following query connects an existing post (`id: 11`) to an existing user (`id: 9`)
...
If a related record may or may not already exist, use [`connectOrCreate`](/6.0/orm/reference/prisma-client-reference#connectorcreate) to connect the related record:
...
To [`disconnect`](/6.0/orm/reference/prisma-client-reference#disconnect) _all_ related records in a one-to-many relation (a user has many posts), `set` the relation to an empty list as shown:
...
Prisma Client provides the [`some`](/6.0/orm/reference/prisma-client-reference#some), [`every`](/6.0/orm/reference/prisma-client-reference#every), and [`none`](/6.0/orm/reference/prisma-client-reference#none) options to filter records by the properties of related records on the "-to-many" side of the relation. For example, filtering users based on properties of their posts.
...
Prisma Client provides the [`is`](/6.0/orm/reference/prisma-client-reference#is) and [`isNot`](/6.0/orm/reference/prisma-client-reference#isnot) options to filter records by the properties of related records on the "-to-one" side of the relation. For example, filtering posts based on properties of their author.
