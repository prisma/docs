...
When doing [`select`](/6.0/orm/reference/prisma-client-reference#select) or [`include`](/6.0/orm/reference/prisma-client-reference#include) operations on your models and returning these variants from a function, it can be difficult to gain access to the return type, e.g:
