...
The `$use()` method adds [middleware](/6.0/orm/prisma-client/client-extensions/middleware) :
...
`next` represents the "next level" in the middleware stack, which could be the next middleware or the Prisma Query, depending on [where in the stack you are](/6.0/orm/prisma-client/client-extensions/middleware#running-order-and-the-middleware-stack).
...
See [middleware examples](/6.0/orm/prisma-client/client-extensions/middleware#samples).
