...
From version 4.3.0, you do not need to use raw queries to compare columns in the same table. You can use the `<model>.fields` property to [compare the columns](/6.0/orm/reference/prisma-client-reference#compare-columns-in-the-same-table).
...
From version 4.3.0, you do not need to use raw queries to compare columns in the same table. You can use the `<model>.fields` property to compare the columns. [Learn more](/6.0/orm/reference/prisma-client-reference#compare-columns-in-the-same-table)
