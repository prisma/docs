...
The `usePrismaClient` module does not currently allow for configuration of `PrismaClient` [constructor options](/6.0/orm/reference/prisma-client-reference#prismaclient).
