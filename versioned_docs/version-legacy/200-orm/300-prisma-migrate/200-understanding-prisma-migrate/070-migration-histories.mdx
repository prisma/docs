...
There may be situations where a manual change to your migration history doesn't actually alter the database schema, like adding a comment to a generated SQL migration. In these situation, you can avoid resetting the database by following the instructions in this [tutorial](https://echobind.com/post/make-prisma-ignore-a-migration-change).
