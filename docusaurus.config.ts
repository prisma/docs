		...
		[
			"classic",
			{
				...
				docs: {
					...
					editUrl: "https://github.com/prisma/docs",
				},
				blog: false,
				theme: {
					customCss: [
	...
	themeConfig: {
		...
		prism: {
			...
			magicComments: [
				...
				{
					className:
						"theme-code-block-added-line added-line code-highlight",
					line: "add-next-line",
				...
				{
					className:
						"theme-code-block-edited-line edited-line code-highlight",
					line: "edit-next-line",
					block: { start: "edit-start", end: "edit-end" },
				},
				{
					className:
						"theme-code-block-highlighted-line highlighted-line",
