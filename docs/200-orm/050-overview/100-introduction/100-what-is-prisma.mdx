...
![Typical workflow with Prisma Migrate](@site/static/images/prisma-migrate-development-workflow.png)
...
![Introspect workflow](@site/static/images/prisma-evolve-app-workflow.png)
