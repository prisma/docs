...
type SiteSiteMetadataHeader = {
  readonly secondLevelHeaderMenuItems: Maybe<ReadonlyArray<Maybe<SiteSiteMetadataHeaderSecondLevelHeaderMenuItems>>>;
};
...
type SiteSiteMetadataHomepage = {
  ...
  readonly ReferenceLinkData: Maybe<ReadonlyArray<Maybe<SiteSiteMetadataHomepageReferenceLinkData>>>;
...
type HomepageQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly homepage: { readonly GuideText: string | null, readonly ReferenceText: string | null, readonly SummaryLinkData: { readonly gettingStarted: string | null, readonly readyToRun: string | null, readonly slack: string | null, readonly git: string | null, readonly buttons: ReadonlyArray<{ readonly text: string | null, readonly url: string | null, readonly special: boolean | null, readonly icon: string | null } | null> | null } | null, readonly GeneralLinkData: ReadonlyArray<{ readonly categoryName: string | null, readonly icon: string | null, readonly links: ReadonlyArray<{ readonly url: string | null, readonly text: string | null, readonly codeBlock: boolean | null } | null> | null } | null> | null, readonly GuideLinkData: ReadonlyArray<{ readonly title: string | null, readonly color: string | null, readonly small: boolean | null, readonly content: string | null, readonly url: string | null } | null> | null, readonly ReferenceLinkData: ReadonlyArray<{ readonly categoryName: string | null, readonly mainUrl: string | null, readonly icon: string | null, readonly links: ReadonlyArray<{ readonly url: string | null, readonly text: string | null, readonly codeBlock: boolean | null } | null> | null } | null> | null, readonly MoreUsefulLinks: ReadonlyArray<{ readonly text: string | null, readonly url: string | null, readonly codeBlock: boolean | null } | null> | null } | null } | null } | null };

type SEOQueryVariables = Exact<{ [key: string]: never; }>;


type SEOQuery = { readonly site: { readonly siteMetadata: { readonly pathPrefix: string | null, readonly titlePrefix: string | null, readonly titleSuffix: string | null, readonly siteUrl: string | null, readonly twitter: { readonly site: string | null, readonly creator: string | null, readonly image: string | null } | null, readonly og: { readonly site_name: string | null, readonly type: string | null, readonly image: { readonly url: string | null, readonly alt: string | null, readonly type: string | null, readonly height: string | null, readonly width: string | null } | null } | null } | null } | null };

type SiteTitleQueryQueryVariables = Exact<{ [key: string]: never; }>;


type SiteTitleQueryQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly footer: { readonly newsletter: { readonly text: string | null } | null } | null, readonly header: { readonly secondLevelHeaderMenuItems: ReadonlyArray<{ readonly type: string | null, readonly to: string | null, readonly bucketName: string | null, readonly text: string | null } | null> | null } | null } | null } | null };

type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_1_Query = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null, readonly id: string | null, readonly modSlug: string | null } | null, readonly frontmatter: { readonly title: string, readonly metaTitle: string | null, readonly metaDescription: string | null, readonly langSwitcher: ReadonlyArray<string | null> | null, readonly dbSwitcher: ReadonlyArray<string | null> | null, readonly techMetaTitles: ReadonlyArray<{ readonly name: string | null, readonly value: string | null } | null> | null, readonly techMetaDescriptions: ReadonlyArray<{ readonly name: string | null, readonly value: string | null } | null> | null } | null, readonly internal: { readonly contentFilePath: string | null } }> }, readonly site: { readonly siteMetadata: { readonly redirects: ReadonlyArray<{ readonly from: string | null, readonly to: string | null } | null> | null } | null } | null };
