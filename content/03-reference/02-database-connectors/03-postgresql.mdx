...
The PostgreSQL connector maps the [scalar types](../tools-and-interfaces/prisma-schema/data-model#scalar-fields) from the Prisma [data model](../tools-and-interfaces/prisma-schema/data-model) as follows to native column types:
