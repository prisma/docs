...
To connect to a SQLite database file, you need to configure a [`datasource`](../prisma-schema/data-sources) block in your [schema file](../prisma-schema/prisma-schema-file):
...
The SQLite connector maps the [scalar types](../prisma-schema/data-model#scalar-types) from the [data model](../prisma-schema/data-model) to native column types as follows:
