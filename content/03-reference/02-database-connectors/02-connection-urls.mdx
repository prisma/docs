...
> **Note**: You must [enable the `microsoftSqlServer` preview feature](../../reference/tools-and-interfaces/preview-features/Microsoft SQL Server#enable-Microsoft SQL Server-preview-feature) in order to use the Microsoft SQL Server connector.
