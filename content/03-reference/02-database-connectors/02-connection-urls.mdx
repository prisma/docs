...
> **Note**: You must [enable the `microsoftSqlServer` preview feature](../../reference/tools-and-interfaces/preview-features/mssql#enable-mssql-preview-feature) in order to use the Microsoft SQL Server connector.
