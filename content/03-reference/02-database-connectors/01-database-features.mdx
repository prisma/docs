...
| `DEFAULT`     |     ✔️     |  ✔️   |   ✔️   |       [`@default`](../tools-and-interfaces/prisma-schema/data-model#defining-a-default-value)        |      ✔️       |       ✔️       |
...
| --------------------------------- | ---------- | ----- | ------ | ---------------------------------------------------------------------------------------------- | ------------- | -------------- |
| Autoincrementing IDs              | ✔️         | ✔️    | ✔️     | [`autoincrement()`](../tools-and-interfaces/prisma-schema/data-model#defining-a-default-value) | ✔️            | ✔️             |
