...
| `NOT NULL`    |     ✔️     |  ✔️   |   ✔️   |       [`?`](../tools-and-interfaces/prisma-schema/data-model#type-modifiers)        |      ✔️       |       ✔️       |
...
| Arrays                            | ✔️         | No    | No     | [`[]`](../tools-and-interfaces/prisma-schema/data-model#type-modifiers)                                    | ✔️            | ✔️             |
...
The following [attributes](../tools-and-interfaces/prisma-schema/data-model#defining-attributes) are available in Prisma. They either map to a database feature or are implemented by Prisma's [query engine](../tools-and-interfaces/prisma-client/query-engine):
