...
| ------------- | :--------: | :---: | :----: | :--------------------------------------------------------------------------------------------------: | :-----------: | :------------: |
| `PRIMARY KEY` |     ✔️     |  ✔️   |   ✔️   |      [`@id` and `@@id`](../tools-and-interfaces/prisma-schema/data-model#defining-an-id-field)       |      ✔️       |       ✔️       |
| `FOREIGN KEY` |     ✔️     |  ✔️   |   ✔️   |          [Relation fields](../tools-and-interfaces/prisma-schema/relations#relation-fields)          |      ✔️       |       ✔️       |
| `UNIQUE`      |     ✔️     |  ✔️   |   ✔️   | [`@unique` and `@@unique`](../tools-and-interfaces/prisma-schema/data-model#defining-a-unique-field) |      ✔️       |       ✔️       |
...
| Enums                             | ✔️         | ✔️    | No     | [`enum`](../tools-and-interfaces/prisma-schema/data-model#defining-enums)                                  | ✔️            | ✔️             |
