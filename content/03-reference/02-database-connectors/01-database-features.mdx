...
| ------------- | :--------: | :------ | :---: | :----: | :--------------------------------------------------------------------------------------------------: | :-----------: | :------------: |
| `PRIMARY KEY` |     ✔️     |  ✔️    |✔️    |   ✔️   |      [`@id` and `@@id`](../tools-and-interfaces/prisma-schema/data-model#defining-an-id-field)       |      ✔️       |       ✔️       |
| `FOREIGN KEY` |     ✔️     |  ✔️    |✔️   |   ✔️   |          [Relation fields](../tools-and-interfaces/prisma-schema/relations#relation-fields)          |      ✔️       |       ✔️       |
| `UNIQUE`      |     ✔️     |  ✔️†    |✔️   |   ✔️   | [`@unique` and `@@unique`](../tools-and-interfaces/prisma-schema/data-model#defining-a-unique-field) |      ✔️       |       ✔️       |
| `CHECK`       |     ✔️     |  ✔️    |✔\*  |   ✔️   |                                               Not yet                                                |      ✔️       |    Not yet     |
| `NOT NULL`    |     ✔️     |  ✔️    |✔️   |   ✔️   |                [`?`](../tools-and-interfaces/prisma-schema/data-model#type-modifiers)                |      ✔️       |       ✔️       |
| `DEFAULT`     |     ✔️     |  ✔️    |✔️   |   ✔️   |       [`@default`](../tools-and-interfaces/prisma-schema/data-model#defining-a-default-value)        |      ✔️       |       ✔️       |

* \*In [MySQL 8 and higher](https://mysqlserverteam.com/mysql-8-0-16-introducing-check-constraint/)
* † [Caveats apply when using the `UNIQUE` constraint with SQL Server](../tools-and-interfaces/preview-features/sql-server##cannot-use-column-with-unique-constraint-and-filtered-index-as-foreign-key)
