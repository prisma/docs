...
| Cascading deletes                   | `ON DELETE`                     | Not yet ([workaround](../../04-guides/01-database-workflows/06-cascading-deletes/01-postgresql)) |
| Cascading updates                   | `ON UPDATE`                     |                                 Not yet (workaround coming soon)                                 |
| Data validation                     | `CHECK`                         |  Not yet ([workaround](../../04-guides/01-database-workflows/07-data-validation/01-postgresql))  |
=======
| Operation                           | SQL                             |        Supported         |
| :---------------------------------- | :------------------------------ | :----------------------: |
| Create a new table                  | `CREATE TABLE`                  |            ✔️            |
...
>>>>>>> 095081cf438422ec916aa42cd2c81929e1834ec9
