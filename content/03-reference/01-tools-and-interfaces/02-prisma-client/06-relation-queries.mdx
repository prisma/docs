...
With nested reads, you can modify the structures of the objects that are returned by your Prisma Client queries by _including_ their relations. In ORM terminoloy, this is sometimes called _eager loading_.
