...
- Shallow pagination of results. For example, a blog interface that allows you to filter `Post` records by its author and shows the filtered results in N number of pages (with limited results per page as set).
