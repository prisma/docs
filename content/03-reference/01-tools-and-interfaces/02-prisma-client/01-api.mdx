...
Note that this command also run the `prisma generate` command which generates the Prisma Client into the `node_modules/.prisma/client` directory. `node_modules/.prisma/client` is referenced by `node_modules/@prisma/client`:
