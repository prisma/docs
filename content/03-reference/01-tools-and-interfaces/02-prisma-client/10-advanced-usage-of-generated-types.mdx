...
Note that you can find all type definitions inside the `index.d.ts` file inside the [generated `.prisma/client` folder](generating-prisma-client#the-prisma-client-npm-module).
