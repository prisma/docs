...
| Operator | Notes                                                                                                                                                                                                                              |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AND`    | All conditions must return`true`. Alternatively, pass a list of objects into the `where` clause - the `AND` operator is [not required](#retrieve-all-post-records-where-the-content-field-contains-prisma-and-published-is-false). |
