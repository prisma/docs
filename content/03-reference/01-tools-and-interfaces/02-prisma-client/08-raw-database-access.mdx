...
To send raw SQL queries to your database, you can you two functions that are expored by your `PrismaClient` instance:
...
The can for example be the case if you want to perform an `UPDATE` query, that potentially updates multiple records in the database:
