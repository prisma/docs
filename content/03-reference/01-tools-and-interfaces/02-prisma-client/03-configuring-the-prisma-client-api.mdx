...
Because these fields are [virtual relation fields]() you can manually rename them in your Prisma schema.

**Naming of physical relation fields**

Foreign keys are represented as a combination of a [physical relation fields]() and a corresponding [link field]() in the Prisma schema. Here's how all the relations from the SQL schema are currently represented:
