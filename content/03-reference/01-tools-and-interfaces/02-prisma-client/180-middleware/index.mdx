...
metaDescription: 'Prisma Client middleware allows you to perform actions before or after any query on any model.'
---
...
| `model` | The name of the mode - for example, `Post` or `User`. |
...
- Consider whether middleware is the appropriate solution for your scenario. For example:
  ...
  - If you need to populate a field, can you use the [`@default`](../../prisma-schema/prisma-schema-reference#default) attribute?
