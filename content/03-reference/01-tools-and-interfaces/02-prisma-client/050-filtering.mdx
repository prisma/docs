...
> **Note**: Prisma Client supports case-insensitive filtering (preview) with PostgreSQL in 2.5.0 and later.
...
Case-insensitive filtering is a preview feature and [can only be used with PostgreSQL](case-sensitivity#options-for-case-insensitive-filtering). Add the highlighted feature flag to enable case-insensitive filtering capabilities:
...
Please help us make this feature production-ready by trying it out, [sharing your feedback](https://github.com/prisma/prisma/issues/3340) and [reporting bugs](https://www.prisma.io/docs/more/creating-bug-reports/)! The more and better feedback we receive, the earlier the feature can be released for production usage.
