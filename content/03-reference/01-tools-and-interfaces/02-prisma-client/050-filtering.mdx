...
Case-insensitive filtering is preview feature and [can only be used with PostgreSQL](case-sensitivity#options-for-case-insensitive-filtering). Add the highlighted feature flag to enable case-insensitive filtering capabilities:
