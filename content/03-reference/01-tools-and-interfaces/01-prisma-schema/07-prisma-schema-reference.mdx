...
Date and time - format depends on database, Prisma returns ISO 8601 string
...
| Name       | Required | Type                                   | Description                                                                                                            |
| ---------- | -------- | -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `name` | **No**  | `String`  | A list of field names - for example, `["firstname", "lastname"]` |
| `fields` | **Yes**  | `FieldReference[]`  | A list of field names - for example, `["firstname", "lastname"]` |
| `references` | **Yes**  | `FieldReference[]`  | A list of field names - for example, `["firstname", "lastname"]` |
...
An array of [field](data-model#fields names. 
...
### <inlinecode>Expression</inlinecode>
 ...
 An expression that can be evaluated by Prisma.

Here's an overview of the _types_ that are used in the attribute signatures:

| Type               | Description                                   | Example                                |
| :----------------- | :-------------------------------------------- | :------------------------------------- |
| `FieldReference[]` | An array of [field](data-model#fields names      | `[id]`, `[firstName, lastName]`        |
