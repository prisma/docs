...
### <inlinecode>fields</inlinecode> (<inlinecode>FieldReference[]</inlinecode>)

A list of [fields](../../../reference/tools-and-interfaces/prisma-schema/data-model#fields) of the _current_ model.

#### Remarks

Required on [annotated](../../../reference/tools-and-interfaces/prisma-schema/relations#annotated-relation-fields-and-relation-scalar-fields) relation fields.
...
### <inlinecode>value</inlinecode> (<inlinecode>String</inlinecode>)
...
### <inlinecode>references</inlinecode> (<inlinecode>FieldReference[]</inlinecode>)

A list of [fields](data-model#fields of the model on _the other side of the relation_.
...
### <inlinecode>name</inlinecode> (<inlinecode>String</inlinecode>)
