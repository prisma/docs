...
* If you specify [multiple providers](#specify-multiple-data-sources), Prisma Client uses the provider that matches the connection string defined by the `url` field.
...
* Can be annotated with a [`@default()`](#default) value, including [functions]()
* Cannot be optional
