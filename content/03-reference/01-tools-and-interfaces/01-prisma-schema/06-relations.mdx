...
Relation [fields](data-model#fields are fields on a Prisma [model](data-model#defining-models) that do _not_ have a [scalar type](data-model#scalar-types). Instead, their type is another model.
