...
> **Note**: Implicit many-to-many relations do **not** require the `@relation` attribute.

Implicit many-to-many relations require models on either side to have a single `@id`. Be aware of the following limitations:
