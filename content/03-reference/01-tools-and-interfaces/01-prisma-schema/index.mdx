...
1. install dot-env cli:

```
npm install -g dotenv-cli
```

2. move env file to the root folder - on the same level as the prisma folder:
3. include ref at top of page

> **Note** Only required in your project's entry file.
...
4. For any command, use dotenv. For example:
