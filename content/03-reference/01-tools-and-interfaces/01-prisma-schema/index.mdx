...
Variables can be expanded using the format specified by [dotenv-expand](https://github.com/motdotla/dotenv-expand) (useful when dealing with PaaS or similar products. E.g. Heroku):
