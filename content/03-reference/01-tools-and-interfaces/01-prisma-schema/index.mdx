...
> **Note**: You can perform [additional steps to use an `.env` file outside the Prisma schema file's directory](#use-multiple-env-files-or-env-files-outside-the-prisma-folde).
