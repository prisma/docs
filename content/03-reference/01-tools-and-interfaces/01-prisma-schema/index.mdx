...
| **Command**                                                 | **Schema file location**                                                        | **`.env` file locations**                            |
| :---------------------------------------------------------- | :------------------------------------------------------------------------------ | :--------------------------------------------------- |
| `prisma [command] —schema=./folder/subfolder/schema.prisma` | `./folder/subfolder/schema.prisma`                                              | 1. `./folder/subfolder/.env`<br />2. `./prisma/.env` |
| `prisma [command]`                                          | `./prisma/schema.prisma`                                                        | 1. `./prisma/.env`                                   |
| `prisma [command]`                                          | No schema (for example, when running `prisma introspect` in an empty directory) | 1. `./prisma/.env`                                   |
