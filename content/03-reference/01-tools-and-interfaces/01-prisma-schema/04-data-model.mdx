...
- [Scalar types](data-model#scalar-fields) (includes [enums](data-model#enums)) - for example, [`String`](prisma-schema-reference#inlinecodestringinlinecode) <span class="api"></span> or [`Int`](prisma-schema-reference#inlinecodeintinlinecode) <span class="api"></span>
...
See [complete list of scalar field types](prisma-schema-reference#inlinecodemodelinlinecode-field-scalar-types) <span class="api"></span>.
...
* [`[]`](prisma-schema-reference##inlinecodeinlinecode) <span class="api"></span> Make a field a list
* [`?`](prisma-schema-reference#inlinecodeinlinecode-1) <span class="api"></span> Make a field optional
...
Enums are defined via the [`enum`](prisma-schema-reference#inlinecodeenuminlinecode) <span class="api"></span> block. For example, a `User` has a `Role`:
