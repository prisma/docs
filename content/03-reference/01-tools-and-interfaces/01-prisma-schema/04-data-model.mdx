...
- [Enums](#defining-enums) ([`enum`](prisma-schema-reference#defining-enums) <span class="api"></span> primitives) - only available if [enums are supported natively by your database](../../database-connectors/database-features#misc)
...
Models represent the entities of your application domain. Models are represented by [`model`](prisma-schema-reference#model) <span class="api"></span> blocks and define a number of [fields](prisma-schema-reference#defining-fields). In the [example data model](data-model), `User`, `Profile`, `Post` and `Category` are models.
...
> **Note**: You can also [`@map`](prisma-schema-reference#map) <span class="api"></span> a column name.
...
- [Scalar types](data-model#scalar-fields) (includes [enums](data-model#enums)) - for example, [`String`](prisma-schema-reference#string) <span class="api"></span> or [`Int`](prisma-schema-reference#int) <span class="api"></span>
...
The Prisma schema supports a number of [functions](prisma-schema-reference#attribute-functions) <span class="api"></span>. These can be used to specify [default values](prisma-schema-reference#defining-a-default-values) on fields of a model. 
