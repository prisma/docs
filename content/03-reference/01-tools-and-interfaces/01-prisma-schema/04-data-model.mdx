...
- [Enums](#defining-enums) ([`enum`](prisma-schema-reference#defining-enums) <span class="api"></span> primitives) - only available if enums are supported natively by your database
