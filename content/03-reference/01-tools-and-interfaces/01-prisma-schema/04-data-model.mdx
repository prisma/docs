...
<div style="background-color: rgb(246, 248, 250); background-image: url(https://cdn.onlinewebfonts.com/svg/img_285835.png);background-size:50px;background-position: 10px 10px;background-repeat:no-repeat; padding:20px 10px 10px 70px;min-height: 70px">
