...
**API Reference:** [Field types](../../../api-reference/prisma-schema#field-types), [type modifiers](../../../api-reference/prisma-schema#model-field-type-modifiers), and [attributes](../../../api-reference/prisma-schema#attributes)
