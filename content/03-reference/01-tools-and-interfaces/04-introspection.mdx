...
In version 2.6.0 and later, introspection merges manual changes made to the schema with changes made in the database. Re-introspection maintains the following manual changes:

- `@updatedAt`
- Order of `model` blocks
- Order of `enum` blocks

The following database-level
