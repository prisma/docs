...
metaTitle: 'Start from scratch with SQL Server (Preview)'
metaDescription: ''
...
1. Expand the database node in the Object Explorer to confirm that your tables were created:
  ...
  ![A list of database tables in the Object Explorer in SQL Server Managment Studio](../../../../doc-images/database-tables.png)

m
## Introspect your database with Prisma

As a next step, you will introspect your database. The result of the introspection will be a [data model](../../../tools-and-interfaces/prisma-schema/data-model) inside your Prisma schema.
