...
- A [Microsoft SQL Server](https://docs.microsoft.com/en-us/sql/?view=sql-server-ver15) database
  ...
  - [Microsoft SQL Server on Windows (local)](mssql-local)
...
1. Adjust the connection string to match your setup - see [Microsoft SQL Server connection string](mssql-connection-string) for more information.
