...
metaTitle: 'MSSQL  on Docker (Preview)'
metaDescription: 'Download and use the MSSQL Docker image.'

---

<TopBlock>

To run a MSSQL Server container image with Docker:

1. Install and set up [Docker](https://docs.docker.com/get-docker/)
1. Run the following command in your terminal to download the MSSQL 2019 image:
