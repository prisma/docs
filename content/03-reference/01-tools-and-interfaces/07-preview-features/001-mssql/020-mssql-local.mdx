...
To run a MSSQL Server locally on a Windows machine:

1. If you do not have access to an instance of MSSQL Server, download and set up [SQL Server 2019 Developer](https://www.microsoft.com/en-us/sql-server/sql-server-downloads).
...
1. Use Windows Authentication to log in to MSSQL Server Management Studio (expand the **Server Name** dropdown and click **&lt;Browse for more...&gt;** to find your database engine):


  ![The New Query button in MSSQL Management Studio](../../../../doc-images/connect-sql-server.png)
...
1. In MSSQL Management Studio, in the Object Explorer, expand **Security** > **Logins** and double-click **sa**.
...
You can now use the `sa` account in a connection string and when you log in to MSSQL Management Studio.
