...
| `binaryTargets` | No       | List of Enums (see belo0)                      | Specify the OS on which the Prisma Client will run to ensure binary compatibility of the [query engine](). **Default**: `native` |
...
| `fields`     | `FieldReference[]` |  |                                                                 | `["authorId"]`, `["authorFirstName, authorLastName"]` |
| `references` | `FieldReference[]` | On [annotated](#annotated-relation-fields-and-relation-scalar-fields) relation fields |                                       | `["id"]`, `["firstName, lastName"]`                   |
...
A list of [fields](models#fields) of the _current_ model.
...
A list of [fields](models#fields) of the model on _the other side of the relation_
...
An array of [field](models#fields) names. 
