...
Attributes modify the behavior of a [field](#model-fields) or block (e.g. [models](#models)). There are two ways to add attributes to your data model:
...
A list of [fields](data-model#fields of the _current_ model.

#### Remarks

Required on [annotated](#annotated-relation-fields-and-relation-scalar-fields) relation fields.
