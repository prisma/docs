...
**Concepts:** [Datasources](../../../concepts/tools-and-interfaces/prisma-schema/data-sources)
...
**Concepts:** [Generators](../../../concepts/tools-and-interfaces/prisma-schema/generators)
...
**Concepts:** [Models](../../../concepts/tools-and-interfaces/prisma-schema/data-model#models)
...
Note that in this case you can only create new `Post` records by using Prisma Client's [nested writes](../../../concepts/tools-and-interfaces/prisma-client/relation-queries#nested-writes) to immediately connect the new `Post` record with a new or existing `User` record, e.g.:
...
Defines meta information about the relation. [Learn more](../../../concepts/tools-and-interfaces/prisma-schema/relations#the-relation-attribute).
...
A list of [fields](../../../concepts/tools-and-interfaces/prisma-schema/data-model#fields) of the _current_ model.

#### Remarks

Required on [annotated](../../../concepts/tools-and-interfaces/prisma-schema/relations#annotated-relation-fields-and-relation-scalar-fields) relation fields.
...
* Implemented by Prisma and therefore not "visible" in the underlying database schema. You can still use `cuid()` when using [introspection](../../../concepts/tools-and-interfaces/introspection) by [manually changing your Prisma schema](../../../concepts/tools-and-interfaces/prisma-client/configuring-the-prisma-client-api) and [generating Prisma Client](../prisma-client/generating-prisma-client), in that case the values will be generated by Prisma's [query engine](../../../concepts/tools-and-interfaces/prisma-client/query-engine).
...
* Compatible with `String`      
* Implemented by Prisma and therefore not "visible" in the underlying database schema. You can still use `uuid()` when using [introspection](../../../concepts/tools-and-interfaces/introspection) by [manually changing your Prisma schema](../../../concepts/tools-and-interfaces/prisma-client/configuring-the-prisma-client-api) and [generating Prisma Client](../../../concepts/tools-and-interfaces/prisma-client/generating-prisma-client), in that case the values will be generated by Prisma's [query engine](../../../concepts/tools-and-interfaces/prisma-client/query-engine).
...
Represents default values that can't be expressed in the Prisma schema (such as `random()`). Only available after [introspection](../../../concepts/tools-and-interfaces/introspection).
