...
**Concepts:** [Generators](../../../concepts/tools-and-interfaces/prisma-schema/data-model)
...
Attributes modify the behavior of a [field](data-model#fields or block (e.g. [models](models)). There are two ways to add attributes to your data model:
...
Represents default values that can't be expressed in the Prisma schema (such as `random()`). Only available after [introspection](../introspection).
