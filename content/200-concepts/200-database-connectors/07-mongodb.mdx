...
| Database | `DATABASE`  | Name of the database to use. If none is specified but the [`authSource`](https://www.mongodb.com/docs/manual/reference/connection-string/#mongodb-urioption-urioption.authSource) option is set then the [`authSource`](https://www.mongodb.com/docs/manual/reference/connection-string/#mongodb-urioption-urioption.authSource) database name is used. If neither the database in the connection string nor the [`authSource`](https://www.mongodb.com/docs/manual/reference/connection-string/#mongodb-urioption-urioption.authSource) option is specified then it defaults to `admin`                                                                                                    |
...
### Error: Error in Connector: SCRAM failure: Authentication failed.

Remember to specify the database name associated with the credentials you provide in the connection string by using the [`authSource`](https://www.mongodb.com/docs/manual/reference/connection-string/#mongodb-urioption-urioption.authSource) connection option. If `authSource` is unspecified it will default to using the database name provided. 

For example, when developing using a local MongoDB Database you may need to include `?authSource=admin` in the connection string.
