...
- [`@@id`](/reference/api-reference/prisma-schema-reference#id-1) and [autoincrement](/reference/api-reference/prisma-schema-reference#generate-autoincrementing-integers-as-ids) are **not** supported.
