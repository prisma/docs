...
The [`@@id`](/reference/api-reference/prisma-schema-reference#id-1) attribute and [`autoincrement()`](/reference/api-reference/prisma-schema-reference#generate-autoincrementing-integers-as-ids) function are not supported.
