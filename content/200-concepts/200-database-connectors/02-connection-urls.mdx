...
Prisma needs a connection URL to be able to connect to your database, e.g. when sending queries with [Prisma Client](../components/prisma-client) or when changing the database schema with [Prisma Migrate](../components/prisma-migrate).
...
<<<<<<< HEAD:content/03-reference/02-database-connectors/02-connection-urls.mdx
> **Note**: You must [enable the `microsoftSqlServer` preview feature](../../reference/tools-and-interfaces/preview-features/sql-server#enable-sql-server-preview-feature) in order to use the Microsoft SQL Server connector.
=======
...
>>>>>>> 6bb901ebd39b101cba96be698dfd3de81b10a3bf:content/200-concepts/200-database-connectors/02-connection-urls.mdx
