...
Prisma needs a connection URL to be able to connect to your database, e.g. when sending queries with [Prisma Client](../components/prisma-client/api) or when changing the database schema with [Prisma Migrate](../components/prisma-migrate).
