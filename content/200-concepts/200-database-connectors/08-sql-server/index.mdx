...
To connect to a Microsoft SQL Server database, you need to configure a [`datasource`](../components/prisma-schema/data-sources) block in your [Prisma schema file](../components/prisma-schema):
...
- `url`: Specifies the [connection URL](#connection-url) for the Microsoft SQL Server database. In this case, an [environment variable is used](../components/prisma-schema#accessing-environment-variables-from-the-schema) to provide the connection URL.
...
| `connectionLimit`                                                 | No                | `num_cpus * 2 + 1` | Maximum size of the [connection pool](../../components/prisma-client/working-with-prismaclient/connection-pool)                                                                                                                                                                                                                                                                                                                                            |
...
See [Special rules for referential actions in SQL Server](../../components/prisma-schema/relations/referential-actions/special-rules-for-referential-actions) for more information.
