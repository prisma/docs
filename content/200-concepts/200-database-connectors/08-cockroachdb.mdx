...
| `BOOL` \| `BOOLEAN`                          | `Bool`     |    ✔️     | `@db.Boolean`\*                      |       |
...
| ``INT4`                                      | `Int`      |    ✔️     | `@db.Int4`                           |       |
| `SERIAL2` \| `SMALLSERIAL`                   | `Int`      |    ✔️     | `@db.Int2 @default(autoincrement())` |       |
| `SERIAL4` \| `SERIAL`                        | `Int`      |    ✔️     | `@db.Int4 @default(autoincrement())` |       |
| `SERIAL8` \| `BIGSERIAL`                     | `Int`      |    ✔️     | `@db.Int8 @default(autoincrement()`  |       |
