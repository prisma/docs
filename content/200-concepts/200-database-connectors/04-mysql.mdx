...
- `url`: Specifies the [connection URL](#connection-url) for the MySQL database server. In this case, an [environment variable is used](../components/more/environment-variables) to provide the connection URL.
