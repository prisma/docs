...
| :----------------- | :------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `connection_limit` | No       | `num_cpus * 2 + 1`     | Maximum size of the [connection pool](../components/prisma-client/working-with-prismaclient/connection-management#connection-pool)                                                      |
...
Fields with types that **do not yet have a match in the Prisma schema (and are not yet supported)** will be also be added as comments to the Prisma schema as comments using the MySQL type, e.g. `xml` would be added to a model as follows:
