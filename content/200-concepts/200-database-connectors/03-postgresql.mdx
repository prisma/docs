...
| `sslcert`          | No       |                        | Path of the server certificate. Certificate paths are [resolved relative to the `./prisma folder`](../components/prisma-schema/data-sources#securing-database-connections) |
