...
These two tables show the type mapping between PostgreSQL and Prisma schema. First [how Prisma scalar types are translated into PostgreSQL database column types](TODO), and then [how PostgreSQL database column types relate to Prisma scalar and native types](TODO).
