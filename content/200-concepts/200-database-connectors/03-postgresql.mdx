...
| `xml`                                       | `String`      |    ✔️     | `@db.Xml`                                |
| Array types                                 | `[]`          |    ✔️     |
| `citext`                                    | `String`      |   ✔️\*    | `@db.Citext`                             | \* Only available if [Citext extension is enabled](/concepts/components/prisma-schema/features-without-psl-equivalent#enable-postgresql-extensions-for-native-database-functions). |
