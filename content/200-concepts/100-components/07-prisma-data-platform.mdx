...
Prisma Data Proxy is an intermediary between your application and your database. It manages connection pooling, so you can reliably use traditional databases in serverless environments.

### Why using the Data Proxy?
...
Navigate to the "Data Proxy" tab of your Prisma Data Platform project, select the desired proxy location, and click on "Enable".
...
If you are loading the connection string in your Prisma Schema using `env()`, there should be no further changes needed besides making sure the environment variable is properly set. For example:
...
If you are looking to scale up traffic beyond the limits or if you're seeing `429` HTTP errors in your logs - this may mean you're hitting the quotas, [**please reach out to us**](#feedback-and-support). We'd love to know about your use case and work together with you to help your Prisma application scale.

To contact us find us on Slack or you can submit a feedback form.
