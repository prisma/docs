...
Alternatively, follow the [Microsoft SQL Server tutorial](sql-server-start-from-scratch-typescript).
...
To make local development easier on MacOS, you can add `encrypt=DANGER_PLAINTEXT` to the end of your connection URL (**[not required in 2.15.0 and later](https://github.com/prisma/tiberius/issues/65)**).
