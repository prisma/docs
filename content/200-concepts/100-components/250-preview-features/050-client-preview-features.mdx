...
In the list below, you can find Prisma Client features that are already promoted from Preview to General Availability.

- [`interactiveTransactions`](/concepts/components/prisma-client/transactions#interactive-transactions) is promoted to General Availability in [4.7.0](https://github.com/prisma/prisma/releases/tag/4.7.0) - [Submit feedback](https://github.com/prisma/prisma/issues/new/choose)