...
- [`metrics`](/guides/performance-and-optimization/metrics) since release [3.15.0](https://github.com/prisma/prisma/releases/tag/3.15.0) - [Submit feedback](https://github.com/prisma/prisma/issues/link TBA)**link to feedback TBA!!!**
- [`improvedQueryRaw`](/concepts/components/prisma-client/raw-database-access#using-improvedqueryraw-preview) since release [3.14.0](https://github.com/prisma/prisma/releases/tag/3.14.0) - [Submit feedback](https://github.com/prisma/prisma/issues/13466)
