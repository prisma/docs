...
- [`filteredRelationCount`](/concepts/components/prisma-client/aggregation-grouping-summarizing#filter-the-related-records) since release [4.1.0](https://github.com/prisma/prisma/releases/tag/4.1.0) **need to add feedback link**]
