...
- [`cockroachdb`](/concepts/database-connectors/cockroachdb) since release [3.9.0](https://github.com/prisma/prisma/releases/tag/3.9.0) - [Submit feedback](https://github.com/prisma/prisma/issues/11542)
