...
- [`fieldReference`](reference/api-reference/prisma-client-reference#compare-columns-in-the-same-table) since release [4.2.0](https://github.com/prisma/prisma/releases/tag/4.3.0) - [Submit feedback] **TBA** (https://github.com/prisma/prisma/issues/14640)
