...
- [`clientExtensions`](/concepts/components/prisma-client/client-extensions) since release [4.7.0](https://github.com/prisma/prisma/releases/tag/4.7.0) - [Submit feedback](TBA)
