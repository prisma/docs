...
- [`deno`](/guides/deployment/deployment-guides/deploying-to-deno-deploy) since release [4.53.0](https://github.com/prisma/prisma/releases/tag/4.5.0) - [Submit feedback](https://github.com/prisma/prisma/issues/15844)
