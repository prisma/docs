...
| Native database type | Native database type attribute | Notes                                                                                                                                  |
| :------------------- | :----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `VARCHAR`            | `@db.VarChar(X)`               | Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `String`. Default length (`X`) is `191`. |
| `TEXT`               | `@db.Text`                     |
| `CHAR`               | `@db.Char(X)`                  |
...
| `nvarchar`           | `@db.NVarChar(X)`              | Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `String` Default length (`X`) is `1000`. |
| `text`               | `@db.Text`                     |
| `ntext`              | `@db.NText`                    |
| `xml`                | `@db.Xml`                      |
...
| :-------------------- | :----------------------------- | -------------------------------------------------------------------------------------------------------- |
| `boolean`             | `@db.Boolean`                  | Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `Boolean`. |
...
| Native database types               | Native database type attribute | Notes |
| ----------------------------------- | ------------------------------ | ----- |
| `TINYINT(1)` \| `BOOLEAN`, `BOOL` | `@db.TinyInt`                  | <ul><li>Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `Boolean`</li><li>`TINYINT` maps to `Int` if the max length is greater than 1 (for example, `TINYINT(2)`) _or_ the default value is anything other than `1`, `0`, or `NULL`</li></ul> |
...
| Native database types | Native database type attribute | Notes |
| :-------------------- | :----------------------------- | ----- |
| `bit`                 | `@db.Bit`                      |  Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `Boolean`. |
...
| Native database types                  | Native database type attribute | Notes |
| -------------------------------------- | ------------------------------ | ----- |
| `integer` \| `int`, `int4`, `serial4`, | `@db.Integer`                  |  <ul><li>Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `Int`.</li><li>`@db.Int @default(autoincrement())` is equivalent to `serial4`</li></ul>
| `smallint` \| `int2`, `serial2`        | `@db.SmallInt`                 |  <!-- `@db.SmallInt @default(autoincrement())` is equivalent to `serial2` -->
...
| Native database types                      | Native database type attribute | Notes |
| ------------------------------------------ | ------------------------------ | ----- |
| `bigint` \| `int8`, `serial8`, `bigserial` | `@db.BigInt`                   |  <ul><li>Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `BigInt`.</li><!-- <li>`@db.BigInt @default(autoincrement())` is equivalent to `bigserial` / `serial8`</li> --></ul>
...
| Native database types | Native database type attribute | Notes   |
| --------------------- | ------------------------------ | ------- |
| `BIGINT`              | `@db.BigInt`                   |  Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `BigInt`.
...
| **Native database types** | **Native database type attribute** | Notes |
| ------------------------- | ---------------------------------- | ----- |
| `decimal` \| `numeric`    | `@db.Decimal(X, Y)`                      |  <ul><li>Prisma Migrate default native type <a href="#prisma-migrate-default-native-types" class="question"></a> for `Decimal`.</li><li>Default size (`X, Y`) is `2, 2`.</li></ul>
