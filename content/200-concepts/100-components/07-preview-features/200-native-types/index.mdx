...
Extended native database type support is a preview feature in 2.11.0. This preview include:

* **Type attributes** that **enrich your schema** with information about the underlying native database type
