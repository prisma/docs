...
| Native database types                                                      | Native database type attribute (preview) | Introspection |
| -------------------------------------------------------------------------- | ---------------------------------------- | :------------ |
| `integer` (default type) \| `int`, `int4`, `serial4`,  | `@db.Integer`                            | ✔️            |
| `smallint` \| `int2`, `serial2`                                                       | `@db.SmallInt`                           | ✔️            |  |
...
| **Native database types**      | **Native database type attribute (Preview)** | Introspection |
| ------------------------------ | -------------------------------------------- | ------------- |
| `DATETIME(x)`\* (default type) | `@db.DateTime(x)`                            | ✔️            |
| `DATE`                         | `@db.Date`                                   | ✔️            |
| `TIME(x)`                      | `@db.Time(x)`                                | ✔️            |
