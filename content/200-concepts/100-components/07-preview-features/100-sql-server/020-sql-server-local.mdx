...
![The New Query button in SQL Server Management Studio](../../../../doc-images/connect-sql-server.png)
...
You can now use the `sa` account in a connection string and when you log in to SQL Server Management Studio.
