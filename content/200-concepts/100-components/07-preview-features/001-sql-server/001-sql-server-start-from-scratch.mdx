...
1. Set up your Prisma project by creating your [Prisma schema](../../concepts/components/prisma-schema) file with the following command:
...
1. Define the `DATABASE_URL` [environment variable](../../concepts/components/prisma-schema#using-environment-variables) in the `prisma/.env` file - this is the connection string to your database.
