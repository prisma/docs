...
**Note**<br /><br />
The features of Prisma Studio are identical to those in the Data Browser in the Prisma Data Platform. See the [Data Browser](/data-platform/data-browser/) documentation.
</Admonition>
