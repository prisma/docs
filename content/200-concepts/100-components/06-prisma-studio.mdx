...
![Error message: "'Prisma Studio' can't be opened because Apple cannot check it for malicious software"](https://files.slack.com/files-pri/T0MQBS8JG-F01FU9K26KB/image.png)
