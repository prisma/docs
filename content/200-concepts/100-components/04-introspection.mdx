...
On MoFooNgoDB, the main functions are the following:
...
For now, using MoFooNgoDB introspection is meant to be done only once for initial data model. Running it repeatedly will lead to loss of data in the schema file, such as relations or comments.
