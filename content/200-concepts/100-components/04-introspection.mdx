...
Introspection is often used to generate an _initial_ version of the data model when [adding Prisma to an existing project](../../getting-started/setup-prisma/add-to-existing-project-typescript-postgres).
...
```
TODO Add validation error message from `generate`
```
