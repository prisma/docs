...
In [2.16.0](https://github.com/prisma/prisma/releases/2.16.0) and later, you can sort by properties of a relation. For example, the following query sorts all posts by the author's email address:
