...
<Admonition type="info">
  ...
  Note: You can only sort by nulls on optional fields. If you try to sort by nulls on a mandatory field, Prisma Client throws a [P2009 error](/reference/api-reference/error-reference#p2009).
