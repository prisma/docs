...
The following query returns all post returns all posts whose `content` field is `null`:
...
The following query returns all post returns all posts whose `content` field **not** `null`:
