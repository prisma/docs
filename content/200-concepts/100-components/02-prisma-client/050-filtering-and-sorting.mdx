...
Scalar lists (for example, `String[]`) have a special set of [filter conditions](../../../reference/api-reference/prisma-client-reference#scalar-list-filters) <span class="api"></span>
