...
The above query will match any name starting with any character — any user whose name is not `NULL`. If you instead wanted to find any user whose name starts with a literal `_`, you could do:
