...
Prisma Client supports [filtering on related records](relation-queries#filtering). For example, in the following schema, a user can have many blog posts:
...
In [2.16.0](https://github.com/prisma/prisma/releases/2.16.0) and later, you can sort by properties of a relation.  To enable this feature, add `orderByRelations` to `previewFeatures` in your schema:
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/vmVUeZny73o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

</div>

In [2.19.0](https://github.com/prisma/prisma/releases/2.19.0) and later, you can sort by the **count of related records**.  To enable this feature, add `orderByRelations` to `previewFeatures` in your schema:
