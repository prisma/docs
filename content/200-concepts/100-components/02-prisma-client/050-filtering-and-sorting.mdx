...
**Note:** You can only sort by nulls on optional scalar fields. If you try to sort by nulls on a required or relation field, Prisma Client throws a [P2009 error](/reference/api-reference/error-reference#p2009).
