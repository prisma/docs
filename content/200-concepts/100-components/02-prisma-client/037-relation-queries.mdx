...
The following example returns a post and its author relation:
...
For example, the following query returns all users and a list of titles for unpublished posts associated with each user:
