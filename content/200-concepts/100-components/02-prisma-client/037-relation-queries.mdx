...
Prisma Client provides the [`some`](../../../reference/api-reference/prisma-client-reference#some), [`every`], and [`none`] options to filter records by the properties of _related_ records. For example:
