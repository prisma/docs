...
> **Note**: Be aware that [concurrent `connectOrCreate` queries can result in a race condition](../../../reference/api-reference/prisma-client-reference#remarks-15) <span class="api"></span> and may need to be retried.
