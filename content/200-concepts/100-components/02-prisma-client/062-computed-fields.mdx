...
- This is an excerpt from a larger guide on [How to Extend the Prisma Client](/guides/database/extend-client). In the guide we talk about how you can move this `computeFullName` function into a custom model.
