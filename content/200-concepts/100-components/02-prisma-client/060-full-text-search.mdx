...
The Prisma Client supports searching for text within a field. You can use full-text search to add search to your application.

The Prisma Client supports a full-text search API for Postgres. With full-text search, you can search for text within a column.
