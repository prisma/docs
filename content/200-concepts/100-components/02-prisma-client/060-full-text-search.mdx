...
While the Prisma Schema doesn't natively support GIN indices yet, you can easily
define your own index in SQL:

```sql
CREATE INDEX post_body_index ON "Post" USING GIN (to_tsvector('english', "body"));
```

And you can continue using Prisma Migrate as you were before, it will ignore indexes
