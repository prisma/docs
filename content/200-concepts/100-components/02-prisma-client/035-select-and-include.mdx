...
- Use [`select`](../../../reference/api-reference/prisma-client-reference#select) <span class="api"></span> to return specific fields
- Use [`include`](../../../reference/api-reference/prisma-client-reference#include) <span class="api"></span> to explicitly include relations
...
Use `select` to return a limited subset of fields instead of all fields.
...
Use  <span class="api"></span> to include related records, such as a user's posts or profile, in the response.
