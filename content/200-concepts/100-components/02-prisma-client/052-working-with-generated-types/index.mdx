...
To access the generated types you need to import the Prisma namespace from the `@prisma/client` package. You can then access the `validator` function. It helps you create re-usable query parameters based on your schema models while making sure that the objects you create are valid.
...
// HasSelect
const hasSelect = Prisma.validator<Prisma.HasSelect>()({
      select: {
        name: true,
        email: true,
        posts: false
...
// HasInclude
const hasInclude = Prisma.validator<Prisma.HasInclude>()({
      include: {
        posts: true
      }
})
