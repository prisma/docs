...
Also, go through the public proposal for information: https://github.com/prisma/prisma/issues/15074#issuecomment-1282419200

Also: for the docs to be complete, we will need how type utilities can be used in $extends for full type-safety.
