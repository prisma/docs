...
Prisma Client is an auto-generated database client that's tailored to your database schema. By default, Prisma Client is generated into the `node_modules/@prisma/client` folder, but [you can specify a custom location](#specifying-the-target-location-for-prisma-client).
...
1. You can now [instantiate the Prisma Client](instantiating-prisma-client) in your code:
