...
Add Prisma middleware **outside the context of the request handler**. The following example demonstrates where to add Prisma middleware in the context of an Express app:
...
* Runs the next middleware (middlewares #1 and #2 in the example) _or_
* Runs the original Prisma Client query (middleware #3)
