...
Middlewares act as query-level lifecycle hooks, which allow you to perform an action **before or after** a query runs. Use the [`prisma.$use`](../../../../reference/api-reference/prisma-client-reference#on) <span class="api"></span> method to add middlewares:
