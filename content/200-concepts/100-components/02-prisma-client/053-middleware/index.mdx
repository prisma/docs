...
Middleware allows you to perform an action **before or after** each query runs. Use the [`prisma.$use`](../../../../reference/api-reference/prisma-client-reference#on) <span class="api"></span> method to add middleware:
