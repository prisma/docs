...
If you want an even more detailed insight into your application's performance, at the level of individual queries, see [Tracing](/concepts/components/prisma-client/tracing).
