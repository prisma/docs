...
- Counters (always increase):
  ...
  - `prisma_datasource_queries_total`: The total number of datasource queries executed.
  - `prisma_client_queries_total`: The total number of Prisma Client queries executed.
    - The value returned by `prisma_client_queries_total` can be less than `prisma_datasource_queries_total`, because some Prisma Client operations create multiple queries.
