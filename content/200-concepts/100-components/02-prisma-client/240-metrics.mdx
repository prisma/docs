...
If you want an even more detailed insight into your Clients performance, at the level of individual queries, see [Tracing](/concepts/components/prisma-client/tracing).
