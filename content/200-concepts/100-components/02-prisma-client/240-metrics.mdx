...
- Gauges (can increase or decrease):
  ...
  - `prisma_pool_connections_open`: The number of [pool connections](/concepts/components/prisma-client/working-with-prismaclient/connection-pool#default-connection-pool-size) open.
