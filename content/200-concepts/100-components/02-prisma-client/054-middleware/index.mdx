...
From version 4.7.0, you can use the [Prisma Client extensions `query` component type](/concepts/components/prisma-client/extensions/query) as an alternative to middleware. You can create independent clients and bind each client to a specific filter or user. For example, you could bind clients to specific users to provide user isolation. Client extensions also provide end-to-end type safety.
