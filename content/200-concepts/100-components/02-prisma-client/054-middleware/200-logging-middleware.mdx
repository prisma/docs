...
You can also use [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) to log the time it takes to perform a query. You can also find a functional example in [this GitHub repository](https://github.com/prisma/prisma-client-extensions/tree/main/query-logging).
