...
<TabbedContent tabs={[ <FileWithIcon text="Prisma Client extension" icon="file"/>,<FileWithIcon text="Example query" icon="file"/>, <FileWithIcon text="Prisma schema" icon="file"/>]}>
