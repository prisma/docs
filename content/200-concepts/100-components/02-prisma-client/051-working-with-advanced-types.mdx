---
title: 'Working with field values'
metaTitle: 'Working with field values (Concepts)'
...
In [2.20.0](https://github.com/prisma/prisma/releases/2.20.0) and later, you can use the atomic [`push`](../../../reference/api-reference/prisma-client-reference#push) <span class="api"></span> method to add a single value to a scalar list:
