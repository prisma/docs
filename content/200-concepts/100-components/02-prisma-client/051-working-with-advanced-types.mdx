...
The following example demonstrates how to create and filter on `sample` records with Prisma Client. - `Decimal` uses the [`Decimal.js` library](https://mikemcl.github.io/decimal.js/)
