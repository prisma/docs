...
### Order composite types with <inlineCode>orderBy</inlineCode>

You can use the `orderBy` operation in combination with `findMany` to sort results in ascending or descending order.
