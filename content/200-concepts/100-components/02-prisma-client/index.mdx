...
color="dark"
type="primary"
href="../../../getting-started/setup-prisma/start-from-scratch/relational-databases-typescript-postgres">Set up a new project from scratch
</ButtonLink>
<br />
<br />
<ButtonLink
color="dark"
type="primary"
href="../../../getting-started/setup-prisma/add-to-existing-project/relational-databases-typescript-postgres">Add Prisma to an existing project</ButtonLink>
