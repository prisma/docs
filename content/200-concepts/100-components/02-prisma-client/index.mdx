...
color="dark"
type="primary"
href="../../../getting-started/setup-prisma/start-from-scratch-sql">Set up a new project from scratch
</ButtonLink>
<br />
<br />
<ButtonLink
...
Whenever you make changes to your database that are reflected in the Prisma schema, you need to manually re-generate Prisma Client to update the generated code in the [`node_modules/@prisma/client`](configuring-and-initializing-prisma-client/generating-prisma-client#the-prismaclient-npm-package) directory:
