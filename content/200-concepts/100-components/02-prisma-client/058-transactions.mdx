...
**Note**: If you use interactive transactions, then you cannot use [Prisma Data Proxy](/concepts/data-platform/data-proxy#providing-the-connection-string-to-prisma-migrate) at the same time.
