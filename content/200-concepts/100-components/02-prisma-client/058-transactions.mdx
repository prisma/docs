...
From version 4.2.0, you can set the transaction isolation level.

Note: Prisma does not support this feature on MongoDB.

<Admonition type="info">

**Before version 4.2.0**

Before version 4.2.0, you could not configure the transaction isolation level at a Prisma level, and the isolation level was not explicitly set by Prisma. For more information, see the following resources:
...
To set the transaction isolation level, use the following statement:
