...
To avoid this problem, you can set higher isolation levels of either `RepeatableRead` or `Serializable`. From Prisma version 4.4.0, you do not need to set the isolation level in your database configuration. You can instead set a higher isolation level on the transactions.
