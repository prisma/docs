...
> **Note**: To use interactive transactions, you need to [enable it as a Preview feature](/guides/upgrade-guides/upgrading-to-use-preview-features#enabling-preview-features).
...
**Note**: Interactive Transactions with the [Data Proxy](/data-platform/data-proxy#providing-the-connection-string-to-prisma-migrate) are in General Avaialbility in version 4.7.0.
