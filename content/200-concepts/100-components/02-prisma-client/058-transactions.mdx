...
Interactive Transactions with the [Data Proxy](/data-platform/data-proxy#providing-the-connection-string-to-prisma-migrate) are in General Avaialbility since version 4.7.0.
