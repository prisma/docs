...
To support this use case and more, you can pass an async function into the [`$transaction`](../../../guides/performance-and-optimization/prisma-client-transactions-guide#transaction-api) method.

The following is an example of purchasing a movie ticket online. This is a good use case for interactive transactions because you don't want to sell the same ticket twice.
...
The 2nd parameter supports the following configuration options:
