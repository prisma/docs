...
Interactive transactions are generally available from version 4.7.0. Version 2.29.0 introduces interactive transactions that do not yet support the [Data Proxy](/data-platform/data-proxy). In version 4.6.0, you can use interactive transactions with the [Data Proxy](/data-platform/data-proxy) in preview. 
