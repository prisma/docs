...
metaDescription: 'How to use Prisma Client extensions to add custom validation for your queries.'
tocDepth: 3
---
...
The following extension validates the input for the `create` and `update` methods on a `User` model using [Zod](https://github.com/colinhacks/zod):
