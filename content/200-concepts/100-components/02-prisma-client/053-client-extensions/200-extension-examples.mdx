...
## Prisma-built extensions

The following is a list of extensions we've built at Prisma:

| Extension                                                                                             | Description                                                                                                               |
| :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------ |
| [`@prisma/extension-accelerate`](https://www.prisma.io/docs/data-platform/accelerate/getting-started) | Enables Accelerate, a global database cache                                                                               |
...
| [`@prisma/extension-read-replicas`](https://github.com/prisma/read-replicas)                          | Adds read replica support to Prisma Client                                                                                |
