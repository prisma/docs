---
title: 'Examples'
metaTitle: 'Prisma Client extensions | Prisma- & Community-built extensions and examples'
metaDescription: 'Prisma Client extensions | Prisma- & Community-built extensions and examples'
---
...
| :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------ |
| [`@prisma/extension-accelerate`](https://www.prisma.io/docs/data-platform/accelerate/getting-started) | Enables Accelerate, a global database cache available in 300+ locations with built-in connection pooling                                                                           |
| [`@prisma/extension-pulse`](https://www.prisma.io/docs/data-platform/pulse/what-is-pulse)             | Enables Pulse, a service that captures change events from your database and delivers them instantly to your applications. |
...
The following is a list of extensions created by the community. If you want to create your own package, refer to the [Shared Prisma Client extensions](./shared-extensions) documentation.

| Extension                                                                                      | Description                                                                                                                                    |
| :--------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------- |
| [`prisma-extension-supabase-rls`](https://github.com/dthyresson/prisma-extension-supabase-rls) | Adds support Supabase Row Level Security with Prisma                                                                                           |
| [`prisma-extension-bark`](https://github.com/deptyped/prisma-extension-pagination)             | The extension is implementation of the Materialized Path pattern that allows you to easily create and interact with tree structures in Prisma. |
| [`prisma-cursorstream`](https://github.com/etabits/prisma-cursorstream)                        | Adds cursor-based streaming                                                                                                                    |
| [`prisma-gpt`](https://github.com/aliyeysides/prisma-gpt)                                      | Let's you query your database using natural language.                                                                                          |
...
These example extensions are provided as examples only, and without warranty. They are supposed to show how Prisma Client extensions can be created, using approaches documented here. We recommend using the examples as a source of inspiration for building your own extensions.
