...
| [`prisma-extension-bark`](https://github.com/deptyped/prisma-extension-pagination)             | Implements the Materialized Path pattern that allows you to easily create and interact with tree structures in Prisma |
