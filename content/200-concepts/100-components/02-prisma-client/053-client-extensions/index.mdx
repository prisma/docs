...
Prisma Client extensions currently do not support nested read and write operations. If you're interested in this feature, let us know by opening a [feature request](https://github.com/prisma/prisma/issues/new?assignees=&labels=&template=feature_request.md&title=) with your use case. 
