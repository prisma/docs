...
- [Enable the preview feature](#enable-the-preview-feature)
...
- [Query extensions versus middlewares](#query-extensions-versus-middlewares)
  - [If you use the query extension component and middlewares](#if-you-use-the-query-extension-component-and-middlewares)
...
Alternatively, you can also use the `$allOperations` method available directly from the `query` extension component to extend all operations on all models:
