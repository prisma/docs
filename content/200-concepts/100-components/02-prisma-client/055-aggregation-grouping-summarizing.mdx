...
This feature is generally available in version `4.16.0` and later. It was first added as a [Preview feature](/concepts/components/preview-features) in version [`4.3.0`](https://github.com/prisma/prisma/releases/tag/4.3.0).
