...
- From version 4.1.0, can [filter relation counts](#filter-the-relation-count)
...
This feature is available from version 4.1.0. To use it, you need to add the [preview feature](/concepts/components/preview-features/client-preview-features#enabling-a-prisma-client-preview-feature) `filteredRelationCount`.
