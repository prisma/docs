...
2. Exists in the context of a long-running application, such as a background service. If the application never shuts down, Prisma Client never disconnects. In fact, each new `PrismaClient` results in an additional connection pool.
