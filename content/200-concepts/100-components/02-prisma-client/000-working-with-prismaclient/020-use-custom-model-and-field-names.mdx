...
Foreign keys are represented as a combination of a [annotated relation fields](/concepts/components/prisma-schema/relations#relation-fields) and its corresponding relation scalar field in the Prisma schema. Here's how all the relations from the SQL schema are currently represented:
