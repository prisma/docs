...
When and where to instantiate `PrismaClient` depends on your environment, as does whether or not explicitly connect or disconnect. Each instance of `PrismaClient` controls a connection pool,
...
## Why does the number of `PrismaClient` instances matter?

Test

## <inlinecode>PrismaClient</inlinecode> in long-running environments
...
* Create an instance outside of function (e.g. in runtime)
* *Might* need Explicitly disconnect
