...
1. The query engine instantiates a connection pool with a [configurable pool size](#setting-the-connection-limit) and [pool timeout](#setting-the-connection-pool-timeout).
