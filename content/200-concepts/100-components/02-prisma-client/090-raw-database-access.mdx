...
If you cannot use tagged templates, you can instead use [`$queryRawUnsafe`](#queryrawunsafe) or [`$executeRawUnsafe`](#executerawunsafe) but **be aware that your code may be vulnerable to SQL injection**.
