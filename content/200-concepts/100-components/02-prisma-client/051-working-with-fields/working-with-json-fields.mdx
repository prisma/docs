...
No - it is not yet possible to select a subset of key/values to return. Prisma Client returns the entire JSON object.

## Filter on the presence of a specific key
