...
## Reasons to use the <inlinecode>Json</inlinecode> field type {#something-dark-side}
...
Filtering on object key values within an array is **only** supported by the [MySQL database connector](../../../database-connectors/mysql).
