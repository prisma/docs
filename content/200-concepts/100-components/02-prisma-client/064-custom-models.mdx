...
We recommend using [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) to extend your models with [custom model methods](/concepts/components/prisma-client/client-extensions/custom-model-methods).
