...
- Creating static methods using a [Prisma Client extension](/concepts/components/prisma-client/client-extensions)
...
<TabbedContent tabs={[<FileWithIcon text="Prisma Client extension" icon="code"/>, <FileWithIcon text="Example query" icon="code"/>,<FileWithIcon text="Prisma schema" icon="file"/>]}>
...
We recommend using [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) to extend your models with [custom model methods](https://github.com/prisma/prisma-client-extensions/tree/main/instance-methods).
