...
- [Create](/concepts/components/prisma-client/crud/create)
- [Read](/concepts/components/prisma-client/crud/create)
- [Update](/concepts/components/prisma-client/crud/update)
- [Delete](/concepts/components/prisma-client/crud/delete)
