...
If you are comfortable working with raw SQL you can perform a `TRUNCATE` on a table by utilizing [`$queryRaw`](/concepts/components/prisma-client/raw-database-access#queryraw).
