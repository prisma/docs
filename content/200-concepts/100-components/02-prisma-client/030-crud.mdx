...
For more information about creating related records, see [Working with relations](relation-queries).

### Create a record and connect it to an existing related record

See [Working with relations](relation-queries#connect-an-existing-record) for information about connecting related records.
