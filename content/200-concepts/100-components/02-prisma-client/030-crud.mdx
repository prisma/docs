...
Prisma Client does not yet support batching at a database level.  The following example does create two `User` records - however, this will result in two separate `INSERT` queries. Follow GitHub issue #XXX for information about bulk inserts.
