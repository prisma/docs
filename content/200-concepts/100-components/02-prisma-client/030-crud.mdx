...
Prisma Client supports bulk inserts as a Preview feature in 2.16.0 and later. To enable this feature, add `createMany` to the `previewFeatures` list as shown:
