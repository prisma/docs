...
The user's `id` is auto-generated, and your schema determines [which fields are mandatory](../prisma-schema/data-model#optional-and-mandatory-fields).
...
In [2.26.0](https://github.com/prisma/prisma/releases/tag/2.26.0) and later it is possible to do cascading deletes using the **preview feature** [referential actions](../prisma-schema/relations/referential-actions).
