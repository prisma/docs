...
The following examples demonstrate how to retrieve records by a compound ID or unique identifier, defined by [`@@id`]() <span class="api"></span> or [`@@unique`]() <span class="api"></span>. 
...
#### <inlinecode>prisma migrate reset</inlinecode>

#### Native SQL to truncate tables

https://github.com/prisma/prisma/issues/742#issuecomment-776901281

#### Prisma Client / reflection
