...
You can use the `result` [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) component to add custom fields and methods to query results. We introduced this feature in version 4.7.0.
