...
Before you create custom queries, you must satisfy the [prerequsites for client extensions](/concepts/components/prisma-client/client-extensions#prerequisites).
...
query — an optional field for changing the queries of a model.
