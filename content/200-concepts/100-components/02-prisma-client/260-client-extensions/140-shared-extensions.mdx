...
You can improve the type-safety and developer experience of your shared extensions with the [type utilities on `model` components](/concepts/components/prisma-client/client-extensions/model#advanced-type-safety-improve-the-type-safety-and-developer-experience-of-your-extensions).
