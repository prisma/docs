...
You could then share the above code on `npm` or as a code snippet. When you choose a package name, we recommend that you use the `prisma-extension-<package-name>` convention, to make it easier to find and install.
