...
Use `Prisma.defineExtension` to make your extensions shareable. You can use it to do the following:

- Move an extension to another file in your project, and you still benefit from auto-completion and type checks.
- Package a feature that you want to share with other users. Prisma users can export and load the result of `Prisma.defineExtension` with `$extends`.
