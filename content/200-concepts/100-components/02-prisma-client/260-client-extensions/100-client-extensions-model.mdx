...
From version 4.7.0, you can use `model` [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) to add custom methods to your models.
...
You would call `signUp` in your application as follows: **_ is this correct? _**
