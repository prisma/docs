...
This feature is available from Prisma version 4.9.0.

</Admonition>

If you want your `model` component to work with multiple models, not just a specific one, you can use the following arguments.
