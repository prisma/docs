...
From version 4.7.0, you can use `model` component type of [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) to add custom methods to your models.
