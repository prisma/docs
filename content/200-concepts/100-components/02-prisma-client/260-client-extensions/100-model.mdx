...
To help you create highly type-safe extensions, Prisma Client provides a set of type utilities that tap into input and output types. You can use them to create [shared extensions](/concepts/components/prisma-client/client-extensions/shared-extensions) that have an excellent auto-completion and developer experience. They are fully dynamic, which means that they adapt to any given model and schema.
