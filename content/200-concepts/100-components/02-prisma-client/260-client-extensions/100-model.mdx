...
When you call a method in an extension, use the constant name from your`$extends`statement, not `prisma`. Instead, use the constant name from your`$extends`statement. In the above example,`xprisma.user.signUp` works, but `prisma.user.signUp` does not.
...
When you call a method in an extension, use the constant name from your`$extends`statement, not `prisma`. Instead, use the constant name from your`$extends`statement. In the above example,`xprisma.user.getClass` works, but `prisma.user.getClass` does not.
