...
From version 4.7.0, you can use `model` [Prisma Client extensions](/concepts/components/prisma-client/client-extensions) component type to add custom methods to your models.
