...
To help you create highly type-safe extensions, Prisma Client provides a set of type utilities that tap into input and output types. They are especially useful when you create shared extensions, because they are fully dynamic. This means that they adapt to any given model and schema. You can use them to create extensions that have an excellent auto-completion and developer experience.
