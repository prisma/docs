...
You can improve the type-safety of your shared extensions with the [type utilities on `model` components](/concepts/components/prisma-client/client-extensions/type-utilities).
