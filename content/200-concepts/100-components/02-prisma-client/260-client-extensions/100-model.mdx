...
If you want to call a method in the same extension, or in another extension, then you cannot use the form `prisma.user.<method name>`

You can use this to: 1. call a sibling method in the same extension. 2. call a method in another extension.
...
Add note that it doesn't work with $allModels.
