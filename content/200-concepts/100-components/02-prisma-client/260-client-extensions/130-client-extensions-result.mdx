...
## Add a custom field or method to query results

UTo add a custom field or method to query results, use the following structure. In this example, we extend query results in the `user` model.
