...
- [A specific top-level client operation](#add-or-modify-a-custom-query-for-a-specific-top-level-client-operation)
...
### Add or modify a custom query for a specific top-level client operation

To apply custom behavior to a specific top-level client query operation:
