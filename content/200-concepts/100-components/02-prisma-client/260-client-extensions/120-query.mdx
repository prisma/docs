...
The following example shows how to wrap an extended query into a batch transaction. It extends `findFirst` to take the input `args` and wraps it in a batch transaction.
