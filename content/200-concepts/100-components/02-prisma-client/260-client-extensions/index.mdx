...
Prisma Client extensions are available in Preview since the [4.7.0](https://github.com/prisma/prisma/releases/tag/4.7.0) release.
...
Generally, Prisma Client extensions should be able to be used in all scenarios where middlewares are being used as well.
