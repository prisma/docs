...
There are four types of extension component that you can use to extend the client, as follows:
...
You can combine more than one of these component types in a single extension. For example, you might create an extension that uses the `model` and `client` component types.
