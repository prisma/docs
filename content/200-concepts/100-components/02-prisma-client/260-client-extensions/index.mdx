...
You can run an extension in its own isolated extended client, or combine it with other extensions in an extended client by using [multiple extensions](#multiple-extensions).
