...
You can infer the type of an extended Prisma Client instance using the [`ReturnType`](https://www.typescriptlang.org/docs/handbook/utility-types.html#returntypetype) as follows:
