...
## Create generic extensions

You can create extensions that do not apply only to a specific schema, but that can work with multiple schemas.

**TBW**
What we want to cover:

Use the $all forms
Use getExtensionContext (name and methodName)
