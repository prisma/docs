...
Use Prisma Client extensions to add functionality to your models, result objects, and queries, or to add client-level methods. There are four extension components that you can use to change aspects of the client, as follows:
