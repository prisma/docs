...
const xprisma = prisma.$extends({
  name: `signUp`,  // (Optional) This extension name appears in error logs and tracing
...
Each time that you call `$extends`, you create an _extended client_. This extended client is a forked variant of the standard Prisma Client. The original client does not change.
