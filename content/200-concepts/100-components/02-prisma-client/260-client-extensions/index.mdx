...
Use Prisma Client extensions to add functionality to your models, result objects, and queries, or to add client-level methods. There are four types of extension as follows:
...
You can combine more than one of these extension types in a single extension. For example, you might create an extension that uses the `model` and `client` extension types.
