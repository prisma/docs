...
You can use [multiple independent extensions at the same time](#multiple-extensions). Each of these instances runs in its own isolated instance of Prisma Client, unless you deliberately combine them.
