...
You can also combine two or more extensions into one extended client, if you want the functionality from all of these extensions to apply in the same client instance. Note that it is possible for [combined extensions to conflict](#conflicts-in-combined-extensions).
