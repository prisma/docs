...
- Middlewares always apply globally to the same client, while extensions are isolated, unless you deliberately combine them.
...
- Extensions benefit from end-to-end type safety and inference, while middlewares don't.
