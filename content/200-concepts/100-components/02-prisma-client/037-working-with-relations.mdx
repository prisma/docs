...
Use  <span class="api"></span> to include related records, such as a user's posts or profile, in the response. This is known as a **nested read**. The following example returns a single user _and_ that user's posts:
