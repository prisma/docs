...
| Requirement                                                            | Query option                        |
| ---------------------------------------------------------------------- | ----------------------------------- |
| "I want a list of every user that has _at least one_ unpublished post" | `some` posts are unpublished        |
| "I want a list of every user that has _no_ unpublished post"           | `none` of the posts are unpublished |
| "I want a list of every user that has _only_ unpublished post"         | `every` post is unpublished         |
