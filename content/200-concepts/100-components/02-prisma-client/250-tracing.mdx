...
**TBA: Garren to provide some notes on performance considerations. We'll say something like "Note that tracing has a significant effect on performance in the following situations:"**
