...
Depending on the Prisma operation, Prisma Client might output any of the following spans:
...
- `prisma:middleware`: The amount of time the operation spends in your [middleware](/concepts/components/prisma-client/middleware).
