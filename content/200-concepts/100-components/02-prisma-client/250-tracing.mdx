...
Prisma Client outputs the following spans. The number and type of spans varies depending on the Prisma operation.
...
If you application sends a large number of spans to a [collector](https://opentelemetry.io/docs/collector/), then this can have a significant performance impact. For our recommended approaches to reduce this performance impact, see [Reduce performance impact](#reduce-performance-impact).
