...
**TBA: Garren to provide some notes on performance considerations. We'll say something like "Note that tracing has a significant effect on performance in the following situations". See notes here - https://github.com/prisma/prisma/issues/13503#event-6977115220**
