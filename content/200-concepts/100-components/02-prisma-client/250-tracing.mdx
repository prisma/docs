...
Tracing provides a record of each query that Prisma Client generates. It is fully compliant with Open Telemetry, so you can use tracing as part of your end-to-end application diagnostics.
