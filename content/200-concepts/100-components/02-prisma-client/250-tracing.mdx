...
For each trace, Prisma Client outputs a series of spans. The number and type of these spans varies, depending on the Prisma operation.

For example, if you perform the following operation...
...
...then the trace is structured as follows:
...
The possible spans that Prisma Client can output are as follows:
