...
**For this code example, rather than provide a complete app, I think we need to just give the user some snippets of what to add to their app to 1. configure tracing in general, 2. send tracing to the console, and 3. send tracing output to Jaeger. These should probably be separate headings**
