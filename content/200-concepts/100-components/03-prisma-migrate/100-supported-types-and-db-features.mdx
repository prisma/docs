...
- [PostgreSQL mappings](/concepts/database-connectors/postgresql#type-mapping-between-postgresql-to-prisma-schema)
- [MySQL mappings](/concepts/database-connectors/mysql#type-mapping-between-mysql-to-prisma-schema)
