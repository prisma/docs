...
Prisma Migrate does not currently support the [MongoDB connector](/concepts/components/database-connectors/mongodb).
...
- [PostgreSQL mappings](/concepts/components/database-connectors/postgresql#prisma-migrate)
- [MySQL mappings](/concepts/components/database-connectors/mysql#prisma-migrate)
- [Microsoft SQL Server mappings](/concepts/components/database-connectors/sql-server#type-mapping-between-microsoft-sql-server-to-prisma-schema)
- [SQLite mappings](/concepts/components/database-connectors/sqlite#data-model-mapping)
