...
1. Edit the generated `20201208100950_fullname_field/migration.sql` file:
...
See [Guide: Add Prisma Migrate to an existing project](../../../guides/prisma-guides/add-prisma-migrate-to-a-project)

## Seeding

See: [Guide: Seeding your database](../../../guides/application-lifecycle/seed-database#integrated-seeding-with-prisma-migrate)
