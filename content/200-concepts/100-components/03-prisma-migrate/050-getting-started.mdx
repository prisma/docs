...
metaDescription: 'Getting started with Prisma Migrate'
tocDepth: 2
---

<TopBlock>

This page explains how to get started with migrating your schema using Prisma Migrate.
