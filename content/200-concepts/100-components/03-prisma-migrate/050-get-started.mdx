...
This page explains how to get started with migrating your schema in a development environment using Prisma Migrate. See [Developing with Prisma Migrate](/guides/database/developing-with-prisma-migrate) <span class="guide"></span> for a more in-depth development workflow.
