...
If you want to prototype or iterate on a schema design in a development environment, consider the [`db push` command](/reference/api-reference/prisma-cli/command-reference#db-push).
