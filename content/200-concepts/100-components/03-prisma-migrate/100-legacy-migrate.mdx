...
If you want to prototype or iterate on a schema design in a development environment, consider the [`db push` command](../../../../reference/api-reference/command-reference#db-push--preview).
...
| Cascading deletes                   | `ON DELETE`                     | Not yet ([workaround](../../../guides/database/advanced-database-guides/cascading-deletes/postgresql)) |
