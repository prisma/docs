...
The following table shows which SQL operations are currently supported by legacy Prisma Migrate. If an operation is not yet supported, it links to a workaround that uses plain SQL and [introspection](/concepts/components/introspection) to enable this feature in Prisma Client.
...
![Typical workflow with legacy Prisma Migrate](https://res.cloudinary.com/prismaio/image/upload/v1628761154/docs/OImder6.png)
