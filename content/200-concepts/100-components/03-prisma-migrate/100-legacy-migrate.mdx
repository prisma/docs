...
> **Important!** This page documents legacy Prisma Migrate available in version 2.12.0 and earlier. As of version 2.13.0, legacy Prisma Migrate is **no longer being maintained**.
