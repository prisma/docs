...
- You want to [rename a field](/guides/migrate/developing-with-prisma-migrate/customizing-migrations#renaming-a-field) (by default, Prisma Migrate will drop the existing field)
- You want to [change the direction of a 1-1 relationship](/guides/migrate/developing-with-prisma-migrate/customizing-migrations#changing-the-direction-of-a-1-1-relation)
