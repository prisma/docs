...
- You want to [rename a field](/guides/database/developing-with-prisma-migrate/customizing-migrations#example-rename-a-field) (by default, Prisma Migrate will drop the existing field)
- You want to [change the direction of a 1-1 relationship](/guides/database/developing-with-prisma-migrate/customizing-migrations#example-change-the-direction-of-a-1-1-relation)
