---
title: 'Prototype your schema'
metaTitle: 'Prototype your schema'
metaDescription: 'Prototype your schema'
codeStyle: false
---

<TopBlock>

The Prisma CLI has a dedicated command for prototyping schemas: [`db push`](/reference/api-reference/prisma-cli/command-reference#db-push) <span class="api"></span>
...
See [Schema prototyping with `db push`](/guides/migrate/prototyping-schema-db-push) <span class="guide"></span> for an example of how to use `db push` in this way.
...
- You want fine-grained control over how the schema changes are executed - for example, [renaming a column instead of dropping it and creating a new one](/guides/migrate/developing-with-prisma-migrate/customizing-migrations#example-rename-a-field).
