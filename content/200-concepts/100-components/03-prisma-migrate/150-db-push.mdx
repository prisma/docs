...
-   You want fine-grained control over how the schema changes are executed - for example, [renaming a column instead of dropping it and creating a new one](../../../guides/database/developing-with-prisma-migrate/advanced-migrate-scenarios#renaming-a-field).
...
Yes, you can [use `db push` and Prisma Migrate together in you development workflow](../../../guides/database/prototyping-schema-db-push) <span class="guide"></span>. For example, you can:
