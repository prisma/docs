...
- You want fine-grained control over how the schema changes are executed - for example, [renaming a column instead of dropping it and creating a new one](/guides/database/developing-with-prisma-migrate/customizing-migrations#example-rename-a-field).
