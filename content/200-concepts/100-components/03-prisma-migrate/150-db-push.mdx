...
[`db push`]() <span class="api"></span> uses the same engine as Prisma Migrate to synchronize your Prisma schema with your database schema, and is best suited to **schema prototyping**. The `db push` command:
