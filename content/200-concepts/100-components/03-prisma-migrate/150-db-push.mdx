...
[`db push`](../../../reference/api-reference/command-reference#db-push--preview) <span class="api"></span> uses the same engine as Prisma Migrate to synchronize your Prisma schema with your database schema, and is best suited for **schema prototyping**. The `db push` command:
