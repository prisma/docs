...
[`db push`](../../../reference/api-reference/command-reference#db-push) <span class="api"></span> uses the same engine as Prisma Migrate to synchronize your Prisma schema with your database schema, and is best suited to **schema prototyping**. The `db push` command:
...
Yes, you can [use `db push` and Prisma Migrate together in you development workflow](../../../guides/application-lifecycle/prototyping-schema-db-push) <span class="guide"></span>. For example, you can:
