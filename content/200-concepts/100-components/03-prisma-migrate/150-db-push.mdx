...
- You want fine-grained control over how the schema changes are executed - for example, [renaming a column instead of dropping it and creating a new one](/guides/migrate/developing-with-prisma-migrate/customizing-migrations#renaming-a-field).
