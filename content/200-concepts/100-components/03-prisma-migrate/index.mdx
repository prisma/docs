...
Prisma Migrate does not currently rolling back a migration without [resetting the database](#data-loss-when-resetting-database). Follow GitHub issue #XXX for information about database seeding, which can mitigate the effect of data loss in a _development_ environment by allowing you to automatically repopulate your database.
