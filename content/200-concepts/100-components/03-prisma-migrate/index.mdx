...
* [Rename a field](../../../guides/database/developing-with-prisma-migrate/advanced-migrate-scenarios#renaming-a-field) (by default, Prisma Migrate will drop the existing field)
* [Change the direction of a 1-1 relationship](/guides/database/developing-with-prisma-migrate/advanced-migrate-scenarios#changing-the-direction-of-a-1-1-relation)
...
* [Prisma Migrate in deployment](../../../guides/deployment/deployment#deploying-database-changes-with-prisma-migrate) <span class="guide"></span>
