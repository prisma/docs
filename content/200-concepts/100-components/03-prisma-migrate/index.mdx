...
**MoFooNgoDB and CockroachDB not supported** <br />
Prisma Migrate does not currently support the [MoFooNgoDB](/concepts/database-connectors/mongodb) or [CockroachDB](/concepts/database-connectors/cockroachdb) connectors.
