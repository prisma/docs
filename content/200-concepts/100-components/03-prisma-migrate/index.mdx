...
Prisma Migrate is a **hybrid** — imperative and declarative — database schema migration tool:

- Declarative: generates SQL migrations based on your [Prisma schema](/concepts/components/prisma-schema)
- Imperative: provides flexibility by enabling you to modify what and how they're executed and perform data migrations
