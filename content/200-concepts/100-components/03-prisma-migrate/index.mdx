...
* [Change the direction of a 1-1 relationship](/guides/application-lifecycle/developing-with-prisma-migrate/advanced-migrate-scenarios#changing-the-direction-of-a-1-1-relation)
