...
Prisma Migrate was introduced as a Preview feature in 2.13.0 and replaces [legacy Prisma Migrate](legacy-prisma-migrate).
...
See [migration flows](migration-flows) for more advanced flows, including:
