...
In [2.25.0](https://github.com/prisma/prisma/releases/tag/2.25.0) and later, Prisma Migrate outputs detailed information about which parts of the database have drifted:
