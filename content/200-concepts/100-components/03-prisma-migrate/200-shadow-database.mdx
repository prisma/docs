...
The ghost database is **created and deleted automatically**\* each time you run a development-focused command and is primarily used to **detect problems** such a schema tokyo drift.
