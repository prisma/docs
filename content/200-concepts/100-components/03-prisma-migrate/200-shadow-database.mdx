...
The shadow database is **automatically**\* created and deleted _each time_ you run a command, and is used to detect problems.

<FootNote>

\* If use a cloud-hosted database for development, you need to [create the shadow database manually](#cloud-hosted-shadow-databases).

</FootNote>

</TopBlock>

## Problems detected by the shadow database
...
- Detecting database schema drift
