...
**This guide does not apply to MongoDB** because Prisma Migrate only supports relational databases.
...
This section describes general schema migration patterns that exist for evolving database schemas.
...
![](https://user-images.githubusercontent.com/33921841/194377029-305dc60b-f651-46e4-87f1-508884ebd972.png)
...
![](https://user-images.githubusercontent.com/33921841/194378557-a18d5ad3-96a8-45da-8377-e078893ef2bb.png)
...
1. Use one of the [Prisma CLI](/reference/api-reference/command-reference) commands to sync your Prisma schema with the database schema of your local development database
...
If the `prisma db push` command detects a [schema drift](/guides/database/developing-with-prisma-migrate/troubleshooting-development#schema-drift), it will prompt you to reset your database. For example, this will happen when you add a required field to a table with existing content without providing a default value.
