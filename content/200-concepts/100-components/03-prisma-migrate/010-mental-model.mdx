...
<TopBlock>Something something somethi</TopBlock>
...
`db push` is great for quickly prototyping and iterating on your database schema and prioritizing a desired-end state for your database schema.
