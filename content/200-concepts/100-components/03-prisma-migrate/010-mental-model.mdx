...
For more information on what database migrations are, see the [Prisma Data Guide](https://www.prisma.io/dataguide/types/relational/what-are-database-migrations).
