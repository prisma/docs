...
CREATE INDEX "Example_value_idx" ON "Example" USING HASH (val);
```
...
CREATE INDEX "Example_value_idx" ON "Example" USING GIST (val inet_ops);
```

The allowed value to the operator class (`ops`) argument depends on the native type of the field, and the type of the index. Prisma Schema Language provides all operator classes provided natively by PostgreSQL version 14.0, if the native type is supported by Prisma. For cases where we don't yet support the operator class, or the native type of the indexed field, the `raw` function can be used as an escape hatch:
...
<details>
<summary>Operator classes currently supported in the Prisma Schema Language<summary>
| index type | operator class              | operator class in database     | allowed field type | allowed native types      | default | postgres version |
|------------|-----------------------------|--------------------------------|--------------------|---------------------------|---------|------------------|
| `Gist`     | `InetOps`                   | `inet_ops`                     | `String`           | `@db.Inet`                |         |                  |
| `Gin`      | `ArrayOps`                  | `array_ops`                    | any array          |                           | ✅      | also CockroachDB |
| `Gin`      | `JsonbOps`                  | `jsonb_ops`                    | `Json`             | `@db.JsonB`               | ✅      | also CockroachDB |
| `Gin`      | `JsonbPathOps`              | `jsonb_path_ops`               | `Json`             | `@db.JsonB`               |         |                  |
| `SpGist`   | `InetOps`                   | `inet_ops`                     | `String`           | `@db.Inet`                | ✅      | 10+              |
| `SpGist`   | `TextOps`                   | `text_ops`                     | `String`           | `@db.Text`, `@db.VarChar` | ✅      |                  |
| `Brin`     | `BitMinMaxOps`              | `bit_minmax_ops`               | `String`           | `@db.Bit`                 | ✅      |                  |
| `Brin`     | `VarBitMinMaxOps`           | `varbit_minmax_ops`            | `String`           | `@db.VarBit`              | ✅      |                  |
| `Brin`     | `BpcharBloomOps`            | `bpchar_bloom_ops`             | `String`           | `@db.Char`                |         | 14+              |
| `Brin`     | `BpcharMinMaxOps`           | `bpchar_minmax_ops`            | `String`           | `@db.Char`                | ✅      |                  |
| `Brin`     | `ByteaBloomOps`             | `bytea_bloom_ops`              | `Bytes`            | `@db.Bytea`               |         | 14+              |
| `Brin`     | `ByteaMinMaxOps`            | `bytea_minmax_ops`             | `Bytes`            | `@db.Bytea`               | ✅      |                  |
| `Brin`     | `DateBloomOps`              | `date_bloom_ops`               | `DateTime`         | `@db.Date`                |         | 14+              |
| `Brin`     | `DateMinMaxOps`             | `date_minmax_ops`              | `DateTime`         | `@db.Date`                | ✅      |                  |
| `Brin`     | `DateMinMaxMultiOps`        | `date_minmax_multi_ops`        | `DateTime`         | `@db.Date`                |         | 14+              |
| `Brin`     | `Float4BloomOps`            | `float4_bloom_ops`             | `Float`            | `@db.Real`                |         | 14+              |
| `Brin`     | `Float4MinMaxOps`           | `float4_minmax_ops`            | `Float`            | `@db.Real`                | ✅      |                  |
| `Brin`     | `Float4MinMaxMultiOps`      | `float4_minmax_multi_ops`      | `Float`            | `@db.Real`                |         | 14+              |
| `Brin`     | `Float8BloomOps`            | `float8_bloom_ops`             | `Float`            | `@db.DoublePrecision`     |         | 14+              |
| `Brin`     | `Float8MinMaxOps`           | `float8_minmax_ops`            | `Float`            | `@db.DoublePrecision`     | ✅      |                  |
| `Brin`     | `Float8MinMaxMultiOps`      | `float8_minmax_multi_ops`      | `Float`            | `@db.DoublePrecision`     |         | 14+              |
| `Brin`     | `InetInclusionOps`          | `inet_inclusion_ops`           | `String`           | `@db.Inet`                | ✅      | 14+              |
| `Brin`     | `InetBloomOps`              | `inet_bloom_ops`               | `String`           | `@db.Inet`                |         | 14+              |
| `Brin`     | `InetMinMaxOps`             | `inet_minmax_ops`              | `String`           | `@db.Inet`                |         |                  |
| `Brin`     | `InetMinMaxMultiOps`        | `inet_minmax_multi_ops`        | `String`           | `@db.Inet`                |         | 14+              |
| `Brin`     | `Int2BloomOps`              | `int2_bloom_ops`               | `Int`              | `@db.SmallInt`            |         | 14+              |
| `Brin`     | `Int2MinMaxOps`             | `int2_minmax_ops`              | `Int`              | `@db.SmallInt`            | ✅      |                  |
| `Brin`     | `Int2MinMaxMultiOps`        | `int2_minmax_multi_ops`        | `Int`              | `@db.SmallInt`            |         | 14+              |
| `Brin`     | `Int4BloomOps`              | `int4_bloom_ops`               | `Int`              | `@db.Integer`             |         | 14+              |
| `Brin`     | `Int4MinMaxOps`             | `int4_minmax_ops`              | `Int`              | `@db.Integer`             | ✅      |                  |
| `Brin`     | `Int4MinMaxMultiOps`        | `int4_minmax_multi_ops`        | `Int`              | `@db.Integer`             |         | 14+              |
| `Brin`     | `Int8BloomOps`              | `int8_bloom_ops`               | `BigInt`           | `@db.BigInt`              |         | 14+              |
| `Brin`     | `Int8MinMaxOps`             | `int8_minmax_ops`              | `BigInt`           | `@db.BigInt`              | ✅      |                  |
| `Brin`     | `Int8MinMaxMultiOps`        | `int8_minmax_multi_ops`        | `BigInt`           | `@db.BigInt`              |         | 14+              |
| `Brin`     | `NumericBloomOps`           | `numeric_bloom_ops`            | `Decimal`          | `@db.Decimal`             |         | 14+              |
| `Brin`     | `NumericMinMaxOps`          | `numeric_minmax_ops`           | `Decimal`          | `@db.Decimal`             | ✅      |                  |
| `Brin`     | `NumericMinMaxMultiOps`     | `numeric_minmax_multi_ops`     | `Decimal`          | `@db.Decimal`             |         | 14+              |
| `Brin`     | `OidBloomOps`               | `oid_bloom_ops`                | `Int`              | `@db.Oid`                 |         | 14+              |
| `Brin`     | `OidMinMaxOps`              | `oid_minmax_ops`               | `Int`              | `@db.Oid`                 | ✅      |                  |
| `Brin`     | `OidMinMaxMultiOps`         | `oid_minmax_multi_ops`         | `Int`              | `@db.Oid`                 |         | 14+              |
| `Brin`     | `TextBloomOps`              | `text_bloom_ops`               | `String`           | `@db.Text`, `@db.VarChar` |         | 14+              |
| `Brin`     | `TextMinMaxOps`             | `text_minmax_ops`              | `String`           | `@db.Text`, `@db.VarChar` | ✅      |                  |
| `Brin`     | `TextMinMaxMultiOps`        | `text_minmax_multi_ops`        | `String`           | `@db.Text`, `@db.VarChar` |         | 14+              |
| `Brin`     | `TimestampBloomOps`         | `timestamp_bloom_ops`          | `DateTime`         | `@db.Timestamp`           |         | 14+              |
| `Brin`     | `TimestampMinMaxOps`        | `timestamp_minmax_ops`         | `DateTime`         | `@db.Timestamp`           | ✅      |                  |
| `Brin`     | `TimestampMinMaxMultiOps`   | `timestamp_minmax_multi_ops`   | `DateTime`         | `@db.Timestamp`           |         | 14+              |
| `Brin`     | `TimestampTzBloomOps`       | `timestamptz_bloom_ops`        | `DateTime`         | `@db.Timestamptz`         |         | 14+              |
| `Brin`     | `TimestampTzMinMaxOps`      | `timestamptz_minmax_ops`       | `DateTime`         | `@db.Timestamptz`         | ✅      |                  |
| `Brin`     | `TimestampTzMinMaxMultiOps` | `timestamptz_minmax_multi_ops` | `DateTime`         | `@db.Timestamptz`         |         | 14+              |
| `Brin`     | `TimeBloomOps`              | `time_bloom_ops`               | `DateTime`         | `@db.Time`                |         | 14+              |
| `Brin`     | `TimeMinMaxOps`             | `time_minmax_ops`              | `DateTime`         | `@db.Time`                | ✅      |                  |
| `Brin`     | `TimeMinMaxMultiOps`        | `time_minmax_multi_ops`        | `DateTime`         | `@db.Time`                |         | 14+              |
| `Brin`     | `TimeTzBloomOps`            | `timetz_bloom_ops`             | `DateTime`         | `@db.Timetz`              |         | 14+              |
| `Brin`     | `TimeTzMinMaxOps`           | `timetz_minmax_ops`            | `DateTime`         | `@db.Timetz`              | ✅      |                  |
| `Brin`     | `TimeTzMinMaxMultiOps`      | `timetz_minmax_multi_ops`      | `DateTime`         | `@db.Timetz`              |         | 14+              |
| `Brin`     | `UuidBloomOps`              | `uuid_bloom_ops`               | `String`           | `@db.Uuid`                |         | 14+              |
| `Brin`     | `UuidMinMaxOps`             | `uuid_minmax_ops`              | `String`           | `@db.Uuid`                | ✅      |                  |
| `Brin`     | `UuidMinMaxMultiOps`        | `uuid_minmax_multi_ops`        | `String`           | `@db.Uuid`                |         | 14+              |
