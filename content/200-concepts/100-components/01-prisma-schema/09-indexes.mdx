...
| operator class | allowed field type | allowed native types | default | other            |
|----------------|--------------------|----------------------|---------|------------------|
| `ArrayOps`     | any array          | any array                     | ✅      | also CockroachDB |
...
| operator class | allowed field type | allowed native types      | default | supported PostgreSQL versions |
|----------------|--------------------|---------------------------|---------|-------------------------------|
