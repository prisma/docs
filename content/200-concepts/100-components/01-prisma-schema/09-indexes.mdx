...
The GIN index stores composite values, such as arrays or `JsonB`, speeding up queries such as is an object part of another object. Also commonly used for full-text searches.
