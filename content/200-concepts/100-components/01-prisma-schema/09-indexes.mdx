...
| operator class              | operator class in database     | allowed field type | allowed native types      |
|-----------------------------|--------------------------------|--------------------|---------------------------|
| `InetOps`                   | `inet_ops`                     | `String`           | `@db.Inet`                |

Operator classes currently supported in the Prisma Schema Language for Gin indexes:

| operator class | operator class in database | allowed field type | allowed native types | default | other            |
|----------------|----------------------------|--------------------|----------------------|---------|------------------|
| `ArrayOps`     | `array_ops`                | any array          |                      | ✅      | also CockroachDB |
| `JsonbOps`     | `jsonb_ops`                | `Json`             | `@db.JsonB`          | ✅      | also CockroachDB |
| `JsonbPathOps` | `jsonb_path_ops`           | `Json`             | `@db.JsonB`          |         |                  |

Operator classes currently supported in the Prisma Schema Language for SpGist indexes:

| operator class | operator class in database | allowed field type | allowed native types      | default | supported PostgreSQL versions |
|----------------|----------------------------|--------------------|---------------------------|---------|-------------------------------|
| `InetOps`      | `inet_ops`                 | `String`           | `@db.Inet`                | ✅      | 10+                           |
| `TextOps`      | `text_ops`                 | `String`           | `@db.Text`, `@db.VarChar` | ✅      |                               |

Operator classes currently supported in the Prisma Schema Language for Brin indexes:

| operator class              | operator class in database     | allowed field type | allowed native types      | default | supported PostgreSQL versions |
|-----------------------------|--------------------------------|--------------------|---------------------------|---------|-------------------------------|
| `BitMinMaxOps`              | `bit_minmax_ops`               | `String`           | `@db.Bit`                 | ✅      |                               |
| `VarBitMinMaxOps`           | `varbit_minmax_ops`            | `String`           | `@db.VarBit`              | ✅      |                               |
| `BpcharBloomOps`            | `bpchar_bloom_ops`             | `String`           | `@db.Char`                |         | 14+                           |
| `BpcharMinMaxOps`           | `bpchar_minmax_ops`            | `String`           | `@db.Char`                | ✅      |                               |
| `ByteaBloomOps`             | `bytea_bloom_ops`              | `Bytes`            | `@db.Bytea`               |         | 14+                           |
| `ByteaMinMaxOps`            | `bytea_minmax_ops`             | `Bytes`            | `@db.Bytea`               | ✅      |                               |
| `DateBloomOps`              | `date_bloom_ops`               | `DateTime`         | `@db.Date`                |         | 14+                           |
| `DateMinMaxOps`             | `date_minmax_ops`              | `DateTime`         | `@db.Date`                | ✅      |                               |
| `DateMinMaxMultiOps`        | `date_minmax_multi_ops`        | `DateTime`         | `@db.Date`                |         | 14+                           |
| `Float4BloomOps`            | `float4_bloom_ops`             | `Float`            | `@db.Real`                |         | 14+                           |
| `Float4MinMaxOps`           | `float4_minmax_ops`            | `Float`            | `@db.Real`                | ✅      |                               |
| `Float4MinMaxMultiOps`      | `float4_minmax_multi_ops`      | `Float`            | `@db.Real`                |         | 14+                           |
| `Float8BloomOps`            | `float8_bloom_ops`             | `Float`            | `@db.DoublePrecision`     |         | 14+                           |
| `Float8MinMaxOps`           | `float8_minmax_ops`            | `Float`            | `@db.DoublePrecision`     | ✅      |                               |
| `Float8MinMaxMultiOps`      | `float8_minmax_multi_ops`      | `Float`            | `@db.DoublePrecision`     |         | 14+                           |
| `InetInclusionOps`          | `inet_inclusion_ops`           | `String`           | `@db.Inet`                | ✅      | 14+                           |
| `InetBloomOps`              | `inet_bloom_ops`               | `String`           | `@db.Inet`                |         | 14+                           |
| `InetMinMaxOps`             | `inet_minmax_ops`              | `String`           | `@db.Inet`                |         |                               |
| `InetMinMaxMultiOps`        | `inet_minmax_multi_ops`        | `String`           | `@db.Inet`                |         | 14+                           |
| `Int2BloomOps`              | `int2_bloom_ops`               | `Int`              | `@db.SmallInt`            |         | 14+                           |
| `Int2MinMaxOps`             | `int2_minmax_ops`              | `Int`              | `@db.SmallInt`            | ✅      |                               |
| `Int2MinMaxMultiOps`        | `int2_minmax_multi_ops`        | `Int`              | `@db.SmallInt`            |         | 14+                           |
| `Int4BloomOps`              | `int4_bloom_ops`               | `Int`              | `@db.Integer`             |         | 14+                           |
| `Int4MinMaxOps`             | `int4_minmax_ops`              | `Int`              | `@db.Integer`             | ✅      |                               |
| `Int4MinMaxMultiOps`        | `int4_minmax_multi_ops`        | `Int`              | `@db.Integer`             |         | 14+                           |
| `Int8BloomOps`              | `int8_bloom_ops`               | `BigInt`           | `@db.BigInt`              |         | 14+                           |
| `Int8MinMaxOps`             | `int8_minmax_ops`              | `BigInt`           | `@db.BigInt`              | ✅      |                               |
| `Int8MinMaxMultiOps`        | `int8_minmax_multi_ops`        | `BigInt`           | `@db.BigInt`              |         | 14+                           |
| `NumericBloomOps`           | `numeric_bloom_ops`            | `Decimal`          | `@db.Decimal`             |         | 14+                           |
| `NumericMinMaxOps`          | `numeric_minmax_ops`           | `Decimal`          | `@db.Decimal`             | ✅      |                               |
| `NumericMinMaxMultiOps`     | `numeric_minmax_multi_ops`     | `Decimal`          | `@db.Decimal`             |         | 14+                           |
| `OidBloomOps`               | `oid_bloom_ops`                | `Int`              | `@db.Oid`                 |         | 14+                           |
| `OidMinMaxOps`              | `oid_minmax_ops`               | `Int`              | `@db.Oid`                 | ✅      |                               |
| `OidMinMaxMultiOps`         | `oid_minmax_multi_ops`         | `Int`              | `@db.Oid`                 |         | 14+                           |
| `TextBloomOps`              | `text_bloom_ops`               | `String`           | `@db.Text`, `@db.VarChar` |         | 14+                           |
| `TextMinMaxOps`             | `text_minmax_ops`              | `String`           | `@db.Text`, `@db.VarChar` | ✅      |                               |
| `TextMinMaxMultiOps`        | `text_minmax_multi_ops`        | `String`           | `@db.Text`, `@db.VarChar` |         | 14+                           |
| `TimestampBloomOps`         | `timestamp_bloom_ops`          | `DateTime`         | `@db.Timestamp`           |         | 14+                           |
| `TimestampMinMaxOps`        | `timestamp_minmax_ops`         | `DateTime`         | `@db.Timestamp`           | ✅      |                               |
| `TimestampMinMaxMultiOps`   | `timestamp_minmax_multi_ops`   | `DateTime`         | `@db.Timestamp`           |         | 14+                           |
| `TimestampTzBloomOps`       | `timestamptz_bloom_ops`        | `DateTime`         | `@db.Timestamptz`         |         | 14+                           |
| `TimestampTzMinMaxOps`      | `timestamptz_minmax_ops`       | `DateTime`         | `@db.Timestamptz`         | ✅      |                               |
| `TimestampTzMinMaxMultiOps` | `timestamptz_minmax_multi_ops` | `DateTime`         | `@db.Timestamptz`         |         | 14+                           |
| `TimeBloomOps`              | `time_bloom_ops`               | `DateTime`         | `@db.Time`                |         | 14+                           |
| `TimeMinMaxOps`             | `time_minmax_ops`              | `DateTime`         | `@db.Time`                | ✅      |                               |
| `TimeMinMaxMultiOps`        | `time_minmax_multi_ops`        | `DateTime`         | `@db.Time`                |         | 14+                           |
| `TimeTzBloomOps`            | `timetz_bloom_ops`             | `DateTime`         | `@db.Timetz`              |         | 14+                           |
| `TimeTzMinMaxOps`           | `timetz_minmax_ops`            | `DateTime`         | `@db.Timetz`              | ✅      |                               |
| `TimeTzMinMaxMultiOps`      | `timetz_minmax_multi_ops`      | `DateTime`         | `@db.Timetz`              |         | 14+                           |
| `UuidBloomOps`              | `uuid_bloom_ops`               | `String`           | `@db.Uuid`                |         | 14+                           |
| `UuidMinMaxOps`             | `uuid_minmax_ops`              | `String`           | `@db.Uuid`                | ✅      |                               |
| `UuidMinMaxMultiOps`        | `uuid_minmax_multi_ops`        | `String`           | `@db.Uuid`                |         | 14+                           |
