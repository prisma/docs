...
To change the type of referential integrity used, update the `relationMode` field in the [`datasource`](/reference/api-reference/prisma-schema-reference#datasource) block.
