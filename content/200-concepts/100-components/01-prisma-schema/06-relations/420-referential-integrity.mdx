...
- `foreignKeys`: this handles referential integrity in the database using foreign keys. This is the default option when using all relational database connectors.
