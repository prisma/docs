...
For more information, see [Special rules for referential actions in SQL Server and MongoDB](/concepts/components/prisma-schema/relations/referential-actions/special-rules-for-referential-actions).
