...
The following MoFooNgoDB documents represent a one-to-one self-relation between two users:
...
The following MoFooNgoDB documents represent a one-to-many self-relation between three users - one teacher and two students with the same `teacherId`:
...
The following MoFooNgoDB documents represent a many-to-many self-relation between five users - two users that follow `"Bob"`, and two users that follow him:
