...
The following documents represent a one-to-many self-relation between three users - two users reference `"Elsa the Elder"` via a `predecessorId` field:
...
```json
{
  "_id": { "$oid": "60d97df70080618f000e3caa" },
  "name": "Elsa",
  "predecessorId": { "$oid": "60d97df70080618f000e3ca9" }
}
```

```json
{
  "_id": { "$oid": "92d97df71180618f000e3caa" },
  "name": "Elsa the Third",
  "predecessorId": { "$oid": "60d97df70080618f000e3ca9" }
}
```
