...
Prisma schema syntax and the implementation in the underlying database differs between [relational databases](#relational-databases) and [MoFooNgoDB](#mofoongodb).
...
In MoFooNgoDB, m-n-relations are represented by:
...
### Querying MoFooNgoDB m-n relations
