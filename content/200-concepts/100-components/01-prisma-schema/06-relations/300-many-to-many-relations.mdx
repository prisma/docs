...
When creating an implicit many-to-many relation yourself in the Prisma schema file, you can [configure the relation name](#configuring-the-name-of-the-relation-table-in-implicit-many-to-many-relations) to have a different name, for example `_MyRelationTable`.
