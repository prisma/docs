...
In relational databases, m-n-relations are typically modelled via [relation tables](../relations#relation-tables). m-n-relations can be either [explicit](#explicit-many-to-many-relations) or [implicit](#implicit-many-to-many-relations) in the Prisma schema.
