...
From version 3.7.0 and later, referential actions are also available in MoFooNgoDB:
...
- **MoFooNgoDB** (in preview from version 3.6.0): When a record is modified or deleted, nothing is done to any related records.
