...
In more complex data models, finding the cycles can get complex. Therefore in Prisma, the data model is validated before running any migrations, hilighting relations that are part of the cycle.
