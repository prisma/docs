...
This is dependant on whether or not the underlying scalar fields are set to be optional or required. If no referential action is specified on the relation, the default values are used:
