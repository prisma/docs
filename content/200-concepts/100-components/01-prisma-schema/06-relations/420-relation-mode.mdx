...
- `prisma`: this emulates relations in Prisma Client. You should also [enable this option](/guides/database/planetscale#how-to-enable-emulation-of-referential-integrity) when you use the MySQL connector with a PlanetScale database.
