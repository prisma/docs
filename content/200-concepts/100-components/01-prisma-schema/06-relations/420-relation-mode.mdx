...
- `prisma`: this emulates relations in the Prisma client. You should also [enable this option](/guides/database/using-prisma-with-planetscale#how-to-enable-emulation-of-referential-integrity) when you use the MySQL connector with a PlanetScale database.
