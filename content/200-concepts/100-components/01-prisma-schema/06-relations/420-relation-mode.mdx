...
- `prisma`: this emulates relations in the Prisma client. You should also [enable this option](/guides/database/using-prisma-with-planetscale#how-to-emulate-relations-in-prisma-client) when using the MySQL connector with a PlanetScale database.
