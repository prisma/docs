...
If you are using the [Prisma VS Code extension](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma) (or our [language server in another editor](/guides/development-environment/editor-setup)) the warning will be augmented with a Quick Fix that will add the required index for you:
