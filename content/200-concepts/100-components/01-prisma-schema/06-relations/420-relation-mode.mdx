...
- ensure referential integrity via constraints (Can this foreign key field hold this value?) 
...
<Admonition type="warning">
  There are performance implications to emulating referential integrity and referential actions in the Prisma client. In cases where the underlying database supports foreign keys, it is usually the preferred choice.
</Admonition>
