...
In **relational databases only**, you can also use [multi-field IDs](/reference/api-reference/prisma-schema-reference#id-1)/composite key to define a 1-1 relation:
