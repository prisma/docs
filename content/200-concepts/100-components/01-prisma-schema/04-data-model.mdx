...
`Unsupported` fields are not available in the generated Prisma Client API, but can still use the [raw database access](/concepts/components/prisma-client/raw-database-access) to query these fields.
