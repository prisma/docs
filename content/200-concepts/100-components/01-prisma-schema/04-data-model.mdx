...
Composite types (known as [embedded documents](https://docs.mongodb.com/manual/core/data-model-design/#std-label-data-modeling-embedding) in MongoDB) provide support for embedding records inside other records, by allowing you to define new object types. Composite types are structured and typed in a similar way to models.
...
Composite types currently have some limitations:
...
- [Relations](/concepts/components/prisma-schema/relations) cannot exist inside a composite type
