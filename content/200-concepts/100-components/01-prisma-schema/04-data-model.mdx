...
- [Enums](#defining-enums) ([`enum`](../../../reference/api-reference/prisma-schema-reference#enum) <span class="api"></span> primitives) - only available if [enums are supported natively by your database](../../database-connectors/database-features#misc)
