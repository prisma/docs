...
**Model names in relational databases** <br />
You can optionally [map Prisma model names to a different collection / table name]() in the underlying database.
...
**Field names in relational databases** <br />
You can optionally [map Prisma schema field names to a different field name]() in the underlying database.
...
**Constraint names in relational databases** <br />
You can optionally define a [custom constraint name]() in the underlying database.
