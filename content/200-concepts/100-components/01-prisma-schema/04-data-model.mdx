...
You can optionally [map Prisma model names to a different collection / table name](names-in-underlying-database#collectiontable-and-fieldcolumn-names) in the underlying database.
...
You can optionally [map Prisma schema field names to a different field names](names-in-underlying-database#collectiontable-and-fieldcolumn-names) in the underlying database.
...
You can optionally [map Prisma enums and enum values to different names](names-in-underlying-database#collectiontable-and-fieldcolumn-names) in the underlying database.
