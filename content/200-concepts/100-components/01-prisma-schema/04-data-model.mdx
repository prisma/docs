...
- [Scalar lists](/reference/api-reference/prisma-schema-reference#-modifier) <span class="api"></span> in versions `4.0.0` and later, when using databases that support them natively (PostgreSQL, CockroachDB and MongoDB)
