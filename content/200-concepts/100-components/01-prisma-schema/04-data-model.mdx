...
You can optionally [map Prisma model names to a different table/collection name](names-in-underlying-database#mapping-collectiontable-and-fieldcolumn-names) in the underlying database.
