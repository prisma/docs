...
Constraints and indexes have **names** in the underlying database. You can [define constraint and index names in the Prisma schema in 2.XX.0 and later](#constraint-and-index-names-preview).
