...
Native database type attributes are a preview feature in 2.10.0. To enable this feature, add native types to the `generator` block as shown and run `npx prisma generate`:
