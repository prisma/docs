...
To activate an extension, it must already be available on the local file system of your database server. Activating the extension then runs a script file that adds the new functionality.
