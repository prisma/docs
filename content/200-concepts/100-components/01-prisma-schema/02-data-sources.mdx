...
Some data source providers, such as SQL Server, enable you to configure your connection with TLS by providing parameters in the connection `url`.

- [Configure a TLS connection with SQL Server](../../database-connectors/sql-server#connection-details)
