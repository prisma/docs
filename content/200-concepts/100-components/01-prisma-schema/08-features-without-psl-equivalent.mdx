...
Not all database functions and features of all our supported databases have a Prisma Schema Language equivalent. Refer to the [database features matrix](/reference/database-reference/database-features) for a complete list of supported features.
