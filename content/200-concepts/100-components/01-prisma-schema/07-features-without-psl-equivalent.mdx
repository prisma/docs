...
If your project uses [Prisma Migrate](../prisma-migrate), you must [install the extension as part of a migration](../../../guides/database/developing-with-prisma-migrate/enable-native-database-functions) <span class="guide"></span>.
...
Some features, like SQL views or partial indexes, cannot be represented in the Prisma schema. If your project uses [Prisma Migrate](../prisma-migrate), you must include unsupported features as part of a migration:
