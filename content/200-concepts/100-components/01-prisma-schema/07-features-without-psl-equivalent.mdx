...
### Enable native database functions
...
Some features, like SQL views or partial indexes, cannot be represented in the Prisma schema. To include unsupported features, you must include them in a migration:
