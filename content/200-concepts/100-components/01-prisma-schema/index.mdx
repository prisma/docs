...
- [**Data sources**](https://www.prisma.io/docs/concepts/components/prisma-schema/data-sources): Specify the details of the data sources Prisma should connect to (e.g. a PostgreSQL database)
- [**Generators**](https://www.prisma.io/docs/concepts/components/prisma-schema/generators): Specifies what clients should be generated based on the data model (e.g. Prisma Client)
