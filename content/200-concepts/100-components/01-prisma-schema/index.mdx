...
metaTitle: 'Prisma Schema Language (Reference)'
metaDescription: 'TODO The Prisma schema is the main configuration file when using Prisma. It is typically called schema.prisma and contains your database connection and data model.'
---
