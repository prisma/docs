...
As an example, when you [introspect](/concepts/components/prisma-schema/introspection) a database with a table named `comments`, the resulting Prisma model will look like this:
