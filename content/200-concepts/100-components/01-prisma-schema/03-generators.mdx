...
- [`graphql-schema-generator`](https://github.com/prisma-korea/graphql-schema-generator): Generates GraphQL schema from Prisma schema without [GraphQL Nexus](https://nexusjs.org/docs/).
