...
- [`prisma-dbml-generator`](https://notiz.dev/blog/prisma-dbml-generator): Transforms the Prisma schema into [Database Markup Language
#](https://www.dbml.org/home/) (DBML) which allows for an easy visual representation
