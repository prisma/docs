...
- [`typegraphql-prisma-nestjs`](https://github.com/EndyKaufman/typegraphql-prisma-nestjs#readme): Fork of Generates [TypeGraphQL](https://github.com/MichalLytek/typegraphql-prisma) CRUD resolvers for Prisma models but for NestJS
