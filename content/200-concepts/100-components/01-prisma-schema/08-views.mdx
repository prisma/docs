...
Currently Prisma treats all `view`s as updatable views. If the underlying view supports this functionality for the view, the operation should succeed. If the view is not marked as updatable, the database will return an error that Prisma Client will throw as an error.
