...
Currently Prisma has not understanding of materialized views. When creating a view manually you can also create a materialized view. You can then use Prisma's raw query feature to execute the command to refresh the view manually.
