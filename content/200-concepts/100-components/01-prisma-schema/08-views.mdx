...
These two pieces allow you to define the name of your view in the generated Prisma Client and the columns present in a view's query results.
...
Please note the [limitations](/concepts/components/prisma-schema/views#introspection) of this feature described below.
...
In the example above, the `id` field has a `@unique` attribute.
