...
In the future Prisma Client might support marking individual views as materialized and add a Prisma Client method to refresh the materialized view. Please [comment on our `views` feedback issue with your use case](https://github.com/prisma/prisma/issues/17335).
