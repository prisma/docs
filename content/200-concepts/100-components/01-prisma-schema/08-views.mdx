...
The `view` block is generated initially with a `@@ignore` attribute because [there is no unique identifier defined](#unique-identifier) (which is a currently a [limitation](#unique-identifier) of the views implementation in Prisma).
