...
Depending on your [project plan](/concepts/data-platforms/billing/plans-and-quotas), the Prisma Data Proxy provides a different [limit of concurrent proxy instances](/concepts/data-platform/platform-limits-and-status).
...
[Conctact Support](/concepts/data-platform/contact-support) if you are hitting the concurrency limits and have trouble scaling your Prisma application.
