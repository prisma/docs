...
[Use this link to create a Vercel project based on this branch](TODO). It makes sure you set the correct environment variables for getting a Prisma Client for Data Proxy and running migrations when Data Proxy is configured.
