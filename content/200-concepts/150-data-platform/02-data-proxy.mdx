...
To use the Prisma Data Proxy in your existing project that uses Prisma Client with [Vercel Serverless Functions](https://vercel.com/docs/concepts/functions#serverless-functions), you only need to make minimal changes. 
