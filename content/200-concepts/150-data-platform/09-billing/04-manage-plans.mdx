...
See [Plans and quotas](/concepts/data-platform/billing/plans-and-quotas) for descriptions of all plans available in the Prisma Data Platform.
...
1. Go to the **[Billing](https://cloud.prisma.io/billing)** page.
2. Under _Your projects_, click **Cancel** for the project that you want to downgrade.
