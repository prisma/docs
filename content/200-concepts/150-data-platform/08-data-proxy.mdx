...
**Not supported** <br />
You cannot use the Prisma Data Proxy at the same time as you use [Interactive Transactions](/concepts/components/prisma-client/transactions#interactive-transactions-in-preview) (Preview Feature). To use Prisma Data Proxy, you must disable Interactive Transactions.
...
**!!! introduction to go here: explain what we are doing - set up the connection locally in your project? **
...
**!!! does the generate output confirm that we have a data proxy client, and not a normal one? If so, note this here**

The Data Proxy does not need local engine files. When you use the above
command, the generation process does not include the [query
engine](/concepts/components/prisma-engines/query-engine) in the generated
Prisma Client. This helps to keep Prisma Client lightweight.
...
**!!! This seems to overlap with step 3 - can we disentangle?**
