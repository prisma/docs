...
If you are looking to scale up traffic beyond the limits or if you're seeing `429` HTTP errors in your logs - this might mean you're hitting the quotas; [**please reach out to us**](/concepts/components/data-platform#feedback-and-support). We'd love to know about your use case and work together with you to help your Prisma application scale.
