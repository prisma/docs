...
The Data Proxy does not need binaries. Therefore, to keep the client lightweight, when you use this command Prisma **<is "Prisma" right here, or should we say a module name here?>** does not copy any binaries to the client.
