...
The Data Proxy does not need local engine files. When you use the above command, the generation process does not include the [query engine](/concepts/components/prisma-engines/query-engine) in the generated Prisma Client. This helps to keep Prisma Client lightweight.
