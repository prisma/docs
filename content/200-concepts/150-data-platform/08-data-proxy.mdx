...
If you want to use the Data Proxy with CloudFlare Workers or the Vercel Edge Network, you will need to import and instantiate Prisma Client in your code as follows.
