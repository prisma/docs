...
The Data Proxy does not need local engine files. To keep Prisma Client lightweight, when you use this command the generation process does not include the [query engine](/concepts/components/prisma-engines/query-engine) in the generated Prisma Client.
