...
metaTitle: 'Upgrading and downgrading plans'
metaDescription: 'You can upgrade to a paid plan to increase the Prisma Data Proxy usage and the number of team members and environments that you can add to your project. If you no longer need a paid plan for a project, you can always downgrade.'
---
...
1. Go to the [Billing](https://cloud.prisma.io/billing) page.
2. Under _Your projects_, click **Cancel** for the project you want to downgrade.
