...
The Prisma Data Platform uses [Stripe](https://stripe.com/) as the payments provider and it is Stripe that issues and sends the monthly invoices when you have a paid plan for a project.
