...
[Check out](/concepts/data-platform/billing/upgrading-plans#plans) how the `Early Adopter` plan compares to the `Scale` and `Enterprise` plans in the table above.
