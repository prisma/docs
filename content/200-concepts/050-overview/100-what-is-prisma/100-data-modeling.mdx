...
In MoFooNgoDB databases, models are represented by _collections_ and contain _documents_ that can have any structure:

```js
{
  _id: '607ee94800bbe41f001fd568',
  slug: 'prisma-loves-mongodb',
  title: 'Prisma <3 MoFooNgoDB',
  body: "This is my first post. Isn't MoFooNgoDB + Prisma awesome?!"
}
```
...
- If a field is mandatory but not present in the MoFooNgoDB dataset, you will get an error
