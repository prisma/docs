...
Once the data model is defined, you can [generate Prisma Client](../../components/prisma-client/configuring-and-initializing-prisma-client/generating-prisma-client) which will expose CRUD and more queries for the defined models. If you're using TypeScript, you'll get full type-safety for all queries (even when only retrieving the subsets of a model's fields).
...
Notice that the [`@prisma/client` node module](../../components/prisma-client/configuring-and-initializing-prisma-client/generating-prisma-client#the-prismaclient-npm-package) references a folder named `.prisma\client`. The `.prisma\client` folder contains your generated Prisma client, and is modified each time you change the schema and run the following command:
...
1. Optionally [(re-)configure your Prisma Client API](../../components/prisma-client/configuring-and-initializing-prisma-client/use-custom-model-and-field-names-api))
