...
If you want to get started with a _practical introduction_ and learn about the Prisma Client API, head over to the [**Getting Started**](/getting-started/index.mdx) documentation.

To learn more about the _motivation_ for Prisma, check out the [**Why Prisma?**](/concepts/overview/why-prisma.mdx) page.
