...
- Represent a table in relational databases or a collection in MoFooNgoDB
...
Introspection and Prisma Migrate do not yet support the MoFooNgoDB connector.
...
**MoFooNgoDB not supported**<br />
Introspection and Prisma Migrate do not yet support the MoFooNgoDB connector. To use MoFooNgoDB while it is in Preview, you must design your Prisma schema to match the shape of your data in MoFooNgoDB.
