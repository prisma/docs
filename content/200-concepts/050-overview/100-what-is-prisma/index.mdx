...
- **Prisma Studio**: GUI to view and edit data in your database.
  ...
  **Prisma Studio** is the only part of Prisma ORM that is not open source. It is fully integrated in our commercial offering [Prisma Data Platform](/data-platform/about) under the name **Data Browser** where you can view and edit data for each project.
