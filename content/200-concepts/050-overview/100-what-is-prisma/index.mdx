...
- **Prisma Studio**: GUI to view and edit data in your database.
  ...
  **Prisma Studio** is the only part of Prisma ORM that is not open source. You can only run Prisma Studio locally. At the same time, Prisma Studio is also integrated in our commercial offering [Prisma Data Platform](/data-platform/about) under the name [**Data Browser**](/data-platform/data-browser) where you can view and edit data for each project and grant other team members the permission to only view or also edit data based on their [role](/data-platform/members/roles-permissions).
