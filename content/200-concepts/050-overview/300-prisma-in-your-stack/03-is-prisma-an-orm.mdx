...
| ------------ | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| SQL Schema   | Migrations and model classes         | [Prisma schema](../../components/prisma-schema)                             |
| Tables       | Model classes                        | [Models](../../components/prisma-schema/data-model#defining-models) in the Prisma schema       |
| Columns      | Properties in model classes          | Model [fields](../../components/prisma-schema/data-model#defining-fields) in the Prisma schema |
| Records      | Instances of a model class (objects) | Plain JavaScript objects                                                                                           |
| Foreign keys | Foreign keys on model classes        | [Relations](../../components/prisma-schema/relations) between Prisma models                    |
...
- [**Prisma Client**](../../components/prisma-client): Auto-generated and type-safe database client
- [**Prisma Migrate**](../../components/prisma-migrate) (experimental): A CLI for declarative data modeling and migrations

Both Prisma Client and Prisma Migrate rely on the [Prisma schema](../../components/prisma-schema). The Prisma schema is a declarative representation of your database schema. It serves as the single source truth for both the database schema and your application models.
