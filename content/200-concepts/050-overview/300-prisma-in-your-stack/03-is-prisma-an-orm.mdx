...
- [**Prisma Migrate**](../../components/prisma-migrate) [(preview)](/about/releases#preview): A declarative data modeling and migration tool.
...
Prisma schema's declarative nature is concise and allows defining the database schema and corresponding representation in Prisma Client.
