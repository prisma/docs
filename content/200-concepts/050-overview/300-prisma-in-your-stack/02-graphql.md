...
<a href="https://graphql.org target="_blank" rel="noopener">GraphQL</a> is a query language for APIs. It is often used as an alternative to RESTful APIs, but can also be used as an additional "gateway" layer on top of existing RESTful services.
