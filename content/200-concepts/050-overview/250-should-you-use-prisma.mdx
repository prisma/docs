...
- prototyping (via [`prisma db push`](/reference/api-reference/prisma-cli/command-reference#db-push))
- seeding (via [`prisma db seed`](/reference/api-reference/prisma-cli/command-reference#db-seed))
