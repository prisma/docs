...
At the moment, Prisma only [supports](../../reference/database-reference/supported-databases) relational databases but we're planning to broaden the range of database types to e.g. support document databases like [MongoDB](https://www.notion.so/prismaio/Support-MongoDB-9f115ebf4a754069a7d7eaae94dc4651) as well.
