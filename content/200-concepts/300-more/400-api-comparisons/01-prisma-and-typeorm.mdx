...
- applying filters on related records ([docs](../../components/prisma-client/relation-filters))
...
- implicit handling of relation tables (also sometimes called JOIN, link, privot or junction tables) ([docs](../../components/prisma-schema/relations#implicit-many-to-many-relations))
