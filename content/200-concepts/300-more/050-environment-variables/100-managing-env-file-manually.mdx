...
Although Prisma creates a `.env` file for you upon installation, there can be times when you want to:
...
### Manually set environment variable on a Unix system
...
### Manually set environment variable on a Windows system
