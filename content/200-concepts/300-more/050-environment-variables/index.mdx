...
You can use environment variables to provide configuration values for Prisma CLI commands or when running Prisma Client queries in your application. Environment variables allow you to:
