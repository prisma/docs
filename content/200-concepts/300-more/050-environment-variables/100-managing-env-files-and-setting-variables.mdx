...
The following steps show how to use the `dotenv-cli` package to create an alternative `.env` file to the [default](./#using-env-files) created by Prisma. The file is then used in a script to run an introspection.
