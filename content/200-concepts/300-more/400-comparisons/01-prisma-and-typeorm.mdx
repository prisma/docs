...
- creating nested TypeScript typings based on models and their relations ([docs](../../components/prisma-client/advanced-type-safety/operating-against-partial-structures-of-model-types))
