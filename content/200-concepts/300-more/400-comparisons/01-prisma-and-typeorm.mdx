...
- creating nested TypeScript typings based on models and their relations ([docs](https://prisma.io/docs/concepts/components/prisma-client/advanced-type-safety))
- intuitive modeling of relations in the data model via relation fields ([docs](/concepts/components/prisma-schema/relations))
