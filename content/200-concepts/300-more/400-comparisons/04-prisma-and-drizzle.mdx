...
While Drizzle is a relatively new product, Prisma 2.0.0 was released in June of 2020 and is well established in the JavaScript/TypeScript space. It has proven value , [many companies trust Prisma in production](http://prisma.io/showcase), and is even included as the data layer tool of choice in many meta-frameworks and development platforms like [Amplication](https://amplication.com/), [Wasp](https://wasp-lang.dev/), [RedwoodJS](https://redwoodjs.com/), [KeystoneJS](https://keystonejs.com/) and [Remix](https://remix.run/). In the community, Prisma has generators and clients for other languages like [Go](https://github.com/steebchen/prisma-client-go) and [Python](https://github.com/RobertCraigie/prisma-client-py).
