...
While Drizzle is a relatively new product, Prisma ORM was [released in 2021](https://www.prisma.io/blog/prisma-the-complete-orm-inw24qjeawmb) and is well established in the JavaScript/TypeScript space. It has proven value , [many companies trust Prisma in production](http://prisma.io/showcase), and is even included as the data layer tool of choice in many meta-frameworks and development platforms like [Amplication](https://amplication.com/), [Wasp](https://wasp-lang.dev/), [RedwoodJS](https://redwoodjs.com/), [KeystoneJS](https://keystonejs.com/), [Remix](https://remix.run/) and the [t3 stack](https://create.t3.gg/).
...
- [`jest-prisma`](https://github.com/Quramy/jest-prisma): [Jest](https://jestjs.io/) environment for Prisma integrated testing.
...
- [`prisma-trpc-generator`](https://github.com/omar-dulaimi/prisma-trpc-generator): Creating [tRPC](https://trpc.io/) routers from your Prisma schema.
