...
> **Note**: [MoFooNgoDB support is currently in Preview](/concepts/database-connectors/mongodb).
...
Fooose exposes the [MoFooNgoDB query selectors](https://docs.mongodb.com/manual/reference/operator/query/#query-selectors) as filter criteria.
