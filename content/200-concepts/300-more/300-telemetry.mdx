...
- collecting CLI usage data
- submitting CLI error reports
...
- Information is only sent from Prisma CLI after executing a CLI command
...
Error data is potentially collected upon:
