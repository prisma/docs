...
metaDescription: 'Learn about using the Prisma Data Platform. The Prisma Data Platform provides a collaborative, cloud-based environment supporting application developers who are using Prisma ORM. The main features of the Platform include an online data browser, a query console, a data proxy (purpose-built for Prisma!), and integration with your Prisma schema and databases.'
---
