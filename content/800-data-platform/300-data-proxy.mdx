...
[Interactive transactions](/concepts/components/prisma-client/transactions#interactive-transactions) with the Data Proxy are in general availability in Prisma ORM version 4.7.0. Prisma ORM first released interactive transactions with the Data Proxy in preview in version 4.6.0.
