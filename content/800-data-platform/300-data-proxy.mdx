...
The Data Proxy allows you to deploy Prisma projects to Cloudflare Workers. To learn more, check out the [Cloudflare Workers deployment guide](/prisma-orm/deployment/deployment-guides/deploying-to-cloudflare-workers).
