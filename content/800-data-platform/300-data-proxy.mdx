...
[Interactive Transactions](/concepts/components/prisma-client/transactions#interactive-transactions) with the Data Proxy are in General Availability in Prisma ORM version 4.7.0.
