...
To use the Data Proxy for your serverless application, you must first [create a project](/data-platform/projects/create) in Prisma Data Platform. When you create the project, you select a Data Proxy region for the project (make sure that it is close to your database) and, at the same time, you can [create a Data Proxy connection string](/data-platform/projects/create#optional-create-a-data-proxy-connection-string). 
