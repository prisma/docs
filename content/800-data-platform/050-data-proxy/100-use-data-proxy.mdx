...
For more detailed information regarding the limits of the Data Proxy and its concurrency limits, we recommend referring to the [Concurrency Limits](/data-platform/about/limits-and-status#data-proxy-concurrency-limits) documentation.
