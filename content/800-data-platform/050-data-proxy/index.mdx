...
If you want us to make the Data Proxy available in a new region, you can submit your request [here](
https://prisma103696.typeform.com/to/Y03RBE5c).
...
By default, Prisma Client bundles the query engine which includes the connection logic for all databases that Prisma supports. 
...
When you generate Prisma Client to work with Data Proxy, the query engine logic to connect and maintain connection pools is delegated to Data Proxy. As a result, you have a reduced bundle size for your application that helps to speed up load times and enables faster performance.
