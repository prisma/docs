...
Data Proxy prevents unnecessary serverless cold starts because it keeps the existing database connections live and reuses them for new requests. This prevents the cold start of new containers whenever your application invokes serverless functions after the first cold start.
