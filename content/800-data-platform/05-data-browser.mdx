...
In the **Filters** menu, the first condition that you add is indicated with the `where` clause. 

When you add multiple conditions, results are filtered so that all conditions apply in combination. This is indicated with the `and` operator in front of each new condition.
...
3. Configure the condition.
   ...
   3. Type the value you want to use for the condition.<br />
      **Step result**: The data in the model is updated immediately based on the condition.
...
<img src="https://res.cloudinary.com/prismaio/image/upload/v1661875676/docs/pdp/data-browser-model-sort-v02_q4qneb.png" width="650px" alt="Data Browser - Open and close models"/>
