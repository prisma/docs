...
- We will send [notifications](/data-platform/billing/data-proxy-usage) in advance before your project reaches the quota limit, so that you have time to consider upgrading to a paid plan to avoid service interruptions.
