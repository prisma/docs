...
You receive automated email notifications based on your project plan and on the amount of Data Proxy usage you reach during any given month.

- [Early Adopter](/data-platform/billing/early-adopter-plan/) and [Free plan](/data-platform/billing/plans-and-quotas#strongfreestrong-plan)
...
You can see an example of an email notification when the Data Proxy usage reaches 50% on the Free or Early Adopter plan.

<img
  src="https://res.cloudinary.com/prismaio/image/upload/v1668021667/docs/pdp/billing/prisma-data-proxy-usage-notifications_tvzl6m.png"
