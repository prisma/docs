...
3. Select the **Free** plan and click **Downgrade**.
   <img
     src="../images/billing/manage-project-plan-select-free-and-click-downgrade.png"
     alt="Prisma Data Platform - Manage project plan - Select Free plan and click Downgrade"
   />
...
6. Click **Continue**.
   <img
     src="../images/billing/manage-project-plan-reduce-members-environments-to-free-plan-quotas.png"
