...
If you need to downgrade a project that is on the **Enterprise** plan, [contact Support](/data-platform/troubleshooting/contact-support).
...
If you see an error message for an unsuccessful downgrade, [contact Support](https://www.prisma.io/docs/data-platform/troubleshooting/contact-support).
