...
1. Go to the [_Billing_](https://cloud.prisma.io/billing) page.
...
## Downgrade to <strong>Free</strong> plan
...
1. Go to the _[Billing](https://cloud.prisma.io/billing)_ page.
...
5. If on your project you have more collaborators or environments than are included in the quotas on the [**Free** plan](https://www.prisma.io/docs/data-platform/billing/plans-and-quotas#strongfreestrong-plan), decide how to handle each overage.
   ...
   3. Click **Continue**.
      <img
        src="https://res.cloudinary.com/prismaio/image/upload/v1665491648/docs/pdp/manage-project-plan-reduce-members-environments-to-free-plan-quotas_cyhlxj.png"
