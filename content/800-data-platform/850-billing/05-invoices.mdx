...
When you purchase the [**Scale** plan](/data-platform/billing/plans-and-quotas#strongscalestrong-plan) for the first time, you will receive an invoice that is at the pro-rated amount for the remainder of the month based on the purchase date.
...
## Track overages on the Data Proxy usage

Prisma Data Platform sends [automated email notifications](/data-platform/billing/data-proxy-usage) when your project reaches specific usage milestones.
