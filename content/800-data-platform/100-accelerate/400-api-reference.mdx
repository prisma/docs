...
With the Accelerate extension for Prisma Client, you can use the `cacheStrategy` parameter for model queries and use the [`ttl`](/data-platform/accelerate/concepts#time-to-live-ttl) and [`swr`](/data-platform/accelerate/concepts#stale-while-revalidate-swr) parameters to define a cache strategy for Accelerate. The Accelerate extension requires that you install Prisma Client version `4.10.0`.
...
| ------ | ------- | ------------------------------------------- |
| `swr`  | `60`    | The stale-while-revalidate time in seconds. |
| `ttl`  | `60`    | The time-to-live time in seconds.           |
...
- [`findUnique`](/docs/reference/api-reference/prisma-client-reference#findunique)
- [`findUniqueOrThrow`](/docs/reference/api-reference/prisma-client-reference#finduniqueorthrow)
- [`findFirst`](/docs/reference/api-reference/prisma-client-reference#findfirst)
- [`findFirstOrThrow`](/docs/reference/api-reference/prisma-client-reference#findfirstorthrow)
- [`findMany`](/docs/reference/api-reference/prisma-client-reference#findmany)
- [`count`](/docs/reference/api-reference/prisma-client-reference#count)
- [`aggregate`](/docs/reference/api-reference/prisma-client-reference#aggregate)
- [`groupBy`](/docs/reference/api-reference/prisma-client-reference#groupby)
...
| `region`       | `String`                                                     | The datacenter region that received the request.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
