...
- A GitHub account.
- A project that uses [Prisma Client](/docs/concepts/components/prisma-client) `4.16.1` or higher. (If your project is using interactive transactions, you need to use `5.1.1` or higher.)
