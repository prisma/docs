...
To get started using Accelerate, we recommend using the latest version of Prisma.
...
Similar to Data Proxy, Accelerate can be used as a **stand-alone connection pooler** for your application.
