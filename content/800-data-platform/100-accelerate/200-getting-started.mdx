...
To migrate from Data Proxy to Accelerate, make sure that you fulfill the [prerequisites](/data-platform/accelerate/getting-started#prerequisites) to use Accelerate in your application. After you have successfully [enable](/data-platform/accelerate/getting-started#1-enable-accelerate-in-a-cloud-project) Accelerate and generate an Accelerate connection string, follow the steps outlined [here](/data-platform/accelerate/getting-started#21-update-your-database-connection-string) to use Accelerate in your application.
