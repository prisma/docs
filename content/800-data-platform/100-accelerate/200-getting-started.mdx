...
### Use Accelerate in your database queries

The `withAccelerate` extension does two primary things:

1. Gives you access to the `cacheStrategy` field within each applicable model method that allows you to define a cache strategy per-query.
2. Routes all of your queries through a connection pooler.
