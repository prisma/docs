...
<Admonition type="warning">
  ...
  After adjusting your database connection string, you must disable Accelerate and re-enable it using the new connection string for the changes to take effect.
