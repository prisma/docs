...
Accelerate is in Preview. While we have high confidence in our product, the nature of a preview product is that significant iterations might happen at any time, so we would advise against placing it in a system that requires stability.
