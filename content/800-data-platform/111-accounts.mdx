...
To start using the Prisma Data Platform, you need to sign up with your GitHub account. When you do so, you authorize the Prisma GitHub app to read your list of repositories (or only the ones to which you grant access), and to create new repositories for new projects.

In addition to your GitHub, you can also use your accounts for [PlanetScale](https://planetscale.com/) and [Heroku](https://www.heroku.com/) when you want to use either platform to quickly provision a new database for your projects.

Any PlanetScale or Heroku account that you use is a _linked account_ in the Prisma Data Platform. At any time, you can link only one PlanetScale and only one Heroku account. You can unlink any currently linked accounts and use others to quickly provision databases.
</TopBlock>

## Prisma Data Platform account

You need a GitHub account to sign up and log in to the Prisma Data Platform. Your Prisma Data Platform profile is tied to your GitHub username and email address.

### Sign up to for the Prisma Data Platform

When you sign up, you need to have an existing GitHub session and you need to grant the required permissions for the Prisma GitHub app to read the list of existing repositories and to create new ones.
...
4. To grant the Prisma GitHub app the required permissions, click **Install**.

**Result**

If your sign up is successful, you see the [_Projects_](https://cloud.prisma.io/projects) page from which you can view your existing projects and create new ones.
...
You can view your linked PlanetScale and Heroku accounts when you click your profile in the upper-right corner and select **Manage integrations**.
...
The account you select is now unlinked.

**What's next**

The next time you create a new project, you can use another PlanetScale or Heroku account to provision a database for the project.