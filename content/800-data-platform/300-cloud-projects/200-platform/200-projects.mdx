...
Accelerate is currently in early access. If you want to learn more about it, check out the [Accelerate webpage](/data-platform/accelerate) and read the [Accelerate documentation](/data-platform/accelerate/what-is-accelerate).
...
If you do not yet have early access to Accelerate, this page will look different. You will find a button labeled **"Join the waitlist"** that, when clicked, takes you to the Accelerate webpage.
...
This option will look slightly different if you have not yet been given early access to Accelerate. In that scenario the link’s text will change and will take you to the Accelerate webpage.
