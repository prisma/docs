...
- AWS Aurora via [security groups](https://aws.amazon.com/premiumsupport/knowledge-center/aurora-mysql-connect-outside-vpc/) (not Aurora Serverless v1)
- AWS Aurora Serverless v2 (the instance must have a public IP address)
