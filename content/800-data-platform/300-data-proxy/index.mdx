...
* **High availability**. In each region, the Data Proxy infrastructure runs multiple clusters. By default and until your application reaches higher workloads, from each clust the Data Proxy starts and assigns a connection pool to an application. If any of the clusters goes through a period of downtime, the remaining clusters take over the management of connection pools.
    <Admonition>
