...
This architecture allows the Data Proxy to create new connection pools in cases of higher demand and to close connection pools in cases of lower activity and provides the flexible capablities of scaling your application demands as necessary.
