...
metaDescription: 'When viewing models in the Data Browser or running queries in the Query Console, you might see errors reporting that the connection to your database times out.'
---
...
* The time added to a request as a result of it going through the Data Proxy pushed the timeout beyond the limit
...
* Configure your Data Proxy to be in a closer or the same location as the database. 
    <Admonition>
