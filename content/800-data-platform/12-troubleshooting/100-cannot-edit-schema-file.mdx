...
The Prisma Data Platform does not support the complete development workflow of making iterative changes to your Prisma schema, creating migrations with<br />`prisma migrate`, or pushing the schema changes directly to the database with<br />`prisma db push`.
