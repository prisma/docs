...
In the Prisma Data Platform, to [create projects](/data-platform/projects/create), you only need to provide the connection string for your database. If necessary, you can configure database access from the supported static IPs and select a Data Proxy location.
