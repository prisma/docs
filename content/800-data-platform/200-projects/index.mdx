...
In the Prisma Data Platform, to [create projects](/data-platform/projects/create), you only need to provide the connection string for your database. You can also select a Data Proxy region for the project, and if necessary, you can configure database access from the supported [static IPs](/data-platform/static-ips) of the platform.
