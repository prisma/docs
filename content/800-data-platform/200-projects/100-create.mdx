...
When you create a project with an existing database, the platform introspects your database and generates a Prisma schema for your project. If you make a change to your database model and the platform does not have a linked schema, you and your team might start seeing errors when you use [Data Browser](/data-platform/data-browser), [Query Console](/data-platform/query-console), and [Schema Viewer](/data-platform/schema-viewer).<br /><br />

If you crate a project with an empty database, you cannot begin to use [Data Browser](/data-platform/data-browser), [Query Console](/data-platform/query-console), and [Schema Viewer](/data-platform/schema-viewer) for the project because the database introspection cannot read your database model and cannot generate a Prisma schema for the project.
...
The platform creates your project and assigns it a random name, such as **Grey&nbsp;fish&nbsp;<random-code\>**, where **<random-code\>** is an auto-generated code.
<br />
...
Later, when you open the [Data Browser](/data-platform/data-browser) or [Query Console](/data-platform/query-console), each indicates that your project is missing a Prisma schema.
<br />
