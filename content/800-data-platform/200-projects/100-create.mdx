...
You can [develop your Prisma schema](https://www.prisma.io/docs/concepts/components/prisma-schema/data-model) further and [migrate the schema changes you make to your database](https://www.prisma.io/docs/concepts/components/prisma-migrate) with `prisma migrate dev`. You can then push the changes to a GitHub repository. 

With this, you can [enable schema synchronization](#optional-enable-schema-synchronization) so that the platform can read the schema from your repository and update your project with the latest schema and keep the models and attributes up-to-date when you use [Data Browser](/data-platform/data-browser), [Query Console](/data-platform/query-console), and [Schema Viewer](/data-platform/schema-viewer).
