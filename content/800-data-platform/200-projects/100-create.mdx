...
Next, you can [develop your Prisma schema and your database models](/concepts/components/prisma-schema/data-model) further and [migrate any schema changes to your database](/concepts/components/prisma-migrate) with [`prisma migrate dev`](/reference/api-reference/prisma-cli/command-reference#migrate-dev).
