...
In the Prisma Data Platform, you can create new projects only with an available database connection string. If your database sits behind a firewall or only allows connections from specific IPs, you can configure the [static IPs of the platform](/data-platform/static-ips). You can also select the [Data Proxy](/data-platform/data-proxy) region to take advantage of connection pooling and load balancing in serverless environments.

After you create your project, you can optionally link your Prisma schema (if you push it to a GitHub repository) so that we can keep your project in sync with its latest version and enable you and your team members to work with the [Data Browser](/data-platform/data-browser), [Query Console](/data-platform/query-console), and [Schema Viewer](/data-platform/schema-viewer).
