...
You can now [enable connection pooling with Data Proxy](/data-platform/data-proxy/use-data-proxy#enable-the-data-proxy-for-a-project) locally or in your deployment environment.
