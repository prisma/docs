...
* Use the connection string format below.<br />
...
Prisma Data Platform introspects the database to read the data models so that it can generate the Prisma schema. The Prisma schema enables the features in the Data Browser, Query Console, and Schema Viewer.

If your database is empty, the introspection cannot generate a Prisma schema and you cannot use the features in Data Browser, Query Console, and Schema Viewer. In such cases, if you push your Prisma schema to a GitHub repository, you can [link the schema and repository](#optional-enable-schema-synchronization) to your project and enable all features.
...
You can now use Data Browser, Query Console, and Schema Viewer with the latest version of your Prisma schema.
