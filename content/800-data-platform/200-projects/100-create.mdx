...
5. Click **Create project**.
  <img
    src="../images/projects/create-project-01-paste-connection-string.png"
...
5. Click **Link Prisma schema**.<br />
   <img
     src="../images/projects/create-project-02-enable-schema-synchronization-select-github-account-branch-prisma-schema-path.png"
...
4. Copy the `prisma://` connection string.
   ...
   <img
     src="../images/projects/create-project-03-copy-data-proxy-connection-string.png"
