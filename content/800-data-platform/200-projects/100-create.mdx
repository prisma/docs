...
Because of this, when you open the [Data Browser](/data-platform/data-browser) or [Query Console](/data-platform/query-console), each indicates that your project is missing a Prisma schema.
<br />
...
Alternatively, you can go directly to your project or view it on the [Projects](https://cloud.prisma.io/projects) page. You can [edit the project settings](/data-platform/projects/edit-settings) 
...
As a result, the platform automatically updates the Prisma schema for your project and keep your work in Data Browser and Query Console up-to-date with its latest version.
