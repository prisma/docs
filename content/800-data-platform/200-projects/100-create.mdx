...
* Click Skip and continue to Data Platform
...
If you push your Prisma schema to a GitHub repository, you can [enable schema synchronization](#optional-enable-schema-synchronization) so that the platform can update your project with the latest schema and keep the models and attributes up-to-date when you use [Data Browser](/data-platform/data-browser), [Query Console](/data-platform/query-console), and [Schema Viewer](/data-platform/schema-viewer).

Alternatively, you can go directly to your project or view it on the [Projects](https://cloud.prisma.io/projects) page.
