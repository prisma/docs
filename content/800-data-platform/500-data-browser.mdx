...
For more information, see [Defining models](/concepts/e/components/prisma-schema/data-model#defining-models).
...
5. To remove a filter, click the **x** button on the right.
   <img
     src="https://res.cloudinary.com/prismaio/image/upload/v1661864213/docs/pdp/data-browser-filters-actions-v04_r0jnps.png"
     width="650px"
...
<img
  src="https://res.cloudinary.com/prismaio/image/upload/v1661875676/docs/pdp/data-browser-model-sort-v02_q4qneb.png"
  width="650px"
  alt="Data Browser - Open and close models"
/>
