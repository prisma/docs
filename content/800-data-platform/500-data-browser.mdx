...
2. Based on the data allowed in each field, type the data for the record.
   ...
   |       <img src="https://res.cloudinary.com/prismaio/image/upload/v1657313048/docs/pdp/icons/array_mapns7.svg" width="10px" alt="Array type"/>       | List of related records from another model<br /><br />It typically refers to a list of records that exist in another model in the database. If you are adding a new record and records from the related model do not yet exist, you do not need to enter anything in the current model.                                                                                                                                                                 |
