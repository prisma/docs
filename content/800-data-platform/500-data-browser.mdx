...
The response size when loading data on the Databrowser is limited to 4MB. If the size of the data requested exceeds 4MB, you will run into Prisma Client Error on the Databrowser.
