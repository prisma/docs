...
When you add multiple conditions, the **Data Browser** filters the results so that all conditions apply in combination. Each new condition indicates this with the `and` operator, which appears in front.
...
3. Configure the condition.
   ...
   3. Type the value you want to use for the condition.<br />
      **Step result**: The **Data Browser** updates the data in the model immediately, based on the condition.
