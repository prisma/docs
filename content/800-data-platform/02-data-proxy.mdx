...
Depending on your [project plan](/data-platform/billing/plans-and-quotas), the Data Proxy provides a different [limit of concurrent proxy instances](/data-platform/about/limits-and-status#concurrency-limits-of-the-prisma-data-proxy.
