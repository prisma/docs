...
Depending on your [project plan](/data-platform/billing/plans-and-quotas), the Prisma Data Proxy provides a different [limit of concurrent proxy instances](/data-platform/about-platform/platform-limits-and-status#concurrency-limits-of-the-prisma-data-proxy).
