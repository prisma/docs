...
Depending on your database provider, the setup may vary. This section will attempt to cover the most common providers. If you have a provider that isn't covered, please reach out to a developer advocate at Prisma for assistance. Once we help you get the database set up, we can then add that information to this section.
...
[Railway.app](https://railway.app) offers an excellent templates feature. If you wish to quickly start with Pulse, you can utilize our [Prisma Pulse DB Only](https://railway.app/template/pulse-pg) template, which provides a fresh pre-configured PostgreSQL database. Or you can use our [Prisma Pulse DB & App](https://railway.app/template/pulse-starter) railway template that provides a pre-configured PostgreSQL database and a Pulse starter app.
