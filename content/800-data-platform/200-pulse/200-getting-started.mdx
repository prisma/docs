...
With the Pulse extension applied, you may now use Pulse's `.subscribe` method on any model defined in your Prisma Schema to subscribe to database changes.
