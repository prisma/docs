...
We will soon add heartbeating capability that throws an error to the Prisma Client when the connection is no longer active so the application can reconnect.
