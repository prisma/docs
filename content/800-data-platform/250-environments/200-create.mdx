...
The platform links the Prisma schema from the selected branch so that it can keep your project up-to-date with the latest schema version. The updates of the Prisma schema keep the models and attributes up-to-date in **Data Browser**, **Query Console**, and also the schema contents in **Schema Viewer**.
