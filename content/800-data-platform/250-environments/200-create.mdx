...
You can use environments to isolate database development activities with separate branches and databases, and dedicate each environment to an activity, such as Development, Staging, and Production.
...
* Based on your [project plan quota](/data-platform/billing/plans-and-quotas), check that you have capacity for more environments in the project.
