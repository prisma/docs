...
As a result, [Data Browser](/data-platform/data-browser) and [Query Console](/data-platform/query-console) will be inactive. You can start using them after you provide a schema. You can provide a schema by [uploading your schema](#upload-a-schema-file).
