...
- a Data Proxy region
- ([if schema synchronization is enabled](/data-platform/projects/create#optional-enable-schema-synchronization)) a GitHub branch from the repository of the Production environment
