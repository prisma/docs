...
metaDescription: 'You can upgrade to a paid plan to increase Data Proxy usage and the number of team members and environments that you can add to your project. If you no longer need a paid plan for a project, you can always downgrade.'
---
...
- You exceeded or are concerned about exceeding Data Proxy usage quota in the **Free** plan.

<Admonition type="info">

**Available plans**<br /><br />
See [Plans and quotas](./plans-and-quotas) for descriptions of all plans available in the Prisma Data Platform.
...
If you have a project in the Prisma Data Platform that is currently on the **Free** plan, and you want to increase the quota of environments, team members, and Data Proxy CPU usage, you can do so by upgrading to the **Scale** plan.
...
1. Go to the [_Billing_](https://cloud.prisma.io/billing) page or click your profile icon and select **Manage billing**.
   ...
   <img
     src="./images/profile-menu-select-manage-billing.png"
...
If you need to downgrade a project that is on the **Enterprise** plan, [contact Support](/data-platform/classic-projects/contact-support).
...
- Data Proxy CPU usage changes to the hard limit included with the **Free** plan.
...
Learn about the [**Free** plan](./plans-and-quotas#strongfreestrong-plan) and the quotas that it includes for team members, environments, and Data Proxy CPU usage.
...
3. Select the **Free** plan and click **Downgrade**.
   ...
   <img
     src="./images/downgrade-01-select-free-and-click-downgrade.png"
     alt="Prisma Data Platform - Manage project plan - Select Free plan and click Downgrade"
   />

4. Click **Confirm downgrade** if the number of collaborators or environments on your project does not exceed the quotas on the [**Free** plan](./plans-and-quotas#strongfreestrong-plan).
5. If on your project you have more collaborators or environments than are included in the quotas on the [**Free** plan](./plans-and-quotas#strongfreestrong-plan), decide how to handle each overage.
...
6. Click **Continue**.
   ...
   <img
     src="./images/downgrade-02-reduce-members-environments.png"
...
If you see an error message for an unsuccessful downgrade, [contact Support](/data-platform/classic-projects/contact-support).
