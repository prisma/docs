...
metaDescription: 'Prisma Data Platform continuously monitors Data Proxy usage of your projects and sends automated notifications to the email address of your GitHub account when your project reaches usage milestones.'
tocDepth: 3
---

<TopBlock>

Prisma Data Platform continuously monitors Data Proxy usage of your projects and sends automated notifications to the email address of your GitHub account when your project reaches usage milestones.
...
- [Free plan](./plans-and-quotas#strongfreestrong-plan)
...
- [Scale plan](./plans-and-quotas#strongscalestrong-plan)
...
Below you can see an example of an email notification when Data Proxy usage reaches 50% on the Free plan.
