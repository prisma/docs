...
When you purchase the [**Scale** plan](./plans-and-quotas#strongscalestrong-plan) for the first time, you will receive an invoice that is at the pro-rated amount for the remainder of the month based on the purchase date.
...
![invoicing diagram](images/pdp-monthly-billing.png)

## Invoices with overages and overage refunds

Paid plans have an unlimited number of team members, environments, and usage of Data Proxy, but **they do have quotas**. The quotas limit how many members and environments, and how much Data Proxy usage you can have within the price of the plan.
...
![team members overage diagram](./images/pdp-invoice-overage-team-member.png)
...
![team members refund diagram](./images/pdp-invoice-refund-team-member.png)

### Overages on Data Proxy usage

The **Scale** plan has a monthly quota of 30,000,000 CPU milliseconds. Overages begin when you exceed the 30,000,000 CPU milliseconds. The overages are billed at the fixed price of the **Scale** plan.

![Data Proxy usage overages diagram](./images/pdp-invoice-data-proxy-overages.png)

## Track overages on Data Proxy usage

Prisma Data Platform sends [automated email notifications](./data-proxy-usage) when your project reaches specific usage milestones.
