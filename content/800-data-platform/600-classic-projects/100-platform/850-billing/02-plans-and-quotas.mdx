...
- If a project reaches the quota limit on the **Free** plan, we will pause your project until the beginning of next month, when the Data Proxy CPU usage quota resets.
