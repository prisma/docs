...
- the IP addresses are specific to the region in which Data Proxy is configured. Changing the region of Data Proxy will change the IPs for egress and will thus require a change of the IP allow list on your provider
