...
The [**Data Browser**](/data-platform/data-browser) and [**Query Console**](/data-platform/classic-projects/platform/query-console) remain disabled until you enable schema synchronization or manually re-trigger a new introspection.
...
[**Data Browser**](/data-platform/data-browser) and [**Query Console**](/data-platform/classic-projects/platform/query-console) are now active and you and your team members can now use them.
