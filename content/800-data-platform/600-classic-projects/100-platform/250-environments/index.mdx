...
- A Data Proxy region
- ([if schema synchronization is enabled](./create#optional-enable-schema-synchronization)) a GitHub branch from the same repository as the Production environment
