...
- a Data Proxy region
- ([if schema synchronization is enabled](/data-platform/classic-projects/create#optional-enable-schema-synchronization)) a GitHub branch from the same repository as the Production environment

## Default environment of a project

When you first [create a project](/data-platform/classic-projects/create), the platform defines the default environment of the project. The default environment has the name **Production**.
