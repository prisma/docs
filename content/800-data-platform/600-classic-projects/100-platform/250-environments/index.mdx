...
For each new environment in a [project](/data-platform/classic-projects), you define:

- A database connection string
- A Data Proxy region
- ([if schema synchronization is enabled](../projects/create#optional-enable-schema-synchronization)) a GitHub branch from the same repository as the Production environment

## Default environment of a project

When you first [create a project](./create), the platform defines the default environment of the project. The default environment has the name **Production**.
...
- When you manipulate data in **Data Browser** or run queries in **Query Console**, you do so on the database and Data Proxy region that are defined in the **Production** environment.
...
After you [add more environments](./create), you can switch to another environment from the **Environments** drop-down menu.
