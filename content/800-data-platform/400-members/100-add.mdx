...
5. From the **Role** drop-down menu, select a [role](/data-platform/members/roles-permissions) for the new team member.
...
The new team member can now see the project from the [Projects](https://cloud.prisma.io/projects) page. The team member can see and perform actions based on the granted [role](/data-platform/members/roles-permissions).