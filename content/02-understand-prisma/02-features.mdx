...
| `FOREIGN KEY` |     ✔️     |  ✔️   |   ✔️   |     [Relation fields]()      |      ✔️       |       ✔️       |
...
| -------- | ---------- | ----- | ------ | ---------------------------- | ------------- | -------------- |
| `UNIQUE` | ✔️         | ✔️    | ✔️     | [`@unique` and `@@unique`]() | ✔️            | Not yet        |
...
| --------------------------------- | ---------- | ----- | ------ | --------------------- | ------------- | -------------- |
| Autoincrementing IDs              | ✔️         | ✔️    | ✔️     | [`autoincrement()`]() | ✔️            | ✔️             |
| Arrays                            | ✔️         | No    | No     | [`[]`]()              | ✔️            | ✔️             |
| Enums                             | ✔️         | ✔️    | No     | [`enum`]()            | ✔️            | ✔️             |
...
You can find a full reference of all data modeling feature on the [Data model]() page.
...
`autoincrement()` is commonly used to generated autoincrementing [ID]() values. `now()` is commonly used to initialize "createdAt"-fields that store the point in time when a record was created.
...
| `@relation`  | n/a\*                   | Defines meta information about the relation. [Learn more]().                           |
