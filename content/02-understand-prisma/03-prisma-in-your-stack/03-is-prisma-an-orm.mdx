...
| ------------ | ------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| SQL Schema   | Migrations and model classes         | [Prisma schema](../../concepts/tools-and-interfaces/prisma-schema/)                                     |
| Tables       | Model classes                        | [Models](../../concepts/tools-and-interfaces/prisma-schema/data-model#models) in the Prisma schema      |
| Columns      | Properties in model classes          | Model [fields](../../concepts/tools-and-interfaces/prisma-schema/data-model#fields in the Prisma schema |
| Records      | Instances of a model class (objects) | Plain JavaScript objects                                                                                |
| Foreign keys | Foreign keys on model classes        | [Relations](../../concepts/tools-and-interfaces/prisma-schema/relations) between Prisma models          |
...
- [**Prisma Client**](../../concepts/tools-and-interfaces/prisma-client/): Auto-generated and type-safe database client
- [**Prisma Migrate**](../../concepts/tools-and-interfaces/prisma-migrate) (experimental): A CLI for declarative data modeling and migrations

Both Prisma Client and Prisma Migrate rely on the [Prisma schema](../../concepts/tools-and-interfaces/prisma-schema/). The Prisma schema is a declarative representation of your database schema. It serves as the single source truth for both the database schema and your application models.
...
- _Existing application_ (brownfield): Projects that already have a database schema can be [introspected](../../concepts/tools-and-interfaces/introspection) by Prisma to generate the Prisma schema and Prisma Client. This use-case works with any existing migration tool and is useful for incremental adoption. It's possible to switch to Prisma Migrate as the migration tool. However, this is optional.
...
Prisma will generate Prisma Client inside the `node_modules` folder, from which it can be imported in your application. For more extensive usage documentation, see the [Prisma Client API](../../concepts/tools-and-interfaces/prisma-client/) docs.
