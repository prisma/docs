...
| ------------ | ------------------------------------ | ----------------------------------------------------------------------------------------------------- |
| SQL Schema   | Migrations and model classes         | [Prisma schema](../../cconcepts/tools-and-interfaces/prisma-schema/prisma-schema-file)                |
| Tables       | Model classes                        | [Models](../../cconcepts/tools-and-interfaces/prisma-schema/models) in the Prisma schema              |
| Columns      | Properties in model classes          | Model [fields](../../cconcepts/tools-and-interfaces/prisma-schema/models#fields) in the Prisma schema |
| Records      | Instances of a model class (objects) | Plain JavaScript objects                                                                              |
| Foreign keys | Foreign keys on model classes        | [Relations](../../cconcepts/tools-and-interfaces/prisma-schema/relations) between Prisma models       |
...
- [**Prisma Client**](../../cconcepts/tools-and-interfaces/prisma-client/api): Auto-generated and type-safe database client
- [**Prisma Migrate**](../../cconcepts/tools-and-interfaces/prisma-migrate) (experimental): A CLI for declarative data modeling and migrations

Both Prisma Client and Prisma Migrate rely on the [Prisma schema](../../cconcepts/tools-and-interfaces/prisma-schema/prisma-schema-file). The Prisma schema is a declarative representation of your database schema. It serves as the single source truth for both the database schema and your application models.
...
- _Existing application_ (brownfield): Projects that already have a database schema can be [introspected](../../cconcepts/tools-and-interfaces/introspection) by Prisma to generate the Prisma schema and Prisma Client. This use-case works with any existing migration tool and is useful for incremental adoption. It's possible to switch to Prisma Migrate as the migration tool. However, this is optional.
...
Prisma will generate Prisma Client inside the `node_modules` folder, from which it can be imported in your application. For more extensive usage documentation, see the [Prisma Client API](../../cconcepts/tools-and-interfaces/prisma-client/api) docs.
