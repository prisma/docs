...
| Tables       | Model classes                        | [Models](../../reference/tools-and-interfaces/prisma-schema/data-model#defining-models) in the Prisma schema       |
| Columns      | Properties in model classes          | Model [fields](../../reference/tools-and-interfaces/prisma-schema/data-model#defining-fields) in the Prisma schema |
