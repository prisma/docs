...
Prisma generates many [additional filters](../../cconcepts/tools-and-interfaces/prisma-client/filtering) that are commonly used in modern application development.

**Mongoose**

Mongoose exposes the [MongoDB query selectors](https://docs.mongodb.com/manual/cconcepts/operator/query/#query-selectors) as filter criteria.
