...
Prisma generates many [additional filters](../../concepts/tools-and-interfaces/prisma-client/filtering) that are commonly used in modern application development.

**Mongoose**

Mongoose exposes the [MongoDB query selectors](https://docs.mongodb.com/manual/concepts/operator/query/#query-selectors) as filter criteria.
