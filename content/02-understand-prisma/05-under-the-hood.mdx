...
- **Introspect**: Read a database schema and translate into [Prisma data model](../cconcepts/tools-and-interfaces/prisma-schema/data-model)
- **Schema**: Construct and modify a [Prisma schema file](../cconcepts/tools-and-interfaces/prisma-schema/prisma-schema-file)
...
As an example, Prisma Client connects to the [query engine](../cconcepts/tools-and-interfaces/prisma-client/query-engine) in order to read and write data in a database:
...
> **Note**: It is possible to [use an `.env` file in a location outside the `prisma` folder](../cconcepts/tools-and-interfaces/prisma-schema#use-multiple-env-files-or-env-files-outside-the-prisma-folder).
