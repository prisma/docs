...
For the above Prisma 1 datamodel, this results in the following Prisma 2 schema (note that the models and fields have been reordered to match the initial order of the Prisma 1 datamodel):
