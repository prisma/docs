...
> **Note**: With Prisma 1, it was usually recommended to install the CLI globally. We now recommend to [install the Prisma CLI locally](../../../concepts/tools-and-interfaces/prisma-cli/installation#local-installation-recommended) to prevent version conflicts.
...
For this guide, you'll first create a new Prisma schema using the `prisma init` command and then "fill" it with a data model using [introspection](../../../concepts/tools-and-interfaces/introspection).
...
- `schema.prisma`: Your Prisma schema file that specifies the [data source](../../../concepts/tools-and-interfaces/prisma-schema/data-sources), [generator](../../../concepts/tools-and-interfaces/prisma-schema/generators) and [data model](../../../concepts/tools-and-interfaces/prisma-schema/data-model) (note that the data model doesn't exist yet, it will be generated via introspection).
- `.env`: A [dotenv](https://github.com/motdotla/dotenv#readme) file to configure your database [connection URL](../../../concepts/database-connectors/connection-urls).
...
With Prisma 2, the HTTP layer isn't exposed any more and Prisma Client 2.0 is configured to run requests "directly" against the database (that is, requests are proxied by Prisma's [query engine](../../../concepts/tools-and-interfaces/prisma-client/query-engine), but there isn't an extra server any more).
...
Learn more on the [Connection URLs](../../../concepts/database-connectors/connection-urls) page.
...
Note that this data model has three [relations](../../../concepts/tools-and-interfaces/prisma-schema/relations):
...
One thing you'll notice with this version of the Prisma 2 schema is that all [relation fields](../../../concepts/tools-and-interfaces/prisma-schema/relations#relation-fields) are named after their respective models, e.g:
...
<!-- To make sure your Prisma Client queries feel natural and idiomatic, it's recommended to make a few adjustments to the Prisma in order to [configure your generated Prisma Client API](../../../concepts/tools-and-interfaces/prisma-client/configuring-the-prisma-client-api).

Mostly, this means renaming [relation fields](../../../concepts/tools-and-interfaces/prisma-schema/relations#relation-fields). -->
