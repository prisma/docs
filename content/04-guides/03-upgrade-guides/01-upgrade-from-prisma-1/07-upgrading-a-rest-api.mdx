...
Consider each occurence of the Prisma client instance `prisma` and replacing with the respective usage of Prisma Client 2. You can learn more in the [API Reference](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/api).

### 1.1. Adjusting the import

Since Prisma Client 2 is generated into `node_modules/@prisma/client`, it is imported as follows:
