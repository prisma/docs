...
metaDescription: 'Learn how to upgrade existing Prisma 1 projects with prisma-binding to Prisma 2 and Nexus.'
---
...
If you haven't already, yuo can can now uninstall dependencies that were related to the Prisma 1 setup:
...
Since the entire app has now been upgrade to Prisma 2 and Nexus, you can delete all unnecessary files and remove the no longer needed dependencies.
