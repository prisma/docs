...
- Prisma 1 datamodel and `prisma.yml` have been merged into the [Prisma schema](../../cconcepts/tools-and-interfaces/prisma-schema/prisma-schema-file).
...
- **Database migrations**: In Prisma 1, you could migrate your database schema using `prisma deploy`. Prisma 2 aims to bring back this functionality with [Prisma Migrate](../../cconcepts/tools-and-interfaces/prisma-migrate). Until Prisma Migrate is available, you'll have to run your database migrations with plain SQL or another migration tool.
