...
- [Schema incompatibilities](https://www.nexusjs.org/#/): A _reference_ page about the schema incompatibilities between Prisma 1 and Prisma 2. Reading this page is optional but it will give you a better understanding of certain steps in the upgrade process.
...
>>>>>>> 626f14bf2895d03034c9ce01524600b3bfd9f960
...
- **Breaking Prisma 1**: Do the SQL statements break the Prisma 1 setup?
...
Note that if you are planning to run Prisma 1 and Prisma 2 side-by-side, you must not yet resolve the [schema compatilibites](#schema-incompatibilities) that are breaking the Prisma 1 setup.
