...
Prisma unfortunately doesn't have a production-ready solution for running schema migrations against a database yet. This means that if you migrate to Prisma and want to evolve your application in the future, you'll need to migrate your database schema _manually_ using SQL or another migration tool like [Flyway](https://flywaydb.org/) (until [Prisma Migrate](../../concepts/tools-and-interfaces/prisma-migrate) is considered production-ready).
...
1. [Introspect](../../concepts/tools-and-interfaces/introspection) your database with Prisma 2.0
