...
This upgrade guide describes how to migrate a Node.js project that's based on [Prisma 1](https://github.com/prisma/prisma1) and uses `prisma-binding` to build a GraphQL server. The code will be migrate to using [Nexus](https://www.nexusjs.org).
...
1. Fix the [schema incompatibilities](./schema-incompatibilities) in the new Prisma schema
1. Install and generate Prisma Client 2.0
1. Adjust your application code from 
