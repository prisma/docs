...
This upgrade guide describes how to migrate a Node.js project that's based on [Prisma 1](https://github.com/prisma/prisma1) and uses [`nexus`]() (< v0.X) or [`@nexus/schema`]() and [`nexus-prisma`]() (< v0.X) to implement a GraphQL server. 
