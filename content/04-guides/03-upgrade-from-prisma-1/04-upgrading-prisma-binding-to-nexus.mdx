...
> **Note**: Be sure to have you Nexus development server that you started with `yarn dev` running all the time. It constantly updates the generated Nexus types that enable the autocompletion in the background.
