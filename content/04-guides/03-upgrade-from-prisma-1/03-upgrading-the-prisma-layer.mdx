...
The shown SQL statemnts fall are categorized into five buckets, all aiming to resolve a certain [schema incompatibility]():
...
As a next step, you can start sending the SQL statements to your database. Note that all of these changes are non-breaking and you'll be able to continue using Prisma 1 side-by-side.
