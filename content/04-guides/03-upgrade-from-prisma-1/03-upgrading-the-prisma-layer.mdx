...
1. Use the [Prisma schema upgrade CLI](./how-to-upgrade#prisma-schema-upgrade-cli) to resolve the [schema incompatibilities](./schema-incompatibilities) in the new Prisma 2.0 data model
...
The [Prisma schema upgrade CLI](./how-to-upgrade#prisma-schema-upgrade-cli) is an interactive tool that helps you upgrading your Prisma schema and ironing out most of the inconsistencies listed above.
