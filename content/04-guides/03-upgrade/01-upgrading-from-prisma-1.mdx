---
title: 'Upgrading from Prisma 1'
metaTitle: 'Upgrading from Prisma 1'
metaDescription: 'Learn how to upgrade existing Prisma 1 projects to Prisma 2.0.'
---

## Overview

This upgrade guide describes how to migrate a Node.js project that's based on [Prisma 1](https://github.com/prisma/prisma1) and uses the [Prisma client](https://www.prisma.io/docs/prisma-client/) to Prisma 2. This tutorial uses a REST API as an example, detailled migration guides for upgrading projects that are using `prisma-binding` or `nexus-prisma` for building a GraphQL API will [follow soon](https://github.com/prisma/prisma/issues/1937). 
...
**Note that the steps will look somewhat different if you are:**
