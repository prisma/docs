...
ConnectorError(ConnectorError { user_facing_error: None, kind: ForeignKeyConstraintViolation { constraint: Fields(["author"]) } })
    at PrismaClientFetcher.request (C:\Users\Jan\Documents\prisma2-docs-demos\cascading-deletes\mysql\node_modules\@prisma\client\runtime\index.js:1:51487)
