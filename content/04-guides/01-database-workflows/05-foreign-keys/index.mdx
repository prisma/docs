...
The Prisma schema represents tables as models, and connections between two models are called [relations](../../../cconcepts/tools-and-interfaces/prisma-schema/relations). You can [filter and query by relations](../../../cconcepts/tools-and-interfaces/prisma-client/relation-queries) - for example, you can get all posts where the author's email address contains _"prisma.io"_.
