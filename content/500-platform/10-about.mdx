...
In addition to the web interface of the Platform Console, the Prisma CLI provides another way to interact with your PDP account and manage PDP products.
