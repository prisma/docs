...
In your PDP account, you can create several workspaces. A workspace is an isolated space to host projects in which you use PDP products. A workspace can have multiple user accounts that are part of it for collaboration.
