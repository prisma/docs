...
- access the [Optimize](/optimize) dashboard to measure query performance and receive AI-powered recommendations.

#### Optimize

Each workspace in your [Prisma Data Platform account](https://pris.ly/pdp) has an associated Optimize project.

##### Accessing the Optimize dashboard

To access the Optimize dashboard in your desired workspace:

1. Click the **Optimize** tab on the left panel.
...
3. Click your profile name in the top right corner of the navbar.
4. Select **Settings**.
5. Click **Create API key**.
6. Enter a name for the API key in the **Name** field, then click **Create**.
7. Copy the API key and store it securely. Finally, click the **I've stored it securely** button.
