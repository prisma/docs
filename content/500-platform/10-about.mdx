...
Each workspace in your [Prisma Data Platform account](https://console.prisma.io/optimize) has an associated Optimize project.
...
8. Copy the API key and store it securely. Finally, click the **I've stored it securely** button.
