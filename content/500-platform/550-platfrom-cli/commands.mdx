...
This document describes the Prisma Data Platform integrated Prisma CLI commands, arguments, and options.
...
--workspace cdlgqeDwSJxhazrsFgouRg2zQ \
--early-access
```
...
--workspace cdlgqeDwSJxhazrsFgouRg2zQ \
--project ciii6b2JT4gZEk60LLj3AULyw \
--early-access
```
...
--workspace cdlg1gzm000000000001b7m8b \
--project ciiirb3z700017qyi0v7rcltd \
--apikey ciiirb3z700037qyi0xjf63c1 \
--early-access
```
...
```bash
prisma platform accelerate disable \
--workspace cdlg1gzm000000000001b7m8b \
--project ciiirb3z700017qyi0v7rcltd \
--early-access
```
