...
Next, you can [develop your Prisma schema and your database models](/concepts/components/prisma-schema/data-model) further and [migrate any schema changes to your database](/concepts/components/prisma-migrate) with [`prisma migrate dev`](/orm/reference/prisma-cli-reference#migrate-dev).
