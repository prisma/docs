...
Next, you can [develop your Prisma schema and your database models](/orm/prisma-schema/data-model/models) further and [migrate any schema changes to your database](/orm/prisma-migrate) with [`prisma migrate dev`](/reference/api-reference/command-reference#migrate-dev).
