...
For more information, see [Defining models](/orm/prisma-schema/data-model#defining-models).
...
For more information, see [Defining fields](/orm/prisma-schema/data-model#defining-fields).
