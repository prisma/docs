...
1. To introspect your database or perform migrations using the Prisma CLI, a direct database connection is required. <versioninfo>If you are using Prisma version 4.1.0 or later, include the `directUrl` property in the [`datasource`](/orm/reference/prisma-schema-reference#datasource) block of your Prisma schema.</versioninfo>
