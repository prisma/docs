...
Depending on your project plan, the Prisma Data Proxy provides a different [limit of concurrent proxy instances](/platform/classic-projects/about/limits-and-status#concurrency-limits-of-the-data-proxy).
