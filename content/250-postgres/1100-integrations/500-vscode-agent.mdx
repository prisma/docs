...
Visual Studio Code includes an [agent mode](](https://code.visualstudio.com/docs/copilot/chat/chat-agent-mode)) (powered by GitHub Copilot) that automatically performs code changes and executes Prisma CLI commands based on your prompts.
