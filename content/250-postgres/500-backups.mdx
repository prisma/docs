...
Prisma Postgres takes full snapshots of your database every 24 hours to back up your data. Backups every 24 hours are available exclusively on Pro, Business and Enterprise plans. For more details about backup availability and plan-specific features, visit our [pricing page](https://www.prisma.io/pricing).

If you need to access a database backup, [reach out to our Support team](mailto:support@prisma.io) from the email address associated with your Prisma Data Platform account. Doing so helps us verify your account quickly and expedite the restoration process.
