...
Prisma Postgres takes full snapshots of your database every 24 hours to back up your data. Automated daily backups are not available on the Starter plan. They are available exclusively on Pro, Business, and Enterprise plans. For more details about backup availability and plan-specific features, visit our [pricing page](https://www.prisma.io/pricing).
