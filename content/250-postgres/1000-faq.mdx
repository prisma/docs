...
## Is my data in Prisma Postgres durable?

Yes. Prisma Postgres uses [Prisma Pulse](/pulse/) to ensure data durability. Database events are immediately picked up and routed to off-site storage in less than a second.
