...
- **Business Annual plan** - \$1 per million operations in the 50-100M/month usage bracket
...
- `ops_cost` = $`0` 
- `storage_cost` = $`0` (0.5 GB is below the 10 GB free tier)
- `base_plan_fee` = $`10`
...
- `ops_cost` = $`0`
- `storage_cost` = $`0` (6 GB is below the 50 GB free tier)
- `base_plan_fee` = $`49.00`
...
- `storage_cost` = $`0.00` (40 GB is below the 100 GB free tier)
