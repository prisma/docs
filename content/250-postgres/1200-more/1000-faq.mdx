...
While it is technically possible to connect via the [TCP tunnel](/postgres/database/direct-connections#tcp-tunnel-deprecated), this approach is only intended for _tooling_ purposes, such as command line tools or query editors.
