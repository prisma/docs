...
- Use via the [Prisma VS Code extension](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma)
- [Embed Prisma Studio](/postgres/database/prisma-studio/embedding-studio) in your own app
