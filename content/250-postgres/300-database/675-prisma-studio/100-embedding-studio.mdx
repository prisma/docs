...
- **PostgreSQL**: Full support with Prisma Postgres or any PostgreSQL instance
- **SQLite**: Full support with local SQLite database files
- **MySQL**: Full support with MySQL instances
