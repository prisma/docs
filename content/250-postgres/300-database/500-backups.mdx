...
On [Pro and Business plans](https://www.prisma.io/pricing), Prisma Postgres supports snapshots of your database to support recovery and backup workflows. 

Navigate to the **Backups** tab of your Prisma Postgres instance in the [Prisma Console](https://console.prisma.io) to view and re-instantiate your available backups.

Prisma Postgres automatically creates _daily_ snapshots to back up your data. Additionally, you can create manual snapshots for specific point-in-time recovery.

Depending on your plan, your screenshot retention will be different:
