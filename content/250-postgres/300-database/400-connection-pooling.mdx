...
For Prisma Postgres, the connection limit starts at 10 and scales depending on your plan.
...
If you're using **your own database** with Prisma Accelerate, the connection limits are:
...
For Prisma Postgres, the connection limit is managed automatially for you.
