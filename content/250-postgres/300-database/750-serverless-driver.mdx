...
##### With generated Prisma Client types
...
{
  columns: [
    { name: 'id', oid: 23, type: 23 },
    { name: 'title', oid: 25, type: 25 },
    { name: 'content', oid: 25, type: 25 },
    { name: 'published', oid: 16, type: 16 },
    { name: 'authorId', oid: 23, type: 23 }
  ],
