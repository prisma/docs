...
```sql
-- prisma/migrations/<timestamp>-add-pgvector
...
This command will apply the pending `prisma/migrations/<timestamp>-add-pgvector` migration and create the `Document` table in your database.
...
This will update your Prisma schema as follows:
