...
metaTitle: 'Using Prisma Postgres in a development environment'
metaDescription: 'Guide to setting up local development using Prisma Postgres with PGlite'
tocDepth: 3
toc: true
---
...
## Setting up local development with PGlite

Follow these steps to integrate PGlite into your local development workflow.
...
Persistent storage will be supported in the future.
