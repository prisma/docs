...
The Prisma Extension can support both vesion 6 and version 7 of Prisma ORM. If you open a project
using either version, you can set the supported version by the command pallet or the diagnostics
prompt. 
