...
- [**Import data from an existing PostgreSQL database**](/getting-started/prisma-postgres/import-from-existing-database)
- [**Import data from an existing MySQL database**](/getting-started/prisma-postgres/import-from-mysql-database)
