...
**Suggested solution:** You'll have to enable static IP within your Accelerate configuration in your project environment. After you opt-in to use Accelerate with static IP enabled, add the IP address you receive in the database firewall IP allowlist or permit it access to your private network. This will ensure that Accelerate can securely access your database.
