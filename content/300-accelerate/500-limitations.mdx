...
Accelerate has a global timeout of `15s` for each [interactive transaction](/guides/performance-and-optimization/prisma-client-transactions-guide#interactive-transactions). Reach out to [support@prisma.io](mailto:support@prisma.io) with your use case if your application requires a greater timeout value.
