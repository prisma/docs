...
:::warning
While you can increase these limits based on your subscription plan, it's *still* recommended to optimize your database operations. [Learn more in our troubleshooting guide.](https://www.prisma.io/docs/concepts/components/prisma-accelerate/troubleshoot)
:::