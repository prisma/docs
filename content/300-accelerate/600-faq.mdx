...
A static IP address is an IPv4 or an IPv6 address that doesn’t change. Unlike dynamic IP addresses, which can change unpredictably, traffic from static IP addresses are predictable.
...
> ℹ️ To enable static IP support for Accelerate within your existing or new project environment, ensure you're on our **Pro** or **Business** plan. Refer to our [pricing page](https://www.prisma.io/pricing) for more information.
