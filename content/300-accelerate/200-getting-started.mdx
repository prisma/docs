...
For further information on each individual step, you can find additional documentation [here](/platform/platform-console/concepts/projects#configure-accelerate).
...
For information about which strategy best serves your application, see [Select a cache strategy](/accelerate/concepts#selecting-a-cache-strategy).
...
To migrate from Data Proxy to Accelerate, make sure that you fulfil the [prerequisites](/accelerate/getting-started#prerequisites) to use Accelerate in your application.

After you have successfully [enabled](/accelerate/getting-started#1-enable-accelerate-in-a-cloud-project) Accelerate and generated an Accelerate connection string, follow the steps outlined [here](/accelerate/getting-started#21-update-your-database-connection-string) to use Accelerate in your application.
