...
> If you are using Prisma Postgres then there is no need for `directUrl` as Prisma Migrate and Introspection work with the `prisma+postgres://` connection string.
