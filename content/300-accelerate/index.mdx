...
[Prisma Accelerate](https://www.prisma.io/data-platform/accelerate) makes your database queries faster. Accelerate is a managed connection pool and global cache that you can easily configure, and choosing the right cache strategy for every query is just a few lines of code. 
