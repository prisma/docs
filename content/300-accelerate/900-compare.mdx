...
- Automatic cache updates means that the cache is automatically updated when a change in the database occurs. With Accelerate, you are in control of how the cache is invalidated, using [various caching strategies](https://www.prisma.io/docs/accelerate/caching). 
...
- Never worry about 'noisy neighbours' with isolated compute resources. Other customers never impact on your own performance.
...
Note: Support for MariaDB coming soon to Prisma Accelerate
