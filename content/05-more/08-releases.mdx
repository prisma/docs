---
title: 'Releases and maturity stages'
metaTitle: 'Releases and maturity stages'
...
If a feature or product is an **experimental**:
...
- Users can count on the feature or product and associated API to be stable, unless stated otherwise in the release notes and documentation.
...
Previews are typically available behind a feature flag or require some form of opt-in (for example, by providing a `--preview` flag in the CLI).
