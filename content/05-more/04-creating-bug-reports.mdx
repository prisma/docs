...
metaDescription: 'This page explains best practices for creating bug reports for Prisma, inlcuding sharing additional debugging output and other recommendations.'
---
...
Please make sure to include _any_ [logging](../reference/tools-and-interfaces/prisma-client/logging) and [debugging](../reference/tools-and-interfaces/prisma-client/debugging) output in the issue that may help to identify the problem.
...
Query Engine         : prisma 2accb9c7eacdc984874eaeb63377fe705dfd3203 (at /usr/local/lib/node_modules/@prisma/cli/query-engine-darwin)
Migration Engine     : migration-engine-cli 2accb9c7eacdc984874eaeb63377fe705dfd3203 (at /usr/local/lib/node_modules/@prisma/cli/migration-engine-darwin)
Introspection Engine : introspection-core 2accb9c7eacdc984874eaeb63377fe705dfd3203 (at /usr/local/lib/node_modules/@prisma/cli/introspection-engine-darwin)
```
