...
Prisma offers a limited set of transactions in the form of [nested writes](../cconcepts/tools-and-interfaces/prisma-client/relation-queries#nested-writes). There currently is no plan to provide an API to allow a transaction API for long-running transactions.
