...
- Migration history conflicts caused by [modified or missing migrations](/concepts/components/prisma-migrate/migration-histories#do-not-edit-or-delete-migrations-that-have-been-applied)
...
Refer to [Customizing migrations](/guides/migrate/developing-with-prisma-migrate/customizing-migrations)  for examples.

### Team development

See: [Team development with Prisma Migrate](/guides/migrate/developing-with-prisma-migrate/team-development) .
...
- [Prisma Migrate in deployment](/guides/deployment/deploy-database-changes-with-prisma-migrate) 
...
Since `5.3.0`, the advisory locking can be disabled using the [`PRISMA_SCHEMA_DISABLE_ADVISORY_LOCK` environment variable](https://www.prisma.io/docs/reference/api-reference/environment-variables-reference#prisma_disable_advisory_lock)
