...
The Prisma schema is able to represent [unsupported field types](/orm/prisma-schema/features-without-psl-equivalent#unsupported-field-types) and [native database functions](enable-native-database-functions).
