...
The Prisma CLI has a dedicated command for prototyping schemas: [`db push`](/reference/api-reference/command-reference#db-push) 
...
See [Schema prototyping with `db push`](/guides/migrate/prototyping-schema-db-push)  for an example of how to use `db push` in this way.
...
Yes, you can [use `db push` and Prisma Migrate together in your development workflow](/guides/migrate/prototyping-schema-db-push) . For example, you can:
