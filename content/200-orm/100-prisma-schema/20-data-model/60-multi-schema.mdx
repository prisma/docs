...
Multi-schema support is currently in [Preview](/orm/more/releases#preview) and has been available since [v4.3.0](https://github.com/prisma/prisma/releases/tag/4.3.0) for PostgreSQL, CockroachDB, and SQL Server. It is not available for SQLite and MySQL because these databases don't have the same concept of _schemas as namespaces_.
