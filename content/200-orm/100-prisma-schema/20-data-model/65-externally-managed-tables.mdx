...
:::warning
Exrernally managed tables are currently in [Preview](/orm/more/releases#preview).
:::
...
1. You can now query the external table using Prisma Client but it will be ignore by Prisma Migrate
