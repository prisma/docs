...
- <versioninfo>
    †† Referential actions for MongoDB are available in Prisma versions 3.7.0
    and later.
  </versioninfo>
...
- **MongoDB** <versioninfo>(in preview from version 3.6.0): When a record is modified or deleted, nothing is done to any related records.</versioninfo>
