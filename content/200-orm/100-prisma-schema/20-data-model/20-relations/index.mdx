...
<TabbedContent tabs={[<FileWithIcon text="Relational databases" icon="database"/>, <FileWithIcon text="MongoDB" icon="database"/>]}>
Relation [fields](/orm/prisma-schema/data-model#defining-fields) are fields on a Prisma [model](/orm/prisma-schema/data-model#defining-models) that do _not_ have a [scalar type](/orm/prisma-schema/data-model/models#scalar-fields). Instead, their type is another model.
