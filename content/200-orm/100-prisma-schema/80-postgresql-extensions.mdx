...
metaDescription: 'How to represent PostgreSQL extensions in your Prisma schema, introspect extensions in your database, and apply changes to extensions with Prisma Migrate'
tocDepth: 3
---
