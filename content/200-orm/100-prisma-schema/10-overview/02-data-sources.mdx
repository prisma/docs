...
**Note:** When the [`prismaSchemaFolder`](/orm/prisma-schema/overview/location#multi-file-prisma-schema) preview feature is enabled, Prisma ORM resolves SSL certificates relative to the `./prisma/schema` directory.
