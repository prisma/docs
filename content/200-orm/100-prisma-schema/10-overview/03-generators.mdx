...
Existing generators or new ones should not be affected if you are using a [multi-file Prisma schema](/orm/prisma-schema/location/overview#multi-file-prisma-schema), unless a generator reads the schema manually.
