...
Currently in [Early Access](/orm/more/releases#early-acess), this generator ensures you can bundle your application code exactly the way you want, without relying on hidden or automatic behaviors.
