...
Currently, `prisma-client-js` is generally available, while the `prisma-client` generator is in preview. Be sure to define a custom output folder for the generated assets using the output property. 
