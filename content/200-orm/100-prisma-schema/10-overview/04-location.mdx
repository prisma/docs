...
When first updating to the `prismaSchemaFolder` preview feature, your IDE may not recognize the new format immediately. Be sure to restart your IDE to confirm you have the latest version of the Prisma VS Code Extension installed.
