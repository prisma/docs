---
title: 'Tabnine'
metaTitle: 'Use Tabnine with Prisma ORM'
metaDescription: 'Learn tips and best practices for using Prisma ORM with the Tabnine AI code editor.'
---

## Overview

[Tabnine](https://www.tabnine.com/) is a an AI software development platform that comes as an [extension for your IDE](https://www.tabnine.com/install/) (e.g. VS Code, WebStorm, IntelliJ, ...) and helps develolpers write code faster by:

- providing context-aware [code completion](https://docs.tabnine.com/main/getting-started/getting-the-most-from-tabnines-code-completion) suggestions in the editor for small, repetive coding tasks
- offering an integrated [chat](https://docs.tabnine.com/main/getting-started/getting-the-most-from-tabnine-chat) for higher-level tasks and detailled instructions
...
- Generating CRUD funcionality and other boilerplate code
...
- Build SQL queries based on your Prisma schema.
...
Writing tests ensures that Prisma-based applications function correctly and behave according to requirements and expectations. However, writing tests is a time-consuming activity that often follows predictable and repetive patterns.

Tabnine can drastically speed up writing tests by by:
