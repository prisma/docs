...
[Tabnine](https://www.tabnine.com/) is a an AI software development platform that comes as an [extension for your IDE](https://www.tabnine.com/install/) (e.g. VS Code, WebStorm, IntelliJ, ...).
