...
```terminal
Generate a migration script using best practices from [Prisma Documentation](https://www.prisma.io/docs).
```
...
```terminal
Always use the Prisma Changelog at https://www.prisma.io/changelog for Prisma updates in this project.
```
...
```terminal
Before suggesting Prisma code, check the latest changes from https://www.prisma.io/changelog.
```
