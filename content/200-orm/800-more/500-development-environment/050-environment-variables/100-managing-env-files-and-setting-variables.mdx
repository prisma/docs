...
[Prisma ORM creates an `.env` file for you upon installation](/orm/more/development-environment/environment-variables#how-does-prisma-use-environment-variables). You are not limited to using that file, some other options include:
