...
4. Start the development server:
    ...
    - Automatically install the [Prisma CLI](https://www.prisma.io/docs/orm/reference/prisma-cli-reference)
    ...
    - Prompt you to start the [Prisma Studio](https://www.prisma.io/docs/orm/tools/prisma-studio)
...
### Option A: <inlinecode>usePrismaClient</inlinecode> composable
...
### Option B: <inlinecode>lib/prisma.ts</inlinecode>
