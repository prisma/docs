...
The module is designed to work with popular package managers, including npm, Yarn, and pnpm. However, as of `v1.4`, it is not fully compatible with Bun due to an issue causing an indefinite installation loop.
