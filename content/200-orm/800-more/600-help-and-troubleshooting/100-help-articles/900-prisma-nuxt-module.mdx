...
The module is designed to work with popular package managers, including npm, Yarn, and pnpm. However, as of `v2.0`, it is not fully compatible with Bun due to an issue causing an indefinite installation loop.
