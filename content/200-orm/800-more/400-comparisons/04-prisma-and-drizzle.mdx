...
## Typesafety
Drizzle is not end-to-end Typesafe. As quoted on this [comparison study](https://github.com/thetutlage/meta/discussions/8) done by a 3rd party, "Drizzle gives the impression of type-safety. However, only the query results have type information. You can write invalid queries with Drizzle."

With Prisma, you get end-to-end typesafety. This means, less potential for errors when writing code and collaborating with team members.
