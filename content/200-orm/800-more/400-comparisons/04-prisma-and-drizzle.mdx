...
- [Prisma Pulse](https://www.prisma.io/pulse?utm_source=docs&utm_medium=orm-docs): A change data capture (CDC) service where Prisma Client can subscribe to database changes and receive them in real-time with little to no setup.
