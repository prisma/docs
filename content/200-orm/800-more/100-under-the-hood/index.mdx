...
If you're new to using Prisma ORM, be sure to check out the [Quickstart](/getting-started/quickstart) and [Introduction](/orm/overview/introduction/what-is-prisma) pages first.
