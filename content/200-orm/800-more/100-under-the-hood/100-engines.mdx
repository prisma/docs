...
- <versioninfo>From versions <Link to="https://github.com/prisma/prisma/releases/2.20.0">2.20.0</Link> to 3.x the <inlinecode>library</inlinecode> engine type was available and used by default by <Link to="/orm/reference/preview-features/client-preview-features#enabling-a-prisma-client-preview-feature">activating the preview feature flag</Link> <inlinecode>"nApi"</inlinecode> or using the <inlinecode>PRISMA_FORCE_NAPI=true</inlinecode> environment variable.</versioninfo>
