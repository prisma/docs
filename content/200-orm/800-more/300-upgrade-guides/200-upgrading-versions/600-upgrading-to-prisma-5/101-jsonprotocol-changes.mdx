...
Operations on lists of [Composite types](/concepts/components/prisma-schema/data-model#defining-composite-types) (for [MongoDB](/orm/)) now only accept array values.
