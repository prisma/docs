...
[Scalar list](/orm/prisma-schema/data-model#scalar-fields) values must be arrays in all operations.
...
Operations on lists of [Composite types](/orm/prisma-schema/data-model#defining-composite-types) (for [MongoDB](/orm/)) now only accept array values.
