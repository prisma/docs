...
### [$queryRaw](/orm/prisma-client/raw-database-access/raw-queries)
...
You can learn more about the new `$queryRaw` and `$queryRawUnsafe` methods in the [Raw database access](/orm/prisma-client/raw-database-access/raw-queries) section of the docs.
