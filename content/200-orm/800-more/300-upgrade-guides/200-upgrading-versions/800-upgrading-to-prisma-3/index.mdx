...
### [$queryRaw](/orm/prisma-client/writing-custom-sql/raw-queries)
...
You can learn more about the new `$queryRaw` and `$queryRawUnsafe` methods in the [Raw database access](/orm/prisma-client/writing-custom-sql/raw-queries) section of the docs.
