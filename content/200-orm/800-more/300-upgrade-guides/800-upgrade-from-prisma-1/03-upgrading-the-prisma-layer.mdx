...
<TabbedContent languages={["Prisma 1 datamodel", "SQL"]}>

<TabItem value="Prisma 1 datamodel">
...
![Introspect your database with Prisma ORM](/img/orm/prisma-db-pull-generate-schema.png)
