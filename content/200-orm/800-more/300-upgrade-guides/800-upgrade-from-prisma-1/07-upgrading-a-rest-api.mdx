---
title: 'REST API'
metaTitle: 'Upgrading a REST API from Prisma ORM 1 to Prisma ORM 2'
metaDescription: 'Learn how to upgrade a REST API from Prisma ORM 1 to Prisma ORM 2.'
---

## Overview

This upgrade guide describes how to migrate a Node.js project that's based on [Prisma ORM 1](https://github.com/prisma/prisma1) and uses the [Prisma ORM 1 client](https://v1.prisma.io/docs/1.34/prisma-client/) to implement a REST API.
