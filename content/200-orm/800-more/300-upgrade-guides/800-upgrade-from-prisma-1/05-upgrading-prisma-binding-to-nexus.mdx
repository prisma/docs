...
metaTitle: 'Upgrading from Prisma ORM 1 with prisma-binding to Nexus'
metaDescription: 'Learn how to upgrade existing Prisma ORM 1 projects with prisma-binding to Prisma ORM 2.0 and Nexus.'
---
