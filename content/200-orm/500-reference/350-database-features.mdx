...
| ------------- | :--------: | :------------------: | :---: | :----: | :---------: | :-------------------------------------------------------------------------------: | :-----------: | :------------: |
| `PRIMARY KEY` |     ✔️     |          ✔️          |  ✔️   |   ✔️   |     ✔️      |      [`@id` and `@@id`](/orm/prisma-schema/data-model#defining-an-id-field)       |      ✔️       |       ✔️       |
| `FOREIGN KEY` |     ✔️     |          ✔️          |  ✔️   |   ✔️   |     ✔️      |          [Relation fields](/orm/prisma-schema/relations#relation-fields)          |      ✔️       |       ✔️       |
| `UNIQUE`      |     ✔️     |         ✔️†          |  ✔️   |   ✔️   |     ✔️      | [`@unique` and `@@unique`](/orm/prisma-schema/data-model#defining-a-unique-field) |      ✔️       |       ✔️       |
| `CHECK`       |     ✔️     |          ✔️          | ✔️\*  |   ✔️   |     ✔️      |                                      Not yet                                      |      ✔️       |    Not yet     |
| `NOT NULL`    |     ✔️     |          ✔️          |  ✔️   |   ✔️   |     ✔️      |                [`?`](/orm/prisma-schema/data-model#type-modifiers)                |      ✔️       |       ✔️       |
| `DEFAULT`     |     ✔️     |          ✔️          |  ✔️   |   ✔️   |     ✔️      |       [`@default`](/orm/prisma-schema/data-model#defining-a-default-value)        |      ✔️       |       ✔️       |
...
| -------------- | :--------: | :------------------: | :---: | :----: | :---------: | :----------------------------------------------------------------------------------------------------------: | :-----------: | :------------: |
| `UNIQUE`       |     ✔️     |          ✔️          |  ✔️   |   ✔️   |     ✔️      |              [`@unique` and `@@unique`](/orm/prisma-schema/data-model#defining-a-unique-field)               |      ✔️       |       ✔️       |
| `USING`        |     ✔️     |          No          |  No   |   No   |     ✔️      | [`type`](/orm/prisma-schema/indexes#configuring-the-access-type-of-indexes-with-type-postgresql)<sup>†</sup> |      ✔️       | ✔️<sup>†</sup> |
...
| --------------------------------- | :--------: | :------------------: | :---: | :----: | :---------: | :-------------------------------------------------------------------------: | :-----------: | :------------: |
| Autoincrementing IDs              |     ✔️     |          ✔️          |  ✔️   |   ✔️   |     ✔️      | [`autoincrement()`](/orm/prisma-schema/data-model#defining-a-default-value) |      ✔️       |       ✔️       |
| Arrays                            |     ✔️     |          No          |  No   |   No   |     ✔️      |            [`[]`](/orm/prisma-schema/data-model#type-modifiers)             |     ✔️\*      |      ✔️\*      |
| Enums                             |     ✔️     |          No          |  ✔️   |   No   |     ✔️      |           [`enum`](/orm/prisma-schema/data-model#defining-enums)            |     ✔️\*      |      ✔️\*      |
...
- ‡ JSON arrays are not yet supported: see the [CockroachDB connector page](/orm/overview/introduction/databases/cockroachdb) for details
...
| Generated `ObjectId`                      |         ✔️          |     See: [Defining IDs for MongoDB](/orm/prisma-schema/data-model#defining-ids-in-mongodb)      |
| Arrays                                    |         ✔️          |                                                                                                 |
