...
Defines an instance of a [driver adapter](/orm/overview/databases/database-drivers#driver-adapters). See also [Database drivers](/orm/overview/introduction/databases/database-drivers) .
...
The example below uses the [Neon driver adapter](/orm/overview/databases/neon#how-to-use-the-neon-serverless-driver-with-prisma-preview)
