...
After adding this flag, you need to run `prisma generate` again to re-generate Prisma Client. Also note that this feature is currently only available on MySQL and PostgreSQL.
