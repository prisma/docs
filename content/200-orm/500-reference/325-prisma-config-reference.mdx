...
If you want to split your Prisma schema into multiple files, you need to use the `prismaSchemaFolder` [Preview feature](/orm/reference/preview-features/client-preview-features) and specify the path to your Prisma schema folder via the `schema` property:
