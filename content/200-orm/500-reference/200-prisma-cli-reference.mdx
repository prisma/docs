...
| `--no-hints`        | No       | The `generate` command will generate Prisma Client without usage hints, surveys or ads being printed to the terminal. Available in Prisma ORM 5.16.0 and later.                                                                                     |
