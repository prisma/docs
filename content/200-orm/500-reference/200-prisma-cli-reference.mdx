...
| Argument              | Required | Description                                                                                                         | Default |
| --------------------- | -------- | ------------------------------------------------------------------------------------------------------------------- | ------- |
| `--port` (or `-p`)    | No       | Specifies the port on HTTP server starts.                                             | `51213`  |
| `--db-port` (or `-P`) | No       | Specifies the port on which the local Prisma Postgres TCP server listens, allowing TCP and HTTP ports to be configured separately. | `51215`  |
