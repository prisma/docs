...
You can access the Prisma Data Platform through the Prisma CLI. To get started, ensure you have the [Prisma Client](/concepts/components/prisma-client) updated to version `5.7.0` or later. This is necessary to access the Platform through the Prisma CLI.
