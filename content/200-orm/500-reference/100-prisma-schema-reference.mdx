...
- [`sqlite`](/orm/overview/introduction/databases/sqlite)
- [`postgresql`](/orm/overview/introduction/databases/postgresql)
- [`mysql`](/orm/overview/introduction/databases/mysql)
- [`sqlserver`](/orm/overview/introduction/databases/sql-server)
- [`mongodb`](/orm/)
- [`cockroachdb`](/orm/overview/introduction/databases/cockroachdb)
...
Learn more about PostgreSQL connection strings [here](/orm/overview/introduction/databases/postgresql).
...
Learn more about MySQL connection strings [here](/orm/overview/introduction/databases/mysql).
...
Learn more about MongoDB connection strings [here](/orm/).
...
Learn more about SQLite connection strings [here](/orm/overview/introduction/databases/sqlite).
...
The format for connection strings is the same as for PostgreSQL. Learn more about PostgreSQL connection strings [here](/orm/overview/introduction/databases/postgresql).
...
The following tables list all supported operating systems with the name of platform to specify in [`binaryTargets`](/orm/prisma-schema/generators#binary-targets).
...
Defines a Prisma [model](/orm/prisma-schema/data-model#defining-models) .
...
[Fields](/orm/prisma-schema/data-model#defining-fields) are properties of models.
...
| `xml`                | `@db.Xml`                      |
| `inet`               | `@db.Inet`                     |
| `citext`             | `@db.Citext`                   | Only available if [Citext extension is enabled](/orm/prisma-schema/features-without-psl-equivalent#enable-postgresql-extensions-for-native-database-functions). |
...
The [MongoDB connector](/orm/) does not support the `Unsupported` type.
...
**Not supported by MongoDB** <br />
The [MongoDB connector](/orm/) does not support composite IDs.
...
Defines a [default value for a field](/orm/prisma-schema/data-model#defining-a-default-value) .
...
Defines a compound [unique constraint](/orm/prisma-schema/data-model#defining-a-unique-field) for the specified fields.
...
- In version `3.12.0` and later, you can define an index on a field of a [composite type](/orm/prisma-schema/data-model#defining-composite-types) using the syntax `@@index([compositeType.field])`. See [Defining composite type indexes](/orm/prisma-schema/data-model#defining-composite-type-indexes) for more details.
...
Defines meta information about the relation. [Learn more](/orm/prisma-schema/relations#the-relation-attribute).
...
| `fields`     | `FieldReference[]`                                                                                                                  | On [annotated](/orm/prisma-schema/relations#relation-fields) relation fields | A list of [fields](/orm/prisma-schema/data-model#defining-fields) of the _current_ model                                                                                   | `["authorId"]`, `["authorFirstName, authorLastName"]` |
| `references` | `FieldReference[]`                                                                                                                  | On [annotated](/orm/prisma-schema/relations#relation-fields) relation fields | A list of [fields](/orm/prisma-schema/data-model#defining-fields) of the model on _the other side of the relation_                                                         | `["id"]`, `["firstName, lastName"]`                   |
| `map`        | `String`                                                                                                                            | No                                                                           | Defines a [custom name](/orm/prisma-schema/names-in-underlying-database#constraint-and-index-names) for the foreign key in the database.                                   | `["id"]`, `["firstName, lastName"]`                   |
| `onUpdate`   | Enum. See [Types of referential actions](/orm/prisma-schema/relations/referential-actions#types-of-referential-actions) for values. | No                                                                           | Defines the [referential action](/orm/prisma-schema/data-model/relations/referential-actions) to perform when a referenced entry in the referenced model is being updated. | `Cascade`, `NoAction`                                 |
...
See: [The `@relation` attribute](/orm/prisma-schema/relations#the-relation-attribute).
...
**Not supported by MongoDB** <br />
The [MongoDB connector](/orm/) does not support the `autoincrement()` function.
...
The sequence function is only supported by [CockroachDB connector](/orm/overview/introduction/databases/cockroachdb).
...
The [SQLite connector](/orm/overview/introduction/databases/sqlite) and the The [Microsoft SQL Server connector](/orm/overview/introduction/databases/sql-server) do not support the `enum` type.

</Admonition>

Defines an [enum](/orm/prisma-schema/data-model#defining-enums) .
...
Defines a [composite type](/orm/prisma-schema/data-model#defining-composite-types) .
