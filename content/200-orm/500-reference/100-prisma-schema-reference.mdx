...
Defines a [data source](/concepts/components/prisma-schema/data-sources)  in the Prisma schema.
...
Defines a [generator](/concepts/components/prisma-schema/generators)  in the Prisma schema.
...
| Name              | Required | Type                                            | Description                                                                                                                                                                                                                  |
| ----------------- | -------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| `provider`        | **Yes**  | String (file path) or Enum (`prisma-client-js`) | Describes which [generator](/concepts/components/prisma-schema/generators)  to use. This can point to a file that implements a generator or specify a built-in generator directly.              |
...
Defines a Prisma [model](/concepts/components/prisma-schema/data-model#defining-models) .
...
[Fields](/concepts/components/prisma-schema/data-model#defining-fields)  are properties of models.
...
Prisma models also have [model field types](/concepts/components/prisma-schema/relations)  that define relations between models.
...
Defines a [default value for a field](/concepts/components/prisma-schema/data-model#defining-a-default-value) .
...
Defines a compound [unique constraint](/concepts/components/prisma-schema/data-model#defining-a-unique-field)  for the specified fields.
...
Defines an [enum](/concepts/components/prisma-schema/data-model#defining-enums) .
...
Defines a [composite type](/concepts/components/prisma-schema/data-model#defining-composite-types) .
