...
The Schema Engine was previously called Migration Engine. <versioninfo>This change was introduced in version [5.0.0](https://github.com/prisma/prisma/releases/tag/5.0.0).</versioninfo>
