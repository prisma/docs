...
- A unique constraint denoted with [`@unique`](/orm/prisma-schema/data-model#defining-a-unique-field)
- A composite unique constraint denoted with [`@@unique`](/orm/prisma-schema/data-model#defining-a-unique-field)
- An [`@id`](/orm/prisma-schema/data-model#defining-an-id-field) field
- A composite identifier denoted with [`@@id`](/orm/prisma-schema/data-model#composite-ids)
