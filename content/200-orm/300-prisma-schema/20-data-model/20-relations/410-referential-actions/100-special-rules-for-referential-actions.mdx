...
By not defining any actions, Prisma will use the following default values depending if the underlying [scalar fields](/orm/prisma-schema/data-model#scalar-fields) are set to be optional or required.
