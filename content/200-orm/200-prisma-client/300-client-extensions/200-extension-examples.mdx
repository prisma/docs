...
| [`@prisma/extension-pulse`](https://www.npmjs.com/package/@prisma/extension-pulse)               | Enables [Pulse](https://www.prisma.io/pulse), a service that captures change events from your database and delivers them instantly to your applications. |
