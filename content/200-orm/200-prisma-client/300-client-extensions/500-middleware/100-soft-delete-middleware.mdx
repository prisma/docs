...
- Prisma ORM middleware is responsible for preventing records from being deleted
...
Option two uses Prisma ORM middleware to prevent soft deleted records from being returned. The following table describes how the middleware affects each query:
