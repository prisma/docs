...
When using a [driver adapter](/orm/overview/databases/database-drivers#driver-adapters), the trace contains less spans as the database driver it out of the control of Prisma. Its structure usually looks lik this:
