...
Not defining an output path was the default behavior of Prisma ORM prior to version 6.6. We strongly recommend you define an output path. 

In Prisma ORM 6.6, not defining an output path will result in a warning. In Prisma ORM 7, the field will be required.
