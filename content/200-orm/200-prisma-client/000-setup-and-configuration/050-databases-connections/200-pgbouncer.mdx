...
> Note: Previous versions of the docs suggested setting `pgbouncer=true` in the connection URL. This is [no longer the case with PgBouncer `1.21.0`](https://github.com/prisma/prisma/issues/21531#issuecomment-1919059472)

### Set PgBouncer `max_prepared_statements` > 0 

Prisma uses prepared statements, and setting this allows PgBouncer to use those prepared statements. 
