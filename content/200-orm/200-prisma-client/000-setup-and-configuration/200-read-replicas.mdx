...
<versioninfo>
  The read replicas extension supports Prisma versions
  [5.2.0](https://github.com/prisma/prisma/releases/tag/5.2.0) and higher. If
  you run into a bug or have feedback, create a GitHub issue
  [here](https://github.com/prisma/extension-read-replicas/issues/new).
</versioninfo>
