...
- You must set `array_contains` to a JSON object, not a string. If you use a string, Prisma ORM escapes the quotation marks and the query will not return results. For example:
...
## Typed <inlinecode>Json</inlinecode>
...
### Using <inlinecode>prisma-json-types-generator</inlinecode>
