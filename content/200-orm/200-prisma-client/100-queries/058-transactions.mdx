...
- For information about transactions in general and the reasoning behind Prisma ORM's current solutions, see [Blog: How Prisma ORM supports transactions](https://www.prisma.io/blog/how-prisma-supports-transactions-x45s1d5l0ww1).
