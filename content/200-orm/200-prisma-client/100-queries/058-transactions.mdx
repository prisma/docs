...
<versioninfo>
  {' '}
  From version 4.4.0, the sequential operations transaction API has a second parameter.
...
- <versioninfo>
    In version 4.6, Data Proxy support for interactive transactions was
    available in preview.
  </versioninfo>
- <versioninfo>
    {' '}
    From version 2.29.0 to version 4.5, interactive transactions were available in
    preview, but did not support the [Data Proxy](/platform/classic-projects/data-proxy).{' '}
  </versioninfo>

<versioninfo>
  If you use interactive transactions in preview from version 2.29.0 to 4.6.1
  (included), you need to add the `interactiveTransactions` preview feature to
