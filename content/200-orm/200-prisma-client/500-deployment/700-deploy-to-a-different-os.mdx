...
The query engine is implemented in Rust and is used by Prisma ORM in the form of executable binary files. The binary is downloaded when `prisma generate` is called.
