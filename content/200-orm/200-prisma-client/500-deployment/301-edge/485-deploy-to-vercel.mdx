...
This page covers everything you need to know in order to deploy [Vercel Edge Middleware](https://vercel.com/docs/functions/edge-middleware) or a [Vercel Function](https://vercel.com/docs/functions) that use Prisma Client for talking to a database to the [Vercel Edge Runtime](https://vercel.com/docs/functions/runtimes/edge-runtime).
