...
This page covers everything you need to know in order to deploy an rdge function to Cloudflare Workers that uses Prisma Client for talking to a database.
