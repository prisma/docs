...
| Netlify Edge Functions  | Not yet                                                 | ✅                               |
| Supabase Edge Functions | Not yet                                                 | ✅                               |
...
- [`@libsql/client`](https://github.com/tursodatabase/libsql-client-ts) is used to accessed Turso databases. It works with Cloudflare Workers and Vercel Edge Functions.

> **Note**: There's [also work being done](https://github.com/sidorares/node-mysql2/pull/2289) on the `node-mysql2` driver which will enable to access traditional MySQL databases from Cloudflare Workers as well.
