...
metaDescription: 'This page documents various scenarios for using the generated types from the Prisma ORM namespace'
---
...
With the `PromiseReturnType` that is exposed by the Prisma ORM namespace, you can solve this more elegantly:
