...
- exit code 130 when the CLI receives a signal interrupt (SIGINT) message or if the user cancels a prompt. <versioninfo>This exit code is available in Prisma versions 4.3.0 and later.</versioninfo>
