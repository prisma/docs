...
Here's an overview of the different scenarios where Prisma ORM might or might not be a good fit for your project. To learn about each scenario in more detail, find the respective section further down on this page.
...
**Prisma ORM likely _is not_ a good fit for you if ...**
