...
// View the event object and Pulse API: https://www.prisma.io/docs/pulse/api-reference
```
...
Both Accelerate and Pulse take features built into Prisma ORM and build upon them by adding additional capabilities like globally-optimized caching and real-time data synchronization. Get started for free the [Prisma Data Platform](https://console.prisma.io) and explore how Accelerate and Pulse can help you build scalable, high-performance applications!
...
Both Accelerate and Pulse build on Prisma ORM through [Prisma Client Extensions](https://www.prisma.io/docs/orm/prisma-client/client-extensions). This opens up features that we couldn’t include in the ORM like globally-optimized caching and real-time data synchronization. Create a free [Prisma Data Platform](https://console.prisma.io) account and explore how Accelerate and Pulse can help you build scalable, high-performance applications!
