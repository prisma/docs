...
The SQLite connector maps the [scalar types](/orm/prisma-schema/data-model#scalar-fields) from the [data model](/orm/prisma-schema/data-model/models) to native column types as follows:
