...
Notice that this code requires the `DATABASE_URL` environment variable to be set to your your PostgreSQL connection string. You can learn more about the connection string below.
