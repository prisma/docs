...
Need a Postgres database yesterday? Try [Prisma Postgres](https://www.prisma.io/postgres?utm_source=docs&utm_campaign=postgresql)! It's a lightning fast database with a generous free tier and pay-as-you-go pricing. [Visit the Console](https://console.prisma.io?utm_source=docs&utm_campaign=postgresql) to get started today.
