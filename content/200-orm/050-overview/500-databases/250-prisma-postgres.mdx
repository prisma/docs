...
Unlike traditional datase providers, Prisma Postgres charges for _query volume_, not compute. This is a mental shift compared to other products, but we believe that this ultimately presents a more intuitive model for developers to think about database cost. 
...
During the [Early Access](/platform/maturity-levels#early-access) phase, we will continue to refine the pricing structure to make it as straightforward and cost-effective as possible. If you have feedback or questions about pricing, you can raise them on our [Discord](https://pris.ly/discord).

You can find all details on our [pricing page](https://www.prisma.io/pricing).
