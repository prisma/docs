...
#### 2. Update your Prisma data model
...
#### 3. Create migration file using `wrangler` CLI
...
#### 4. Generate SQL statements using `prisma migrate diff`
...
#### 5. Execute the migration using `wrangler d1 migrations apply`
