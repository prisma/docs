...
| <ul><li>`ApplicationName`</li><li>`Application Name`</li></ul>(case insensitive)      | No                |                    | Sets the application name for the connection. <versioninfo>Since version 2.28.0.</versioninfo>                                                                                                                                                                                                                                                                                                                                                             |
