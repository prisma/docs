...
As of [v6.6.0](https://pris.ly/release/6.6.0) and with a `prisma.config.ts` file, you can use `prisma db push` to make changes to your database schema.  This is currently in [Early Access](/orm/more/releases#early-access).
