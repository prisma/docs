...
- connect to your database, using Prisma's [`cockroachdb` database connector](/orm/overview/introduction/databases/cockroachdb)
...
Further reference information is available in the [CockroachDB connector documentation](/orm/overview/introduction/databases/cockroachdb).
