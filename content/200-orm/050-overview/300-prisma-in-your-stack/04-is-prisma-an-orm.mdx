...
3. (Optional) Customize [field and model mappings](/orm/prisma-schema/data-model#mapping-model-names-to-tables-or-collections) between Prisma Client and the database.
