...
<div className="container">
  <div className="row"> 
    <div className="col col--4">
      [Accelerate](https://www.prisma.io/data-platform/accelerate?utm_source=docs&utm_medium=orm-docs)
    </div>
    <div className="col col--4">
      [Pulse](https://www.prisma.io/data-platform/pulse?utm_source=docs&utm_medium=orm-docs)
    </div>
    <div className="col col--4">
      [Optimize](https://www.prisma.io/data-platform/optimize?utm_source=docs&utm_medium=orm-docs)
    </div>
  </div>
</div>
