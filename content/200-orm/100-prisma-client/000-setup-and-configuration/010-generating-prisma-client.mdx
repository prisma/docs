...
metaTitle: 'Generating Prisma Client (Concepts)'
...
1. Ensure that you have [Prisma CLI installed on your machine](/orm/reference/prisma-cli-reference#installation).
...
Prisma Client is generated from your Prisma schema and is unique to your project. Each time you change the schema (for example, by performing a [schema migration](/concepts/components/prisma-migrate)) and run `prisma generate`, Prisma Client's code changes:
