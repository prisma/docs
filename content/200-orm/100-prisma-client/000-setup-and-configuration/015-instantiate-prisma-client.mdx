...
You can further customize `PrismaClient` with [constructor parameters](/orm/reference/prisma-client-reference#prismaclient)  - for example, set [logging levels](logging) or customize [error formatting](error-formatting).
