...
Alternatively, use the `PrismaClient` [`errorFormat`](/reference/api-reference/prisma-client-reference#errorformat) <span class="api"></span> parameter to set the error format:
