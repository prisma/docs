...
See Prisma's [database connector pages](/orm/overview) for the default type mappings for a given database. For example, [this table](/concepts/database-connectors/postgresql#native-type-mapping-from-prisma-to-postgresql) gives the default type mappings for PostgreSQL.  
