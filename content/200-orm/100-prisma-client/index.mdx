...
The import path will depend on the custom `output` specified in Prisma Client's [`generator`](/reference/api-reference/prisma-schema-reference#fields-1) block in your Prisma schema.
