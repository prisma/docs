...
You can [share your Prisma Client extensions](/orm/prisma-client/client-extensions/shared-extensions) with other Prisma users, and [import Prisma Client extensions developed by other users](/concepts/components/prisma-client/client-extensions/shared-extensions#install-a-packaged-extension) into your Prisma project.
