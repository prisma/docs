...
- Use nested reads ([`include`](/reference/api-reference/prisma-client-reference#include) ) to return users and related posts
- Use the [`in`](/reference/api-reference/prisma-client-reference#in)  filter
