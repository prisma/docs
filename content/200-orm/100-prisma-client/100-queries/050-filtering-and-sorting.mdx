...
**Note:** You can only sort by nulls on optional [scalar](/orm/prisma-schema/data-model#scalar-fields) fields. If you try to sort by nulls on a required or [relation](/orm/prisma-schema/data-model#relation-fields) field, Prisma Client throws a [P2009 error](/orm/reference/error-reference#p2009).
