...
This is in contrast to the [`AND`](/reference/api-reference/prisma-client-reference#and)  and [`NOT`](/reference/api-reference/prisma-client-reference#not-1)  operators, which will both return all the users
