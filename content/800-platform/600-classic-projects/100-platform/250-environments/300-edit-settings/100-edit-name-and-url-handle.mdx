...
You must have the [Project owner](../../members/roles-permissions) or [Admin](../../members/roles-permissions) role for the project to change the environment name and URL handle.
