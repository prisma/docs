...
To connect to a MySQL database server, you need to configure a [`datasource`](../tools-and-interfaces/prisma-schema/data-sources) block in your [Prisma schema file](../tools-and-interfaces/prisma-schema/):
...
- `url`: Specifies the [connection URL](#connection-url) for the MySQL database server. In this case, an [environment variable is used](../tools-and-interfaces/prisma-schema/#using-environment-variables) to provide the connection URL.
