...
Prisma needs a connection URL to be able to connect to your database, e.g. when sending queries with [Prisma Client](../tools-and-interfaces/prisma-client/) or when changing the database schema with [Prisma Migrate](../tools-and-interfaces/prisma-migrate).
