...
With this model definition, Prisma automatically maps the `User` model to the `users` table in the underlying database. 

> **Note**: You can also [`@map`](../../../api-reference/prisma-schema#map) a column name.
