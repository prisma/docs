...
The data model definition part of the Prisma schema defines your _application models_ (also called (**Prisma models**). These models represent the _entities of your application domain_ and map to the _tables_ in your database.

The following schema represents a blogging platform, and includes four `model` blocks and an `enum` block:
