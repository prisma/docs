...
The data model definition part of the [Prisma schema](index) defines your application models (also called **Prisma models**). These models represent the entities of your _application domain_, map to the _tables_ in your database, and determine the shape of your generated [Prisma Client API](../prisma-client/). 
