...
Add two models with [relation fields](https://www.prisma.io/docs/cconcepts/tools-and-interfaces/prisma-schema/relations#relation-fields) to your Prisma schema:
