...
<HomepageCard
  light
  heading={
    <CardHeading title="Vibe Coding an E-commerce App with Prisma MCP and Next.js" icon="fa-regular fa-message-dots" light />
  }
  href={{
    text: "Read now",
...
<HomepageCard
  light
  heading={
    <CardHeading title="Automate your workflows with Prisma Postgres and +2800 apps" icon="fa-regular fa-wand-magic-sparkles" light />
  }
  href={{
    text: "Get started",
    url: "https://pipedream.com/apps/prisma-management-api"
  }}
  body={`Connect Prisma Postgres to others apps to create powerful automations and data workflows, such as automatically spinning up a new database when a customer signs up in Stripe or connecting your databvase with Slack, Notion, Airtable, or any other app in the Pipedream ecosystem.`}
/>
<HomepageCard
  light
  heading={
  ...
  body={`Google's <a target="_blank" rel="openeer noreferrer" href="https://studio.firebase.google.com/">Firebase Studio</a> is a fully-fledged online IDE with a native AI integration. Prompt and build apps directly in your browser and deploy them by connecting witrh a powerful Prisma Postgres database in just a few clicks.`}
/>
</Grid>
