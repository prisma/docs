...
![Unwanted autocomplete values by VSCode](https://res.cloudinary.com/prismaio/image/upload/v1628765455/docs/pqTTXdi_xzwkse.png)
...
![The correct parameters for context are obtained](https://res.cloudinary.com/prismaio/image/upload/v1628765514/docs/Mp9AMvf_yrairm.png)
...
So here's a simple method to get autocompletion for your all Prisma's methods in JavaScript. You can find a practical example of this approach in the [`prisma-examples`](https://github.com/prisma/prisma-examples/) repo [here](https://github.com/prisma/prisma-examples/tree/latest/javascript/graphql-sdl-first).
