...
For the purpose of this guide, we're using the same setup instructions you can find in the [TanStart Start docs](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch).
...
- Defines the `output` directory for the generated Prisma Client as `app/generated/prisma`.
...
Next, create an instance of Prisma Client:
...
Finally, map over the posts and display them in a list:
