...
The Prisma CLI is now installed. Generate the Prisma Schema file by running:

```terminal
npx prisma init --datasource-provider postgresql
```

This will create a `schema.prisma` file in a newly created `~/prisma` directory.

Create a `.env` file in the root of your project and copy over your `DATABASE_URL`:
