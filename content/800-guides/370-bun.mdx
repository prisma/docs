...
sidebar_label: 'Bun'
image: '/img/guides/prisma-bun-cover.png'
...
Create a [`prisma.config.ts` file](/docs/orm/reference/prisma-config-reference#migrationsseed) to configure Prisma's seed command:
