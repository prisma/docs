---
title: 'Use Prisma ORM with pnpm Workspaces'
metaTitle: 'How to use Prisma ORM with pnpm Workspaces'
...
image: '/img/guides/prisma-pnpm-setup.png'
tags:
  - pnpm
  - Monorepo
  - Prisma
...
Then add `prisma` to your package.json as a dev dependecy:
...
## 3. Initialize Prisma in the database package
