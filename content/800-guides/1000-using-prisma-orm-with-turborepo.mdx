...
Navigate to the `https://localhost:3000` and you should see the message:
...
This command starts a server with a GUI at https://localhost:5555, allowing you to view and modify your data.
