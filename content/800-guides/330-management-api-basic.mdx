...
This guide walks you through setting up a basic TypeScript project that uses the [Prisma Management API](/postgres/database/api-reference/management-api) to create a new project and database, and print out all connection details. You'll authenticate via a [service token](/postgres/database/api-reference/management-api#bearer-tokens), set up your environment, and run a script to interact with the API.
...
First, you need to create a service token to be able to access your workspace in Prisma Console:
