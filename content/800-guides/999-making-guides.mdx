...
- [ ] **Remove Deployment section if not applicable**
...
- Prisma CLI 6.6.0 or higher (We'll be installing the latest version in this guide)
...
For the latest Prisma 6.6.0 features, update your `schema.prisma` file to use the new `prisma-client` generator:
...
:::tip
The new `prisma-client` generator is more flexible and supports ESM. It will be the default generator in Prisma 7.0. For more information, see the [Prisma Client Generator](/orm/prisma-client/generator) guide.
:::
