...
Inside your `/lib` directory, rename index.ts to prisma.ts. This file will be used to create and export your Prisma Client instance.

Set up the Prisma client like this:

```typescript file=generated/prisma showLineNumbers
