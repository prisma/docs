...
This guide was tested using Turborepo version `2.5.0` and Prisma ORM version `6.6.0`.
...
In the `apps/web` directory, open the `page.tsx` file and add the following code:
