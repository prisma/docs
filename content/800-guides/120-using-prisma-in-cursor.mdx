---
title: "Using Prisma ORM in Cursor"
metaTitle: "Using Prisma ORM in Cursor"
description: "Get the most out of Prisma ORM when using Cursor AI editor"
sidebar_label: "Using Prisma ORM in Cursor"
...
[Cursor](https://www.cursor.com/) is an AI-powered code editor designed to boost productivity by automating repetitive coding tasks. When paired with Prisma ORM, a robust and type-safe toolkit for database workflows, it becomes a powerful solution for managing and optimizing database schemas, queries, and data seeding.
...
<CodeWithResult outputResultText="generated schema">
<cmd>
...
<CodeWithResult outputResultText="generated query">
<cmd>
...
<CodeWithResult outputResultText="generated seed code">
<cmd>
...
In summary, using Cursor with Prisma ORM simplifies your workflow, from generating schemas and queries to writing seed scripts. By following this guide, you can save time, reduce errors, and focus on building your application.
