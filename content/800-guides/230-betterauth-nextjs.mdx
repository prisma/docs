...
image: '/img/guides/prisma-better-auth-nextjs-cover.png'
...
## 6. Redirect after sign in/up

1. Automatically redirect users to the dashboard after they sign in or sign up. Configure this in your `auth.ts` file using the `onSuccess` callbacks.
