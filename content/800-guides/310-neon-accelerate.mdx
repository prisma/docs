...
Prisma Accelerate is a robust and mature connection pooler enabling your database to function properly during traffic spikes and high load scenarios. Check out this [video](https://www.youtube.com/watch?v=cnL75if6Aq0) demonstrating how it performs in a load test.
...
If you already have a project using Prisma ORM, you can skip the first two steps and jump ahead to [Step 3. Install the Accelerate extension](#step-3-install-the-accelerate-extension).

## Step 1. Set up Prisma ORM
...
## Step 3. Install the Accelerate extension
...
## Step 4. Set up Accelerate in the Prisma Console
...
## Step 6. Send queries through the connection pool
