...
```jsx file=app/models/QRCode.server.js showLineNumbers
//add-start
...
```jsx file=app/routes/app.qrcodes.$id.js showLineNumbers
//add-start
...
```jsx file=app/routes/app._index.js
//add-start
...
```jsx file=app/routes/app._index.js showLineNumbers
import { json } from "@remix-run/node";
import { useLoaderData, Link, useNavigate } from "@remix-run/react";
import { authenticate } from "../shopify.server";
import {
...
Add the dependencies:
```jsx file=app/routes/qrcodes.$id.js
//add-start
import { json } from "@remix-run/node";
import invariant from "tiny-invariant";
...
```jsx file=app/routes/qrcodes.$id.scan.js
//add-start
