...
- Explore [deployment workflows](/orm/prisma-migrate/workflows/deployment)
- Set up [continuous integration](/orm/prisma-migrate/workflows/team-development#continuous-integration)
