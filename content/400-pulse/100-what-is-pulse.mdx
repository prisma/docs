...
In this example, we stream _all_ changes that are happening on the `User` table from the database:
...
| Project                                                          | Description                                                                                        |
| :--------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [pulse-starter](https://github.com/prisma/tbd)         | General Pulse starter project.                                                                     |
| [pulse-resend-demo](https://github.com/prisma/tbd) | Optimize your onboarding with Pulse by triggering welcome emails via Resend for new user sign-ups. |
| [pulse-simple-chat](https://github.com/prisma/tbd) | TBD. |
| [pulse-simple-chat](https://github.com/prisma/tbd) | Optimize your onboarding with Pulse by triggering welcome emails via Resend for new user sign-ups. |
