...
| [cron-job-data-sync-with-typesense](https://github.com/prisma/prisma-examples/tree/latest/pulse/cron-job-data-sync-with-typesense) | A cron job that synd data into Typesense (built with Hono.js) |
