...
Manually deleting a Pulse-created publication disconnects Pulse, causing a backlog in the Write-Ahead Log (WAL). While Pulse may attempt to recreate the publication automatically, it's best to avoid manually deleting publications managed by Pulse.
