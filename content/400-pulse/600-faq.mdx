...
Pulse persists database events if you enable the **Event persistence** feature in your [project](/pulse/about#project) in the Console. This allows usage of the `stream()` API and take advantage of delivery guarantees.
