...
This section provides step-by-step instructions to make Neon compatible for Prisma Pulse.

## 1. Enable logical replication on Neon

To enable logical replication on Neon and ensure compatibility with Pulse, follow these steps:
