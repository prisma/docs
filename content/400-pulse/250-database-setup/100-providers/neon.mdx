...
2. Create publication for database events. Use the following SQL query to create a publication for all tables:
   ...
   Additionally, you can manage specific models for which you want to listen to database events in Neon. Refer to [this](/pulse/database-setup#manage-your-own-publication-slot) section for more details on managing Publications.
