...
2. View your logical replication slots:
   ...
   For more info on replication and replication slots, please refer to the [PostgreSQL Documentation](https://www.postgresql.org/docs/current/logicaldecoding-example.html#LOGICALDECODING-EXAMPLE)
