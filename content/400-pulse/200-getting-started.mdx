...
- enabled **Event persistence** to use delivery guarantees with `.stream()` (or disable it if you want to use `.subscribe()` for fully ephemeral events without delivery guarantees)
