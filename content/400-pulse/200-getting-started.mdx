...
- A publicly accessible PostgreSQL (version 12+) database with [logical replication](https://www.postgresql.org/docs/current/logical-replication-quick-setup.html) enabled.
  - Learn how to enable logical replication [here](/pulse/database-setup#enable-logical-replication)

## 1. Enable Prisma Pulse
...
## 2. Use Prisma Pulse in your application
...
### 2.2. Create a Prisma Pulse-enabled Prisma Client
...
To setup your database to work with Prisma Pulse, refer to the [database setup section](/pulse/database-setup) or the [provider-specific instructions](/pulse/database-setup/providers)
