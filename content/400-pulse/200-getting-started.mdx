...
If you want to enable replication for specific models or use a database provider that doesn’t allow super user access for Prisma Pulse. You must create and submit your replication slot before enabling Prisma Pulse.

Our **paid plan** users can provide a **replication slot name** and a **publication name**.
...
#### Removing replication and publication slots

If you are managing your replication and publication slots independently and opt to disable Prisma Pulse for a particular environment, you can refer to the following SQL queries.
