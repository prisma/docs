...
- A GitHub account.
- Pulse requires [Prisma Client](/orm/prisma-client) version `4.16.1` or higher and [@prisma/extension-pulse](https://www.npmjs.com/package/@prisma/extension-pulse) version `v0.2.0` or higher.
...
To learn about the database providers that support Pulse, visit [here](/pulse/faq#what-database-providers-are-supported-with-pulse).
