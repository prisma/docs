...
The connection URL is read from the env-file when updating the schema based on the actual DB as well as during run time to connect to the actual database.
