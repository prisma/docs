...
| Constraint    | PostgreSQL | Microsoft SQL Server | MySQL | SQLite |                                           Prisma schema                                           | Prisma Client | Prisma Migrate |
| ------------- | :--------: | :------------------- | :---: | :----: | :-----------------------------------------------------------------------------------------------: | :-----------: | :------------: |
...
| Deletion behavior | PostgreSQL | Microsoft SQL Server | MySQL | SQLite | Prisma schema | Prisma Client | Prisma Migrate |
| ----------------- | ---------- | -------------------- | ----- | ------ | ------------- | ------------- | -------------- |
| `CASCADE`         | ✔️         | ✔️                   | ✔️    | ✔️     | **✔️**†       | ✔️            | **✔️**†        |
| `RESTRICT`        | ✔️         | No                   | ✔️    | ✔️     | **✔️**†       | ✔️            | **✔️**†        |
...
| Update behavior | PostgreSQL | Microsoft SQL Server | MySQL | SQLite | Prisma schema | Prisma Client | Prisma Migrate |
| --------------- | ---------- | -------------------- | ----- | ------ | ------------- | ------------- | -------------- |
| `CASCADE`       | ✔️         | ✔️                   | ✔️    | ✔️     | **✔️**†       | ✔️            | **✔️**†        |
| `RESTRICT`      | ✔️         | No                   | ✔️    | ✔️     | **✔️**†       | ✔️            | **✔️**†        |
| `NO ACTION`     | ✔️         | ✔️                   | ✔️    | ✔️     | **✔️**†       | ✔️            | **✔️**†        |
...
| Index    | PostgreSQL | Microsoft SQL Server | MySQL | SQLite | Prisma schema                                                                                     | Prisma Client | Prisma Migrate |
| -------- | ---------- | -------------------- | ----- | ------ | ------------------------------------------------------------------------------------------------- | ------------- | -------------- |
| `UNIQUE` | ✔️         | ✔️                   | ✔️    | ✔️     | [`@unique` and `@@unique`](/concepts/components/prisma-schema/data-model#defining-a-unique-field) | ✔️            | ✔️             |
...
| Index type (Algorithm) | PostgreSQL | Microsoft SQL Server | MySQL | SQLite | Prisma schema | Prisma Client | Prisma Migrate |
| ---------------------- | ---------- | -------------------- | ----- | ------ | ------------- | ------------- | -------------- |
...
| Feature                           | PostgreSQL | Microsoft SQL Server | MySQL | SQLite | Prisma schema                                                          | Prisma Client                                                                               | Prisma Migrate |
| :-------------------------------- | :--------- | :------------------- | :---- | :----- | :--------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | -------------- | --- |
...
| :---------------------------------------- | :------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Embedded documents                        | Work in progress    | Embedded documents are not yet supported, but you can use the `Json` field while we work to provide support. See [GitHub issue #8272](https://github.com/prisma/prisma/issues/8272) to monitor progress. |
| Transactions                              | ✔️                  |                                                                                                                                                                                                               |
...
| JSON support                              | ✔️                  | Advanced `Json` field filtering is supported by [Postgres and MySQL since 2.26.0](https://www.prisma.io/docs/concepts/components/prisma-client/working-with-fields/working-with-json-fields#filtering-on-a-json-field)                                                                                                                                                                |
| DBrefs                                    | No                  |
| Change streams                            | No                  |
