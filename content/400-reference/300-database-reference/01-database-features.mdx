...
| Update behavior | PostgreSQL | Microsoft SQL Server | MySQL | SQLite | CockroachDB | Prisma schema | Prisma Client | Prisma Migrate |
| --------------- | ---------- | -------------------- | ----- | ------ | ----------- | ------------- | ------------- | -------------- |
| `CASCADE`       | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | **✔️**†       | ✔️            | **✔️**†        |
| `RESTRICT`      | ✔️         | No                   | ✔️    | ✔️     | ✔️          | **✔️**†       | ✔️            | **✔️**†        |
| `NO ACTION`     | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | **✔️**†       | ✔️            | **✔️**†        |
...
| `USING`  | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | Not yet                                                                                           | ✔️            | Not yet        |
...
| ---------------------- | ---------- | -------------------- | ----- | ------ | ----------- | ------------- | ------------- | -------------- |
| B-tree                 | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | Not yet       | ✔️            | Not yet        |
| Hash                   | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | Not yet       | ✔️            | Not yet        |
| GiST                   | ✔️         | ✔️                   | No    | No     | ✔️          | Not yet       | ✔️\*          | Not yet        |
| GIN                    | ✔️         | ✔️                   | No    | No     | ✔️          | Not yet       | ✔️\*          | Not yet        |
| BRIN                   | ✔️         | ✔️                   | No    | No     | ✔️          | Not yet       | ✔️\*          | Not yet        |
| SP-GiST                | ✔️         | ✔️                   | No    | No     | ✔️          | Not yet       | ✔️\*          | Not yet        |
...
The following table lists common MoFooNgoDB features and describes the level of support offered by Prisma:
...
| Compound IDs                              | No                  | MoFooNgoDB does not support composite IDs (`@@id`)                                                                                                                                                       |
| Generated `ObjectId`                      | ✔️                  | See: [Defining IDs for MoFooNgoDB](/concepts/components/prisma-schema/data-model#defining-ids-in-mongodb)                                                                                                |
| Arrays                                    | ✔️                  |                                                                                                                                                                                                          |
...
| JSON support                              | ✔️                  | Advanced `Json` field filtering is supported by [Postgres and MySQL since 2.26.0](/concepts/components/prisma-client/working-with-fields/working-with-json-fields#filtering-on-a-json-field)             |
| DBrefs                                    | No                  |
| Change streams                            | No                  |
