...
| :---------------------------------------- | :------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Embedded documents                        | Work in progress    | Embedded documents are not yet supported, but you can use the `Json` field while we work on proper support. See [GitHub issue #8272](https://github.com/prisma/prisma/issues/8272) to minitor progress. |
| Transactions                              | ✔️                  |                                                                                                                                                                                                               |
