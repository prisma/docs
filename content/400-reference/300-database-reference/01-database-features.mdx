...
| `USING`  | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | [`type`](/concepts/components/prisma-schema/indexes#configuring-the-access-type-of-indexes-with-type-postgresql)<sup>†</sup> | ✔️            | Not yet        |
...
| :-------------------------------- | :--------- | :------------------- | :---- | :----- | :---------- | :------------------------------------------------------------------------------------------ | ------------- | -------------- |
| Auto-incrementing IDs              | ✔️         | ✔️                   | ✔️    | ✔️     | ✔️          | [`autoincrement()`](/concepts/components/prisma-schema/data-model#defining-a-default-value) | ✔️            | ✔️             |
