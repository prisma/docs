...
- [Installing the Prisma CLI](/rreference/api-reference/prisma-cli/installation) <span class="api"></span> for a complete list of commands.
- [Prisma CLI command reference](/reference/api-reference/prisma-cli/command-reference) <span class="api"></span> for a complete list of commands.
