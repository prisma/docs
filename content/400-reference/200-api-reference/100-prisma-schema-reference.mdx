...
The following tables list all supported operating systems with the name of platform to specify in [`binaryTargets`](TODO link to generator docs where this is kinda explained).
