...
- If a model contains a **mandatory** `Unsupported` type, `prisma.model.create(..)` and `prisma.model.update(...)` are not available in Prisma Client.
