...
<TabbedContent tabs={[<FileWithIcon text="Relational databases" icon="display"/>, <FileWithIcon text="MongoDB" icon="display"/>]}>
<tab>
...
<TabbedContent tabs={[<FileWithIcon text="Relational databases" icon="display"/>]}>
<tab>
