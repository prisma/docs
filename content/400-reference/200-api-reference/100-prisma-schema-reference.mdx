...
> **Note**: Prisma models also have [model field types](../../../concepts/components/prisma-schema/relations) <span class="concept"></span> that define relations between models.
...
| Native database type | Native database type attribute | Introspection | Migrate |
| :------------------------ | :--------------------------------- | :------------------| :-------------
| `text` (default type)     | Default mappings do not require an attribute.                                | ✔️                | ✔️*         |
| `char`                    | `@db.Char(x)`                         | ✔️ ||
...
_* Prisma Migrate only supports migrating to the default native database type in 2.11.0._
...
| **Native database type** | **Native database type attribute** | **Comments**                       | 
| ------------------------- | ---------------------------------- | ---------------------------------- |
| `VARCHAR` (default type)  | Default mappings do not require an attribute.                      | Maps to `VARCHAR(191)` by default. |
| `TEXT`                    | `@db.Text`                         |                                    |
| `CHAR`                    | `@db.Char`                         ||
...
| ------------------------- | ---------------------------------- |
| `boolean` (default)       | Default mappings do not require an attribute.                      |
...
| **Native database types** | **Native database type attribute (preview)** |
| ------------------------- | -------------------------------------------- |
| `integer` (default type)  |  Default mappings do not require an attribute.                                          |
| `smallint`                | `@db.SmallInt`                               |
| `bigint`                  | `@db.BigInt`                                 |
| `serial`                  | `@db.Serial`                                 |
| `smallserial`             | `@db.SmallSerial`                            |
| `bigserial`               | `@db.BigSerial`                              |
...
| **Native database types** | **Native database type attribute (Preview)** |
| ------------------------- | -------------------------------------------- |
| `INT` (default type)      | Default mappings do not require an attribute.                                          |
| `SMALLINT`                | `@db.SmallInt`                               |
...
| **Native database types** | **Native database type attribute** |
| ------------------------- | ---------------------------------- |
| `DECIMAL` (default type)  | `@db.Decimal`                      |
| `FLOAT` (default type)    | `@db.Float`                        |
| `DOUBLE`                  | `@db.Double`                       |
...
| **Native database types** | **Native database type attribute (Preview)** | **Comments**              |
| ------------------------- | -------------------------------------------- | ------------------------- |
| `timestamp(x)` (default)  | `@db.Timestamp(x)`                           | `timestamp(3)` by default |
| `date`                    | `@db.Date`                                   |                           |
| `time(x)`                 | `@db.Time(x)`                                |                           |
...
| **Native database types**    | **Native database type attribute (Preview)** | **Comments**  |
| ---------------------------- | -------------------------------------------- | ------------- |
| `DATETIME(x)` (default type) | N/A                                          | `DATETIME(3)` |
| `DATE`                       | `@db.Date`                                   |               |
| `TIME(x)`                    | `@db.Time(x)`                                |               |
...
|        | Prisma Client JS &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Input  | `string`<br />`number`<br />`BigInt`                                                                                                                               |
| Output | `number`                                                                                                                                                           |
