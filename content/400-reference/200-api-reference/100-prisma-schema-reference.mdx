...
The _data source connector_ determines what _native database type_ each of [Prisma scalar type](../../../concepts/components/prisma-schema/data-model#field-types) <span class="concept"></span> maps to. Similarly, the _generator_ determines what _type in the target programming language_ each of these types map to.
...
> **See also:** [`String` mappings](../../../concepts/components/preview-features/native-types/native-types-mappings#string) in the [`nativeTypes` Preview (2.11.0)](../../../concepts/components/preview-features/native-types)
...
> **See also:** [`Boolean` mappings](../../../concepts/components/preview-features/native-types/native-types-mappings#boolean) in the [`nativeTypes` Preview (2.11.0)](../../../concepts/components/preview-features/native-types)
...
> **See also:** [`Int` mappings](../../../concepts/components/preview-features/native-types/native-types-mappings#int) in the [`nativeTypes` Preview (2.11.0)](../../../concepts/components/preview-features/native-types)
...
> **See also:** [`Float` mappings](../../../concepts/components/preview-features/native-types/native-types-mappings#float) in the [`nativeTypes` Preview (2.11.0)](../../../concepts/components/preview-features/native-types)
...
> **See also:** [`DateTime` mappings](../../../concepts/components/preview-features/native-types/native-types-mappings#datetime) in the [`nativeTypes` Preview (2.11.0)](../../../concepts/components/preview-features/native-types)
...
> **See also:** [`Json` mappings](../../../concepts/components/preview-features/native-types/native-types-mappings#json) in the [`nativeTypes` Preview (2.11.0)](../../../concepts/components/preview-features/native-types)
...
<AlgoliaTerm name="apiReference" value="@default" />
...
> **See also**: [Custom `name` property on `@@unique` attributes in the Prisma Client](../../concepts/components/prisma-client/crud#retrieve-the-user-record-with-firstname-of-alice-and-lastname-of-smith-1)
...
- Implemented by Prisma and therefore not "visible" in the underlying database schema. You can still use `cuid()` when using [introspection](../../concepts/components/introspection) by [manually changing your Prisma schema](../../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/customizing-the-prisma-client-api) and [generating Prisma Client](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/generating-prisma-client), in that case the values will be generated by Prisma's [query engine](../../concepts/components/prisma-client/query-engine).
...
- Compatible with `String`
- Implemented by Prisma and therefore not "visible" in the underlying database schema. You can still use `uuid()` when using [introspection](../../concepts/components/introspection) by [manually changing your Prisma schema](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/customizing-the-prisma-client-api) and [generating Prisma Client](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/generating-prisma-client), in that case the values will be generated by Prisma's [query engine](../../concepts/components/prisma-client/query-engine).
...
Represents default values that can't be expressed in the Prisma schema (such as `random()`). Only available after [introspection](../../concepts/components/introspection).
