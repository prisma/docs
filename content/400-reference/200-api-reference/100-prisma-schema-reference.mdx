...
For more information about using the `multiSchema` feature, refer to [this guide](/guides/database/multi-schema#how-to-include-multiple-database-schemas-in-your-prisma-schema).
