...
- Since the length of `cuid()` output is [undefined per the cuid creator](https://github.com/ericelliott/cuid/issues/164), a safe minimum field size is 30 characters, otherwise you may see random Prisma errors like `Error: The provided value for the column is too long for the column's type.`
