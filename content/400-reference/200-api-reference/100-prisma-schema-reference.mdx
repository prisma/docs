...
> **Note**: In versions `4.0.0` and later, and in versions `3.5.0` and later with the `extendedIndexes` Preview feature enabled, the signature is:
>
> ```prisma no-lines
