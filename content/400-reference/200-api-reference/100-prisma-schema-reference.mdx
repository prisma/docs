...
- [`mongodb`](/concepts/database-connectors/mongodb) (Preview)
...
- Prisma has a number of **reserved words** that are being used by Prisma internally and therefore cannot be used as a model name. You can find the reserved words <a href="https://github.com/prisma/prisma/blob/main/packages/client/src/generation/generateClient.ts#L376">here</a> and [here](https://github.com/prisma/prisma-engines/blob/master/libs/datamodel/core/src/transform/ast_to_dml/reserved_model_names.rs#L10).
...
| `varbit`             | `@db.VarBit`                   |
| `uuid`               | `@db.Uuid`                     |
| `xml`                | Not yet                        | Not currently supported in CockroachDB                                                                                                                               |
| `inet`               | `@db.Inet`                     |
| `citext`             | `@db.Citext`                   | Only available if [Citext extension is enabled](/concepts/components/prisma-schema/features-without-psl-equivalent#enable-extensions-for-native-database-functions). |
...
| ---------------------- | ------------------------------ | -------------------------------- |
| `decimal` \| `numeric` | `@db.Decimal(p, s)`†           |                                  |
| `money`                | Not yet                        | Not yet supported by CockroachDB |
