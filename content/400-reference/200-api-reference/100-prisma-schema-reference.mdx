...
```prisma highlight=3;normal copy
model User {
  id             Int      @id @default(autoincrement())
  posts          Post[]
...
```prisma highlight=5;normal copy
model User {
  id      Int      @id @default(autoincrement())
  email   String   @unique
  name    String?
