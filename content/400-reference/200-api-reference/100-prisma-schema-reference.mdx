...
To get or retrieve a user, use the generated composite ID field (`firstname_lastname`):
...
To get or retrieve a user, use the generated field name (`firstname_lastname`):
...
To get or retrieve a user, use the custom field name (`admin_identifier`):
