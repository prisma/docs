...
| Native database type | <span style="white-space:nowrap">Native database type attribute</span> | Notes |
| :------------------- | :--------------------------------------------------------------------- | ----- |
| `char`               | `@db.Char(X)`                                                          |
| `nchar`              | `@db.NChar(X)`                                                         |
| `varchar`            | `@db.VarChar(X)`                                                       |
...
| Native database types | Native database type attribute | Notes                                                                                                                                                                                                                                                    |
| --------------------- | ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `integer`             | `@db.Integer`                  | <ul><li>`@db.Int @default(autoincrement())` is equivalent to `serial4`</li><li>Aliases: `int`, `int4`, `serial4`</li></ul> |
