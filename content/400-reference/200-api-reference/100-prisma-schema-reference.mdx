...
| Name                                                                                                                      | Required | Type     | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------- | -------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
| `map` ([2.XX.0](https://github.com/prisma/prisma/releases/tag/2.XX.0) and later with the `namedConstraints` Preview flag) | No       | `String` | The constraint name in the underlying database. Default naming convention: `{table_name}_pk` (for example, `users_pk`) |
...
| Name                                                                                                                      | Required | Type     | Description                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------- | -------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `map` ([2.XX.0](https://github.com/prisma/prisma/releases/tag/2.XX.0) and later with the `namedConstraints` Preview flag) | No       | `String` | The constraint name in the underlying database. Default naming convention: `{table_name}_{column_names}_uniq` (for example, `users_col1_uniq`) |
...
| `map` ([2.XX.0](https://github.com/prisma/prisma/releases/tag/2.XX.0 with the `namedConstraints` Preview flag) and later) | No       | `String`           | The constraint name in the underlying database. Default naming convention: `{table_name}_{column_names}_uniq` (for example, `users_col1_col2_uniq`)                                                         |
...
| ------------------------------------------------------------------------------------------------------------------------------------------ | -------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `fields`                                                                                                                                   | **Yes**  | `FieldReference[]` | A list of field names - for example, `["firstname", "lastname"]`                                                                                                                                                                                                             |
| `map` ([2.XX.0](https://github.com/prisma/prisma/releases/tag/2.XX.0) and later with the `namedConstraints` Preview flag, replaces `name`) | No       | `String`           | The index name in the underlying database. Default naming convention: `{table_name}_{column_names}_idx` (for example, `users_col1_col2_idx`) for globally unique indexes and `{column_names}_idx` for indexes that are only unique at table level (for example: `col1_idx1`) |
...
| `map` ([2.XX.0](https://github.com/prisma/prisma/releases/tag/2.XX.0) and later with the `namedConstraints` Preview flag) | No                 | `String`                                                                                                                                           | The index name in the underlying database. Default naming convention: `{table_name}_{column_names}_fkey` (for example, `post_userid_fkey`) | |
