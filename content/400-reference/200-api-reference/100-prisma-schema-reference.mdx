...
| `noCycle`   | `@default(sequence(noCycle))`                         | By default the sequence will wrap around when the sequence value hits the maximum or minimum value. If `noCycle` is set, the sequence will not wrap.                                                                                                             |
