...
Shorthand for programmatically overriding the [datasource](#datasources) property.
...
From version 5.0.0, you can compare columns in the same table directly, for non-unique filters.

This feature was also available via the `fieldReference` Preview feature from Prisma versions 4.3.0 to 4.16.2
