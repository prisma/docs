...
**Note:** From Prisma 4.0.0, this feature is deprecated. Use [`$improvedqueryraw`](/concepts/components/prisma-client/raw-database-access#queryraw) instead.

<!-- prettier-ignore -->
### <inlinecode>$improvedQueryRaw()</inlinecode>

**Note:** We added this `$improvedQueryRaw` as a [preview feature[(/concepts/components/preview-features/client-preview-features)] in Prisma 3.14.0 and made it generally available in Prisma 4.0.0.
