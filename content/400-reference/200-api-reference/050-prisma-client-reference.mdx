...
- From version 4.6.0, Prisma carries out native upsers for Postgres, SQLite, and CockroachDB databases, if specific crieria are met. [Learn more](/concepts/components/prisma-client/native-upserts).
