...
- If you want to compare a field in MySQL or MariaDB with one of the following [JSON filters](http://localhost:8000/reference/api-reference/prisma-client-reference#json-filters): gt, gte, lt, or lte.
