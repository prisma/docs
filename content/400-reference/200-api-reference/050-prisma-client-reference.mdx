...
- In [2.20.0](https://github.com/prisma/prisma/releases/2.20.0) and later, you can [select a `_count` of relations](#select-a-count-of-relations).
...
- In [2.20.0](https://github.com/prisma/prisma/releases/2.20.0)P and later, you can [`include` a `_count` of relations](#include-a-count-of-relations)
