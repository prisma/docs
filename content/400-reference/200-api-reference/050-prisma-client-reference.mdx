...
`select` defines which fields are included in the selection set that Prisma Client returns. See [Select fields and include relations](../../../concepts/components/prisma-client/select-and-include).
...
`select` defines relations are included in the result that the Prisma Client returns. See [Select fields and include relations](../../../concepts/components/prisma-client/select-and-include).
