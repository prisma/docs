...
Before version 4.3.0, you can [compare columns in the same table with raw queries](/guides/database/troubleshooting-orm/help-articles/comparing-columns-through-raw-queries).
