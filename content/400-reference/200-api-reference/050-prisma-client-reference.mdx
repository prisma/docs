...
- From version 4.6.0, Prisma carries out native upserts for Postgres, SQLite, and CockroachDB databases, if specific criteria are met. [Learn more](/concepts/components/prisma-client/native-upserts).
