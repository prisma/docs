...
| `rejectOnNotFound` (deprecated) | `RejectOnNotFound`       | No       | If true, throw a `NotFoundError: No User found error`. <br></br>**Note:** `rejectOnNotFound`is deprecated in v4.0.0 and removed in v5.0.0. From v4.0.0, use [`findUniqueOrThrow`](#finduniqueorthrow) instead.            |
...
| `rejectOnNotFound` (deprecated) | `RejectOnNotFound`                                           | No       | If true, throw a `NotFoundError: No User found error`. <br></br>**Note:** `rejectOnNotFound`is deprecated in v4.0.0 and removed in v5.0.0. From v4.0.0, use [`findFirstOrThrow`](#findfirstorthrow) instead.                               |
