...
- It is for use on optional fields only. If you try to sort by nulls on a mandatory field, Prisma Client throws a [P2009 error](/reference/api-reference/error-reference#p2009).
...
This feature is available from version 3.5.0 onwards in PostgreSQL only. You'll need to use the `fullTextSearch` preview flag to enable this feature. this is [a link](www.google.com)
