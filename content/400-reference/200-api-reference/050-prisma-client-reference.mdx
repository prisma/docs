...
Prisma metrics give you a detailed insight into how Prisma Client interacts with your database. You can use this insight to help diagnose performance issues with your application. Learn more: [Metrics](/guides/performance-and-optimization/metrics).

Prisma metrics has the following methods:

- `$metrics.json()`: [Retrieves Prisma metrics in JSON format](/guides/performance-and-optimization/metrics#retrieve-metrics-in-json-format).
- `$metrics.prometheus()`: [Retrieves Prisma metrics in Prometheus format](/guides/performance-and-optimization/metrics#retrieve-metrics-in-prometheus-format).
