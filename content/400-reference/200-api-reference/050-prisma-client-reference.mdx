...
If multiple upsert operations happen at the same time and the record doesn't already exist, then one or more of the operations might throw a [unique key constraint error](/reference/api-reference/error-reference#p2002).
