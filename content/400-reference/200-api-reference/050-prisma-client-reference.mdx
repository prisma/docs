...
While Prisma Client supports efficient batch inserts with the [`createMany`](#createmany) query, there are scenarios where using `create` to insert multiple records is necessary or desired.
