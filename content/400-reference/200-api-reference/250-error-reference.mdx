...
**Note:** If you get error code P1012 after you upgrade Prisma to version 4.0.0 or later, see the [version 4.0.0 upgrade guide](/guides/upgrade-guides/upgrading-versions/upgrading-to-prisma-4#upgrade-your-prisma-schema). Valid schemas before version 4.0.0 might be invalid in version 4.0.0 and later. The upgrade guide explains how to update your schema to make it compatible with version 4.0.0 and later.
