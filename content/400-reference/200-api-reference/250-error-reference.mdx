...
The datasource is an invalid one:

* "Could not parse URL of the datasource"
* "Datasource URL should use prisma:// protocol"
...
* "beforeExit event is not supported yet"
* "Interactive transactions are not supported yet"
