...
#### <inlinecode>P6010</inlinecode> (<inlinecode>ProjectDisabledError</inlinecode>)

Your accelerate project is disabled. Please [enable](/data-platform/accelerate/getting-started#1-enable-accelerate-in-a-cloud-project) it again to use it.
