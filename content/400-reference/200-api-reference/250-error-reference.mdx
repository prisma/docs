...
You see error P5000 when the server could not understand the request. In comparison, P5011 indicates that the server understands the request but rejects it due to failed validation checks, such as parameters being out of range.
