...
* "Argument \"{}\" is missing.", argument_name
* "Function \"{}\" takes {} arguments, but received {}.", function_name, required_count, given_count
* "Argument \"{}\" is missing in attribute \"@{}\".", argument_name, attribute_name
* "Argument \"{}\" is missing in data source block \"{}\".", argument_name, source_name
* "Argument \"{}\" is missing in generator block \"{}\".", argument_name, generator_name
* "Error parsing attribute \"@{}\": {}", attribute_name, message
* "Attribute \"@{}\" is defined twice.", attribute_name
* "The model with database name \"{}\" could not be defined because another model with this name exists: \"{}\"", model_database_name, existing_model_name
* "\"{}\" is a reserved scalar type name and can not be used.", type_name
* "The {} \"{}\" cannot be defined because a {} with that name already exists.", top_type, name, existing_top_type
* "Key \"{}\" is already defined in {}.", key_name, conf_block_name
* "Argument \"{}\" is already specified as unnamed argument.", arg_name
* "Argument \"{}\" is already specified.", arg_name
* "No such argument."
* "Field \"{}\" is already defined on model \"{}\".", field_name, model_name
* "Field \"{}\" in model \"{}\" can't be a list. The current connector does not support lists of primitive types.", field_name, model_name
* "The index name `{}` is declared multiple times. With the current connector index names have to be globally unique.", index_name
* "Value \"{}\" is already defined on enum \"{}\".", value_name, enum_name
* "Attribute not known: \"@{}\".", attribute_name
* "Function not known: \"{}\".", function_name
* "Datasource provider not known: \"{}\".", provider
* "shadowDatabaseUrl is the same as url for datasource \"{}\". Please specify a different database as shadow database.", source_name
* "The preview feature \"{}\" is not known. Expected one of: {}", preview_feature, expected_preview_features
* "\"{}\" is not a valid value for {}.", raw_value, literal_type
* "Type \"{}\" is neither a built-in type, nor refers to another model, custom type, or enum.", type_name
* "Type \"{}\" is not a built-in type.", type_name
* "Unexpected token. Expected one of: {}", expected_str
* "{}", message
* "{}", message
* "{}", message
* "Environment variable not found: {}.", var_name
* "Expected a {} value, but received {} value \"{}\".", expected_type, received_type, raw
* "Expected a {} value, but failed while parsing \"{}\": {}.", expected_type, raw, parser_error
* "Error validating model \"{}\": {}", model_name, message
* "Error validating field `{}` in model `{}`: {}", field, model, message
* "Error validating datasource `{datasource}`: {message}"
* "Error validating enum `{}`: {}", enum_name, message
