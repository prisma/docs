...
When Prisma is locally installed with npm, pnpm, or yarn, prepend the command with npx, pnpx, or yarn respectively. If Prisma is installed globally, you can omit the npx, pnpx, or yarn prefix.
