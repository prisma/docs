...
If a [schema drift](/concepts/components/prisma-migrate/shadow-database#detecting-schema-drift) is `prisma migrate dev` detected while using `--create-only`, you will be prompted to reset your database.
