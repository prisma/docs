...
All `prisma` commands return the following codes when they exit:
...
- there are migration files that have not been applied to the database
- the migration history has diverged
