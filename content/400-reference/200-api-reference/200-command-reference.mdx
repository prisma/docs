...
| `--generator-provider`  | No       | Specifies the default value for the `provider` field in the `generator` block.                                                                                         | `prisma-client-js`            |
| `--preview-feature`     | No       | Specifies the preview features for the `generator` block.                                                                                                              | `[]`                          |
| `--output`              | No       | Specifies a custom output path for the `generator` block.                                                                                                              | `node_modules/.prisma/client` |
...
##### Run `prisma init --generator-provider prisma-client-go`
...
##### Run `prisma init --preview-feature x --preview-feature y`
...
##### Run `prisma init --output ./generated-client`
