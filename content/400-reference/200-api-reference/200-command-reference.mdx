...
- [Schema prototyping with `db push`](/guides/migrations/prototyping-schema-db-push) <span class="guide"></span>
...
See [Seeding your database](/guides/migrations/seed-database) <span class="guide"></span>
...
- [Migration troubleshooting in production](/guides/migrations/production-troubleshooting#fixing-failed-migrations-with-migrate-diff-and-db-execute) <span class="guide"></span>
...
- [Developing with Prisma Migrate](/guides/migrations/developing-with-prisma-migrate) <span class="guide"></span>
