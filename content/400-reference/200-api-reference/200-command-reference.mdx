...
The `--` argument/ [option terminator](https://github.com/commandlineparser/commandline/wiki/CommandLine-Grammar#options-terminator-dashdash---) is available from version 4.15.0 or later.
