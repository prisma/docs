...
1. Applies migrations that have not yet been applied
1. Generates a new migration based on the changes in the Prisma schema (you will be prompted to name the migration)
1. Applies the new migration to the database
1. Updates the migrations table with a new entry
1. Triggers generation of artifacts such as Prisma Client (`prisma generate`)
...
| Argument   | Required | Description                                                                                                                                       | Default                                          |
| :--------- | :------- | :------------------------------------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------- |
| `--applied` | No       | Specifies the path to the desired schema.prisma file to be processed instead of the default path. Both absolute and relative paths are supported. | `./schema.prisma`<br /> `./prisma/schema.prisma` |
| `--rolledback` | No       | Specifies the path to the desired schema.prisma file to be processed instead of the default path. Both absolute and relative paths are supported. | `./schema.prisma`<br /> `./prisma/schema.prisma` |
