...
See [the `db` section](#db) for more information.
...
error: The preview feature "namedConstraints" is not known. Expected one of: microsoftSqlServer, groupBy, createMany, namedConstraints, nApi
  -->  schema.prisma:3
   |
 2 |   provider        = "prisma-client-js"
 3 |   previewFeatures = ["namedConstraints"]
   |
...
The `db [command]` command connects to your database and adds Prisma models to your Prisma schema that reflect the current database schema.
