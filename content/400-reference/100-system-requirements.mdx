...
Upgrade the TypeScript dependency in your project to a [version supported by Prisma](reference/system-requirements#software-requirements). `npm install -D typescript`.
