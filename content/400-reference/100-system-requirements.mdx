...
Notes:
- Other Node.js releases [in non-Active-LTS state like _Current_ or _Maintenance-LTS_ , and also odd-numbered versions](https://nodejs.org/en/about/releases/) probably also work, but are not recommended for production use. They are not fully tested by Prisma - the versions listed above are.
