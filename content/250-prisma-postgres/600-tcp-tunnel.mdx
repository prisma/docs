...
The local tunnel enables you to access Prisma Postgres from 3rd party database editors such as Postico, TablePlus and pgAdmin. Learn more in this [section](/prisma-postgres/tooling#2-connect-to-prisma-postgres-using-tableplus).
