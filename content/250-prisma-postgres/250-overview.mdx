...
To learn about how pricing works with Prisma Postgres, visit the [pricing page](https://www.prisma.io/pricing) and [billing documentation](/platform/about#billing).
