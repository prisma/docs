...
3. Enter the following details:
  ...
  - **User**: This value will be ignored due to the tunnel, you can provide anything here.
  - **Password**:  This value will be ignored due to the tunnel, you can provide anything here.
