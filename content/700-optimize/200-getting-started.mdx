...
1. Log in to your [Prisma Data Platform account](https://console.prisma.io/optimize).
...
3. Explore individual query details by clicking on them, and check the **Recommendations** tab for any suggested improvements to enhance query performance.
   ...
   :::info
   Use the [AI Explainer](/optimize/ai-explainer) feature to understand recommendations and apply them within your Prisma model context.
   :::
