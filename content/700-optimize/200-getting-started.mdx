...
While many database engines are supported, Prisma Optimize does not support databases accessed via the [`driverAdapters`](/orm/overview/databases/database-drivers#driver-adapters) Preview feature.

Additionally, Prisma Optimize is intended for use in local environments. Learn more in the [FAQ](/optimize/faq#can-i-use-prisma-optimize-in-production).
...
2. <a href="https://www.prisma.io/docs/platform/about#accessing-the-optimize-dashboard" target="_blank">Follow the instructions</a> to access and launch Prisma Optimize.
...
<a href="https://www.prisma.io/docs/platform/about#generating-an-optimize-api-key" target="_blank">Generate a Prisma Optimize API key</a> and add it to your `.env` file:
