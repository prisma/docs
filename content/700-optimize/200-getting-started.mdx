...
- A project that uses [Prisma Client](/orm/prisma-client) `5.0.0` or higher (we always recommend using the latest version of Prisma).
...
Reach out to us in the `#help-and-questions` channel on our [Discord](https://pris.ly/discord), or connect with our community to see how others are using Optimize.
