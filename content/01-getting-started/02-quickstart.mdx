...
<SwitchTech technologies={['typescript', 'node']}>

<h2>Overview (TypeScript)</h2>
...
<h2>Download starter project & install dependencies</h2>
...
This downloaded a directory called `starter`.

<br />
<details><summary>Expand for more info on the <code>starter</code> project</summary>
...
Befor you move on, navigate into the `starter` directory and install the npm dependencies with these commands:
...
<h2>Write your first query with Prisma Client</h2>
...
<h2>Write data into the database</h2>
...
<h4>Continue exploring the Prisma Client API</h4>
...
<h4>Setup Prisma with your own database</h4>
...
<h4>Explore the data in Prisma Studio (experimental)</h4>
...
<h4>Change the database schema (e.g. add more tables)</h4>
