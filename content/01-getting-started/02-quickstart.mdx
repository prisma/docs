...
This page explains how to get started with Prisma in five minutes. You will learn how to send queries to a SQL database in a plain **TypeScript** script using Prisma Client.
...
- `scr/index.ts`: A plain, executable TypeScript script
...
Also note that `allUsers` is _statically typed_ thanks to [Prisma Client's generated types](). You can observe the type by hovering over the `allUsers` variable in your editor. It should be typed as follows:
