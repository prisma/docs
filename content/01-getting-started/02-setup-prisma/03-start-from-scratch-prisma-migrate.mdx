...
techMetaTitles:
  [
    { name: 'node-postgres', value: 'Start from scratch (Prisma Migrate | Node.js & PostgreSQL)' },
    {
      ...
      value: 'Start from scratch (Prisma Migrate | TypeScript & PostgreSQL)',
    },
...
This page walks you through the process of setting up Prisma from scratch with your own database. It uses [Prisma Migrate](../../cconcepts/tools-and-interfaces/prisma-migrate) to create tables in your database.
...
In this guide, you'll use [Prisma Migrate](../../cconcepts/tools-and-interfaces/prisma-migrate) to create the tables in your database. Add the following Prisma data model to your Prisma schema in `prisma/schema.prisma`:
