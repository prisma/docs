...
```
DATABASE_URL="postgres://johndoe:randompassword@localhost:5432/mydb?schema=public"
```
...
```
DATABASE_URL="postgres://opnmyfngbknppm:XXX@ec2-46-137-91-216.eu-west-1.compute.amazonaws.com:5432/d50rgmkqi2ipus?schema=hello-prisma"
```
...
```
DATABASE_URL="postgres://janedoe:janedoe@localhost:5432/janedoe?schema=hello-prisma"
```
