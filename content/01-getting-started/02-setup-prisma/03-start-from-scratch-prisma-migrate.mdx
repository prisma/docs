...
This page walks you through the process of setting up Prisma from scratch with your own database. It uses [Prisma Migrate](../../concepts/tools-and-interfaces/prisma-migrate) to create tables in your database.
...
In this guide, you'll use [Prisma Migrate](../../concepts/tools-and-interfaces/prisma-migrate) to create the tables in your database. Add the following Prisma data model to your Prisma schema in `prisma/schema.prisma`:
