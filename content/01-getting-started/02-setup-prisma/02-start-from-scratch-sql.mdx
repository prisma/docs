...
Make sure your have your database [connection URL](../../cconcepts/database-connectors/connection-urls) (that includes your authentication credentials) at hand!
...
Next, set up your Prisma project by creating your [Prisma schema](../../cconcepts/tools-and-interfaces/prisma-schema/prisma-schema-file) file with the following command:
...
As an example, for a PostgreSQL database hosted on Heroku, the [connection URL](../../cconcepts/database-connectors/connection-urls) might look similar to this:
...
Also note that `allUsers` is _statically typed_ thanks to [Prisma Client's generated types](../../cconcepts/tools-and-interfaces/prisma-client/advanced-usage-of-generated-types). You can observe the type by hovering over the `allUsers` variable in your editor. It should be typed as follows:
