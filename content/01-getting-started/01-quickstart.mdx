...
For demonstration purposes of this guide, you will use a local [SQLite](https://www.sqlite.org/) database file. This guide does _not_ cover the Prisma setup process. If you're looking to set up Prisma with your own database, you have these options:
...
When adding Prisma to an already existing no project, you can obtain your initial data model through [introspection](../reference/tools-and-interfaces/introspection).
...
First, create a new table in your database database, e.g. with this command in your terminal:
