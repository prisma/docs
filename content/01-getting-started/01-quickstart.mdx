...
- `prisma/schema.prisma`: [Prisma schema file](../concepts/tools-and-interfaces/prisma-schema/) defining your models
...
In this section, you will write your first query with Prisma Client. For reference, this is what the [Prisma schema](../concepts/tools-and-interfaces/prisma-schema/) looks like that your Prisma Client was generated from:
...
One of the main features of Prisma Client is the ease of working with relations. You can retrieve the `posts` of each user by using the [`include`](../concepts/tools-and-interfaces/prisma-client/field-selection#include) option. Adjust your code to look as follows:
...
This code creates a new `Post` record and _connects_ it in a [nested write](../concepts/tools-and-interfaces/prisma-client/relation-queries#nested-writes) to an existing `User` record.
...
You can send a variety of queries with the Prisma Client API. Check out the [API reference](../concepts/tools-and-interfaces/prisma-client/) and use your existing SQLite-based setup from this guide to try them out.
...
The following guides both explain how you can set up a new project from scratch using your own database as well as how to send queries with Prisma Client. The first one uses SQL migrations and [introspection](../concepts/tools-and-interfaces/introspection) while the second one uses [Prisma Migrate](../concepts/tools-and-interfaces/prisma-migrate) as the main Prisma workflow.
...
When adding Prisma to an already existing npm project, you can obtain your initial data model through [introspection](../concepts/tools-and-interfaces/introspection).
...
This updates your [Prisma schema](../concepts/tools-and-interfaces/prisma-schema/) in `prisma/schema.prisma`.

Note that after the introspection, you might want to [configure your  Prisma Client API](../concepts/tools-and-interfaces/prisma-client/configuring-the-prisma-client-api).

<details><summary><strong>Alternative</strong>: Use Prisma Migrate (experimental)</summary>

Changing your database schema using [Prisma Migrate](../concepts/tools-and-interfaces/prisma-migrate) typically happens with the following steps.
...
This updates the generated Prisma Client library in [`node_modules/@prisma/client`](../concepts/tools-and-interfaces/prisma-client/generating-prisma-client#the-prismaclient-npm-package).
