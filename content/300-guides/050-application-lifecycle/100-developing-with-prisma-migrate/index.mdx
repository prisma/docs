...
> **Prototyping?** Use the [`db push`](../../../reference/api-reference/command-reference#db-push) command if you are [prototyping](../prototyping-schema-db-push) and are not concerned with data loss or replicating your changes in other environments. You can start or continue your migration history when you are happy with your changes.
...
* [Advanced migration techniques](advanced-migrate-scenarios)
...
Most of the time, schema changes are **additive** - adding a new field, model, or relation.

## Write a seed script

You should expect to reset your database in a development environment - for example, if you you regularly switch between branches that have different migration histories, Prisma Migrate will prompt you to reset when you run `prisma migrate dev`.
