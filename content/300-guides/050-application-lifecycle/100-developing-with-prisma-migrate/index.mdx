...
If you are at the **prototyping stage**, where data loss and breaking changes do not matter, consider using `db push`.
...
- You use a cloud-hosted database for development
