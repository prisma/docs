...
<Tip>
  ...
  However, this doesn't scale as well as having a more generic solution that maps over your models and performs a truncate on them. For those scenarios and examples of using raw SQL queries see [Delete all records from all tables](../../concepts/components/prisma-client/crud#delete-all-records-from-all-tables)
