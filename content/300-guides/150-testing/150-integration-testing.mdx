...
At the time of writing, this guide uses `jest-mock-extended` version `^2.0.4`. See [mocking Prisma Client](/guides/testing/unit-testing#mocking-the-prisma-client) for information on how to use this version.
