...
In order to fix these situations have a look at [Production Troubleshooting](/guides/migrations/production-troubleshooting#fixing-failed-migrations-with-migrate-diff-and-db-execute)
