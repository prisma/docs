...
- [Patching / hotfixing production databases](/guides/migrate/patching-production)
...
- The database schema was changed _without_ using migrations - for example, by using [`prisma db push`](/reference/api-reference/prisma-cli/command-reference#db-push) or manually changing the database schema.
