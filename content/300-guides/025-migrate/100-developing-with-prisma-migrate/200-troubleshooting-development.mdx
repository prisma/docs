...
> **Note**: You should [never purposefully delete or edit a migration](/concepts/components/prisma-migrate/migration-histories#do-not-edit-or-delete-migrations-that-have-been-applied), as this might result in discrepancies between development and production.
