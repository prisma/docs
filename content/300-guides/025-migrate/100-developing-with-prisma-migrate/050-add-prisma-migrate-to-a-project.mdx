...
- Refer to the [Production Troubleshooting](/guides/migrate/production-troubleshooting#fixing-failed-migrations-with-migrate-diff-and-db-execute) guide to learn how to debug migration issues in production.
