...
You can then apply these changes to your database with Prisma Migrate. See [How to migrate PostgreSQL extensions](/concepts/components/prisma-schema/postgresql-extensions#how-to-migrate-postgresql-extensions) for details.
