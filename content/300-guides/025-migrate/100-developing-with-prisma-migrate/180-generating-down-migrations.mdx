...
This guide describes how to generate a down migration SQL file that reverses a given [migration file](/concepts/components/prisma-migrate/migration-histories).
