...
When prisma db pull detects a comment, it will output a warning and add a comment to your schema file to surface its presence. For example, with the following SQL:
