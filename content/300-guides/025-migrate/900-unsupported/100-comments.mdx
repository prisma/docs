...
COMMENTS are useful for providing metadata that describes your database schema, i.e., tables, fields, enums, etc. <br />
...
You can track support for database-level comments in this [GitHub issue](https://github.com/prisma/prisma/issues/8703).
...
When `prisma db pull` detects COMMENT, it will output a warning and add a comment to your schema file to surface its presence. For example, with the following SQL:

<TabbedContent tabs={[
<FileWithIcon text="PostgreSQL" icon="database"/>,
<FileWithIcon text="CockroachDB" icon="database"/>,
<FileWithIcon text="MySQL" icon="database"/>,
]}>
...
<TabbedContent tabs={[
<FileWithIcon text="PostgreSQL" icon="code"/>,
<FileWithIcon text="CockroachDB" icon="code"/>,
<FileWithIcon text="MySQL" icon="code"/>,
]}>

<!-- #region postgres terminal warnings -->
...
<!-- #region cockroachdb terminal warnings -->
...
<!-- #region mysql terminal warnings -->
...
<TabbedContent tabs={[
<FileWithIcon text="PostgreSQL" icon="prisma"/>,
<FileWithIcon text="CockroachDB" icon="prisma"/>,
<FileWithIcon text="MySQL" icon="prisma"/>,
]}>

<!-- #region postgres schema warnings -->
...
<!-- #region cockroachdb schema warnings -->
...
First, create a migration directory that will be used to persist the SQL migration files.

```terminal
   mkdir -p prisma/migrations
```

Next, create a baseline migration

> Baselining is the process of initializing a migration history. Refer to [Baselining a database](https://www.prisma.io/docs/guides/migrate/developing-with-prisma-migrate/baselining) for more information.

1. Take note of the warning generated during prisma db pull that highlights where it detected comments in your database schema:
