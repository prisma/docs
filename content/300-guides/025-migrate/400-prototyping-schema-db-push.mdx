...
This guide demonstrates how to use [`db push`](/reference/api-reference/prisma-cli/command-reference#db-push) to prototype a new schema or a new feature for an existing schema.
