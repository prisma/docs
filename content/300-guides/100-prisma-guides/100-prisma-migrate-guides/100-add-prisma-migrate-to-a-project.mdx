...
2. Call `prisma migrate resolve --applied "20201124-create-users" --preview-feature` to baseline a migration. Repeat this multiple times if you are baselining multiple migrations.