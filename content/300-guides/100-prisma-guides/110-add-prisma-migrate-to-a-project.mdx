...
Baselining is for introducing Prisma Migrate to existing databases / brownfield projects.

Assuming you have successfully transitioned to Prisma Migrate (Preview) and started a new migration history in your repository using `prisma migrate dev`, you now need to **baseline** any database that contains important data - such as production or staging.
