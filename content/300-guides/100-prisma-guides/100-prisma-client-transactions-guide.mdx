...
4. Running the same code again either:
   ...
   * If `externalId` is not unique, Stripe creates a yet another subscription
...
In between steps 1 and 3, you might find that someone else has managed to reserve the same seat.
