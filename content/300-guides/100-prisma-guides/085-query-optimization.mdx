...
* Use Prisma's automatic batching of [`findUnique`](../../../reference/api-reference/prisma-client-reference#findUnique) <span class="api"></span> (particularly useful in a [GraphQL context](#example-use-inlinecodefinduniqueinlinecode-to-avoid-the-n1-issue-in-your-graphql-resolvers))
...
In this scenario, you should take advantage of Prisma's automatic batching of `findUnique`. For a detailed explanation, review our [example](#example-use-inlinecodefinduniqueinlinecode-to-avoid-the-n1-issue-in-your-graphql-resolvers) or watch the following video from Prisma Day 2020:
