...
* The atabase is reset interactively in the context of using `prisma migrate dev --preview-feature` - for example, as a result of migration history conflicts or database drift.