---
title: Upgrading to 2.XX.0
metaDescription: "Manual steps when upgrading to 2.XX.0."
tocDepth: 2
---

<TopBlock>

This page describes manual upgrade steps that you need to perform after [upgrading to Prisma 2.XX.0](.) if you want to use the `namedConstraints` Preview feature.
...
* [I want to use Prisma's default constraint and index namess](#upgrade-path-2-i-want-to-use-prismas-default-constraint-and-index-namess)
