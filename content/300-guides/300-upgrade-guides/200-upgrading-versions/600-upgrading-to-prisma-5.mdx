...
Used globally or per query

true/false vs custom error handler
...
Due to the switch to the new protocol, several error messages have been improved. The following error message in Prisma 4 and below
