...
[Scalar list](https://www.prisma.io/docs/concepts/components/prisma-schema/data-model#scalar-fields) values must be arrays in all operations.
...
Operations on lists of [Composite](/concepts/components/prisma-schema/data-model#defining-composite-types) types now only accept array values.

<Admonition type="info">

Composite lists are only available in the [MongoDB provider](/concepts/database-connectors/mongodb)
