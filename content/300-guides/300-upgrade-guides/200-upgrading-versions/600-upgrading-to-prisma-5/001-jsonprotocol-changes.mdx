---
title: 'jsonProtocol changes in Prisma 5'
metaTitle: 'Upgrade to jsonProtocol'
metaDescription: 'Guides on how to upgrade to jsonProtocol'
tocDepth: 2
toc: true
---
...
As of Prisma version 5.0.0, the new JSON Protocol is the default. There are some changes that directly result from this change and a few changes that are related to the new protocol.
...
Below are changes that are related to the switch to the new JSON Protocol. If you were using JSON Protocol before Prisma 5, you most likely ran into these issues.
