...
This is because PostgreSQL’s length(string) function expects a string. To fix this, explicitly coerce the incoming number into a string with the following:
