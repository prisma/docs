...
The following guide describes how to upgrade from a third party migration tool to Prisma Migrate (2.13.0 and later).

</TopBlock>

## Prerequisites and assumptions

This guide relies on the following prerequisites:

* You have added Prisma to your project
* 

Be aware that:

* You cannot combine your current migration history with Prisma Migrate
