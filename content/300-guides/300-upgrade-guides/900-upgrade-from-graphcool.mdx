...
Note that Graphcool uses the same data modeling approach as Prisma 1. If you encounter any [schema incompatibilities](/guides/upgrade-guides/upgrade-from-prisma-1/schema-incompatibilities), you can resolve them in the same way as if you were upgrading from Prisma 1.
