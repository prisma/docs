...
The guide assumes that you already went through the [guide for upgrading the Prisma layer](/guides/upgrade-guides/upgrading-from-prisma-1/upgrading-the-prisma-layer-postgres). This means you already:

- installed the Prisma 2.0 CLI
- created your Prisma 2.0 schema
- introspected your database and resolved potential [schema incompatibilities](/guides/upgrade-guides/upgrading-from-prisma-1/schema-incompatibilities-postgres)
