...
- introspected your database and resolved potential [schema incompatibilities](/guides/upgrade-guides/upgrade-from-prisma-1/schema-incompatibilities-postgres-postgres-postgres-postgres-postgres)
