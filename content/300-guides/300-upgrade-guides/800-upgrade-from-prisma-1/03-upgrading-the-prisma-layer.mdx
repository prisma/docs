...
> **Note**: With Prisma 1, it was usually recommended to install the CLI globally. We now recommend to [install the Prisma CLI locally](/reference/api-reference/command-reference#installation#installation) to prevent version conflicts.
