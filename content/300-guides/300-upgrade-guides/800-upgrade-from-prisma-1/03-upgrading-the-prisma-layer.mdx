---
title: 'Upgrading the Prisma1 layer'
# metaTitle: 'Upgrading the Prisma1 layer to Prisma 2+'
# metaDescription: 'Learn how to upgrade the Prisma1 layer to Prisma 2+ and create your Prisma schema.'
dbSwitcher: ['postgresql', 'mysql']
techMetaTitles:
  [
    { name: 'mysql', value: 'Upgrading the Prisma1 layer to Prisma 2+ | MySQL' },
    {
      name: 'postgresql',
      value: 'Upgrading the Prisma1 layer to Prisma 2+ | PostgreSQL',
    },
  ]
techMetaDescriptions:
  [
    {
      name: 'mysql',
      value: 'Learn how to upgrade the Prisma1 layer to Prisma 2+ and create your Prisma schema with MySQL',
    },
    {
      name: 'postgresql',
      value: 'Learn how to upgrade the Prisma1 layer to Prisma 2+ and create your Prisma schema with PostgreSQL',
    },
  ]
---
...
1. Use the [Prisma1 Upgrade CLI](./how-to-upgrade#prisma-upgrade-cli) to resolve the [schema incompatibilities](/guides/upgrade-guides/upgrade-from-prisma-1/schema-incompatibilities-postgresql) in the new Prisma 2 data model
...
The [Prisma1 Upgrade CLI](/guides/upgrade-guides/upgrade-from-prisma-1/how-to-upgrade#prisma-upgrade-cli) is an interactive tool that helps you upgrading your Prisma schema and ironing out most of the inconsistencies listed above.

The Prisma1 Upgrade CLI works in two major phases:
...
```no-lines
◮ Welcome to the interactive Prisma1 Upgrade CLI that helps with the
