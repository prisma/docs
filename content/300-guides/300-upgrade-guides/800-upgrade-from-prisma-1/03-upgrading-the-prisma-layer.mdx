...
1. Use the [Prisma Upgrade CLI](./how-to-upgrade#prisma-upgrade-cli) to resolve the [schema incompatibilities](/guides/upgrade-guides/upgrade-from-prisma-1/schema-incompatibilities-postgresql) in the new Prisma 2 data model
