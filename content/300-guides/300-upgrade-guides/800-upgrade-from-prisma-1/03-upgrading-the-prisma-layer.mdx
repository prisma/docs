...
```terminal copy
prisma-upgrade prisma1/prisma.yml prisma/schema.prisma
```
...
These are the different steps of the upgrade process:
  ...
  3. You run the `prisma db pull` command again.
...
![Altering columns to use ENUM with SQL](https://res.cloudinary.com/prismaio/image/upload/v1628761154/docs/Fo0LbzU.png)
...
![Adding missing `DEFAULT` constraints to columns](https://res.cloudinary.com/prismaio/image/upload/v1628761153/docs/o4dJJic.png)
...
![Running an SQL command to alter a column](https://res.cloudinary.com/prismaio/image/upload/v1628761154/docs/PvuQVkj.png)
...
![Running an SQL command to alter tables](https://res.cloudinary.com/prismaio/image/upload/v1628761154/docs/PvuQVkj.png)
...
the changes.
  ...
  1. Run `prisma db pull` again to refresh your Prisma 2 schema.
...
![Fixing incorrect m-n relations with SQL](https://res.cloudinary.com/prismaio/image/upload/v1628761154/docs/nvrKuVJ.png)
