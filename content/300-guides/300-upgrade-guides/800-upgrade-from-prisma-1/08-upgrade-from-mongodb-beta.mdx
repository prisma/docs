...
The generated Prisma Client from a freshly introspected Prisma 1 based MongoDB database doesn't have the best API. You can adjust the names and use `@map` and `@@map` to map to the underlying collection and field names:
