...
metaTitle: 'Upgrade from the Prisma 1 MongoDB Beta to Prisma 4'
metaDescription: 'Learn how to upgrade your MongoDB application running Prisma 1 to Prisma 4.'
---

## Introduction

This guide helps you migrate from the Prisma 1 MongoDB Beta to MongoDB on Prisma 4.0.0 and later. To learn more about the differences between Prisma 1 and Prisma 2.x and later, refer to [this document](https://www.prisma.io/docs/guides/upgrade-guides/upgrade-from-prisma-1/how-to-upgrade#main-differences-between-prisma-1-and-prisma-version-2x-and-later).
