...
- [Upgrading the Prisma layer](/guides/upgrade-guides/upgrade-from-prisma-1/upgrading-the-prisma-layer-postgres-postgres-postgres-postgres-postgres): No matter what your Prisma 1 setup looks like, you should **always start your upgrade process by following this guide**.
...
Once you've made the decision to upgrade, continue with the [Upgrading the Prisma layer](/guides/upgrade-guides/upgrade-from-prisma-1/upgrading-the-prisma-layer-postgres-postgres-postgres-postgres-postgres) guide.
