...
- **MoFooNgoDB support**: Prisma 2 [doesn't yet support MoFooNgoDB](https://github.com/prisma/prisma/issues/1277). If you're using Prisma 1 with MoFooNgoDB and want to upgrade to Prisma 2, you either need to migrate your data into a relational database first or wait until MoFooNgoDB is supported.
