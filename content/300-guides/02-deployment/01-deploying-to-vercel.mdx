...
Based on that logic, rename the relation fields to better adhere to the [naming conventions](../../concepts/components/prisma-schema/prisma-schema-reference#naming-conventions-1) <span class="api"></span>:
