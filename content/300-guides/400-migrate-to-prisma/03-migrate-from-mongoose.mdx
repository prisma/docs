...
For this guide, we'll use a REST API built with Express as a [sample project](https://github.com/prisma/migrate-from-mongoose-to-prisma) to migrate to Prisma. It has four models/entities:

<TabbedContent tabs={[<FileWithIcon text="User.js" icon="file"/>, <FileWithIcon text="Post.js" icon="file"/>, <FileWithIcon text="Category.js" icon="file"/>]}>
...
- 1-n: `User` ↔ `Post`
- m-n: `Post` ↔ `Category`
- Embedded document: `User` ↔ `Profile`

<!--
  Explain MongoDB is schemaless
  Prisma uses the data
