...
When migrating to Prisma, mark the `versionKey` field as optional ( __?__ ) in your Prisma schema and add the `@ignore` attribute to exclude it from Prisma Client.
