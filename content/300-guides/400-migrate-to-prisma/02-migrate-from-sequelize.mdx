...
If you wish to change this default behavior in Sequelize, you can either enforce the table name to be equal to the model name or provide the table name directly:
