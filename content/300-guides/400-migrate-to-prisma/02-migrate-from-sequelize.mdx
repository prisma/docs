...
```js file=src/models/index.js copy
...
```js copy file=src/prisma.js copy
...
```js file=src/controllers/post.js copy
const { Post, User, Category } = require('../models')
const { Op } = require('sequelize')
```

```js file=src/controllers/user.js copy
...
```js file=src/controllers/posts.js copy
const post = await prisma.post.update({
  data: {
    category: {
