...
To continue using Prisma Migrate to evolve your database schema, you will need to [baseline your database](/guides/database/developing-with-prisma-migrate/add-prisma-migrate-to-a-project).
