...
Note that if you are running on macOS **and a version of Prisma before 2.15.0**, you must use `encrypt=DANGER_PLAINTEXT` to work around the current [TLS limitation](https://github.com/prisma/prisma/issues/4075):
