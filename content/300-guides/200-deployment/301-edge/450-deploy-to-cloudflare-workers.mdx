...
**Note**<br /><br />
We are continuously testing the Prisma Accelerate with Cloudflare Workers. [Open an issue](https://github.com/prisma/prisma/issues/new/choose) if you run into problems or have questions about deploying to Cloudflare Workers.
...
Next, you'll generate a Prisma Client that connects through [Prisma Accelerate](/data-platform/accelerate) over HTTP.
