...
**Note**<br /><br />
We are continuously testing Data Proxy with Cloudflare Workers. [Open an issue](https://github.com/prisma/prisma/issues/new/choose) if you run into problems or have questions about deploying to Cloudflare Workers.
...
4. Next, you connect the Prisma Data Platform to the MongoDB Atlas database and set up Data Proxy.
   ...
   4. Click **Create Project** to test the connection and set up Data Proxy.
...
The smaller bundle size is due to the fact that the interfaces talking to the database (the [Prisma engines](/concepts/components/prisma-engines)) are no longer bundled with Prisma Client as this logic is now handled by Data Proxy.
