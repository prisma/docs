...
For more information on how to deploy database changes in a CI/CD pipeline, see [Backend with TypeScript, PostgreSQL & Prisma: CI & Deployment](https://www.prisma.io/blog/backend-prisma-typescript-orm-with-postgresql-deployment-bbba1ps7kip5).
