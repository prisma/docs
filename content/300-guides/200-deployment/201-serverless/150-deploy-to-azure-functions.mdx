...
metaTitle: 'How to deploy an Azure Function using Prisma'
metaDescription: 'Learn how to deploy a Prisma based REST API to Azure Functions and connect to an Azure SQL database'
---

<TopBlock>

This guide explains how to avoid common issues when deploying a Node.js-based function app to Azure to [Azure Functions](https://azure.microsoft.com/en-us/services/functions/).

Azure Functions is a serverless deployment platform. You do not need to maintain infrastructure to deploy your code.
...
When deploying a function app, the operating system that Azure functions runs a remote build is different from the one used to host your functions. Therefore, we recommend specifying the following binary targets in your Prisma schema.
