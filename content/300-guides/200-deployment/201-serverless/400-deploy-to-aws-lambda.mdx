...
Update the `plugins` property in your `webpack.config.js` file to include the `copy-webpack-plugin`. This plugin will allow you to copy your `schema.prisma` file into your bundled code.
