...
While a framework is not required to deploy to AWS Lambda, this guide covers deploying with [AWS Serverless Application Model (SAM)](https://aws.amazon.com/serverless/sam/), [Serverless Framework](https://www.serverless.com/framework/), and [SST](https://sst.dev/).
...
### Define binary targets in Prisma Schema</inlinecode>
...
## Considerations when using AWS SAM
...
This section covers resolving issues when using the Serverless Framework. Check the other sections for notes on [AWS Lambda in general](#general-aws-lambda-guidance), [AWS SAM](#aws-sam-guidance), or [SST](#sst-guidance).
