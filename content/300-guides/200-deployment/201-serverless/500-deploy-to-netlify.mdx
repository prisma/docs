...
You can use the [Data Proxy](/data-platform/classic-projects/data-proxy) for connection pooling, to reduce your Prisma Client bundle size, and to avoid cold starts.
