...
You can use [Accelerate](/data-platform/accelerate) or the [Data Proxy](/data-platform/classic-projects/data-proxy) for connection pooling, to reduce your Prisma Client bundle size, and to avoid cold starts.
...
You now have a successfully configured and deployed application using Prisma. Congratulations!
