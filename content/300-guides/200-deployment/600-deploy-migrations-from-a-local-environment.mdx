...
- You are [baselining](/guides/migrate/developing-with-prisma-migrate/baselining) a production environment
...
When you add Prisma Migrate to an **existing database**, you must [baseline](/guides/migrate/developing-with-prisma-migrate/baselining) the production database. Baselining is performed **once**, and can be done from a local instance.
