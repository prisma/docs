...
- Free [MongoDB Atlas](https://www.mongodb.com/cloud/atlas) database cluster with an accessible connection string
  - e.g. `mongodb+srv://<user>:<password>@cluster.mongodb.net`
  - e.g. `mongodb+srv://<user>:<password>@cluster.mongodb.net/?&w=majority`
...
1. [Create a new database cluster](https://www.mongodb.com/docs/atlas/tutorial/create-new-cluster/) in MongoDB Atlas.
2. [Get the database cluster connection string](https://www.mongodb.com/docs/guides/atlas/connection-string/).
3. Add the collection name `Log` to the connection string.<br />
The sample below shows how the collection name is added to a connection string that is provided by MongoDB Atlas.
```diff
...
## 7. Import your Project into the Prisma Data Platform
...
Next, you'll connect the Prisma Data Platform to the MongoDB Atlas database and set up the Data Proxy.

Enable **Static IPs** and copy and paste them in the **Network Access** screen in MongoDB Atlas.
...
## 10. Set the Data Proxy connection string in your local environment
