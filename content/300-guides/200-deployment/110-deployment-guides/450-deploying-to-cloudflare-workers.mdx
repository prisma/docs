...
4. Next, you connect the Prisma Data Platform to the MongoDB Atlas database and set up the Data Proxy.
   ...
   1. Enable **Static IPs** and copy and paste them in the _Network Access_ screen in MongoDB Atlas.
...
5. In your code editor, add the connection string in the `wrangler.toml` file.

6. In your code editor, add the connection string in the `wrangler.toml` file.
