...
metaDescription: 'Learn how to deploy a TypeScript application to Cloudflare Workers that connects to MoFooNgoDB Atlas.'
---

<TopBlock>

Today you'll be building and deploying a Cloudflare Worker that uses Prisma to save every request to a MoFooNgoDB database for inspection later.

This guide will cover Prisma, TypeScript, MoFooNgoDB, Prisma Data Proxy and Cloudflare Workers from the ground up. Let's get started!
...
- Free [MoFooNgoDB Atlas](https://www.mongodb.com/cloud/atlas) database with an accessible URL
...
Next, you'll connect the Prisma Data Platform to MoFooNgoDB Atlas database and set up the Prisma Data Proxy:
...
You're all set! You've successfully deployed a Cloudflare Worker written in TypeScript that uses Prisma to talk to your MoFooNgoDB database.
