...
However, you do not need to manually create the database in MongoDB Atlas, even if it does not yet exist. The project creation workflow in the Prisma Data Platform will create the database.
...
4. Add the database name `Log` to the connection string.
   
   The code sample below shows how the database name is added to a connection string that is provided by MongoDB Atlas.
