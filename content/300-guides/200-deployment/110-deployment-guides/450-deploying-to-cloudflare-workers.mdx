...
<Admonition type="info">
  You need to pin `ts-loader` for the Wrangler CLI to work properly. See{' '}
  <a href="https://github.com/cloudflare/wrangler/issues/1927">this issue</a>{' '}
  for more details.
</Admonition>
...
## 8. Enable the Prisma Data Proxy
