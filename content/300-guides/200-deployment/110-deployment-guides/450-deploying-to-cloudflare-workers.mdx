...
This will create a Prisma Schema in `prisma/schema.prisma`.
...
With Cloudflare Workers, you can't directly access your database because there is no TCP support. Fortunately, Prisma has your back with the [Prisma Data Proxy](/concepts/data-platform/data-proxy).
...
Next you'll generate a Prisma Client that connects through the [Data Proxy](/concepts/data-platform/data-proxy) over HTTP.
