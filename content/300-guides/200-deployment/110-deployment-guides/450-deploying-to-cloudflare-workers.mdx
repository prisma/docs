...
When you import your project in the Prisma Data Platform at [step 8](#8-import-your-project-into-the-prisma-data-platform), you must provide a connection string that includes a collection name.
...
1. Set the Data Proxy connection string to your local environment `.env` file.
