...
You do not need to manually create the database in MongoDB Atlas even if it does not yet exist. The project creation workflow in the Prisma Data Platform will create the database.
