...
1. From the repository root, run `netlify init`.
...
You can open your app now, but you may see errors when you use options that connect to the database. This is because Prisma will look to connect to your database, but if your connection string is setup as an environment variable [Netlify will not recognize it by default](https://docs.netlify.com/environment-variables/get-started/#work-with-env-files).
