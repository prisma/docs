...
![Prisma Netlify GitHub architecture diagram](images/500-01-deploying-to-netlify-application-with-prisma-frontend-backend-deploy-to-netlify-architecture.png)
...
- a [Netlify](https://app.netlify.com/signup) account connected to your GitHub account (Netlify needs access to the repository you will create as part of this guide).
...
When you run `ls -1` from the cloned folder, you should see the following result.
