...
The focus of this guide is showing how Prisma integrates with Netlify. The starting point will the [Prisma Netlify example](https://github.com/prisma/deployment-example-netlify) which has a couple of REST endpoints pre-configured as serverless functions and a static HTML page.
