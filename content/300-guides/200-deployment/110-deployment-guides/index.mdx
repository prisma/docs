...
- [Firebase Cloud Functions](https://github.com/prisma/e2e-tests/tree/dev/platforms-serverless/firebase-functions)
- [GCP Cloud Functions](https://github.com/prisma/e2e-tests/tree/dev/platforms-serverless/gcp-functions)
