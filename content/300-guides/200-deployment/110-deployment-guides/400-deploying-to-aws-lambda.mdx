...
** push vs. migrate - link to a doc that explains the difference: /concepts/components/prisma-migrate/db-push#choosing-db-push-or-prisma-migrate For this guide, we use db push. In a production situation, you would use migrate. **
