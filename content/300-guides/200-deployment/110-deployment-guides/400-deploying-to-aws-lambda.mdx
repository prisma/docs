...
metaDescription: 'Learn how to deploy Node.js and TypeScript applications that use Prisma Client to AWS Lambda.'
---

<TopBlock>

This guide explains how to set up a serverless Node.js REST API and deploy it to [AWS Lambda](https://aws.amazon.com/lambda/) with the Serverless Framework.
