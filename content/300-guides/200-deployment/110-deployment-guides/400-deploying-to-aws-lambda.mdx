...
When you have the _Access key ID_ and a _Secret access key_, set them with the following command. Replace the placeholders with your Access key ID and Secret access key.
