...
You can now run `prisma generate` to generate Prisma Client based on your new Prisma schema. Whenever you make changes to your Prisma schema, invoke `prisma generate` to update your Prisma Client API.
