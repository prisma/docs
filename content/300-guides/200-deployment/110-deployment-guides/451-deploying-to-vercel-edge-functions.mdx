---
title: 'Deploying to Verce Edge Functions'
metaTitle: 'Deploying to Verce Edge Functions'
metaDescription: 'Learn how to deploy a TypeScript application to Verce Edge Functions'
---
