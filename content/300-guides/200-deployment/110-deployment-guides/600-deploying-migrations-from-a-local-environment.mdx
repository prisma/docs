...
- You are [baselining](/guides/migrations/developing-with-prisma-migrate/add-prisma-migrate-to-a-project#baseline-your-production-environment) a production environment
...
When you add Prisma Migrate to an **existing database**, you must [baseline](/guides/migrations/developing-with-prisma-migrate/add-prisma-migrate-to-a-project#baseline-your-production-environment) the production database. Baselining is performed **once**, and can be done from a local instance.
