...
- You are [baselining](../../database/developing-with-prisma-migrate/add-prisma-migrate-to-a-project#baseline-your-production-environment) a production environment
...
2. Swap your local connection string for your production connection string

```js file=.env highlight=1;delete|3;add
...
⛔ <strong>We stongly discourage this solution due to the following reasons</strong> 
</div>
...
When you add Prisma Migrate to an **existing database**, you must [baseline](../../database/developing-with-prisma-migrate/add-prisma-migrate-to-a-project#baseline-your-production-environment) the production database. Baselining is performed **once**, and can be done from a local instance.
