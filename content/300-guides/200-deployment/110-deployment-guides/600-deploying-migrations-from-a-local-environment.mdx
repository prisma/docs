...
- You are [baselining](../../application-lifecycle/add-prisma-migrate-to-a-project#baseline-your-production-environment) a production environment
...
When you add Prisma Migrate to an **existing database**, you must [baseline](../../application-lifecycle/add-prisma-migrate-to-a-project#baseline-your-production-environment) the production database. Baselining is performed **once**, and can be done from a local instance.
