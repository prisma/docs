...
The focus of this guide is showing how Prisma can be used with Next.js and Vercel. The starting point will be the [Prisma Vercel example](https://github.com/prisma/deployment-example-vercel), which has a couple of serverless REST endpoints pre-configured as [Next.js API Routes](https://nextjs.org/docs/api-routes/introduction) and a Next.js page.
