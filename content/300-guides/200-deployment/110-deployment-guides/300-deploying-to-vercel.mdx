...
############# DATA PROXY edit start ############

Open https://github.com/prisma/deployment-example-vercel/tree/data-proxy in your browser.
...
Pick a repository name. This will be the name of the cloned repository in your GitHub account.
...
Before you can fill in these values you actually have to create them first:

1. Open could.prisma.io and log in
2. Create a new project
3. Select the repository from your GitHub account that you just created via Vercel
4. Choose that you have an existing database and provide your PostgreSQL connection string
5. Click the buttons to get to the page with the 2 invisible connection strings
6. Copy the first one into `DATABASE_URL`, and the second one into `MIGRATE_DATABASE_URL`
7. Set `PRISMA_GENERATE_DATAPROXY` to `true`
