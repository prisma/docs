...
metaDescription: 'Learn how to deploy a Next.js app with a serverless REST API, with Prisma Client to Vercel.'
---
...
If you use [vercel/pkg](https://github.com/vercel/pkg) to package your Node.js project, then you might encounter an error like the following at the bundle stage:
