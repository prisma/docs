...
metaDescription: 'Learn how to deploy to Vercel a Next.js app that uses a serverless REST API in conjunction with Prisma Client.'
---
...
![architecture diagram](images/300-01-deploy-to-vercel-architecture.png)
...
![Vercel deploy button](images/300-02-deploy-to-vercel-repo-deploy-button.png)

Vercel prompts you to clone the repository:

![Vercel Clone repository](images/300-03-deploy-to-vercel-clone-git-repo.png)
...
![Vercel configure project](images/300-04-deploy-to-vercel-configure-project.png)
...
![Vercel Build](images/300-05-deploy-to-vercel-deploy-in-progress.png)
...
![Vercel Completed Build](images/300-06-deploy-to-vercel-successful-deploy.png)
...
![deployed-screenshot](images/300-07-deploy-to-vercel-prisma-app-example.png)
...
![Vercel environment variables](images/300-08-deploy-to-vercel-project-settings.png)

Click the three vertical dots on the right of the `DATABASE_URL`, and select **edit**:

![Vercel env var options](images/300-09-deploy-to-vercel-open-environment-variables.png)

Uncheck the **Preview** checkbox:

![Vercel env var options](images/300-10-deploy-to-vercel-set-environment-variable.png)
