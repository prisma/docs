...
1. Add the `prisma` package to your `dependencies` instead of the `devDependencies`. (Making sure to run `npm install` afterwards to update the `package.lock.json`).
