...
Sign up for the Prisma Data Platform and add your application as a project so that you can enable the [Data Proxy](/data-platform/data-proxy) for the project.
