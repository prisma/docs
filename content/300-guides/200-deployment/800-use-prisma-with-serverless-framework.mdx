...
If you use Prisma with AWS Lambda, you can use the [Serverless Framework](https://www.serverless.com/framework/) to help deploy your projects. It provides a CLI that helps with workflow automation and AWS resource provisioning. For an introduction, see [our AWS Lambda and Serverless Framework deployment guide](/guides/deployment/serverless/deploy-to-aws-lambda).
