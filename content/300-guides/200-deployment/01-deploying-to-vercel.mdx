...
Now that the database schema has been created and the `DATABASE_URL` environment variables has been created on Vercel, you will connect your GitHub repository to Vercel and deploy the app.
