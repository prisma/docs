...
![architecture diagram](../images/netlify-architecture.png)
...
![fork button](../images/netlify-fork.png)
...
![Running netlify init to configure a new Netlify site](../images/netlify-init.png)
...
![Netlify admin UI](../images/netlify-admin-ui.png)
...
![deployed-screenshot](../images/netlify-deployed.png)
...
![deployed-screenshot](../images/netlify-deployed-seed.png)
...
Generally, when using a FaaS (function as a service) environment to interact with a database, it's beneficial to pool DB connections for performance reasons. This is because every function invocation may result in a new connection to the database (this is not a problem with a constantly running node.js server). For more information on some of the solutions, you may want to look at our [serverless deployment guide](deployment#serverless-faas).
