...
- Limiting the connection pool of the query engine with the database as described in [connection management](../../../concepts/components/prisma-client/working-with-prismaclient/  connection-pool)
...
## <inlinecode>PrismaClient</inlinecode> instances

## Additional serverless considerations
