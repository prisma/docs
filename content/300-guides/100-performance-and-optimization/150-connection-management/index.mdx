...
Connection poolers like the [Prisma Accelerate](https://www.prisma.io/data-platform/accelerate) and PgBouncer prevent your application from exhausting the database's connection limit.
...
[Prisma Accelerate](/data-platform/accelerate) is a managed external connection pooler and global cache built by Prisma that is integrated in the [Prisma Data Platform](https://console.prisma.io) and handles connection pooling for you.
