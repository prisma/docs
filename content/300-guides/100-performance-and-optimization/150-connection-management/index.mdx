...
The [Prisma Data Proxy](/data-platform/data-proxy) is a managed external connection pooler built by Prisma that is integrated in the [Prisma Data Platform](https://www.prisma.io/dataplatform) and handles connection pooling for you.
