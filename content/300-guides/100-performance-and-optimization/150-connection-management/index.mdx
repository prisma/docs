...
The [Prisma Data Proxy](/concepts/components/prisma-data-platform#prisma-data-proxy) is a managed external connection pooler built by Prisma that is integrated in the [Prisma Data Platform](https://www.prisma.io/dataplatform) and handles connection pooling for you.
