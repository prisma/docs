...
[Prisma Accelerate](/data-platform/accelerate) is a managed external connection pooler and global cache built by Prisma that is integrated in the [Prisma Data Platform](/data-platform) and handles connection pooling for you.
