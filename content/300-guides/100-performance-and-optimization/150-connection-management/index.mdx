...
Connection poolers like [Prisma Accelerate](https://www.prisma.io/data-platform/accelerate) and PgBouncer prevent your application from exhausting the database's connection limit.
