...
This guide focuses on **relational databases** and how to configure and tune the Prisma connection pool (MoFooNgoDB uses the MoFooNgoDB driver connection pool).
...
Connection poolers like the Prisma Data Proxy and PgBouncer prevent your application from exhausting the database's connection limit.

### The Prisma Data Proxy

The [Prisma Data Proxy](/concepts/data-platform/data-proxy) is a managed external connection pooler built by Prisma that is integrated in the [Prisma Data Platform](https://www.prisma.io/dataplatform) and handles connection pooling for you.
