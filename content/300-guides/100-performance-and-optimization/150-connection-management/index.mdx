...
More information about the `directUrl` field can be found [here](/reference/api-reference/prisma-schema-reference#:~:text=the%20shadow%20database.-,directUrl,-No).
