...
<Admonition type="info">
  Note: When you send data to StatsD, you must send both Prisma counter and gauge
...
The following example shows how to combine Prisma metrics with another Prometheus client library:
