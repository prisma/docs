...
title: Metrics
metaTitle: Metrics
metaDescription: 'Use Metrics to diagnose application performance with insights into Prisma Client database activity'
toc: true
tocDepth: 2
---
...
Prisma metrics give you a deep insight into what the Prisma Client is doing when it interacts with your database. You can export metrics in JSON or Prometheus formats to integrate them into a current metric system or to view in a console log.
