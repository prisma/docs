...
Consider each occurence of the Prisma client instance `prisma` and replacing with the respective usage of Prisma Client 2. You can learn more in the [API Reference](https://www.prisma.io/docs/concepts/components/prisma-client/api).
