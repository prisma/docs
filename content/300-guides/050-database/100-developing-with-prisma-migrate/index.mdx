...
> **Prototyping?** Use the [`db push`](../../../reference/api-reference/command-reference#db-push--preview) command if you are [prototyping](../prototyping-schema-db-push) and are not concerned with data loss or replicating your changes in other environments. You can start or continue your migration history when you are happy with your changes.
