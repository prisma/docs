...
> **Prototyping?** Use the [`db push`](/reference/api-reference/command-reference#db-push) command if you are [prototyping](/guides/prototyping-schema-db-push) and are not concerned with data loss or replicating your changes in other environments. You can start or continue your migration history when you are happy with your changes.
