...
model User {
  ...
  email            String  @unique
  name             String?
  favouriteColor   String? // Added by Ania
...
Your `schema.prisma` and local database now includes your team's changes, and the migration history includes your migration:
