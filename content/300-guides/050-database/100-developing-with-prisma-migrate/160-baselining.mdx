...
To baseline a database, run the `prisma migrate resolve` command for each migration that should be ignored.

```terminal
npx prisma migrate resolve --applied initial-migration-for-db
```
