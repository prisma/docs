...
**Tip**: The Prisma schema is able to represent [unsupported field types](../../../concepts/components/prisma-schema/features-without-psl-equivalent#unsupported-field-types) <span class="concept"></span> and [native database functions](enable-native-database-functions).
