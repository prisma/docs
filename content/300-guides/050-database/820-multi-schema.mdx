...
Multiple database schema support is currently available with the PostgreSQL and CockroachDB connectors.
...
In PostgreSQL and CockroachDB, these groups are known as schemas. We will refer to them as _database schemas_ to distinguish them from Prisma's own schema file.
