...
The workaround described in this guide is by no means a best practice, it instead fills in some gaps for missing functionality in Prisma. 
...
- Prisma Migrate will treat these views as tables and try to create them, this can lead to crashes. If you have view models, you **cannot** use Prisma Migrate with them.
