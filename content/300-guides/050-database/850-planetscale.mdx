...
You can then use Prisma Client as you normally would with full type-safety. Prisma Migrate, introspection, and Prisma Studio will work continue working as before using the connection string defined in the Prisma schema.
