...
1. Create a new file named `seed.ts` in the same loction as your `schema.prisma`.
...
1. Create a new file named `seed.js` in the same loction as your `schema.prisma`.
