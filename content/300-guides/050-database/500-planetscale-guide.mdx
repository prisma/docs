...
When connecting to PlanetScale with Prisma, you will need to use the correct connection string for your branch. To find
...
See the Prisma's [Getting Started guide](/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-typescript-planetscale) for more details of how to connect to a PlanetScale database.
...
## Getting started with PlanetScale and Prisma

The fastest way to start using PlanetScale with the Prisma ORM is to refer to our Getting Started documentation:
...
For further information on how to use Prisma and PlanetScale together, watch our video on [Best Practices when using Prisma with PlanetScale](https://www.youtube.com/watch?v=iaHt5_hg44c).
