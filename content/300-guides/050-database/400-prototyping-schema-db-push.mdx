...
Although `db push` and Prisma Migrate both synchronize your Prisma schema and database schema, they play [different roles in the development workflow](/concepts/components/prisma-migrate/schema-prototyping#choosing-db-push-or-prisma-migrate) and should not be used interchangeably.
