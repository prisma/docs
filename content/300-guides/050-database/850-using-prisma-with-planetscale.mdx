...
In Prisma versions 4.7.0 and later, Prisma will warn you if you have a relation with no index on the relation scalar field. For more information, see [Index validation](/concepts/components/prisma-schema/relations/relation-mode#index-validation) in the relation mode documentation.
