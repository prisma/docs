...
From version 4.3.0, you do not need to use raw queries to compare columns in the same table. [Learn more](/reference/api-reference/prisma-client-reference#compare-columns-in-the-same-table)
