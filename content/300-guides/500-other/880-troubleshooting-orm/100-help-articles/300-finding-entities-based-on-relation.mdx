...
### Query based on existence of a list relation

<Admonition type="info">

A list relation refers to a "-to-many" relation
...
### Query based on existence of a singular relation

<Admonition type="info">

A singular relation refers to a "-to-one" relation

</Admonition>

You can also query for the **posts that do not have any author** as follows:
...
The query above returns all posts that don't have a author yet.
