...
Users sometimes encounter situations where they need to transition from implicit many-to-many relationships between models to explicit ones. This guide provides a step-by-step walkthrough on how to make that conversion.
...
Consider these models with an implicit many-to-many relation:
...
Once we create the join table, we need to update our existing models that now look like this:
