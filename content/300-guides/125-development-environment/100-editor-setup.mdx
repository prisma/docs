...
`inshellisense` is built on top of [Fig](https://fig.io/) <a href="https://fig.io/" target="_blank"><img src="https://fig.io/badges/Logo.svg" width="15" height="15"/></a> which you can also use directly. It works in bash, zsh, and fish.
