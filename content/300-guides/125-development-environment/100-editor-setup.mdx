...
You can get support for Prisma in WebStorm and other JetBrains IDEs, including PhpStorm, IntelliJ IDEA Ultimate, and PyCharm Professional. For this, install the [official Prisma plugin](https://plugins.jetbrains.com/plugin/20686-prisma-orm) from Preferences / Settings | Plugins - Marketplace.
