...
<!-- This needs to be a HTML link as Markdown links are turned into all lowercase, which does not work for this link -->
- <a href="https://extensions.panic.com/extensions/robb-j/robb-j.Prisma/">nova</a> provides syntax highlighting of the Prisma Schema Language and uses the Prisma Language Server.
