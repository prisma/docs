...
- [Prisma](https://plugins.jetbrains.com/plugin/20686-prisma-orm) provides syntax highlighting of the Prisma Schema Language and uses the Prisma Language Server.
