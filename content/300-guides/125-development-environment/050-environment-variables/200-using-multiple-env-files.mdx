...
When running tests we advise you to [mock the Prisma Client](/prisma-orm/testing/unit-testing#mocking-the-prisma-client), in doing so you need to tell Jest which environment it should use when running its tests.
