...
When running tests, we advise you to [mock Prisma Client](/guides/testing/unit-testing#mocking-prisma-client). In doing so, you need to tell Jest which environment it should use when running its tests.
