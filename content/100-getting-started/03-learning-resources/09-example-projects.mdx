...
A directory of example and realistic projects that use Prisma.

</TopBlock>

## Realistic, production-ready example projects

The following open source projects demonstrate usage of Prisma in **real world applications**. If your production application uses Prisma and is OSS open source, feel free to [open a PR and add it to the list](https://github.com/prisma/docs/tree/main/content/100-getting-started/03-learning-resources/09-example-projects.mdx):
...
| [`graphql-nextjs`](https://github.com/prisma/prisma-examples/tree/latest/typescript/graphql-nextjs)                 | [Next.js](https://nextjs.org/) app (React) with a GraphQL API (using [Apollo Server](https://github.com/apollographql/apollo-server) and [GraphQL Nexus](https://github.com/graphql-nexus/nexus)) |
...
| [`postgis-express`](https://github.com/prisma/prisma-examples/tree/latest/typescript/postgis-express)             | Demo of spatial queries using [Postgis](https://postgis.net/) and [Express](https://expressjs.com/)                                                                                   |
