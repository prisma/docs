...
### 2.4. Update Prisma schema for ESM

Update your `prisma/schema.prisma` file to use the ESM-first `prisma-client` generator with a custom output path:
...
### 2.5. Create a TypeScript script
