...
If you encounter any issues during the migration, please don't hesitate to reach out to us on [Discord](https://pris.ly/discord?utm_source=docs&utm_medium=generated_text_cta) or via [X](https://pris.ly/x?utm_source=docs&utm_medium=generated_text_cta).