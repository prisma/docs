...
This guide shows you how to migrate your Prisma Postgres Early Access (EA) database running on PostgreSQL 16 to the Prisma Postgres General Availability (GA) database running on PostgreSQL 17. Prisma Postgres Early Access was introduced to allow early adopters to test Prisma’s new managed PostgreSQL service. As we move to GA, it's crucial to safely migrate data from your EA database (PostgreSQL 16) to the new GA database (PostgreSQL 17).
