...
In the third step, you will be using the [TCP tunnel](/postgres/database/direct-connections#tcp-tunnel-deprecated) to securely connect to your Prisma Postgres database during to run `pg_restore`.
...
In this step, you'll use the [TCP tunnel](/postgres/database/direct-connections#tcp-tunnel-deprecated) to connect to your Prisma Postgres instance and import data via `pg_restore`.
