...
Run the following command to create a new Prisma Postgres instance:
...
Once the command completed, you can view and manage your database in [Prisma Console](https://console.prisma.io).
