...
For the most up-to-date installation and configuration details, see the [Kysely documentation](https://kysely.dev/docs/getting-started).
...
Learn more about Kysely in the [Kysely documentation](https://kysely.dev/docs/intro).
