...
The  [`src/realtime.ts`](https://github.com/prisma/prisma-examples/blob/latest/databases/prisma-postgres/src/realtime.ts) script contains a demo for receiving real-time change [events](/pulse/database-events) from your database. 
