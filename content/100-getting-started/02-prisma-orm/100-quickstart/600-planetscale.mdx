---
title: 'PlanetScale'
metaTitle: 'Quickstart: Prisma ORM with PlanetScale (5 min)'
...
PlanetScale is a serverless MySQL-compatible database platform. In this guide, you will learn how to set up a new TypeScript project from scratch, connect it to PlanetScale using Prisma ORM, and generate a Prisma Client for easy, type-safe access to your database.
