...
```terminal copy
curl https://pris.ly/quickstart -L -o master.tar.gz && tar -zxvf master.tar.gz quickstart-master/javascript/starter && move quickstart-master\javascript\starter starter && rmdir /S /Q quickstart-master && del /Q master.tar.gz
```
