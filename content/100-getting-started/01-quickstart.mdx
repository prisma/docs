...
You can send a variety of queries with the Prisma Client API. Check out the [API reference](../concepts/components/prisma-client/api) and use your existing SQLite-based setup from this guide to try them out.
