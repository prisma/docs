...
- `prisma/schema.prisma`: [Prisma schema file](../concepts/components/prisma-schema) defining your models
...
In this section, you will write your first query with Prisma Client. For reference, this is what the [Prisma schema](../concepts/components/prisma-schema) looks like that your Prisma Client was generated from:
...
This updates your [Prisma schema](../concepts/components/prisma-schema) in `prisma/schema.prisma`.

Note that after the introspection, you might want to [configure your  Prisma Client API](../concepts/components/prisma-client/configuring-the-prisma-client-api).

<details><summary><strong>Alternative</strong>: Use Prisma Migrate (Experimental)</summary>

Changing your database schema using [Prisma Migrate](../concepts/components/prisma-migrate) typically happens with the following steps.
...
This updates the generated Prisma Client library in [`node_modules/@prisma/client`](../concepts/components/prisma-client/generating-prisma-client#the-prismaclient-npm-package).
