...
[Prisma Pulse](/pulse) enables you to stream change events from your database in a type-safe way. Here are some example projects that show what you can build with it:
...
[Prisma Accelerate](/accelerate) is a connection pooler and global database cache that can drastically speed up your database queries. Check out the [Speed Test]() or try Accelerate with your favorite framework:
