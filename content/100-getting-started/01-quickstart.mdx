...
- [Set up a new project with Prisma from scratch](setup-prisma/start-from-scratch-typescript-postgres)
- [Add Prisma to an existing project](setup-prisma/add-to-existing-project-typescript-postgres)
