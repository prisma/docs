...
If you're looking to incorporate Prisma with an **existing project**, then the aptly named [Add to existing project](./setup-prisma/add-to-existing-project) guide will show you how.
