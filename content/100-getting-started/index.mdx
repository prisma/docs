...
[**<PrismaPostgres />Prisma Postgres**](/orm/overview/databases/prismaPostgres) is a managed PostgreSQL service that gives you an _always-on_ database pay-as-you-go pricing. Prisma Postgres is currently in [Early Access](/platform/maturity-levels#early-access).
