...
[**<PrismaPostgres />Prisma Postgres**](/orm/overview/databases/prisma-postgres) is a managed PostgreSQL service that gives you an _always-on_ database with _pay-as-you-go_ pricing. Prisma Postgres is currently in [Early Access](/platform/maturity-levels#early-access).
