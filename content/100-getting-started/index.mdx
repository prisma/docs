...
### Easily explore Prisma ORM with a SQLite database

_These options don't require you to have your own database server running._
...
Make your app faster by scaling your database connections and caching database results at the edge.
