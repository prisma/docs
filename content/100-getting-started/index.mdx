...
[**<Inspect />Prisma Optimize**](/optimize/) helps you to analyze queries, generate insights and provides recommendations that can be used to make your database queries faster.
