...
In addition to Prisma ORM, you can use the products of the [Prisma Console](https://console.prisma.io) for different use cases:

- [**Prisma Accelerate**](/data-platform/accelerate/what-is-accelerate): A scalable connection pool and global database cache.
