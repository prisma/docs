...
If you're looking to incorporate Prisma with an **existing project**, then the aptly named [Add to existing project](./setup-prisma/add-to-existing-project/relational-databases-typescript-postgres) guide will show you how.
...
To learn how to **create a project** with Prisma from scratch, the [Start from scratch](./setup-prisma/start-from-scratch/relational-databases-typescript-postgres) section guides you through creating a project, connecting your database and querying your data.
