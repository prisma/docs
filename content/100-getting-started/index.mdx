...
[**<PrismaPostgres />Prisma Postgres**](/orm/overview/databases/prisma-postgres) (Early Access) is a managed PostgreSQL service that gives you an _always-on_ database pay-as-you-go pricing.
