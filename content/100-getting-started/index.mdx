...
[**<PrismaPostgres />Prisma Postgres**](/orm/overview/databases/prisma-postgres) is a managed PostgreSQL service that gives you an _always-on_ database pay-as-you-go pricing. Prisma Postgres is currently in [Early Access](/platform/maturity-levels#early-access).
...
_Explore all Prisma products at once._
  ...
  <LinkCard
    ...
    desc="Create a new database, model your data, run migrations, send queries and observe real-time database change events in this comprehensive 5 minute tutorial."
    link="/getting-started/quickstart-prisma-postgres"
  />
...
<TabbedContent>
  <TabItem value="New database">
    ...
    <List>
      <SquareLogo
        url="/getting-started/setup-prisma/start-from-scratch/relational-databases-typescript-prisma-postgres"
        image={'/img/technologies/prisma-postgres.svg'}
