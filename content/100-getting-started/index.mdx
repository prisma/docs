...
To learn how to **create a project** with Prisma from scratch, the [Start from scratch](./setup-prisma/start-from-scratch-typescript-postgres) section guides you through creating a project, connecting your database and querying your data.
