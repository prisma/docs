...
These changes are relevant for the generated Prisma Client API where using lowercased relation fields `author`, `posts`, `profile` and `user` will feel more natural and idiomatic to JavaScript/TypeScript developers. You can therefore [configure your Prisma Client API](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/customizing-the-prisma-client-api).
...
Learn more about this on the [Configuring your Prisma Client API](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/customizing-the-prisma-client-api) page.
