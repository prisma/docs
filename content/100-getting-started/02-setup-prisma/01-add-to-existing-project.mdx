...
techMetaDescriptions:
  [
    {
      name: 'node-postgres',
      value: 'Learn how to add Prisma to an existing Node.js project by connecting it to your PostgreSQL database and generating Prisma Client for database access.',
    },
    {
      name: 'typescript-postgres',
      value: 'Learn how to add Prisma to an existing TypeScript project by connecting it to your PostgreSQL database and generating Prisma Client for database access.',
    },
    {
      name: 'node-mysql',
      value: 'Learn how to add Prisma to an existing Node.js project by connecting it to your MySQL database and generating Prisma Client for database access.',
    },
    {
      name: 'typescript-mysql',
      value: 'Learn how to add Prisma to an existing TypeScript project by connecting it to your MySQL database and generating Prisma Client for database access.',
    },
  ]
---
...
These changes are relevant for the generated Prisma Client API where using lowercased relation fields `author`, `posts`, `profile` and `user` will feel more natural and idiomatic to JavaScript/TypeScript developers. You can therefore [configure your Prisma Client API](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/use-custom-model-and-field-names-api).
...
If you don't want to use the table and column names from your database in your Prisma Client API, you can configure them with [`@map` and `@@map`](../../concepts/components/prisma-schema/data-model#mapping-model-names-to-tables):
...
Learn more about this on the [Configuring your Prisma Client API](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/use-custom-model-and-field-names-api) page.
...
Notice that the [`@prisma/client` node module](../../concepts/components/prisma-client/configuring-and-initializing-prisma-client/generating-prisma-client#the-prismaclient-npm-package) references a folder named `.prisma\client`. The `.prisma\client` folder contains your generated Prisma client, and is modified each time you change the schema and run the following command:
...
![Introspect workflow](https://imgur.com/ToNkpb2.png)
