...
In this section, you will evolve your Prisma schema and then generate and apply the migration to your database with [`prisma migrate dev`](/reference/api-reference/prisma-cli/command-reference#migrate-dev).
