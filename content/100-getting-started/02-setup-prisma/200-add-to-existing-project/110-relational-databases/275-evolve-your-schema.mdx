...
If you would like to modify the structure of your database schema, you can do so by:

1. Defining the change in your Prisma schema
1. Generating and applying the migration to your database using [`prisma migrate dev`](/reference/api-reference/command-reference#migrate-dev)
...
To map the data model to the database schema you you need to use the `prisma migrate dev` CLI command:
