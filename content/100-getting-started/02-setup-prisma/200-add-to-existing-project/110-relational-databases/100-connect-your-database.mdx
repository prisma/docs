...
For a CockroachDB Serverless database hosted on CockroachDB Cloud, the [connection URL](/reference/database-reference/connection-urls) looks similar to this:
...
For a CockroachDB Dedicated database hosted on CockroachDB Cloud, the [connection URL](/reference/database-reference/connection-urls) looks similar to this:

```bash file=.env
DATABASE_URL="postgresql://<myusername>@<mycluster>-<short-id>.<region>.cockroachlabs.cloud:26257/<database>?sslmode=verify-full&sslrootcert='$HOME'/Library/CockroachCloud/certs/<mycluster>-ca.crt"
```
...
For a CockroachDB database hosted locally, the [connection URL](/reference/database-reference/connection-urls) looks similar to this:
