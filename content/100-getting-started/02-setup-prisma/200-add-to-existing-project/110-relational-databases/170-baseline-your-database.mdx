...
To baseline your database, use [`prisma migrate diff`](/reference/api-reference/prisma-cli/command-reference#migrate-diff) to compare your schema and database, and save the output into a SQL file.
