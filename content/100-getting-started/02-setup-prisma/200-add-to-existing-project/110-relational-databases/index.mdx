...
If you're migrating from another ORM to Prisma check out the [TypeORM](/guides/migrate-to-prisma/migrate-from-typeorm) or [Sequelize](/guides/migrate-to-prisma/migrate-from-sequelize) migration guides.
