...
If you want to learn how to migrate from other ORMs to Prisma, check out our [TypeORM](/guides/migrate-to-prisma/migrate-from-typeorm) and [Sequelize](/guides/migrate-to-prisma/migrate-from-sequelize) migration guides.
