...
metaDescription: 'Learn how to add Prisma to an existing Node.js or TypeScript project by connecting it to your relational database and generating Prisma Client for database access.'
duration: '15 min'
toc: false
...
<ButtonLink color="dark" type="primary" href="./relational-databases/connect-your-database-node-postgres" arrow>
...
<ButtonLink color="dark" type="primary" href="./relational-databases/connect-your-database-node-mysql" arrow>
    Connect your database
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./relational-databases/connect-your-database-typescript-postgres" arrow>
    Connect your database
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./relational-databases/connect-your-database-typescript-mysql" arrow>
    Connect your database
</ButtonLink>
