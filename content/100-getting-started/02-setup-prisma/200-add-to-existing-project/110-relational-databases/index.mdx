...
- creates the `.env` file in the root directory of the project, which is a [dotenv](https://github.com/motdotla/dotenv) file used for defining environment variables (such as your database connection)
