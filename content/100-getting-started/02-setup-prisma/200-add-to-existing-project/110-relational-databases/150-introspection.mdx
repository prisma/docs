...
```prisma file=prisma/schema.prisma highlight=7,14,22,23;edit copy
model Post {
  id        Int      @id @default(autoincrement())
  title     String   @db.VarChar(255)
  createdAt DateTime @default(now()) @db.Timestamp(6)
...
```prisma file=prisma/schema.prisma highlight=8,17,27,28;add copy
model Post {
  id        Int      @id @default(autoincrement())
  createdAt DateTime @default(now())
  updatedAt DateTime
...
```prisma file=prisma/schema.prisma highlight=8,15,22,23;edit copy
model Post {
  id        BigInt   @id(map: "primary") @default(autoincrement())
  title     String   @unique @db.VarChar(255)
  createdAt DateTime @default(now()) @db.Timestamp(6)
