...
[Introspections](../../../../concepts/components/introspection) are often used to get an initial version of your data model when adding Prisma to an existing project. 
...
Your data structure will of course be different, but for this tutorial we will assume you are working with the following models: `User`, `Post` and `Comment`.
...
<ButtonLink color="dark" type="primary" href="./connect-your-database-node-mongodb" arrowLeft>
    Connect your database
</ButtonLink>

<ButtonLink color="dark" type="primary" href="./install-prisma-client-node-mongodb" arrow>
...
<ButtonLink color="dark" type="primary" href="./connect-your-database-typescript-mongodb" arrowLeft>
    Connect your database
</ButtonLink>

<ButtonLink color="dark" type="primary" href="./install-prisma-client-typescript-mongodb" arrow>
    Install Prisma Client
</ButtonLink>
