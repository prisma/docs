...
- Access to a MongoDB 4.2+ server with a replica set deployment. We recommend using [MongoDB Atlas](https://www.mongodb.com/cloud/atlas).
  ...
  The MongoDB database connector **requires** a [replica set](https://docs.mongodb.com/manual/tutorial/deploy-replica-set/) deployment in order to support transactions - you cannot connect to a [standalone deployment](https://docs.mongodb.com/kubernetes-operator/master/tutorial/deploy-standalone/).
