...
If you are using Mongo Atlas you need to append `?authSource=admin` to the connection URL. Atlas uses a slightly different connection string than a regular MongoDB instance.
