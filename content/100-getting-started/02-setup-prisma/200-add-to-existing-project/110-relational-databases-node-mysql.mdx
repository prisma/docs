...
description: 'Learn how to add Prisma to an existing Node.js or TypeScript project by connecting it to your relational database and generating a Prisma Client for database access.'
...
Next, set up your Prisma ORM project by creating your [Prisma schema](/orm/prisma-schema) file template with the following command:
