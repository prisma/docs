...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/add-to-existing-project-node-postgres" arrowLeft>
    Installation
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/add-to-existing-project-node-mysql" arrowRight>
    Installation
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/add-to-existing-project-typescript-postgres" arrowLeft>
    Installation
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/add-to-existing-project-typescript-mysql" arrowRight>
    Installation
</ButtonLink>
