...
metaTitle: 'Start from scratch with relational databases (15 min): JavaScript and PlanetScale'
metaDescription: 'Learn how to create a new Node.js project from scratch by connecting Prisma to your PlanetScale database and generating a Prisma Client for database access.'
