...
metaTitle: 'Start from scratch with relational databases (15 min): JavaScript and CockroachDB'
metaDescription: 'Learn how to create a new Node.js project from scratch by connecting Prisma to your CockroachDB database and generating a Prisma Client for database access.'
