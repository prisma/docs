...
metaTitle: 'Start from scratch with relational databases (15 min): TypeScript and MySQL'
metaDescription: 'Learn how to create a new TypeScript project from scratch by connecting Prisma to your MySQL database and generating a Prisma Client for database access.'
