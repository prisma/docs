...
<ButtonLink color="dark" type="primary" href="./start-from-scratch/connect-your-database-node-postgres" arrow>
...
<ButtonLink color="dark" type="primary" href="./start-from-scratch/connect-your-database-node-mysql" arrow>
    Connect your database
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./start-from-scratch/connect-your-database-typescript-postgres" arrow>
    Connect your database
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./start-from-scratch/connect-your-database-typescript-mysql" arrow>
    Connect your database
</ButtonLink>
