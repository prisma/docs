...
metaTitle: 'Start from scratch with relational databases (15 min): JavaScript and SQL Server'
metaDescription: 'Learn how to create a new Node.js project from scratch by connecting Prisma to your SQL Server database and generating a Prisma Client for database access.'
