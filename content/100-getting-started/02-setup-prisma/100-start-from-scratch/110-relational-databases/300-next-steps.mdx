...
metaDescription: 'Next steps to take now that you have successfully added Prisma ORM to your new TypeScript or Node.js project'
...
<TabItem value="TypeScript" table>
...
<TabItem value="JavaScript (Node.js)" table>
