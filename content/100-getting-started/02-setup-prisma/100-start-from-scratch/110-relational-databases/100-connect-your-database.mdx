...
```bash file=.env
DATABASE_URL="mysql://johndoe:randompassword@localhost:3306/mydbschema"
```
...
```bash file=.env
DATABASE_URL="mysql://johndoe:XXX@mysql–instance1.123456789012.us-east-1.rds.amazonaws.com:3306/mydbschema"
```

When running MySQL locally, your connection URL typically looks similar to this:

```bash file=.env
DATABASE_URL="mysql://root:randompassword@localhost:3306/mydbschema"
```
