...
<SwitchTech technologies={['node', 'cockroach']}>
...
<ButtonLink
  color="dark"
  type="primary"
  href="/getting-started/setup-prisma/start-from-scratch/relational-databases-node-cockroach"
  arrowLeft
>
  Installation
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./using-prisma-migrate-node-cockroach"
  arrow
>
  Using Prisma Migrate
</ButtonLink>
...
<SwitchTech technologies={['typescript', 'cockroach']}>
...
<ButtonLink
  color="dark"
  type="primary"
  href="/getting-started/setup-prisma/start-from-scratch/relational-databases-typescript-cockroach"
  arrowLeft
>
  Installation
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./using-prisma-migrate-typescript-cockroach"
  arrow
>
  Using Prisma Migrate
</ButtonLink>
