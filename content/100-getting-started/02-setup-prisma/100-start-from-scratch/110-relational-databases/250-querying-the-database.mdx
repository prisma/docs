...
<ButtonLink color="dark" type="primary" href="./install-prisma-client-node-postgres" arrowLeft>
...
<ButtonLink color="dark" type="primary" href="./install-prisma-client-node-mysql" arrowLeft>
    Install Prisma Client
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./install-prisma-client-typescript-postgres" arrowLeft>
    Install Prisma Client
</ButtonLink>

<ButtonLink color="dark" type="primary" href="./next-steps-typescript-postgres" arrow>
    Next Steps
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./install-prisma-client-typescript-mysql" arrowLeft>
    Install Prisma Client
</ButtonLink>

<ButtonLink color="dark" type="primary" href="./next-steps-typescript-mysql" arrow>
    Next Steps
</ButtonLink>
