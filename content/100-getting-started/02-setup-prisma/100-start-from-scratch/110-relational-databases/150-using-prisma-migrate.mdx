...
In this guide, you'll use Prisma's [`db push` command](/concepts/components/prisma-migrate/schema-prototyping) to create the tables in your database. Add the following Prisma data model to your Prisma schema in `prisma/schema.prisma`:
