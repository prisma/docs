...
<ButtonLink
  color="dark"
  type="primary"
  href="./connect-your-database-node-cockroach"
  arrowLeft
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./install-prisma-client-node-cockroach"
  arrow
>
  Install Prisma Client
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./connect-your-database-typescript-cockroach"
  arrowLeft
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./install-prisma-client-typescript-cockroach"
  arrow
>
  Install Prisma Client
</ButtonLink>
