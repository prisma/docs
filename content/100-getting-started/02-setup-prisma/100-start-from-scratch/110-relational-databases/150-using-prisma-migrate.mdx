...
You will then need to connect to PlanetScale using the [PlanetScale CLI](https://docs.planetscale.com/tutorials/automatic-prisma-migrations#:~:text=Install%20the-,PlanetScale%20CLI,-.). First, authenticate with the following command:
