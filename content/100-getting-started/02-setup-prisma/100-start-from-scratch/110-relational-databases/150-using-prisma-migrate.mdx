...
In this guide, you'll use [Prisma Migrate](/orm/prisma-migrate) to create the tables in your database. Add the following Prisma ORM data model to your [Prisma schema](/orm/prisma-schema) in `prisma/schema.prisma`:
