...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-node-postgres"
  arrowLeft
>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/install-prisma-client-node-postgres"
  arrow
>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-node-mysql"
  arrowRight
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/install-prisma-client-node-mysql"
  arrow
>
  Install Prisma Client
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-node-sqlserver"
  arrowRight
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/install-prisma-client-node-sqlserver"
  arrow
>
  Install Prisma Client
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-typescript-postgres"
  arrowLeft
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/install-prisma-client-typescript-postgres"
  arrow
>
  Install Prisma Client
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-typescript-mysql"
  arrowRight
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/install-prisma-client-typescript-mysql"
  arrow
>
  Install Prisma Client
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/connect-your-database-typescript-sqlserver"
  arrowRight
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases/install-prisma-client-typescript-sqlserver"
  arrow
>
  Install Prisma Client
</ButtonLink>
