...
metaDescription: 'Learn how to create a new Node.js or TypeScript project from scratch by connecting Prisma to your relational database and generating Prisma Client for database access.'
duration: '15 min'
toc: false
