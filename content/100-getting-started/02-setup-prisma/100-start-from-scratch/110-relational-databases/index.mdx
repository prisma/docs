...
dbSwitcher: ['postgres', 'mysql', 'sqlserver', 'planetscale', 'cockroach']
---
...
<SwitchTech technologies={['*', 'cockroach']}>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./relational-databases/connect-your-database-node-cockroach"
  arrow
>
  Connect your database
</ButtonLink>
...
<ButtonLink
  color="dark"
  type="primary"
  href="./relational-databases/connect-your-database-typescript-cockroach"
  arrow
>
  Connect your database
</ButtonLink>
