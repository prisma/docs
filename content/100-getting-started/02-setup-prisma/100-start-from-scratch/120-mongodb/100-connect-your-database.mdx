...
In this case, the `url` is [set via an environment variable](../../../../concepts/more/environment-variables) which is defined in `.env` (the example uses a [MongoDB Atlas](https://www.mongodb.com/cloud/atlas) URL):
...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/start-from-scratch/mongodb-node-mongodb" arrowLeft>
    Installation
</ButtonLink>

<ButtonLink color="dark" type="primary" href="./creating-the-prisma-schema-node-mongodb" arrow>
...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/start-from-scratch/mongodb-typescript-mongodb" arrowLeft>
    Installation
</ButtonLink>

<ButtonLink color="dark" type="primary" href="./creating-the-prisma-schema-typescript-mongodb" arrow>
    Creating the Prisma schema
</ButtonLink>
