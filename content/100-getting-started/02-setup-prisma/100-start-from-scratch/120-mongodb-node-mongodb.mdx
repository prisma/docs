---
title: 'MongoDB'
metaTitle: 'Start from scratch with MongoDB and JavaScript (15 min)'
metaDescription: 'Learn how to create a new Node.js project from scratch by connecting Prisma to your MongoDB database and generating a Prisma Client for database access.'
