...
<ButtonLink color="dark" type="primary" href="./start-from-scratch-node-postgres" arrowLeft>
    Installation
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="./start-from-scratch-node-mysql" arrowRight>
    Installation
</ButtonLink>
...
<ButtonLink color="dark" type="primary" href="/getting-started/setup-prisma/start-from-scratch-typescript-postgres" arrowLeft>
    Installation
</ButtonLink>
