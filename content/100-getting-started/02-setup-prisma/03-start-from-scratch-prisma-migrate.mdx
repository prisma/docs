...
techMetaTitles:
  [
    { name: 'node-postgres', value: 'Start from scratch | Migrate | Node.js & PostgreSQL' },
    { name: 'typescript-postgres', value: 'Start from scratch | Migrate | TypeScript & PostgreSQL' },
...
techMetaDescriptions: [
  {name: 'node-postgres', value: 'This page walks you through the process of setting up Prisma from scratch using Node.js and PostgreSQL. It uses Prisma Migrate to create tables in your database.'},
  {name: 'typescript-postgres', value: 'This page walks you through the process of setting up Prisma from scratch using TypeScript and PostgreSQL. It uses Prisma Migrate to create tables in your database.'},
  {name: 'node-mysql', value: 'This page walks you through the process of setting up Prisma from scratch using Node.js and MySQL. It uses Prisma Migrate to create tables in your database.'},
  {name: 'typescript-mysql', value: 'This page walks you through the process of setting up Prisma from scratch using TypeScript and MySQL. It uses Prisma Migrate to create tables in your database.'}
]
---

<TopBlock>

This page walks you through the process of setting up Prisma from scratch with your own database. It uses [Prisma Migrate](../../concepts/components/prisma-migrate) to create tables in your database.
...
Make sure your have your database [connection URL](../../reference/database-reference/connection-urls) (that includes your authentication credentials) at hand!
...
<TabbedContent tabs={[<FileWithIcon text="Prisma data model" icon="code"/>, <FileWithIcon text="SQL" icon="database"/>]}>	
