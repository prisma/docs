...
Do not assume that readers will come into a page from a specific page in the docs (such as the preceding page in the sidenav). A reader might jump around in the sidenav, reach a page from a link in another page, or drop into any page from an external search engine. Therefore, always provide adequate context at the start of a page. This should consist of [a self-explanatory page title](/about/prisma-docs/style-guide/spelling-punctuation-formatting#titles-and-headings), and sufficient orienting material - or links to it - in the page introduction.
