...
- Use examples
- Use [appropriate text emphasis, such as bold and italics](/prisma-docs/style-guide/spelling-punctuation-formatting#text-emphasis) to make your writing clearer
...
Try to be as specific as possible when referring to a specific noun. Avoid referring to the noun as "it" unless you have just defined the proper noun in a previous sentence or clause. In particular, avoid starting sentences with "It".
