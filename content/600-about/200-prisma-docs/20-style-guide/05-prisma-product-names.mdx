...
- Prisma CLI
- Prisma Studio
- Data Browser (in the Prisma Data Platform UI, on cloud.prisma.io)
- Query Console (in the Prisma Data Platform UI, on cloud.prisma.io)
- Schema Viewer (in the Prisma Data Platform UI, on cloud.prisma.io)
