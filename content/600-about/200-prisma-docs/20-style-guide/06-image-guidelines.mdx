...
Use SnagIt to edit screenshots and add annotations.

### Style

- Take focused screenshots of visible and legible areas of the UI.
- Apply minimal styling to screenshots. Do not use unnecessary effects, annotations, or callouts.
- Avoid full-screen screenshots.
- Exclude unnecessary UI areas and details.
- Apply a centered shadow on the entire image canvas in SnagIt. If not, a screenshot with a white-background UI blends with the default white background of Prisma Docs.
- Apply the shadow with **Effects** > **Shadow** and configure the parameters as listed below.
  - Position: Centered
  - Color: Black
  - Opacity: 75%
  - Blur: 5pt
...
For full-width images, use the short form `![]()` MDX component.
