...
However, when it is obvious what the link destination is (for example if you've explained the concept in the proceeding sentence), then a very concise (and maintainable) way to provide a link to further information is as follows:
