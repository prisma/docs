...
1. Migrate your database schema: `./node_modules/.bin/sequelize db:migrate` or `sequelize db:migrate`
1. Seed the database: `./node_modules/.bin/sequelize db:seed:all` or `sequelize db:seed:all`
