...
Include the major version of a package in the installation step. This ensures compatibility and reduces the maintenance overhead when a package introduces a breaking change:
