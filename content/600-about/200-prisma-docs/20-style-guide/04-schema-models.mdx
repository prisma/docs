...
Throughout the Prisma docs, Postgres' dialect of SQL is used as the standard. If the context of a particlar section requires specifying multiple dialects, those may be made available via the the technology switcher component (`SwitchTech`) or tabbed code blocks (`TabbedContent`).
