...
metaTitle: 'Prisma documentation example data model'
...
We are actively working on [adding more schema examples](https://github.com/prisma/docs/issues/1626) to the docs to provide you with starting points for common data models, such as e-commerce.
