...
| section                         | Under **Accelerate**, select **Create API Key**.                                                                                                                                                          |
...
- Under _Accelerate_, from **Location**, select the geographic location for Accelerate.
- Under _Accelerate_ and from **Location**, select the geographic location for Accelerate.

<!-- Good -->

Under _Accelerate_, from the **Location** drop-down menu, select the geographic location for Accelerate.
```
