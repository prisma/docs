...
To document a complete task (such as, _Create a new project_), use numbered lists to document separate steps into the a sequence of steps. 

* Use indented numbered lists to document substeps.
* Avoid having tasks that comprise more than 10 steps or steps that comprise more than 10 substeps.
...
To make UI steps easier to read, you can avoid adding the UI term for each UI element.
...
* Under *Data Proxy*, from **Location**, select the geographic location for the Data Proxy.
* Under *Data Proxy* and from **Location**, select the geographic location for the Data Proxy.

<!-- Good -->

Under *Data Proxy*, from the **Location** drop-down menu, select the geographic location for the Data Proxy.
```
</details>
...
One such example is clicking **Done** at the end of a wizard.
