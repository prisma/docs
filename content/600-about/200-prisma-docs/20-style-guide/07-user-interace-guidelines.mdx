...
- Under _Data Proxy_, from **Location**, select the geographic location for Data Proxy.
- Under _Data Proxy_ and from **Location**, select the geographic location for Data Proxy.

<!-- Good -->

Under _Data Proxy_, from the **Location** drop-down menu, select the geographic location for Data Proxy.
```
