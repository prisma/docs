...
Note that Prisma currently does not support _long-running transactions_ yet. If your application already needs long-running transactions, you can use Prisma Client alongside other lightweight query builder such as [knex.js](https://www.github.com/tgriesser/knex) to perform one-off queries as transaction.

See also: [Transaction support in Prisma](../concepts/components/prisma-client/transactions). 
