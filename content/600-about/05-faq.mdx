...
Yes, Prisma Client provides has a method called [`.raw`](../concepts/components/prisma-client/raw-database-access) which you can use to send raw SQL strings to the database.

Note that Prisma currently doesn't support full [transactions](../concepts/components/prisma-client/transactions). If your application needs transactions, you can use Prisma Client alongside other lightweight query builder such as [knex.js](https://www.github.com/tgriesser/knex) to perform one-off queries as transaction.
