...
Note that Prisma currently does not support _long-running transactions_. If your application needs long-running transactions, you can use Prisma Client alongside other lightweight query builder such as [knex.js](https://www.github.com/tgriesser/knex) to perform one-off queries as transaction.
