...
Yes, Prisma Client provides a method called [`.raw`](../concepts/components/prisma-client/raw-database-access) which you can use to send raw SQL strings to the database.
