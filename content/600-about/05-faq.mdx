...
Yes, Prisma Client provides 2 methods called [`.$queryRaw & .$executeRaw`](../concepts/components/prisma-client/raw-database-access) which you can use to send raw SQL to the database.
