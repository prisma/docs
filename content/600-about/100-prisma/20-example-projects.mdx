...
- [nest-graphql-prisma](https://github.com/Mingyang-Li/nest-graphql-prisma): Fintech GraphQL API template that supports advanced filtering, built with NestJS, GraphQL, Prisma and PostgreSQL.
