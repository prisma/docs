...
Yes, Prisma Client provides two methods which you can use to send raw queries to the database. Learn more about these in the docs [here](/concepts/components/prisma-client/raw-database-access).
