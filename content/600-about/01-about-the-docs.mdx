...
- These two models don't require domain specific knowledge.
- They're also commonly used as an example in the ORM space, making them familiar for users coming from other tools.
- Having consistent models makes it easier for the reader when learning about different concepts, since there wil be less context switching.
...
Nevertheless, we're actively working on [adding schema examples](https://github.com/prisma/docs/issues/1626) to the docs. We believe they will give developers a good starting point when they're building their apps and help save their time.
