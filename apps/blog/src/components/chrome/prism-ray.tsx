...
// Ported from apps/docs/src/components/chrome/prism-ray.tsx (itself from the
// marketing site's brand kit) — the canonical triple-band ray: cyan / yellow /
// red brand anchors, stacked top-to-bottom, crossing the frame at the brand
// angle (-16°, rising to the right). API kept identical across apps.
