...
An example of this kind of function is the [`Prisma.validator`](https://www.prisma.io/docs/orm/contract-authoring/the-data-contract) utility, which also does some extra work to only allow known fields defined in the provided generic type.
...
reaching out to us on our [Twitter](https://pris.ly/x).
