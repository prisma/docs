...
metaDescription: "Learn how to use the React Apollo 2.1 render props API in a full-stack GraphQL tutorial."
...
In this section, you’ll prepare everything to get started with the new render props API of React Apollo 2.1. If you don’t want to actually follow the tutorial but only want to _read_ about the new render props API, feel free to [skip ahead](/tutorial-render-props-in-react-apollo-2-1-199e9e2bd01e).
...
Speaking of the backend, the code for the GraphQL server is located inside the server directory. Check out server/src/schema.graphql to see the [GraphQL schema](/graphql-server-basics-the-schema-ac5e2950214e) of the app and learn what API operations are supported.
