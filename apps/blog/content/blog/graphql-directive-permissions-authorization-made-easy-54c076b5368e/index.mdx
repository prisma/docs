...
metaDescription: "Learn how GraphQL directive permissions provide a declarative way to implement authorization rules and protect data in GraphQL servers."
...
As an example project to anchor the discussion, here’s our [GraphQL schema definition](/graphql-server-basics-the-schema-ac5e2950214e). The schema defines the API for car dealer software.
