...
In our commitment to providing a great developer experience, we recently introduced [TypedSQL](/announcing-typedsql-make-your-raw-sql-queries-type-safe-with-prisma-orm)—the best way to write raw SQL and get fully typed results!
...
> Learn more about the benefits of connection pooling in our recent article: [Saving Black Friday With Connection Pooling](/saving-black-friday-with-connection-pooling)
> 
...
```
> You can learn more about the benefits of database caching in our recent blog post: [Speed and Savings: Caching Database Queries with Prisma Accelerate](/caching-database-queries-with-prisma-accelerate)
> 
