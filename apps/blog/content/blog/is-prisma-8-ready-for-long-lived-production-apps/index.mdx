...
```json title="One operation from ops.json, trimmed to its execute step"
{
  "execute": [
...
These files are designed to be reviewed after they're generated. Developers who want to see the SQL on its own can use the [`migration show`](https://www.prisma.io/docs/cli/migration-show) CLI command.
