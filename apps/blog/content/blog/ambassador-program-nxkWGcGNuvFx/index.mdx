...
We are thrilled to announce the [Prisma Ambassador Program](https://www.prisma.io/programs/partners) to empower the Prisma community, while also helping individual contributors build their own brand.
...
The more you contribute the more we'll reward you! You can find more information about the program on the new [Ambassador Program website](https://www.prisma.io/programs/partners) and the [FAQs](https://pris.ly/ambassador-faq).
