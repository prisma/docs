...
metaDescription: "Learn TypeScript's core features in a practical pocket guide covering types, interfaces, functions, and developer productivity."
...
> **Note**: Prisma [currently supports](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases) PostgreSQL, MySQL, MS SQL Server, and SQLite.
...
With the database and table in place, install [Prisma Client](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/introduction) and generate it to get access to the database.
