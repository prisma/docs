...
The [Prisma Postgres Management API](https://www.prisma.io/docs/rest-api/getting-started) for programmatically managing database instances is now Generally Available! 
...
You can also use it to provision databases in your own product! Take it for a spin with [`npx create-db`](https://create-db.prisma.io/) , a CLI tool we built with the same API it, you can read about this [here](https://www.prisma.io/docs/rest-api/partner-integration).
