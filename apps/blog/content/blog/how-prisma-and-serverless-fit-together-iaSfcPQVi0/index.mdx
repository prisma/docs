...
Data Proxy also runs Prisma's query engine, allowing developers to [remove that dependency](https://www.prisma.io/docs/postgres#generate-prisma-client-for-the-data-proxy), which can be rather large, from the bundled artifacts that get deployed. 
