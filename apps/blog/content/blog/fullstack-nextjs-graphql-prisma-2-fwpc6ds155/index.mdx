...
> **Note**: you can set up PostgreSQL [locally](https://www.prisma.io/docs/orm/v7/more/troubleshooting/nextjs) or a hosted instance on [Heroku](https://dev.to/prisma/how-to-setup-a-free-postgresql-database-on-heroku-1dc1). Note that you will need a remote database for the deployment step at the end of the course.
...
- `schema.prisma`: the schema of our database, written in PSL (Prisma Schema Language). If you want to learn how the database was modeled for this app, check out the [last part](/fullstack-nextjs-graphql-prisma-oklidw1rhw) of the course.
- `seed.ts`: script that will [seed the database](https://www.prisma.io/docs/orm/v7/prisma-migrate/workflows/seeding) with dummy data.
...
For more information on why you may want to use off-set based pagination, check out the [documentation](https://www.prisma.io/docs/orm/fundamentals/reading-data#use-cases-for-offset-pagination).
