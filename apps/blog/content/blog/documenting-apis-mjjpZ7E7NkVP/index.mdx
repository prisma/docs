...
metaDescription: "Explore five tools and approaches for documenting web APIs so teams can ship clearer, more usable developer experiences."
...
GraphQL APIs are composed of two main components: [ _the schema definition_ and _resolvers_](/graphql-server-basics-the-schema-ac5e2950214e). 
