...
- [**Prisma Client**](https://www.prisma.io/orm) - **a type-safe database access client for TypeScript and Node.**

  Prisma Client gives Grover confidence in their database access by providing type safety when making queries.

- [**Prisma Migrate**](https://www.prisma.io/docs/orm/v7/prisma-migrate) - **a tool for seamless database migrations**
...
- [**Prisma Studio**](https://www.prisma.io/docs/studio/getting-started) - **a modern database GUI for the browser and the desktop**
