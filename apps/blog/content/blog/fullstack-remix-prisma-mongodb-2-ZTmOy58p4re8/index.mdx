...
Create a new file in the `app/utils` folder named `prisma.server.ts` where you will create and export an instance of [Prisma Client](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/introduction):
...
You will store this data in a field containing an [embedded document](https://www.prisma.io/docs/orm/v6/prisma-schema/data-model/relations/referential-actions/special-rules-for-referential-actions#defining-composite-types) within the `User` model named `profile`.
