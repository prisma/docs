...
2. Add any drivers you may need for your database
    ...
    If you’re using, for example PostgreSQL, you’ll need to [add the necessary driver](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/database-polyfills). In this case `@prisma/adapter-pg` can be used. If you’re using Prisma Postgres, then there’s no extra steps needed here.
