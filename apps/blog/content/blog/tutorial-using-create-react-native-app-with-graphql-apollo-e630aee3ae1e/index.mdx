...
metaDescription: "Learn how to build an Instagram-style React Native app with Create React Native App, GraphQL, and Apollo."
...
[Apollo Client](http://dev.apollodata.com/react/) is one of the most popular GraphQL clients available at the moment. It implements features like caching, optimistic UI, [query batching](/improving-performance-with-apollo-query-batching-66455ea9d8b) as well as realtime updates using subscriptions and generally makes interacting with a GraphQL backend a breeze.
