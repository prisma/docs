...
Accelerate extends your Prisma Client with an intuitive API offering granular control over established caching patterns on a per-query basis. Utilise [time-to-live](https://www.prisma.io/docs/accelerate#time-to-live-ttl) (TTL) or [state-while-revalidate](https://www.prisma.io/docs/accelerate#stale-while-revalidate-swr) (SWR) to fine-tune your cache behavior tailored to your application needs.
...
> Learn more about caching strategies in our [docs](https://www.prisma.io/docs/accelerate#cache-strategies).
...
> Learn more about the serverless connection management challenge <a href="https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/databases-connections/connection-management#serverless-environments-faas"   target="_blank">here</a>.
...
[Read the docs](https://www.prisma.io/docs/accelerate)
