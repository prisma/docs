...
Today we are excited to expand the range of Prisma compatible databases with Preview support for
  ...
  out](https://www.prisma.io/docs/v7/prisma-orm/add-to-existing-project/cockroachdb)
...
Today we are excited to introduce Preview support for [CockroachDB](https://www.cockroachlabs.com/product/) as part of the [3.9.0 release](https://github.com/prisma/orm/releases/tag/3.9.0) of Prisma! 🎉
...
**However, as a [Preview](https://www.prisma.io/docs/orm/v7/more/releases#preview) feature, it is not production-ready and comes with some limitations.** To learn more about the current limitations, see the [limitations section](#limitations).

Today, we're inviting the CockroachDB community to [**try it out**](https://www.prisma.io/docs/v7/prisma-orm/add-to-existing-project/cockroachdb) and [**give us feedback**](https://github.com/prisma/orm/issues/11542), so we can bring CockroachDB support to General Availability.

Your feedback and suggestions will help us shape the future of CockroachDB support in Prisma. 🙌

## Prisma - making databases easy

Prisma is a [next-generation](https://www.prisma.io/docs/orm/v6/overview/prisma-in-your-stack/is-prisma-an-orm) [open-source](https://www.github.com/prisma/orm) ORM for Node.js and TypeScript. It helps you be more productive and confident when developing database-driven applications.
...
With today's release, you can use [introspection](https://www.prisma.io/docs/orm/v7/prisma-schema/introspection) to populate your Prisma schema and Prisma Client to interact with the database in a type-safe manner.
...
<br />
[Get started with Prisma and CockroachDB](https://www.prisma.io/docs/v7/prisma-orm/add-to-existing-project/cockroachdb)
...
Prisma Migrate is not supported yet with CockroachDB; if you're starting without an existing database, you will need to define the schema with SQL. To follow progress on this, subscribe to the [related issue](https://github.com/prisma/orm/issues/4702). 
...
<br />
[Read the Prisma CockroachDB connector docs](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases/postgresql)

## Try Prisma with your existing CockroachDB database and share your feedback

We built this for you and are eager to [hear your feedback](https://github.com/prisma/orm/issues/11542)!

🐜 Found something you'd love to see improved? Please [file an issue](https://github.com/prisma/orm/issues/new/choose) so our engineering team can look into it.
