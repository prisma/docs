...
- **Type performance CI tests**: Added CI guardrails that snapshot instantiations/check times to prevent regressions (PR [#26894](https://github.com/prisma/orm/pull/26894)).

If you're curious about the details, you can check out the PRs ([#27775](https://github.com/prisma/orm/pull/27775) and [#27777](https://github.com/prisma/orm/pull/27777)) where we implemented the optimizations.
...
If you want to see how that workflow looks in practice, explore [Prisma ORM](https://www.prisma.io/orm), review how [Prisma Client generation works](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/generating-prisma-client), and compare it with [TypedSQL](https://www.prisma.io/orm) for the cases where you need lower-level control.
