...
metaDescription: "Learn how to query your database directly from React Server Components with Prisma, and why type-safe database access fits the server-rendered React model."
...
This article summarizes the talk while making some changes to the official demo. Instead of sending raw SQL queries to the database, we'll be using **Prisma**, an [open-source](https://github.com/prisma/orm) ORM.
...
To learn more about Prisma and the different ways you can use it, check out the [getting started guide.](https://www.prisma.io/docs/prisma-postgres/quickstart/prisma-orm)
