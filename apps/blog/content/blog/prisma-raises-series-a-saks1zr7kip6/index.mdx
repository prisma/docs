...
metaDescription: "Prisma raised $12M in Series A funding to keep building the next generation of database tools for application developers."
...
With [Prisma 2.0 ready for production](/announcing-prisma-2-n0v98rzc8br1), we are excited to continue pursuing our mission of building the next generation of database tools for application developers. In this post, we'll share details about the funding and what it means for our community.
...
When working with relational databases, developers have the choice of working directly with SQL or using a higher-level abstraction called ORMs. [None of these options is particularly compelling](https://www.prisma.io/docs/orm/v6/overview/introduction/why-prisma#problems-with-sql-orms-and-other-database-tools).
...
After running Preview and Beta versions for more than a year, we've recently [launched Prisma 2.0 for production](/announcing-prisma-2-n0v98rzc8br1). Having rewritten the core of Prisma from Scala to Rust for the transition, we've built a strong foundation to expand the Prisma toolkit to cover various database workflows in the future.

Prisma's main feature is [Prisma Client](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/introduction), an auto-generated and type-safe query builder which can be used to access a database in Node.js and TypeScript. Thanks to [introspection](https://www.prisma.io/docs/orm/v7/prisma-schema/introspection), Prisma Client can be used to work with any existing database!

> **Note**: Prisma currently supports **PostgreSQL**, **MySQL** and **SQLite** databases – with more planned. Please create [new GitHub issues](https://github.com/prisma/orm/issues/new) or subscribe to existing ones (e.g. for [MongoDB](https://github.com/prisma/orm/issues?q=is%3Aissue+is%3Aopen+mongo) or [DynamoDB](https://github.com/prisma/orm/issues/1676)) if you'd like to see support for specific databases.
...
[Prisma Migrate](https://www.prisma.io/docs/orm/migrations/how-migrations-work) is our solution to this problem. Prisma Migrate lets developers map the declarative [Prisma schema](https://www.prisma.io/docs/orm/contract-authoring/psl-syntax) to their database. Under the hood, Prisma Migrate generates the required SQL statements to perform the migration.
...
Prisma Client is a thin, language-specific layer that delegates the heavy-lifting of query planning and execution to Prisma's [query engine](https://www.prisma.io/docs/orm/v7/more/releases). The query engine is [written in Rust](https://github.com/prisma/prisma-engines) and runs as a standalone process alongside your main application.
...
As of today, we've built connectors for PostgreSQL, MySQL and SQLite. A [connector for MongoDB](https://github.com/prisma/orm/issues/1277) is already in the works and more are planned for the future.
...
We are incredibly grateful for everyone who has accompanied us on our journey! It is fantastic to see our lively community on [Slack](https://slack.prisma.io), [GitHub](https://github.com/prisma/orm), [Twitter](https://pris.ly/x) and a lot of other channels where folks are chatting about Prisma and helping each other out!
