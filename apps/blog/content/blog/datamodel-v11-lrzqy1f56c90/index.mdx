...
metaDescription: "Prisma's new datamodel syntax gave developers more control over database schemas while simplifying migrations and reducing opinionated defaults."
...
While the new datamodel syntax already incorporates many features requested by our community, we still see opportunities to improve it even further. For example, the datamodel doesn't yet provide [multi-column indices](https://github.com/prisma/orm/issues/3405) and [polymorphic relations](https://github.com/prisma/orm/issues/3407).

We are currently working on a new [data modeling language](https://github.com/prisma/specs/tree/master/schema) that will be a variation of the currently used [SDL](/graphql-sdl-schema-definition-language-6755bcb9ce51).
