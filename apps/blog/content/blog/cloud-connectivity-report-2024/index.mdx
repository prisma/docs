...
[Prisma Accelerate](https://www.prisma.io/accelerate) is a global database cache, increasing the performance of websites that are deployed in multiple regions and communicating with a central database. As such, we see traffic from almost all Cloudflare PoPs to any given AWS region. These are the AWS region and Cloudflare PoP pairs where we observe the highest latency:
