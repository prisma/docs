...
[Prisma Migrate](https://www.prisma.io/orm) helps developers evolve their database schema at every step of development, from prototyping to production. Today we are excited to launch Prisma Migrate for General Availability! [Try it out.](https://www.prisma.io/docs/prisma-orm/quickstart/postgresql)
...
[Check out the guide for advanced migration scenarios](https://www.prisma.io/docs/orm/migrations/editing-a-migration)
...
[Learn more about team development with Prisma Migrate](https://www.prisma.io/docs/guides/database/schema-changes)

### Bring your own project

Prisma Migrate can be adopted in an existing project using PostgreSQL, MySQL, SQLite, and SQL Server ([Preview](https://www.prisma.io/docs/orm/v7/more/releases#preview)). This enables you to take any existing project and increase productivity with Migrate's auto-generated migrations. Additionally, you can generate Prisma Client for type-safe database access.

Because Prisma Migrate is language agnostic, it can be adopted in any project that uses one of the supported databases.

[Follow the guide on adding Prisma Migrate to an existing project](https://www.prisma.io/docs/orm/migrations/how-migrations-work)
...
You can use Migrate with [PostgreSQL](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases/postgresql), [MySQL](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases/mysql), [SQLite](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases/sqlite). [SQL Server](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases/sql-server) support is available in [Preview](https://www.prisma.io/docs/orm/v7/more/releases#preview).

There are various ways for getting started with Prisma Migrate:

<center>

[Prisma Migrate Docs](https://www.prisma.io/docs/orm/migrations/how-migrations-work)

[Add Migrate to an existing project](https://www.prisma.io/docs/orm/migrations/how-migrations-work)


[Start from scratch](https://www.prisma.io/docs/prisma-orm/quickstart/postgresql)
</center>
...
Prisma Migrate is based on the [Prisma schema](https://www.prisma.io/docs/orm/contract-authoring/psl-syntax) and works by generating `.sql` migration files that are executed against the database.
...
- **`prisma db push`**: Creates the database schema based on the Prisma schema without any migrations. Intended for use while locally prototyping. The command is currently in [Preview](https://www.prisma.io/docs/orm/v7/more/releases#preview)
...
This is covered in the [Migrate docs](https://www.prisma.io/docs/orm/migrations/how-migrations-work#production-and-testing-environments) and the [production troubleshooting guide](https://www.prisma.io/docs/orm/v7/prisma-migrate/workflows/patching-and-hotfixing) in more detail.
...
Previously, Fields in the Prisma schema would be annotated with a type from the [scalar types](https://www.prisma.io/docs/orm/v7/reference/prisma-schema-reference#model-field-scalar-types) that Prisma exposed.
...
To learn more about native type attributes, check out the [docs](https://www.prisma.io/docs/orm/v7/prisma-migrate/workflows/native-database-types).

### Integrated seeding

Migrate comes with built-in support for [**seeding**](https://www.prisma.io/docs/orm/v7/prisma-migrate/workflows/seeding). Seeding enables you to bootstrap a usable test environment with data quickly. Depending on your desired approach, you can use seeding both locally and in shared environments.

> **Note:** The seeding functionality is still in [Preview](https://www.prisma.io/docs/orm/v7/more/releases#preview) and will be stabilized in a future release.
...
- [Add support for configuring cascading deletes in the Prisma schema.](https://github.com/prisma/orm/issues/2810)
...
- [**Start from scratch guide**](https://www.prisma.io/docs/prisma-orm/quickstart/postgresql) covers both Prisma Migrate and Client.
- [**Prisma Migrate docs**](https://www.prisma.io/docs/orm/migrations/how-migrations-work) delves deeper into the different Migrate workflows.
- [**Developing with Migrate**](https://www.prisma.io/docs/orm/migrations/how-migrations-work) guides you through a typical development workflow.
- [**Advanced migration scenarios**](https://www.prisma.io/docs/orm/migrations/editing-a-migration) goes into customizing the migration SQL.
- [**Team development with Migrate**](https://www.prisma.io/docs/guides/database/schema-changes) explains collaboration with Migrate as a team.
- [**Adding Prisma Migrate to an existing project**](https://www.prisma.io/docs/orm/migrations/how-migrations-work) describes how to add Prisma Migrate to an existing project with a database.
