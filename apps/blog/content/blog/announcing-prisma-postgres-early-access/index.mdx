...
Our suite of Prisma products ensures you can [build, fortify, and grow](/bfg) data-driven applications without worrying about data modeling, migrations, querying, or complex and expensive infrastructure (like Redis or Apache Kafka):
...
- **Prisma ORM**: The [most popular ORM in the TypeScript ecosystem](/how-prisma-orm-became-the-most-downloaded-orm-for-node-js), featuring a human-readable schema, automated migrations, and intuitive, type-safe queries.
...
- **Prisma Optimize**: An AI-driven [query analysis and recommendation system](https://www.prisma.io/data-platform/optimize) that helps you optimize your database queries.
- **Prisma Studio**: The easiest way to [view and edit](https://www.prisma.io/docs/studio/getting-started) your data visually.
...
Also check out the [documentation](https://www.prisma.io/docs/prisma-postgres/quickstart/prisma-orm) to learn about current limitations of Prisma Postgres. 
