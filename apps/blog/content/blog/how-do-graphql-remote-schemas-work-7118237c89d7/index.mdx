...
metaDescription: "Learn how GraphQL remote schemas work and how schema stitching can combine data from multiple GraphQL services."
...
In a [previous article](/graphql-server-basics-the-schema-ac5e2950214e), we already covered the basic mechanics and inner workings of the GraphQL schema. Let’s do a quick recap!
...
- **Resolvers**: Here is where the schema definition _comes to life_ and receives its actual _behaviour_. Resolvers _implement_ the API that’s specified by the schema definition. (For more info, refer to the [last article](/graphql-server-basics-the-schema-ac5e2950214e).)
...
> If you have trouble following this example, make sure to read the [last article](/graphql-server-basics-the-schema-ac5e2950214e) on GraphQL schemas.
