...
## Future Plans
Bucket is excited about upcoming improvements to Prisma, particularly the shift to fully [TypeScript-based client generation](/from-rust-to-typescript-a-new-chapter-for-prisma-orm) and performance enhancements for better serverless and edge computing support.
