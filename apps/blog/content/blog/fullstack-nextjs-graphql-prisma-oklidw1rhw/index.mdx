...
> **Note**: You can set up PostgreSQL [locally](https://www.prisma.io/docs/local-development/postgres) or create a hosted instance, for example with [Prisma Postgres](https://www.prisma.io/docs/postgres). A remote database will be required for the deployment chapter.
