...
metaDescription: "Learn how the network layer controls request handling, transport, and execution flow in GraphQL server implementations."
...
If you’ve read the [previous article](/graphql-server-basics-the-schema-ac5e2950214e) on the GraphQL schema, you’ll have a pretty good understanding what the _lines 7 to 18_ are being used for: We build a `GraphQLSchema` that can execute the following query:
