...
In the [Prisma ORM Manifesto](/prisma-orm-manifesto) we committed to building Prisma “in conversation with our community.” To capture the voice of our community we’ve started prompting for feedback directly in the CLI—an unconventional choice that deserves a short explanation.
...
- Run commands with [`--no-hints`](https://www.prisma.io/docs/orm/v7/reference/prisma-cli-reference#options-1) to avoid survey prompts and other tips
...
Our [Manifesto](/prisma-orm-manifesto) concludes: _“If we ever fall short, call us out.”_ 
