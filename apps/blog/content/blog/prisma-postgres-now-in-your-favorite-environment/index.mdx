...
Check out our General Availability announcement to learn about the architecture, features, and benefits Prisma Postgres provides: [Prisma Postgres: The Future of Serverless Databases](/prisma-postgres-the-future-of-serverless-databases). Or watch our explainer video: [Prisma Postgres in 100 seconds](https://www.youtube.com/watch?v=lImlEhlxxio).
...
> If you're building a tool that could use a database integration, we are working on something exciting that will give your users instant Prisma Postgres databases without authentication required! Read more: [Announcing: Instant Prisma Postgres for AI Coding Agents](/announcing-prisma-postgres-for-ai-coding-agents)
...
<br />
[Try Prisma Postgres on Netlify](https://www.prisma.io/docs/guides/postgres/netlify)
