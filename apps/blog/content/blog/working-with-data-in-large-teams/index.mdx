...
It's a reliable pattern whether you're using raw SQL, Prisma, Rails, or any other system. [Visit our dataguide](https://www.prisma.io/dataguide/types/relational/expand-and-contract-pattern) to learn more about the expand and contract pattern.
...
For example, [TypedSQL in Prisma ORM](https://www.prisma.io/orm) lets you use raw SQL with full TypeScript types, right next to your ORM calls. This gives you the flexibility of SQL without giving up type safety or maintainability.
