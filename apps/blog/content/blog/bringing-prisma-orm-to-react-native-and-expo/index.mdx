...
Prisma ORM is ready to be used in your Expo and React Native app today. Keep in mind this is an Early Access release, so please help us test it out and share your experience with us [on Discord](https://pris.ly/discord). To get started, follow the [instructions in the readme](https://github.com/prisma/react-native-prisma).
