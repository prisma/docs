...
metaDescription: "Explore new GraphQL tooling like GraphQL Config and related libraries that improve project setup, tooling integration, and workflows."
...
> ⚠️ **This article is outdated!** The `graphql-config` and `graphql-cli` projects have been [handed over to the Guild](/the-guild-takes-over-oss-libraries-vvluy2i4uevs) in the meantime. ⚠️ 
