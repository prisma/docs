...
metaDescription: "Learn how to wrap a REST API with GraphQL in three steps and expose a more flexible query interface for clients."
...
> To learn more about this process, be sure to check out the following article: [GraphQL Basics: The Schema](/graphql-server-basics-the-schema-ac5e2950214e)
...
> To learn more about the GraphQL schema definition and resolver functions, be sure to check out [this article](/graphql-server-basics-the-schema-ac5e2950214e).
