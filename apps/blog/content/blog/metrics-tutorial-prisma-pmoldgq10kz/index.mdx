...
Prisma's [metrics feature](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging) gives you detailed
...
You will use a pre-built Express API server that uses Prisma to interact with a PostgreSQL database. Throughout the tutorial, you will learn how to add metrics to the API server using [Prisma's metrics feature](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging). You will also learn how to set up and configure [Prometheus](https://prometheus.io/) and [Grafana](https://grafana.com/) to collect and visualize the generated metrics.
...
> **Note**: A complete list of the available metrics is available in [the metrics docs](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging#about-metrics).
...
> **Note**: Metrics is often combined with [tracing](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/opentelemetry-tracing) to get a granular overview of the system. To learn more about tracing, take a look at our [tracing tutorial](/tracing-tutorial-prisma-pmkddgq1lm2).
...
Metrics is currently available in Prisma as a [Preview feature](https://www.prisma.io/docs/orm/v7/more/releases#preview). To use it, you will need to enable the `metrics` feature flag in the `generator` block of your `schema.prisma` file:
...
npx prisma generate
```
With the metrics feature enabled, Prisma will allow you to retrieve metrics about your database operations using the `prisma.$metrics` API. You can expose metrics in [JSON format](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging#retrieve-metrics-in-json-format) or [Prometheus format](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging#retrieve-metrics-in-prometheus-format).
...
> **Note**: You can also retrieve metrics in JSON format with `prisma.$metrics.json()`. You can read more about the JSON format [in the docs](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging#retrieve-metrics-in-json-format).
...
> **Note**: Feel free to try out other queries in the Prometheus UI. You can find a list of all the available metrics in the [Prisma docs](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging#about-metrics). You can also learn how to do more complex PromQL queries by reading the [Prometheus documentation](https://prometheus.io/docs/prometheus/latest/querying/basics/).
...
- [Prisma metrics documentation](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging)
- [Tutorial on tracing with Prisma](/tracing-tutorial-prisma-pmkddgq1lm2)
- [Prometheus Documentation](https://prometheus.io/docs/introduction/overview/)
- [Grafana Documentation](https://grafana.com/docs/grafana/latest/)

We would love to get your thoughts on the metrics feature! Please give us feedback about metrics on this [Github issue](https://github.com/prisma/orm/issues/13579).
