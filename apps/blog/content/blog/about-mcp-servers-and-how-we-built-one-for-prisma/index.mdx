...
metaDescription: "Learn what MCP servers are and how Prisma built its MCP server, from tool access concepts to remote server architecture and practical implementation details."
...
At Prisma, we've built the [most popular TypeScript ORM](/how-prisma-orm-became-the-most-downloaded-orm-for-node-js) and the [world's most efficient Postgres database](/announcing-prisma-postgres-early-access) running on unikernels. 
...
```
Or check out our [docs](https://www.prisma.io/docs/ai/tools/mcp-server) for specific instructions for Cursor, Windsurf, Claude, or the OpenAI Agents SDK.
