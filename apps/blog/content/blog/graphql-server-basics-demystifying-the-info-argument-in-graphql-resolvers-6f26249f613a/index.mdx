...
metaDescription: "Learn what the `info` argument in GraphQL resolvers contains and how it helps with selection sets, execution context, and server internals."
...
> Part I: [The GraphQL Schema](/graphql-server-basics-the-schema-ac5e2950214e) (required)
> Part II: [The Network Layer](/graphql-server-basics-the-network-layer-51d97d21861) (optional)
...
- Define your [GraphQL schema](/graphql-server-basics-the-schema-ac5e2950214e) (either in SDL or as a plain JS object)
...
1. `parent`: The result of the previous resolver call ([more info](/graphql-server-basics-the-schema-ac5e2950214e)).
...
Let’s now go ahead and see an example for the contents of the `info` object. To set the stage, here is the [schema definition](/graphql-server-basics-the-schema-ac5e2950214e) we’ll use for this example:
