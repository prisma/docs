...
> You can learn more about how we think about Cloudflare as a partner in improving [Data DX](https://www.datadx.io/) in this blog post: [Developer Experience Redefined: Prisma & Cloudflare Lead the Way to Data DX](/cloudflare-partnership-qerefgvwirjq)
> 
...
Note that this feature is based on [driver adapters](https://www.prisma.io/docs/orm/v7/core-concepts/supported-databases/database-drivers#driver-adapters) which are currently in Preview, we therefore consider D1 support to be in Preview as well.
