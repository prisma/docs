...
metaDescription: "Learn how Rapha uses Prisma to manage mobile application data and deliver consistent APIs across platforms and backend systems."
...
Since Prisma defines its data structures for applications and databases in a schema file, changes to the data model are centralized.  [Prisma Migrate](https://www.prisma.io/docs/orm/migrations/how-migrations-work) can be used to detect changes to the schema file and generate SQL migration files.
