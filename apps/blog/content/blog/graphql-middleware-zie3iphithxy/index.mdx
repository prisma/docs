...
metaDescription: "GraphQL Middleware lets you run reusable logic around resolvers for cleaner authorization, logging, error handling, and code organization."
...
- The **remaining four** represent the standard resolver arguments (learn more [here](/graphql-server-basics-the-schema-ac5e2950214e)).
