...
Tracing is a powerful tool that allows you to analyze your application's performance and identify bottlenecks. This tutorial will teach you the core concepts of tracing and how to integrate tracing into your application using [OpenTelemetry](https://opentelemetry.io/) and [Prisma's tracing feature](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/opentelemetry-tracing).
...
> **Note:** Tracing is often combined with [metrics](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging) to get better observability of your system. To learn more about metrics, take a look at our [metrics tutorial](/metrics-tutorial-prisma-pmoldgq10kz).
...
Then you will use the new [tracing feature](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/opentelemetry-tracing) in Prisma to do the same automatically.
...
```
> **Note**: Tracing is currently a [Preview feature](https://www.prisma.io/docs/orm/v7/more/releases#preview). This is why you have to add the `tracing` feature flag before you can use tracing.
...
> **Note:** To learn more about the spans generated by Prisma, see the [trace output
 section of the tracing docs](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/opentelemetry-tracing#trace-output).
