...
- Use a database provider with [built-in caching such as Prisma Postgres](https://www.prisma.io/docs/accelerate/caching)
...
Improving just a few heavy queries can cut your overall latency in half. Tools like [Prisma Optimize](https://www.prisma.io/docs/query-insights) make this easier by identifying your slowest queries across edge and serverless functions, pinpointing the root causes, and suggesting actionable fixes.
