...
We encourage you to upgrade to Prisma [5.0.0](https://github.com/prisma/orm/releases/tag/5.0.0) and are looking forward to hearing your feedback! 🎉

Prisma 5 is a major version increment, and it comes with a few breaking changes. We expect only a few users will be affected by the changes. However, before upgrading, we recommend that you check out our [upgrade guide](https://www.prisma.io/docs/guides/upgrade-prisma-orm/v5) to understand the impact on your application. If you run into any bugs, please submit an [issue](https://github.com/prisma/orm/issues), or upvote a corresponding issue if it already exists.
