...
Sean picked Prisma as his go-to database client from day one. Prisma abstracted managing databases, enabling him to focus on delivering mission-critical features. [**Prisma Client**](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/introduction) provided a clean API for database access and [**Prisma Migrate**](https://www.prisma.io/docs/orm/migrations/how-migrations-work) to manage schema changes.
...
Prisma allows you to prototype your database schema using the [`prisma db push`](https://www.prisma.io/docs/orm/v7/prisma-migrate/workflows/prototyping-your-schema) command. It is handy when you do not need to version the schema changes and prioritize reaching the _desired end-state_ without previewing changes.
