...
[Visit our docs](https://www.prisma.io/docs/local-development/postgres) to learn how to start using Prisma Postgres locally.
...
You can [learn more about the VS Code agent in our docs](https://www.prisma.io/docs/guides/postgres/vscode).
...
```
No adapters, no custom builds—just Prisma ORM, running natively in Deno. Try it out by following the [step-by-step guide here](https://www.prisma.io/docs/orm/v7/prisma-client/deployment/edge/deploy-to-deno-deploy).
...
If you want to try the workflows from this release yourself, start with [Prisma Postgres](https://www.prisma.io/postgres), review [pricing](https://www.prisma.io/pricing), or learn how [Prisma's MCP tooling](https://www.prisma.io/mcp) can help with database setup inside AI-powered tools.
