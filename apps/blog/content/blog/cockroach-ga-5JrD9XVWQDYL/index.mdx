...
On May 10th, we were thrilled to release version [3.14.0](https://github.com/prisma/orm/releases/tag/3.14.0) of
...
Back in February, as part of the [3.9.0](https://github.com/prisma/orm/releases/tag/3.9.0) release of Prisma, preview support for CockroachDB was added. Today, as CockroachDB announces their 22.1 release, we are excited to officially announce the general availability of Prisma's CockroachDB connector.
...
- Modeling their database with [Prisma Schema Language (PSL)](https://www.prisma.io/docs/orm/contract-authoring/psl-syntax)
- [Introspecting](https://www.prisma.io/docs/orm/v7/prisma-schema/introspection) their database to work with existing databases
- Migrations to manage changes to their database schema using [Prisma Migrate](https://www.prisma.io/docs/orm/migrations/how-migrations-work)
- Type safe interactions within their application code using [Prisma Client](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/introduction)
...
This feature, paired with [Prisma Migrate](https://www.prisma.io/docs/orm/migrations/how-migrations-work), gives developers a very smooth workflow for managing your schema without the development team having to worry about how those changes are propagated.
...
Prisma Schema Language (PSL) supports configuring [indexes](https://www.prisma.io/docs/orm/v7/prisma-schema/data-model/indexes) to ensure maximum query performance.
...
To jump in and begin building with CockroachDB and Prisma, you can use [Prisma Migrate](https://www.prisma.io/docs/orm/migrations/how-migrations-work) in a new project or [introspection](https://www.prisma.io/docs/orm/v7/prisma-schema/introspection) in an existing project (see buttons below).
...
<br />
[Start from scratch with CockroachDB](https://www.prisma.io/docs/v7/prisma-orm/quickstart/cockroachdb)
...
<br />
[Add Prisma to existing CockroachDB project](https://www.prisma.io/docs/v7/prisma-orm/add-to-existing-project/cockroachdb)
