...
In case you haven't heard: [**Prisma Postgres is the first database built on unikernels**](/announcing-prisma-postgres-early-access). Here's a quick 100-second summary if you missed it:
...
> Learn more about why connection pooling is important in our recent article: [Saving Black Friday With Connection Pooling](/saving-black-friday-with-connection-pooling)
...
> Check out the [Early Access announcement](/announcing-prisma-postgres-early-access#building-a-managed-postgresql-service-on-millisecond-cloud-infrastructure) to learn about the details of that architecture, our collaboration with [Unikraft](https://unikraft.cloud/), and the millisecond cloud stack that enables the performance benefits of Prisma Postgres.
...
If you are already using Prisma ORM, give Prisma Postgres a try [by importing the data from your existing database](https://www.prisma.io/docs/prisma-postgres/import-from-existing-database-postgresql) in . Otherwise, try out Prisma Postgres from scratch by running this command in your terminal:
```
