...
url: /docs/v6/ai/tutorials/linktree-clone
...
👉 **Find the setup prompt here:** [Next.js + Prisma Prompt](/docs/v6/ai/prompts/nextjs)
...
📖 **Reference:** [Deploy to Vercel - Build Configuration](/docs/v6/orm/prisma-client/deployment/serverless/deploy-to-vercel#build-configuration)
