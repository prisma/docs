...
url: /docs/v6/postgres/troubleshooting
...
Your default [workspace](/docs/v6/platform/about#workspace) project limit has been reached.
...
- Ensure that you are logged into the correct account in the Prisma CLI. For more details on authentication and account management, please refer to the [Prisma CLI documentation](/docs/v6/platform/platform-cli/commands#authentication).
- [Upgrade to a plan](/docs/v6/platform/about#billing) that supports more projects in your default Workspace.
