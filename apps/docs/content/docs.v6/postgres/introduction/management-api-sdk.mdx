...
url: /docs/v6/postgres/introduction/management-api-sdk
...
The [`@prisma/management-api-sdk`](https://www.npmjs.com/package/@prisma/management-api-sdk) is a TypeScript SDK for the [Prisma Data Platform Management API](/docs/v6/postgres/introduction/management-api). Use the simple client for direct API access, or the full SDK with built-in OAuth authentication and automatic token refresh.
...
For usage with an existing access or [service token](/docs/v6/postgres/introduction/management-api#service-tokens).
...
For applications that need [OAuth authentication](/docs/v6/postgres/introduction/management-api#oauth-20-authentication), automatic token refresh, and token storage management, use the full SDK.
