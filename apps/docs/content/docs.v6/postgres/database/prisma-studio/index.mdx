...
- [Embed Prisma Studio](/docs/v6/postgres/database/prisma-studio/embedding-studio) in your own app (e.g. as an admin dashboard)

:::note

If you want to use Prisma Studio with another database than Prisma Postgres, check the docs [here](/docs/v6/orm/tools/prisma-studio).
