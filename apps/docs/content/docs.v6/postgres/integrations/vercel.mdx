...
url: /docs/v6/postgres/integrations/vercel
...
- `DATABASE_URL`: The [direct TCP connection URL](/docs/v6/postgres/database/direct-connections) starting with `postgres://...`
...
To view and edit the data in your Prisma Postgres instance, you can use the local version of [Prisma Studio](/docs/v6/orm/tools/prisma-studio).
