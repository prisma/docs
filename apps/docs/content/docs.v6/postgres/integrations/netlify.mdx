...
<FolderCards />, you are going to add Prisma Postgres to the starter project _on your local
machine_:
...
<FolderCards />, you need to add the Netlify extension to your Netlify site. Follow the instructions
in the [Usage](#usage) section above to do that.
