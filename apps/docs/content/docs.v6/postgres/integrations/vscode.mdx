...
url: /docs/v6/postgres/integrations/vscode
...
1. Authenticate with the [Prisma Console](https://console.prisma.io) via the popup and select a target [workspace](/docs/v6/platform/about#workspace)
...
Beyond managing your database instances, the Prisma VS Code extension embeds Prisma Studio directly in your editor making it easy to perform create, update, delete steps on your database from right inside of VS Code. Follow these [easy steps](/docs/v6/postgres/database/prisma-studio/studio-in-vs-code) to get started.

## Prisma MCP server

Prisma provides its own [Model Context Protocol](/docs/v6/postgres/integrations/mcp-server) (MCP) server that lets you manage Prisma Postgres databases, model database schemas and chat through migrations.
...
Learn more about the MCP server in our [MCP server documentation](/docs/v6/postgres/integrations/mcp-server).
...
:::note
Currently, the agent mode uses your default [workspace](/docs/v6/platform/about#workspace) in the Prisma Data Platform.
:::
...
For more details, refer to our [GitHub Copilot documentation](/docs/v6/orm/more/ai-tools/github-copilot).
