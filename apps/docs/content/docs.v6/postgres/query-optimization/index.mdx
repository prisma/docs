...
url: /docs/v6/postgres/query-optimization
...
- [Setup](/docs/v6/postgres/query-optimization/setup) - Learn how to quickly set up and start optimizing Prisma Postgres queries
- [Recommendations](/docs/v6/postgres/query-optimization/recommendations) - Learn about the recommendations provided by Optimize
- [Prisma AI](/docs/v6/postgres/query-optimization/prisma-ai) - Learn about using Optimize's Prisma AI feature
