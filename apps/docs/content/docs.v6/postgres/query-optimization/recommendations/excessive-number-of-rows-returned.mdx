...
url: /docs/v6/postgres/query-optimization/recommendations/excessive-number-of-rows-returned
...
The following query targeting a `User` model does not provide a [`take` option](/docs/v6/orm/reference/prisma-client-reference#findmany):
