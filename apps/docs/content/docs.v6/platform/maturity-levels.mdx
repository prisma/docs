...
url: /docs/v6/platform/maturity-levels
...
You can [check out the releases and maturity process for the Prisma ORM](/docs/v6/orm/more/releases) for further details.
