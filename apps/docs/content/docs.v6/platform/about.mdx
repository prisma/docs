...
7. Copy the API key and store it securely. This will be used in your project's [`.env` file](/docs/v6/optimize/getting-started) via the `"OPTIMIZE_API_KEY"`. Finally, click the **"I've stored it securely"** button.

You now have your Optimize API key.

### Project

In each workspace, you can create several projects. A project typically represents an application (a product or service). You typically have one [Prisma schema](/docs/v6/orm/prisma-schema/overview) per project.
...
Read more about the [Prisma CLI](/docs/v6/platform/platform-cli/about).
