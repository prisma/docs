...
- [Accelerate](/docs/v6/accelerate): Speeds up your queries with a global database cache with scalable connection pooling.
- [Optimize](/docs/v6/optimize): Provides you recommendations that can help you make your database queries faster.
- [Prisma Postgres](/docs/v6/postgres): A managed PostgreSQL database that is optimized for Prisma ORM.
...
If you need to delete your user account, go [here](/docs/v6/platform/support#deleting-your-pdp-account).
...
7. Copy the API key and store it securely. This will be used in your project's [`.env` file](/docs/v6/optimize/getting-started#22-add-the-optimize-api-key-to-your-env-file) via the `"OPTIMIZE_API_KEY"`. Finally, click the **"I've stored it securely"** button.

You now have your Optimize API key.

### Project

In each workspace, you can create several projects. A project typically represents an application (a product or service). You typically have one [Prisma schema](/docs/v6/orm/prisma-schema) per project.
...
Read more about the [Prisma CLI](/docs/v6/platform/platform-cli).
