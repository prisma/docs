...
- [About](/docs/v6/platform/about) - Learn about the Prisma Data Platform
- [Platform CLI](/docs/v6/platform/platform-cli/about) - Manage platform resources from the command line
- [Concepts](/docs/v6/platform) - Understand workspaces, projects, and environments
