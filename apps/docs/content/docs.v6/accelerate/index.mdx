...
- [Getting started](/docs/v6/accelerate/getting-started) - Set up connection pooling and global caching
- [Connection pooling](/docs/v6/accelerate/connection-pooling) - Scale your database connections
- [Caching](/docs/v6/accelerate/caching) - Global database cache with TTL and SWR
