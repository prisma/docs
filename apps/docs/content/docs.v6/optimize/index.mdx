...
- [Getting started](/docs/v6/optimize/getting-started) - Start analyzing queries in 5 minutes
- [Recommendations](/docs/v6/optimize/recommendations) - Performance optimization recommendations
- [Prisma AI](/docs/v6/optimize/prisma-ai) - AI-powered query optimization assistance
