...
- Node.js installed in your system [with the supported version](/docs/v6/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-6#minimum-supported-nodejs-versions)
