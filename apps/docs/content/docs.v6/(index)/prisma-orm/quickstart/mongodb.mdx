...
url: /docs/v6/prisma-orm/quickstart/mongodb
...
- Node.js installed in your system [with the supported version](/docs/v6/orm/more/upgrades/to-v7#minimum-supported-nodejs--typescript-versions)
...
- [MongoDB data modeling patterns](/docs/v6/orm/overview/databases/mongodb#type-mapping-between-mongodb-and-the-prisma-schema)
- [MongoDB deployment considerations](/docs/v6/orm/overview/databases/mongodb#differences-to-connectors-for-relational-databases)
