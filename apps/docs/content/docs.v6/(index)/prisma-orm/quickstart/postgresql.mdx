...
If you don't already have a PostgreSQL database, follow the quickstart to set up a production-ready [Prisma Postgres](/docs/v6/getting-started/prisma-orm/quickstart/prisma-postgres) database with Prisma ORM in a new project.
