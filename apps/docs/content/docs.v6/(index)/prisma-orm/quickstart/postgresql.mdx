...
url: /docs/v6/prisma-orm/quickstart/postgresql
...
If you don't already have a PostgreSQL database, follow the quickstart to set up a production-ready [Prisma Postgres](/docs/v6/prisma-orm/quickstart/prisma-postgres) database with Prisma ORM in a new project.
...
Next, set up your Prisma ORM project by creating your [Prisma Schema](/docs/v6/orm/prisma-schema/overview) file with the following command:
...
- [Database connection management](/docs/v6/orm/prisma-client/setup-and-configuration/databases-connections)
