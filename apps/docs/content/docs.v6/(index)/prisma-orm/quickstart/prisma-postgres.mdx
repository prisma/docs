...
url: /docs/v6/prisma-orm/quickstart/prisma-postgres
...
- [Prisma Postgres documentation](/docs/v6/postgres)
...
- [Cache your queries](/docs/v6/postgres/database/caching#setting-up-caching-in-prisma-postgres)
