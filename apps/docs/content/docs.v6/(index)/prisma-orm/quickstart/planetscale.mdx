...
PlanetScale also offers PostgreSQL databases. If you're using **PlanetScale PostgreSQL**, follow the [PostgreSQL quickstart guide](/docs/v6/getting-started/prisma-orm/quickstart/postgresql) instead.
