...
url: /docs/v6/prisma-postgres/quickstart/typeorm
...
[TypeORM](https://typeorm.io) is a TypeScript ORM. In this guide, you'll learn how to connect TypeORM to [Prisma Postgres](/docs/v6/postgres).
