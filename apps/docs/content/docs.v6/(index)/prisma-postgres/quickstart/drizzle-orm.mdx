...
url: /docs/v6/prisma-postgres/quickstart/drizzle-orm
...
[Drizzle ORM](https://orm.drizzle.team) is a TypeScript ORM. In this guide, you'll learn how to connect Drizzle ORM to [Prisma Postgres](/docs/v6/postgres).
