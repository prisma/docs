...
For a complete guide on setting up Prisma ORM with Prisma Postgres from scratch, including driver adapter configuration and best practices, see the [Prisma ORM with Prisma Postgres quickstart](/docs/v6/getting-started/prisma-orm/quickstart/prisma-postgres).
...
You can find the detailed step-by-step instructions for this process in this guide: [Add Prisma ORM to an existing project](/docs/v6/getting-started/prisma-orm/add-to-existing-project/prisma-postgres).
