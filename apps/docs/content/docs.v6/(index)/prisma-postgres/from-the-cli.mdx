...
If you ran the `prisma init --db` command inside a folder where you want your project to live, you can skip this step and [proceed to the next section](/docs/v6/getting-started/prisma-postgres/from-the-cli#2-set-up-your-project).
...
After adding the models, migrate your database using [Prisma Migrate](/docs/v6/orm/prisma-migrate):
...
You just got your feet wet with a basic Prisma Postgres setup. If you want to explore more complex queries, such as [adding caching functionality](/docs/v6/postgres/database/caching#setting-up-caching-in-prisma-postgres), check out the official [Quickstart](/docs/v6/getting-started/prisma-orm/quickstart/prisma-postgres).
