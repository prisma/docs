...
When running a [Migration](/docs/v6/orm/prisma-migrate) (or the [`prisma db push`](/docs/v6/orm/prisma-migrate/workflows/prototyping-your-schema) command) the [new defaults](#referential-action-defaults) will be applied to your database.
