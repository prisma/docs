...
Implicit m-n-relations makes the [Prisma Client API](/docs/v6/orm/prisma-client) for m-n-relations a bit simpler (since you have one fewer level of nesting inside of [nested writes](/docs/v6/orm/prisma-client/queries/relation-queries#nested-writes)).
