...
If your project uses [Prisma Migrate](/docs/v6/orm/prisma-migrate), you must [install the extension as part of a migration](/docs/v6/orm/prisma-migrate/workflows/native-database-functions) . Do not install the extension manually, because it is also required by the shadow database.
...
Some features, like SQL views or partial indexes, cannot be represented in the Prisma schema. If your project uses [Prisma Migrate](/docs/v6/orm/prisma-migrate), you must [include unsupported features as part of a migration](/docs/v6/orm/prisma-migrate/workflows/unsupported-database-features) .
