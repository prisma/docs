...
url: /docs/v6/orm/prisma-schema/postgresql-extensions
...
Run the following command to create an empty migration that you can [customize](/docs/v6/orm/prisma-migrate/workflows/customizing-migrations):
