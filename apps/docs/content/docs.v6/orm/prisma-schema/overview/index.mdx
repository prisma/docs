...
url: /docs/v6/orm/prisma-schema/overview
...
- [**Data model definition**](/docs/v6/orm/prisma-schema/data-model/models): Specifies your application [models](/docs/v6/orm/prisma-schema/data-model/models#defining-models) (the shape of the data per data source) and their [relations](/docs/v6/orm/prisma-schema/data-model/relations)
...
See [Environment variables](/docs/v6/orm/more/dev-environment/environment-variables) for more information about how to use an `.env` file during development.
