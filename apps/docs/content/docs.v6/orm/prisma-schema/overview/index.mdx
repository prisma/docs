...
See the [Prisma schema API reference](/v6/orm/reference/prisma-schema-reference) <span class="api"></span> for detailed information about each section of the schema.
...
- Run the [`prisma format`](/v6/orm/reference/prisma-cli-reference#format) <span class="api"></span> command.
