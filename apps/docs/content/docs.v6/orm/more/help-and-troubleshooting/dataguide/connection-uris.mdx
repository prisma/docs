...
description: "Learn how to encode PostgreSQL connection details in connection URIs for applications and libraries"
---
...
In this guide, we'll talk about how to format a connection URI with your PostgreSQL database information and [authentication](/docs/v6/orm/more/help-and-troubleshooting/dataguide/database-glossary#authentication) details. Connection URIs are divided into sections, so we'll cover each part as we go along.
