...
Because Prisma has its own [schema](/docs/v6/orm/prisma-schema), Tabnine can understand the basic shape of your data and help you write code for the other parts of your stack.
