...
- [Enable Prisma Client and schema preview features](/docs/v6/orm/reference/preview-features/client-preview-features)
- [Enable Prisma CLI preview features](/docs/v6/orm/reference/preview-features/cli-preview-features)
