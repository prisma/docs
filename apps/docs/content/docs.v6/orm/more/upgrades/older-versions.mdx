...
url: /docs/v6/orm/more/upgrades/older-versions
metaTitle: Older versions
metaDescription: 'Upgrade guides for Prisma ORM versions 3, 4, 5, and 6'
---

This page provides upgrade guidance for older Prisma ORM versions. For upgrading to the current version, see [Upgrade to v7](/docs/v6/orm/more/upgrades/to-v7).
