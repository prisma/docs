...
url: /docs/v6/orm/prisma-client/type-safety/prisma-validator
...
The [`Prisma.validator`](/docs/v6/orm/reference/prisma-client-reference#prismavalidator) is a utility function that takes a generated type and returns a type-safe object which adheres to the generated types model fields.
