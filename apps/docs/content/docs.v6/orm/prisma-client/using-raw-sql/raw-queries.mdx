...
url: /docs/v6/orm/prisma-client/using-raw-sql/raw-queries
...
For details of supported Prisma types, see the [Prisma connector overview](/docs/v6/orm/overview/databases/database-drivers) for the relevant database.
