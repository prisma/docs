...
url: /docs/v6/orm/prisma-client/debugging-and-troubleshooting/troubleshooting-binary-size-issues
...
Visit [this page](/docs/v6/orm/prisma-client/setup-and-configuration/no-rust-engine) for complete setup instructions and supported databases.
