...
url: /docs/v6/orm/prisma-client/special-fields-and-types
...
Learn more in the [upgrade guide to v6](/docs/v6/orm/more/upgrades/to-v7).
...
When creating records that have fields of type [`DateTime`](/docs/v6/orm/reference/prisma-schema-reference#datetime), Prisma Client accepts values as [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) objects adhering to the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
...
See: [Working with `Json` fields](/docs/v6/orm/prisma-client/special-fields-and-types/working-with-json-fields)

## Working with scalar lists / scalar arrays

See: [Working with scalar lists / arrays](/docs/v6/orm/prisma-client/special-fields-and-types/working-with-scalar-lists-arrays)

## Working with composite IDs and compound unique constraints

See: [Working with composite IDs and compound unique constraints](/docs/v6/orm/prisma-client/special-fields-and-types/working-with-composite-ids-and-constraints)
