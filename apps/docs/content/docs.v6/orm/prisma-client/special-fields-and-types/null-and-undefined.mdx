...
preview: false
url: /docs/v6/orm/prisma-client/special-fields-and-types/null-and-undefined
...
This example shows how an `undefined` parameter impacts the results returned by a query that uses the [`OR`](/docs/v6/orm/reference/prisma-client-reference#or) operator.
...
This is in contrast to the [`AND`](/docs/v6/orm/reference/prisma-client-reference#and) and [`NOT`](/docs/v6/orm/reference/prisma-client-reference#not-1) operators, which will both return all the users
