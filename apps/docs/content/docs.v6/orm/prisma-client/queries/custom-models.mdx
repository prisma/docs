...
- Creating static methods using a [Prisma Client extension](/docs/v6/orm/prisma-client/client-extensions)
...
We recommend using [Prisma Client extensions](/docs/v6/orm/prisma-client/client-extensions) to extend your models with [custom model methods](https://github.com/prisma/prisma-client-extensions/tree/main/instance-methods).
