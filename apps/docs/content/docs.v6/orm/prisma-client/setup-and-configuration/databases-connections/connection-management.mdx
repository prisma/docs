...
From Prisma ORM 5.0.0, the `beforeExit` hook only applies to the [binary Query Engine](/docs/v6/orm/more/under-the-hood/engines#configuring-the-query-engine).
