...
url: /docs/v6/orm/prisma-client/setup-and-configuration/generating-prisma-client
...
1. Ensure that you have [Prisma CLI installed on your machine](/docs/v6/orm/tools/prisma-cli#installation).
...
1. You can now [instantiate Prisma Client](/docs/v6/orm/prisma-client/setup-and-configuration/instantiate-prisma-client) in your code:
...
![Graphical illustration of the typical workflow for generation of Prisma Client](/docs/v6/orm/prisma-client/setup-and-configuration/prisma-client-generation-workflow.png)
...
Prisma Client is generated from your Prisma schema and is unique to your project. Each time you change the schema (for example, by performing a [schema migration](/docs/v6/orm/prisma-migrate/getting-started)) and run `prisma generate`, Prisma Client's code changes:

![The .prisma and @prisma folders](/docs/v6/orm/prisma-client/setup-and-configuration/prisma-client-node-module.png)
