...
url: /docs/v6/orm/prisma-client/setup-and-configuration/no-rust-engine
metaTitle: No Rust engine
metaDescription: Learn how to use Prisma ORM without Rust engines
---

As of [v6.16.0](https://pris.ly/release/6.16.0), usage of Prisma ORM without [Rust engine](/docs/v6/orm/more/internals/engines) binaries on PostgreSQL, CockroachDB, Neon, MySQL, PlanetScale, SQLite, D1 & MS SQL Server databases has been [Generally Available](/docs/v6/orm/more/releases#generally-available-ga).
