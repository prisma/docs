...
As of [v6.16.0](https://pris.ly/release/6.16.0), usage of Prisma ORM without [Rust engine](/docs/v6/orm/more/under-the-hood/engines) binaries on PostgreSQL, CockroachDB, Neon, MySQL, PlanetScale, SQLite, D1 & MS SQL Server databases has been [Generally Available](/docs/v6/orm/more/releases#generally-available-ga).
...
- required usage of [driver adapters](/docs/v6/orm/overview/databases/database-drivers#driver-adapters) for database connection management
...
When using the Rust-free version of Prisma ORM with [Prisma Accelerate](/docs/v6/accelerate) or [Prisma Postgres](/docs/v6/postgres), you **should not** use driver adapters. Instead, you can directly instantiate Prisma Client with the appropriate extension.
