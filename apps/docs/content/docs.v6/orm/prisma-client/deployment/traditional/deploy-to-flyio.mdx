...
url: /docs/v6/orm/prisma-client/deployment/traditional/deploy-to-flyio
...
- `prisma/seed.js`: defines some test users and postsPrisma, used to [seed the database](/docs/v6/orm/prisma-migrate/workflows/seeding) with starter data.
