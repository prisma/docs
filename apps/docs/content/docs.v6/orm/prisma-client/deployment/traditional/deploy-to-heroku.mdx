...
![architecture diagram](/docs/v6/orm/prisma-client/deployment/traditional/images/heroku-architecture.png)
...
![deployed-screenshot](/docs/v6/orm/prisma-client/deployment/traditional/images/heroku-deployed.png)
