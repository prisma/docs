...
url: /docs/v6/orm/prisma-client/deployment/deploy-database-changes-with-prisma-migrate
...
Exactly when to run `prisma migrate deploy` depends on your platform. For example, a simplified [Heroku](/docs/v6/orm/prisma-client/deployment/traditional/deploy-to-heroku) workflow includes:
...
- [`migrate deploy` reference](/docs/v6/orm/reference/prisma-cli-reference#migrate-deploy)
- [How `migrate deploy` works](/docs/v6/orm/prisma-migrate/workflows/development-and-production#production-and-testing-environments)
