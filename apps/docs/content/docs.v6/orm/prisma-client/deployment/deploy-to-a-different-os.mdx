...
Prisma Client depends on the [query engine](/docs/v6/orm/more/under-the-hood/engines) that is running as a binary on the same host as your application.
...
> **Note**: If your OS isn't supported you can include a [custom binary](/docs/v6/orm/more/under-the-hood/engines#using-custom-engine-libraries-or-binaries).
