...
url: /docs/v6/orm/prisma-client/deployment/caveats-when-deploying-to-aws-platforms
...
- Binaries like the [Prisma ORM query engine](/docs/v6/orm/more/internals/engines)
