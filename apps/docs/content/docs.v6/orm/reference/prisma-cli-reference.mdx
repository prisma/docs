...
Validates the [Prisma Schema Language](/docs/v6/orm/prisma-schema) of the Prisma schema file.
...
- [Conceptual overview of Prisma Migrate](/docs/v6/orm/prisma-migrate)
- [Developing with Prisma Migrate](/docs/v6/orm/prisma-migrate)
