...
Prisma ORM needs a connection URL to be able to connect to your database, e.g. when sending queries with [Prisma Client](/docs/v6/orm/prisma-client) or when changing the database schema with [Prisma Migrate](/docs/v6/orm/prisma-migrate).
