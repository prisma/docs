...
url: /docs/v6/orm/reference/prisma-client-reference
...
In the following situations, you must [use raw queries to compare columns in the same table](/docs/v6/orm/more/troubleshooting/raw-sql-comparisons):
