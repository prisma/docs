...
With legacy Prisma Migrate, you write the desired database schema in the form of a [Prisma schema data model](/docs/v6/orm/prisma-schema/data-model/models) inside your [Prisma schema file](/docs/v6/orm/prisma-schema). To map the data model to your database schema, you then have to run these two commands:
...
| Data validation                   | `CHECK`                         | No ([workaround](/docs/v6/orm/more/help-and-troubleshooting/check-constraints)) |
