...
url: /docs/v6/orm/prisma-migrate/workflows/development-and-production
...
- Migration history conflicts caused by [modified or missing migrations](/docs/v6/orm/prisma-migrate/understanding-prisma-migrate/migration-histories#do-not-edit-or-delete-migrations-that-have-been-applied)
...
> **Note**: For a simple and integrated way to re-create data in your development database as often as needed, check out our [seeding guide](/docs/v6/orm/prisma-migrate/workflows/seeding).
...
- You want to [rename a field](/docs/v6/orm/prisma-migrate/workflows/customizing-migrations#example-rename-a-field) (by default, Prisma Migrate will drop the existing field)
- You want to [change the direction of a 1-1 relationship](/docs/v6/orm/prisma-migrate/workflows/customizing-migrations#example-change-the-direction-of-a-1-1-relation)
...
Refer to [Customizing migrations](/docs/v6/orm/prisma-migrate/workflows/customizing-migrations) for examples.

### Team development

See: [Team development with Prisma Migrate](/docs/v6/orm/prisma-migrate/workflows/team-development) .
...
- [Prisma Migrate in deployment](/docs/v6/orm/prisma-client/deployment/deploy-database-changes-with-prisma-migrate)
- [Production troubleshooting](/docs/v6/orm/prisma-migrate/workflows/patching-and-hotfixing)
...
Since `5.3.0`, the advisory locking can be disabled using the [`PRISMA_SCHEMA_DISABLE_ADVISORY_LOCK` environment variable](/docs/v6/orm/reference/environment-variables-reference#prisma_schema_disable_advisory_lock)
