...
url: /docs/v6/orm/overview/introduction/data-modeling
...
No matter which approach though, with Prisma ORM you never create application models in your programming language by manually defining classes, interfaces, or structs. Instead, the application models are defined in your [Prisma schema](/docs/v6/orm/prisma-schema/overview):
