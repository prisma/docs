...
url: /docs/v6/orm/overview/introduction/what-is-prisma
...
Every project that uses a tool from the Prisma ORM toolkit starts with a [Prisma schema](/docs/v6/orm/prisma-schema/overview). The Prisma schema allows developers to define their _application models_ in an intuitive data modeling language. It also contains the connection to a database and defines a _generator_:
...
- Manually writing the data model and mapping it to the database with [Prisma Migrate](/docs/v6/orm/prisma-migrate/getting-started)
...
Learn more about the available operations in the [Prisma Client API reference](/docs/v6/orm/prisma-client/setup-and-configuration/introduction).
