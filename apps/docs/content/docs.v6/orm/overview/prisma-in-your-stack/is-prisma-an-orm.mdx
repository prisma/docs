...
url: /v6/orm/overview/prisma-in-your-stack/is-prisma-an-orm
...
![Database User table schema with id, first_name, and last_name columns.](/docs/v6/orm/overview/introduction/user-table.png)
