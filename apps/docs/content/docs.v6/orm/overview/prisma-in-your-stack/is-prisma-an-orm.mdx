...
![user-table](../introduction/user-table.png)
...
- [**Prisma Client**](/docs/v6/orm/prisma-client): Auto-generated and type-safe database client for use in your application.
- [**Prisma Migrate**](/docs/v6/orm/prisma-migrate): A declarative data modeling and migration tool.
...
These three tools use the [Prisma schema](/docs/v6/orm/prisma-schema) as a single source of truth for the database schema, your application's object schema, and the mapping between the two. It's defined by you and is your main way of configuring Prisma ORM.
...
![1-n relation between User and Post](../introduction/user-post-relation-1-n.png)
...
Prisma ORM will generate Prisma Client inside the `node_modules` folder, from which it can be imported in your application. For more extensive usage documentation, see the [Prisma Client API](/docs/v6/orm/prisma-client) docs.
