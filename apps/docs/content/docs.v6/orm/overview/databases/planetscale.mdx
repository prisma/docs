...
- model your database with the [Prisma Schema Language](/docs/v6/orm/prisma-schema)
...
- use [Prisma Client](/docs/v6/orm/prisma-client) in your application to talk to the database server at PlanetScale
