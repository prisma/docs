...
- Node.js version: A [compatible Node.js version](/docs/v6/orm/more/upgrades/to-v7#minimum-supported-nodejs--typescript-versions), required for Prisma 6.
