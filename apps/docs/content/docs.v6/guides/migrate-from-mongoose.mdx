...
url: /docs/v6/guides/migrate-from-mongoose
...
- Node.js installed [with the supported version](/docs/v6/orm/more/upgrades/to-v7#minimum-supported-nodejs--typescript-versions)
...
For an optimal development experience when working with Prisma ORM, refer to [editor setup](/docs/v6/orm/more/dev-environment/editor-setup) to learn about syntax highlighting, formatting, auto-completion, and many more cool features.
...
- [Prisma Client API reference](/docs/v6/orm/prisma-client/setup-and-configuration/introduction)
