...
url: /docs/v6/guides/permit-io-access-control
...
- [Prisma CLI](/docs/v6/orm/tools/prisma-cli) (`npx prisma`)
...
Integrate your API with an auth provider (e.g., [Clerk](/docs/v6/guides/clerk-nextjs), Auth0) and replace the `x-user-email` header with a secure identity mechanism (like a JWT token).
