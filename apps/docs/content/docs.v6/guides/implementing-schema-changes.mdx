...
url: /docs/v6/guides/implementing-schema-changes
...
- Learn about [customizing migrations](/docs/v6/orm/prisma-migrate/workflows/customizing-migrations)
- Explore [deployment workflows](/docs/v6/orm/prisma-migrate/workflows/development-and-production)

For more information:

- [Prisma Migrate documentation](/docs/v6/orm/prisma-migrate/getting-started)
- [Team development workflows](/docs/v6/orm/prisma-migrate/workflows/team-development)
