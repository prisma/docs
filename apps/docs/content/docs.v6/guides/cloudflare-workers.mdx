...
url: /docs/v6/guides/cloudflare-workers
...
Both the `cloudflare` and `workerd` runtimes are supported. Read more about runtimes [here](/docs/v6/orm/prisma-schema/overview/generators#field-reference).
...
- Use [Hono](https://hono.dev/) for a more robust routing framework with Cloudflare Workers (see our [Hono guide](/docs/v6/guides/hono))
...
- [Deploy to Cloudflare](/docs/v6/orm/prisma-client/deployment/edge/deploy-to-cloudflare)
