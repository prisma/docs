...
url: /docs/v6/guides/management-api-basic
...
This guide walks you through setting up a basic TypeScript project that uses the [Prisma Postgres Management API](/docs/v6/postgres/introduction/management-api) to create a new [Prisma Console project](/docs/v6/platform/about#project) with a [Prisma Postgres](/docs/v6/postgres/introduction/overview) database, and print out all connection details.

You'll authenticate via a [service token](/docs/v6/postgres/introduction/management-api#service-tokens), set up your environment, and run a script to interact with the API.
