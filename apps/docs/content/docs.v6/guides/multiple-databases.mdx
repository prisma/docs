...
- `migrate`: Applies pending migrations in development mode for both databases using [Prisma Migrate](/docs/v6/orm/prisma-migrate), updating their schemas based on changes in your Prisma files.
