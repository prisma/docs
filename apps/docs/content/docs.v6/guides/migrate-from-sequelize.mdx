...
url: /docs/v6/guides/migrate-from-sequelize
...
This migration guide uses PostgreSQL as the example database, but it equally applies to any other relational database that's [supported by Prisma ORM](/docs/v6/orm/reference/supported-databases). You can learn how Prisma ORM compares to Sequelize on the [Prisma ORM vs Sequelize](/docs/v6/orm/more/comparisons/prisma-and-sequelize) page.
