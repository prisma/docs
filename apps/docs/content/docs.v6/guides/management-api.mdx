...
url: /docs/v6/guides/management-api
...
For a complete list of available endpoints and details on request/response formats, see the [Prisma Management API documentation](/docs/v6/postgres/introduction/management-api).
...
For further details, see the [create-db](https://github.com/prisma/create-db) repo for a reference implementation, or consult the [Prisma Management API documentation](/docs/v6/postgres/introduction/management-api).
