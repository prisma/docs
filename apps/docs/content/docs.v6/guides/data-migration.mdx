...
url: /docs/v6/guides/data-migration
...
- Learn more about [Prisma Migrate](/docs/v6/orm/prisma-migrate/getting-started)
- Explore [schema prototyping](/docs/v6/orm/prisma-migrate/workflows/prototyping-your-schema)
- Understand [customizing migrations](/docs/v6/orm/prisma-migrate/workflows/customizing-migrations)

For more information:

- [Expand and Contract Pattern Documentation](https://www.prisma.io/dataguide/types/relational/expand-and-contract-pattern)
- [Prisma Migrate Workflows](/docs/v6/orm/prisma-migrate/workflows/development-and-production)
