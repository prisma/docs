...
url: /docs/v6/guides/supabase-accelerate
...
This guides teaches you how to add connection pooling to a PostgreSQL database hosted on [Supabase](https://supabase.com/) using [Prisma Accelerate](/docs/v6/accelerate).
...
If you want to use Prisma Migrate in the future, you also need to [baseline your database](/docs/v6/orm/prisma-migrate/workflows/baselining).
