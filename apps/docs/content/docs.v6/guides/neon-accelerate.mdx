...
url: /docs/v6/guides/neon-accelerate
...
This guides teaches you how to add connection pooling to a PostgreSQL database hosted on [Neon](https://neon.tech/) using [Prisma Accelerate](/docs/v6/accelerate).
