...
- A [Prisma Postgres database](/docs/v6/postgres) (created during setup)
...
We're going to use a direct connection string for connecting to Prisma Postgres. To get your [direct connection string](/docs/v6/postgres/database/direct-connections#how-to-connect-to-prisma-postgres-via-direct-tcp):
...
- [Prisma Config File](/docs/v6/orm/reference/prisma-config-reference)
- [Prisma Client without the Rust engine](/docs/v6/orm/prisma-client/setup-and-configuration/no-rust-engine)
