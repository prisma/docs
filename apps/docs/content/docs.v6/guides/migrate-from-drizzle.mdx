...
url: /docs/v6/guides/migrate-from-drizzle
...
Before you can introspect your database, you need to set up your [Prisma schema](/docs/v6/orm/prisma-schema/overview) and connect Prisma to your database. Run the following command in the root of your project to create a basic Prisma schema file:
