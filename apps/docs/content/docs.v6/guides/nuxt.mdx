...
- Learn about [Prisma Client API](/docs/v6/orm/prisma-client/setup-and-configuration/introduction)
- Set up [Prisma Postgres](/docs/v6/postgres) for a managed database
