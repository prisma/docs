...
url: /docs/prisma-postgres/quickstart/typeorm
...
[TypeORM](https://typeorm.io) is a TypeScript ORM. In this guide, you'll learn how to connect TypeORM to [Prisma Postgres](/docs/postgres).
