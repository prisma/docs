...
url: /docs/prisma-postgres/quickstart/kysely
...
[Kysely](https://kysely.dev) is a type-safe TypeScript SQL query builder that provides TypeScript support and a fluent API for building SQL queries. In this guide, you'll learn how to connect Kysely to [Prisma Postgres](/docs/postgres) and start querying your database with full type safety.
...
To learn more about the `create-db` CLI tool, see the [create-db documentation](/docs/postgres/npx-create-db).
