...
- Node.js installed in your system [with the supported version](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-6#minimum-supported-nodejs-versions)
...
- [MongoDB data modeling patterns](/docs/v7/orm/overview/databases/mongodb#type-mapping-between-mongodb-and-the-prisma-schema)
- [MongoDB deployment considerations](/docs/v7/orm/overview/databases/mongodb#differences-to-connectors-for-relational-databases)
