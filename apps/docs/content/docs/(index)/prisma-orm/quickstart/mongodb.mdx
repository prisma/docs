...
url: /docs/prisma-orm/quickstart/mongodb
...
- Node.js installed in your system [with the supported version](/docs/guides/upgrade-prisma-orm/v6#minimum-supported-nodejs-versions)
...
- [MongoDB data modeling patterns](/docs/orm/core-concepts/supported-databases/mongodb#type-mapping-between-mongodb-and-the-prisma-schema)
- [MongoDB deployment considerations](/docs/orm/core-concepts/supported-databases/mongodb#differences-to-connectors-for-relational-databases)
