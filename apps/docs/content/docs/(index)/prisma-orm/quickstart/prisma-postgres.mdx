...
url: /docs/prisma-orm/quickstart/prisma-postgres
...
Next, set up your Prisma ORM project by creating your [Prisma Schema](/docs/orm/prisma-schema/overview) file with the following command:
...
- [Database connection management](/docs/orm/prisma-client/setup-and-configuration/databases-connections)
