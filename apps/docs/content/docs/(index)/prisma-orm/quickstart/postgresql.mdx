...
url: /docs/prisma-orm/quickstart/postgresql
...
If you don't already have a PostgreSQL database, follow the quickstart to set up a production-ready [Prisma Postgres](/docs/prisma-orm/quickstart/prisma-postgres) database with Prisma ORM in a new project.
...
- [PostgreSQL database connector](/docs/orm/core-concepts/supported-databases/postgresql)
