...
url: /docs/prisma-orm/quickstart/sql-server
...
- A [Microsoft SQL Server](https://learn.microsoft.com/en-us/sql/?view=sql-server-ver16) database
  - [Microsoft SQL Server on Linux for Docker](/docs/orm/core-concepts/supported-databases/sql-server#local-setup)
  - [Microsoft SQL Server on Windows (local)](/docs/orm/core-concepts/supported-databases/sql-server#local-setup)
...
- [SQL Server database connector](/docs/orm/core-concepts/supported-databases/sql-server)
