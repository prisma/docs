...
- A [Microsoft SQL Server](https://learn.microsoft.com/en-us/sql/?view=sql-server-ver16) database
  - [Microsoft SQL Server on Linux for Docker](/docs/v7/orm/overview/databases/sql-server/sql-server-docker)
  - [Microsoft SQL Server on Windows (local)](/docs/v7/orm/overview/databases/sql-server/sql-server-local)
...
- [SQL Server database connector](/docs/v7/orm/overview/databases/sql-server)
