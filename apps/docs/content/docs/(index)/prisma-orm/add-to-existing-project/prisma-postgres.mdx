...
url: /docs/prisma-orm/add-to-existing-project/prisma-postgres
...
- **`@prisma/adapter-pg`** - The [`node-postgres` driver adapter](/docs/orm/core-concepts/supported-databases/postgresql#using-driver-adapters) that connects Prisma Client to your database
...
If you need to query your database via HTTP from an edge runtime (Cloudflare Workers, Vercel Edge Functions, etc.), use the [Prisma Postgres serverless driver](/docs/postgres/database/serverless-driver#use-with-prisma-orm).
...
- [Prisma Postgres documentation](/docs/postgres)
...
- [Cache your queries](/docs/postgres/database/caching#setting-up-caching-in-prisma-postgres)
