...
- **`@prisma/adapter-pg`** - The [`node-postgres` driver adapter](/docs/v7/orm/overview/databases/postgresql#using-the-node-postgres-driver) that connects Prisma Client to your database (CockroachDB is PostgreSQL-compatible)
...
Set up your Prisma ORM project by creating your [Prisma Schema](/docs/v7/orm/prisma-schema) file with the following command:
...
The [format of the connection URL](/docs/v7/orm/reference/connection-urls) for CockroachDB looks as follows:
...
To use Prisma Migrate with your existing database, you need to [baseline your database](/docs/v7/orm/prisma-migrate/getting-started).
...
[Prisma Studio](/docs/v7/orm/tools/prisma-studio) does not currently support CockroachDB. Support may be added in a future release. See [Databases supported by Prisma Studio](/docs/v7/orm/tools/prisma-studio#databases-supported-by-prisma-studio) for more information.

## Next steps

## More info

- [CockroachDB database connector](/docs/v7/orm/overview/databases/cockroachdb)
- [Prisma Config reference](/docs/v7/orm/reference/prisma-config-reference)
- [Database introspection](/docs/v7/orm/prisma-schema/introspection)
- [Prisma Migrate](/docs/v7/orm/prisma-migrate)
