...
If you're migrating to Prisma ORM from Mongoose, see our [Migrate from Mongoose guide](/docs/v7/guides/migrations/from-mongoose).
...
- [Node.js](https://nodejs.org/en/) installed on your machine (see [system requirements](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-6#minimum-supported-nodejs-versions) for officially supported versions)
...
Make sure you have your database [connection URL](/docs/v7/orm/reference/connection-urls) (that includes your authentication credentials) at hand!
...
[Prisma Studio](/docs/v7/orm/tools/prisma-studio) does not currently support MongoDB. Support may be added in a future release. See [Databases supported by Prisma Studio](/docs/v7/orm/tools/prisma-studio#databases-supported-by-prisma-studio) for more information.

## Next steps

## More info

- [MongoDB database connector](/docs/v7/orm/overview/databases/mongodb)
