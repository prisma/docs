...
The [format of the connection URL](/docs/v7/orm/reference/connection-urls) for PostgreSQL looks as follows:
...
- [PostgreSQL database connector](/docs/v7/orm/overview/databases/postgresql)
