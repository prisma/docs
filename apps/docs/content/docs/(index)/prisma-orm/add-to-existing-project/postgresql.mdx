...
url: /docs/prisma-orm/add-to-existing-project/postgresql
...
The [format of the connection URL](/docs/orm/reference/connection-urls) for PostgreSQL looks as follows:
