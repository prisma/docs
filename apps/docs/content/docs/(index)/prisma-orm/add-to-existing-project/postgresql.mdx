...
It also adds `prisma-next.md`, a short project-level reference your coding agent can read. It does not install agent skills; the Prisma 8 skill ships inside the `@prisma/orm-postgres` package your project installs.
