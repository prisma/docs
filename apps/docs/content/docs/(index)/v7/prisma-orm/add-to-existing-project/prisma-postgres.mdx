...
url: /v7/prisma-orm/add-to-existing-project/prisma-postgres
...
[Prisma Postgres](/postgres) is a managed PostgreSQL database that scales to zero and works with Prisma ORM and Prisma Studio. In this guide, you will learn how to add Prisma ORM to an existing TypeScript project, connect it to Prisma Postgres, introspect your existing database schema, and start querying with type-safe Prisma Client.
