...
url: /v7/prisma-orm/add-to-existing-project/sql-server
...
[SQL Server](https://www.microsoft.com/en-us/sql-server) is Microsoft's enterprise relational database management system. In this guide, you will learn how to add Prisma ORM to an existing TypeScript project, connect it to SQL Server, introspect your existing database schema, and start querying with type-safe Prisma Client.
