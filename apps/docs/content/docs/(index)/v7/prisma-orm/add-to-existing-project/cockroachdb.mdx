...
url: /v7/prisma-orm/add-to-existing-project/cockroachdb
...
The [format of the connection URL](/orm/v7/reference/connection-urls) for CockroachDB looks as follows:
...
To use Prisma Migrate with your existing database, you need to [baseline your database](/orm/v7/prisma-migrate/getting-started).
...
- [Prisma Migrate](/orm/v7/prisma-migrate)
