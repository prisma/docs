...
url: /v7/prisma-orm/quickstart/sqlite
...
[SQLite](https://sqlite.org) is a lightweight, file-based database suited to development, prototyping, and small applications. It requires no setup and stores data in a local file.

In this guide, you will learn how to set up a new TypeScript project from scratch, connect it to SQLite using Prisma ORM, and generate a Prisma Client for type-safe access to your database.
...
- [SQLite database connector](/orm/v7/core-concepts/supported-databases/sqlite)
