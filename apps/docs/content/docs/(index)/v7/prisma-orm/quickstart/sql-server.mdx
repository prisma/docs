...
url: /v7/prisma-orm/quickstart/sql-server
...
[Microsoft SQL Server](https://www.microsoft.com/en-us/sql-server) is an enterprise-grade relational database. In this guide, you will learn how to set up a new TypeScript project from scratch, connect it to SQL Server using Prisma ORM, and generate a Prisma Client for type-safe access to your database.
...
- A [Microsoft SQL Server](https://learn.microsoft.com/en-us/sql/?view=sql-server-ver16) database
  - [Microsoft SQL Server on Linux for Docker](/orm/v7/core-concepts/supported-databases/sql-server#local-setup)
  - [Microsoft SQL Server on Windows (local)](/orm/v7/core-concepts/supported-databases/sql-server#local-setup)
...
- [SQL Server database connector](/orm/v7/core-concepts/supported-databases/sql-server)
