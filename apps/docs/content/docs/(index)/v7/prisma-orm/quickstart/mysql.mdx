...
url: /v7/prisma-orm/quickstart/mysql
...
[MySQL](https://www.mysql.com) is a popular open-source relational database. In this guide, you will learn how to set up a new TypeScript project from scratch, connect it to MySQL using Prisma ORM, and generate a Prisma Client for type-safe access to your database.
