---
title: Terraform
description: Provision and manage Prisma Postgres projects, databases, and connections using Terraform.
...
- A Prisma service token (see [REST API authentication docs](/rest-api/authentication#service-tokens))
