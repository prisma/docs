...
url: /docs/postgres/integrations/raycast
---
...
See the [list of available regions](/docs/postgres/faq#what-regions-is-prisma-postgres-available-in) for all supported locations.

## Learn More

- [Raycast Extension Page](https://www.raycast.com/amanvarshney01/prisma-postgres)
- [Prisma Postgres Documentation](/docs/postgres)
- [Getting Started with Prisma Postgres](/docs/postgres)
