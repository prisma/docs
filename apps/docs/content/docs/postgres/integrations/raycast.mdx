...
With the extension, you can create Prisma Postgres databases without leaving Raycast, which suits rapid prototyping and development.
...
Create a new Prisma Postgres database with no configuration:
...
Use it to retrieve connection details or check which databases still need to be claimed.
