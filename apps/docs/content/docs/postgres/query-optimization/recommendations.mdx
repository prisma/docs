...
Prisma Optimize provides actionable recommendations to help you identify and resolve performance issues in your PostgreSQL database. These recommendations cover indexing strategies, query patterns, data type choices, and storage optimization.

:::info
Use [Prisma AI](/docs/v7/postgres/query-optimization/prisma-ai) to ask follow-up questions about any recommendation.
:::
...
- [Set up Optimize](/docs/v7/postgres/query-optimization#setup) to start receiving recommendations
- [Review query recordings](/docs/v7/postgres/query-optimization/recordings) to understand your application's query patterns
- [Use Prisma AI](/docs/v7/postgres/query-optimization/prisma-ai) to get personalized optimization suggestions
