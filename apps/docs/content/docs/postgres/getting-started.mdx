...
After running this command, the terminal will guide you with next steps. Follow [this page](/docs/v7/getting-started/prisma-postgres/from-the-cli) to complete the setup for your first Prisma Postgres project.
...
You can learn more about `npx create-db` in [the dedicated documentation](/docs/v7/postgres/npx-create-db).

## Prisma ORM

The easiest ways to get started with Prisma Postgres is by following these guides:

- [**Start from scratch**](/docs/v7/getting-started/prisma-postgres/quickstart/prisma-orm)
- [**Import data from an existing database**](/docs/v7/getting-started/prisma-postgres/import-from-existing-database-postgresql)
