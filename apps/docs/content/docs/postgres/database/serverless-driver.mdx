...
If your application currently uses a hosted `prisma+postgres://` Accelerate connection, follow [Switch Prisma Postgres from Accelerate](/postgres/database/switch-from-accelerate).
