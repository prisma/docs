...
badge: early-access
url: /docs/postgres/database/postgres-extensions
...
Prisma ORM doesn't natively support all extension types yet. For extensions that introduce custom types (like `vector` from pgvector), you can use [customized migrations](/docs/orm/prisma-migrate/workflows/customizing-migrations) and [raw SQL](/docs/orm/prisma-client/using-raw-sql) or [TypedSQL](/docs/orm/prisma-client/using-raw-sql/typedsql) to work with them.
...
Because Prisma ORM doesn't natively support the `VECTOR` type, it will be represented as [`Unsupported`](/docs/orm/prisma-schema/data-model/models#unsupported-types):
...
You can also use [TypedSQL](/docs/orm/prisma-client/using-raw-sql/typedsql) for type-safe queries.
...
- **Prisma ORM** does not natively support all extension types. Custom types are represented as [`Unsupported`](/docs/orm/prisma-schema/data-model/models#unsupported-types) in your schema and must be queried with [raw SQL](/docs/orm/prisma-client/using-raw-sql).
