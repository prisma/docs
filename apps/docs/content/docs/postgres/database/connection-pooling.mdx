...
:::note
TCP connection pooling is currently in [Early Access](/docs/console/more/feature-maturity#early-access).
:::
...
You can also connect to your Prisma Postgres database through [Prisma Accelerate](/docs/accelerate), which provides built-in connection pooling along with a global [caching layer](/docs/postgres/database/caching).
...
:::warning
If your queries regularly take longer than 10 seconds, consider optimizing them. Long-running queries can indicate missing indexes or inefficient data access patterns. See the [error reference](/docs/postgres/error-reference#p6009-responsesizelimitexceeded) for more details.
:::
...
See the [error reference](/docs/postgres/error-reference#p6009-responsesizelimitexceeded) and [pricing page](https://www.prisma.io/pricing) for more information.
