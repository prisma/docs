...
- [Getting started](/docs/accelerate/getting-started) - Learn how to get up and running with Prisma Accelerate
- [Local development](/docs/accelerate/local-development) - Learn how to use Prisma Accelerate in a development environment
- [Examples](/docs/accelerate/examples) - Check out ready-to-run examples for Prisma Accelerate
