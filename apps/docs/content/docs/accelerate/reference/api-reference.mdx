...
- [`findUnique()`](/orm/v7/reference/prisma-client-reference#findunique)
- [`findUniqueOrThrow()`](/orm/v7/reference/prisma-client-reference#finduniqueorthrow)
- [`findFirst()`](/orm/v7/reference/prisma-client-reference#findfirst)
- [`findFirstOrThrow()`](/orm/v7/reference/prisma-client-reference#findfirstorthrow)
- [`findMany()`](/orm/v7/reference/prisma-client-reference#findmany)
- [`count()`](/orm/v7/reference/prisma-client-reference#count)
- [`aggregate()`](/orm/v7/reference/prisma-client-reference#aggregate)
- [`groupBy()`](/orm/v7/reference/prisma-client-reference#groupby)
...
This clears the cache for the entire environment. Use it with care.
...
You can find the full error code reference for Prisma Accelerate [here](/orm/v7/reference/error-reference#prisma-accelerate).
