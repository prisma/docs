...
url: /docs/accelerate/reference/api-reference
...
With the Accelerate extension for Prisma Client, you can use the `cacheStrategy` parameter for model queries and use the [`ttl`](/docs/postgres/database/caching#time-to-live-ttl) and [`swr`](/docs/postgres/database/caching#stale-while-revalidate-swr) parameters to define a cache strategy for Accelerate. The Accelerate extension requires that you install Prisma Client version `4.10.0`.
...
| `tags` | `["user"]` | `String[]` | No       | The `tag` serves as a variable to control the invalidation of specific queries within your application. It is an optional array of strings to [invalidate](/docs/accelerate/reference/api-reference#accelerateinvalidate) the cache, with each tag containing only alphanumeric characters and underscores, and a maximum length of 64 characters. |
...
- [`findUnique()`](/docs/orm/reference/prisma-client-reference#findunique)
- [`findUniqueOrThrow()`](/docs/orm/reference/prisma-client-reference#finduniqueorthrow)
- [`findFirst()`](/docs/orm/reference/prisma-client-reference#findfirst)
- [`findFirstOrThrow()`](/docs/orm/reference/prisma-client-reference#findfirstorthrow)
- [`findMany()`](/docs/orm/reference/prisma-client-reference#findmany)
- [`count()`](/docs/orm/reference/prisma-client-reference#count)
- [`aggregate()`](/docs/orm/reference/prisma-client-reference#aggregate)
- [`groupBy()`](/docs/orm/reference/prisma-client-reference#groupby)
...
You can invalidate the cache using the [`$accelerate.invalidate` API](/docs/accelerate).
...
You can find the full error code reference for Prisma Accelerate [here](/docs/orm/reference/error-reference#prisma-accelerate).
