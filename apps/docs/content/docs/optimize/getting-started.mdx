...
url: /docs/optimize/getting-started
...
- A project using [Prisma Client](/docs/orm/prisma-client/setup-and-configuration/introduction)
- A PostgreSQL, MySQL/MariaDB, CockroachDB, or MS SQL Server database

:::note
Prisma Optimize is intended for use in local development environments. Learn more in the [FAQ](/docs/optimize/more/faq).
:::
...
Extensions are applied sequentially. If using [Prisma Accelerate](/docs/accelerate), apply it after Optimize:
...
:::info
Use [Prisma AI](/docs/optimize/prisma-ai) to understand recommendations and apply them within your Prisma model context.
:::

## Next steps

- [Recommendations](/docs/optimize/recommendations) - Learn about performance recommendations
- [Recordings](/docs/optimize/recordings) - Understand recording sessions
