...
Prisma Accelerate, including hosted Accelerate connections for Prisma Postgres such as `prisma://accelerate.prisma-data.net/?api_key=YOUR_API_KEY`, will be retired on December 1, 2026. Choose the path that matches your setup:
