...
url: /docs/console/features/optimize
---
...
7. Copy the API key and store it securely. This will be used in your project's [`.env` file](/docs/optimize/getting-started) via the `"OPTIMIZE_API_KEY"`. Finally, click the **"I've stored it securely"** button.
