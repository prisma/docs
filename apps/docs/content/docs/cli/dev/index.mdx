...
The `prisma dev` command starts a [local Prisma Postgres](/docs/postgres/database/local-development) database that you can run Prisma ORM commands against. It's useful for development and testing and allows easy migration to [Prisma Postgres](/docs/postgres) in production.
...
| Command                                   | Description                       |
| ----------------------------------------- | --------------------------------- |
| [`prisma dev ls`](/docs/cli/dev/ls)       | List available servers            |
| [`prisma dev rm`](/docs/cli/dev/rm)       | Remove servers                    |
| [`prisma dev start`](/docs/cli/dev/start) | Start one or more stopped servers |
| [`prisma dev stop`](/docs/cli/dev/stop)   | Stop servers                      |
