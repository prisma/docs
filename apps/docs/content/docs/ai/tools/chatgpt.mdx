---
title: ChatGPT
description: Learn how to add the Prisma MCP server to ChatGPT to manage your Prisma Postgres databases
url: /ai/tools/chatgpt
metaTitle: Using the Prisma MCP Server with ChatGPT
metaDescription: Learn how to add the Prisma MCP server to ChatGPT to manage your Prisma Postgres databases.
---
...
With the Prisma MCP server connected, you can manage databases from the chat interface. The server supports:
