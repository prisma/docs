...
url: /docs/ai/tutorials/linktree-clone
...
👉 **Find the setup prompt here:** [Next.js + Prisma Prompt](/docs/ai/prompts/nextjs)
...
📖 **Reference:** [Deploy to Vercel - Build Configuration](/docs/orm/prisma-client/deployment/serverless/deploy-to-vercel#build-configuration)
