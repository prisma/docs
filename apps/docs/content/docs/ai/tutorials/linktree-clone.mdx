...
👉 **Find the setup prompt here:** [Next.js + Prisma Prompt](/docs/v7/more/ai/prompts/nextjs)
...
📖 **Reference:** [Deploy to Vercel - Build Configuration](/docs/v7/orm/prisma-client/deployment/serverless/deploy-to-vercel#build-configuration)
