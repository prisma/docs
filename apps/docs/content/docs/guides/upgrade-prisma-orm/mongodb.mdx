...
- **Node.js 22.18 or newer**; Node.js 24 recommended
- **TypeScript 5.9+**
- **MongoDB 8.0+**
...
Prisma 8 MongoDB support evolves quickly, so check anything below against the `@prisma/orm-*` version you install. This guide targets `@prisma/orm-mongo@8.0.0-rc.9`.
