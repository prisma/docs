---
title: Upgrade to v4
description: Guide for upgrading to Prisma ORM v4
...
This guide helps you upgrade your project to Prisma ORM 4. Version 4 includes several breaking changes that may affect your application, so review this guide before upgrading.

## Before you begin

- **Back up your database** before starting the upgrade
- Review the [release notes](https://github.com/prisma/orm/releases/tag/4.0.0) for a complete list of changes
...
- **Database versions**: Check [system requirements](/orm/v7/reference/system-requirements) for database version compatibility
...
- [Prisma 4.0.0 Release Notes](https://github.com/prisma/orm/releases/tag/4.0.0)
...
- [Raw Database Access](/orm/v7/prisma-client/using-raw-sql/raw-queries)

## Getting Help

If you encounter issues during the upgrade:
1. Check the [GitHub Issues](https://github.com/prisma/orm/issues) for known problems
