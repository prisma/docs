...
This guide walks you through setting up a basic TypeScript project that uses the [Prisma Postgres Management API](/docs/v7/management-api) to create a new [Prisma Console project](/docs/v7/more/platform/about#project) with a [Prisma Postgres](/docs/v7/postgres) database, and print out all connection details.

You'll authenticate via a [service token](/docs/v7/management-api#authentication), set up your environment, and run a script to interact with the API.
