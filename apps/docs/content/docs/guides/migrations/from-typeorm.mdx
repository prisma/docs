...
This migration guide uses PostgreSQL as the example database, but it equally applies to any other relational database that's [supported by Prisma ORM](/docs/v7/orm/reference/supported-databases). You can learn how Prisma ORM compares to TypeORM on the [Prisma ORM vs TypeORM](/docs/v7/orm/more/comparisons/prisma-and-typeorm) page.
...
<Tabs items={["TypeORM", "Prisma Client"]}>
