...
|----------|-----------|-------------|----------|
| **Framework** | `guides/frameworks/` | Integrate Prisma with frameworks | [Next.js](/docs/guides/frameworks/nextjs), [NestJS](/docs/guides/frameworks/nestjs), [SvelteKit](/docs/guides/frameworks/sveltekit) |
| **Deployment** | `guides/deployment/` | Deploy apps and set up monorepos | [Turborepo](/docs/guides/deployment/turborepo), [Cloudflare Workers](/docs/guides/deployment/cloudflare-workers) |
| **Integration** | `guides/integrations/` | Use Prisma with platforms and tools | [GitHub Actions](/docs/guides/integrations/github-actions), [Supabase](/docs/guides/integrations/supabase-accelerate) |
| **Database** | `guides/database/` | Database patterns and migrations | [Multiple databases](/docs/guides/database/multiple-databases), [Data migration](/docs/guides/database/data-migration) |
| **Authentication** | `guides/authentication/` | Authentication patterns with Prisma | [Auth.js + Next.js](/docs/guides/authentication/authjs/nextjs), [Better Auth + Next.js](/docs/guides/authentication/better-auth/nextjs), [Clerk + Next.js](/docs/guides/authentication/clerk/nextjs) |
| **Prisma Postgres** | `guides/postgres/` | Prisma Postgres features | [Vercel](/docs/guides/postgres/vercel), [Netlify](/docs/guides/postgres/netlify), [Viewing data](/docs/guides/postgres/viewing-data) |
| **Migration** | `guides/switch-to-prisma-orm/` | Switch from other ORMs | [From Mongoose](/docs/guides/switch-to-prisma-orm/from-mongoose), [From Drizzle](/docs/guides/switch-to-prisma-orm/from-drizzle) |
