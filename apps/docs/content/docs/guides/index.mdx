...
- [Next.js](/docs/guides/frameworks/nextjs) - Learn how to use Prisma ORM in a Next.js app and deploy it to Vercel
- [Hono](/docs/guides/frameworks/hono) - Learn how to use Prisma ORM in a Hono app
- [SvelteKit](/docs/guides/frameworks/sveltekit) - Learn how to use Prisma ORM in a SvelteKit app
