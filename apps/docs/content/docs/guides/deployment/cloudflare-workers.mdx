...
url: /docs/guides/deployment/cloudflare-workers
...
Both the `cloudflare` and `workerd` runtimes are supported. Read more about runtimes [here](/docs/orm/prisma-schema/overview/generators#field-reference).
...
- Use [Hono](https://hono.dev/) for a more robust routing framework with Cloudflare Workers (see our [Hono guide](/docs/guides/frameworks/hono))
- Enable query caching with [Prisma Postgres](/docs/postgres/database/caching) for better performance

### More info

- [Prisma Documentation](/docs/orm)
- [Cloudflare Workers Documentation](https://developers.cloudflare.com/workers/)
- [Deploy to Cloudflare](/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare)
