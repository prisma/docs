...
url: /docs/guides/frameworks/nextjs
...
This guide shows you how to use Prisma with Next.js, a fullstack React framework. You'll learn how to create a [Prisma Postgres](/docs/postgres) instance, set up Prisma ORM with Next.js, handle migrations, and deploy your application to Vercel.
...
- Use [Prisma Studio](/docs/studio) for visual database management
