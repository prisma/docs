...
- A [Prisma Postgres database](/docs/v7/postgres) (created during setup)
...
We're going to use a direct connection string for connecting to Prisma Postgres. To get your [direct connection string](/docs/v7/postgres/database/direct-connections#how-to-connect-to-prisma-postgres-via-direct-tcp):
...
- [Prisma Config File](/docs/v7/orm/reference/prisma-config-reference)
- [Prisma Client without the Rust engine](/docs/v7/orm/prisma-client/setup-and-configuration/no-rust-engine)
