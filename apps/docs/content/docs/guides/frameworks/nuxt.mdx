...
url: /docs/guides/frameworks/nuxt
...
- Learn about [Prisma Client API](/docs/orm/prisma-client/setup-and-configuration/introduction)
- Set up [Prisma Postgres](/docs/postgres) for a managed database
