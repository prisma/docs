...
- `DATABASE_URL`: The [direct TCP connection URL](/docs/v7/postgres/database/direct-connections) starting with `postgres://...`
...
To view and edit the data in your Prisma Postgres instance, you can use the local version of [Prisma Studio](/docs/v7/orm/tools/prisma-studio).
