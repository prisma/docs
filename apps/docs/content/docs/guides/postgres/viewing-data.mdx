...
url: /docs/guides/postgres/viewing-data
...
You can view and edit your data in Prisma Postgres using either [Prisma Studio](/docs/studio) or 3rd party database editors.
