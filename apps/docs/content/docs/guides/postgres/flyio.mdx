...
- An existing application using [Prisma Postgres](/postgres) (see [Quickstart](/v7/prisma-postgres/quickstart/prisma-orm))
...
Fly.io lets you scale and place your application in [multiple regions](https://fly.io/docs/reference/regions/). To reduce latency, deploy your app in a region close to your Prisma Postgres database region.
