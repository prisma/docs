...
- A [Prisma Postgres database](/docs/postgres) (created during setup)
...
We're going to use a direct connection string for connecting to Prisma Postgres. To get your [direct connection string](/docs/postgres/database/direct-connections#how-to-connect-to-prisma-postgres-via-direct-tcp):
...
- [Prisma Config File](/docs/orm/reference/prisma-config-reference)
