...
- [Prisma CLI](/docs/v7/orm/tools/prisma-cli) (`npx prisma`)
...
Integrate your API with an auth provider (e.g., [Clerk](/docs/v7/guides/authentication/clerk/nextjs), Auth0) and replace the `x-user-email` header with a secure identity mechanism (like a JWT token).
