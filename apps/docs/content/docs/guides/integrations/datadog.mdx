...
url: /docs/guides/integrations/datadog
...
Then initialize Prisma with the `--db` flag to create a [new Prisma Postgres](/docs/postgres) instance:
...
- Created a Prisma ORM project with [Prisma Postgres](/docs/postgres).
...
- [Prisma tracing docs](/docs/orm/prisma-client/observability-and-logging/opentelemetry-tracing).
