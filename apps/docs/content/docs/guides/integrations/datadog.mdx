...
Then initialize Prisma with the `--db` flag to create a [new Prisma Postgres](/docs/v7/postgres) instance:
...
- Created a Prisma ORM project with [Prisma Postgres](/docs/v7/postgres).
...
- [Prisma tracing docs](/docs/v7/orm/prisma-client/observability-and-logging/opentelemetry-tracing).
