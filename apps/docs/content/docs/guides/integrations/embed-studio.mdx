...
url: /docs/guides/integrations/embed-studio
...
[**Embeddable Prisma Studio**](/docs/studio/integrations/embedding) is _free_ and licensed under Apache 2.0.
...
For more information, see [Database drivers](/docs/orm/core-concepts/supported-databases/database-drivers).
...
1. **Add authentication**: Currently, anyone who can open your app has access to Prisma Studio. [Add user authentication](/docs/studio/integrations/embedding#adding-user-authentication) and only allow specific roles (for example, admins) to use the embedded Studio. You can do this by checking authentication tokens in your `/api/studio` endpoint before running queries.
...
3. **Apply custom styling**: The Studio component ships with a default look. Pass in [your own theme](/docs/studio/integrations/embedding#custom-styling) and adjust colors, typography, or branding to match the rest of your application. This helps Studio feel like a native part of your app rather than a standalone tool.
