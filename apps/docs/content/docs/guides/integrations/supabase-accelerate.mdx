...
Prisma Accelerate is a connection pooler that keeps your database within its connection limits during traffic spikes and high load. Check out this [video](https://www.youtube.com/watch?v=cnL75if6Aq0) demonstrating how it performs in a load test or [learn why connection pooling is important](https://www.prisma.io/blog/saving-black-friday-with-connection-pooling).
...
If you want to use Prisma Migrate in the future, you also need to [baseline your database](/orm/v7/prisma-migrate/workflows/baselining).
...
With your Prisma schema in place, generate Prisma Client:
