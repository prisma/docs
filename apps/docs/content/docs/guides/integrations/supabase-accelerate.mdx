...
url: /docs/guides/integrations/supabase-accelerate
...
This guides teaches you how to add connection pooling to a PostgreSQL database hosted on [Supabase](https://supabase.com/) using [Prisma Accelerate](/docs/accelerate).
...
If you want to use Prisma Migrate in the future, you also need to [baseline your database](/docs/orm/prisma-migrate/workflows/baselining).
