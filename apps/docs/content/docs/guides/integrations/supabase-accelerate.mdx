...
This guides teaches you how to add connection pooling to a PostgreSQL database hosted on [Supabase](https://supabase.com/) using [Prisma Accelerate](/docs/v7/more/accelerate).
...
If you want to use Prisma Migrate in the future, you also need to [baseline your database](/docs/v7/orm/prisma-migrate/workflows/baselining).
