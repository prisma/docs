...
url: /docs/guides/integrations/neon-accelerate
...
This guides teaches you how to add connection pooling to a PostgreSQL database hosted on [Neon](https://neon.tech/) using [Prisma Accelerate](/docs/accelerate).
