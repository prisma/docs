...
This guide shows you how to implement instant app deployment using [Vercel](https://vercel.com)'s API with integrated [Prisma Postgres](/docs/v7/postgres) databases. You'll learn to programmatically create, deploy, and transfer full-stack applications with a single API call.
...
See the complete list of [supported Prisma Postgres regions](/docs/v7/postgres/faq#what-regions-is-prisma-postgres-available-in) and their corresponding [Vercel region codes](https://vercel.com/docs/regions#region-list).
