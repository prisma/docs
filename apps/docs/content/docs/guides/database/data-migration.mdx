...
url: /docs/guides/database/data-migration
...
- Learn more about [Prisma Migrate](/docs/orm/prisma-migrate)
- Explore [schema prototyping](/docs/orm/prisma-migrate/workflows/prototyping-your-schema)
- Understand [customizing migrations](/docs/orm/prisma-migrate/workflows/customizing-migrations)
