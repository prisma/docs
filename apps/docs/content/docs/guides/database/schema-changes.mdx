...
- Learn about [customizing migrations](/docs/v7/orm/prisma-migrate/workflows/customizing-migrations)
- Explore [deployment workflows](/docs/v7/orm/prisma-migrate/workflows/development-and-production)

For more information:

- [Prisma Migrate documentation](/docs/v7/orm/prisma-migrate)
- [Team development workflows](/docs/v7/orm/prisma-migrate/workflows/team-development)
