...
url: /guides/v7/frameworks/elysia
...
[Elysia](https://elysiajs.com/) is a web framework for Bun with end-to-end type safety. Its route handlers are where you call Prisma ORM to read and write a [Prisma Postgres](https://www.prisma.io/postgres) database, and Prismabox keeps its request and response schemas in sync with your Prisma models.
...
```npm
npm create prisma@stable -- --template elysia
```
...
Your Elysia app now serves a todo API backed by a Prisma Postgres database.
