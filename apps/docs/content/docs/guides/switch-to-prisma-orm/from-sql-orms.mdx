...
url: /docs/guides/switch-to-prisma-orm/from-sql-orms
...
- [Prisma ORM vs Sequelize](/docs/orm/more/comparisons/prisma-and-sequelize)
- [Prisma ORM vs TypeORM](/docs/orm/more/comparisons/prisma-and-typeorm)
...
- PostgreSQL, MySQL, or another [supported database](/docs/orm/reference/supported-databases)
...
- [Schema Reference](/docs/orm/reference/prisma-schema-reference)
- [Prisma ORM vs Sequelize](/docs/orm/more/comparisons/prisma-and-sequelize)
- [Prisma ORM vs TypeORM](/docs/orm/more/comparisons/prisma-and-typeorm)
