...
url: /docs/studio/getting-started
...
- Learn how to [embed Studio in your application](/docs/studio/integrations/embedding)
- Discover [VS Code integration](/docs/studio/integrations/vscode-integration) features
