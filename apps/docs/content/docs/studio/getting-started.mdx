...
- Learn how to [embed Studio in your application](/docs/v7/more/studio/embedding)
- Discover [VS Code integration](/docs/v7/more/studio/vscode-integration) features
