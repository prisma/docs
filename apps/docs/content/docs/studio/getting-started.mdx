...
Prisma Studio comes bundled with the Prisma CLI. Make sure you have Node.js installed, then install the Prisma CLI:
...
This is also how you launch Studio for a [Prisma 8](/orm) project, which has no `schema.prisma` to read. See [Studio with Prisma 8](/studio/prisma-next).
...
- Use the search bar to find tables or columns
...
- Use Studio with a [Prisma 8 project](/studio/prisma-next) to read your applied migration history in the Migrations view
