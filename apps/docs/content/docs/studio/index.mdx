...
- Reading the applied migration history of a [Prisma 8](/orm) database
...
- [Studio with Prisma 8](/studio/prisma-next) - Apply migrations to Prisma Postgres and read your migration history in the Migrations view
