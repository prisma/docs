...
url: /docs/orm/prisma-client/debugging-and-troubleshooting/handling-exceptions-and-errors
...
Use the `Prisma` namespace to access the error type. The [error code](/docs/orm/reference/error-reference#error-codes) can then be checked and a message can be printed.
...
See [Errors reference](/docs/orm/reference/error-reference) for a detailed breakdown of the different error types and their codes.
