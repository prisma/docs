...
url: /docs/orm/prisma-client/using-raw-sql
...
For a detailed guide on how to get started with TypedSQL, including setup instructions and usage examples, please refer to our [TypedSQL documentation](/docs/orm/prisma-client/using-raw-sql/typedsql).
...
- [`$queryRaw`](/docs/orm/prisma-client/using-raw-sql/raw-queries#queryraw)
- [`$executeRaw`](/docs/orm/prisma-client/using-raw-sql/raw-queries#executeraw)
- [`$queryRawUnsafe`](/docs/orm/prisma-client/using-raw-sql/raw-queries#queryrawunsafe)
- [`$executeRawUnsafe`](/docs/orm/prisma-client/using-raw-sql/raw-queries#executerawunsafe)
...
- [`$runCommandRaw`](/docs/orm/prisma-client/using-raw-sql/raw-queries#runcommandraw)
- [`<model>.findRaw`](/docs/orm/prisma-client/using-raw-sql/raw-queries#findraw)
- [`<model>.aggregateRaw`](/docs/orm/prisma-client/using-raw-sql/raw-queries#aggregateraw)
