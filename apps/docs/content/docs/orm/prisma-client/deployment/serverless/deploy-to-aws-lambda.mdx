...
url: /docs/orm/prisma-client/deployment/serverless/deploy-to-aws-lambda
...
You can use [Prisma Postgres](/docs/postgres), which has built-in connection pooling, to solve this issue. For other solutions, see the [connection management guide for serverless environments](/docs/orm/prisma-client/setup-and-configuration/databases-connections#serverless-environments-faas).
