...
![architecture diagram](/img/orm/prisma-client/deployment/traditional/images/heroku-architecture.png)
...
![deployed-screenshot](/img/orm/prisma-client/deployment/traditional/images/heroku-deployed.png)
