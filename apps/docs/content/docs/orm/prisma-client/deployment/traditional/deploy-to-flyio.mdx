...
url: /docs/orm/prisma-client/deployment/traditional/deploy-to-flyio
...
- `prisma/seed.js`: defines some test users and postsPrisma, used to [seed the database](/docs/orm/prisma-migrate/workflows/seeding) with starter data.
