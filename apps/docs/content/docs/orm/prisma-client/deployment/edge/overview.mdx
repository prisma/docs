...
url: /docs/orm/prisma-client/deployment/edge/overview
...
Deploying edge functions that use Prisma ORM on Cloudflare and Vercel is currently in [Preview](/docs/orm/more/releases#preview).
...
We recommend using [Prisma Postgres](/docs/postgres). It is fully supported on edge runtimes and does not require a specialized edge-compatible driver. 
...
- [Prisma Postgres](/docs/postgres) is used to access a PostgreSQL database built on bare-metal using unikernels. It is supported on both Cloudflare Workers and Vercel.
...
You can use all of these drivers with Prisma ORM using the respective [driver adapters](/docs/orm/core-concepts/supported-databases/database-drivers).
...
- Cloudflare
  - [PostgreSQL (traditional)](/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare#postgresql-traditional)
  - [PlanetScale](/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare#planetscale)
  - [Neon](/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare#neon)
...
- Vercel
  - [Vercel Postgres](/docs/orm/prisma-client/deployment/edge/deploy-to-vercel#vercel-postgres)
  - [Neon](/docs/orm/prisma-client/deployment/edge/deploy-to-vercel#neon)
  - [PlanetScale](/docs/orm/prisma-client/deployment/edge/deploy-to-vercel#planetscale)
  - [Prisma Postgres](/docs/guides/frameworks/nextjs)

If you want to deploy an app using Turso, you can follow the instructions [here](/docs/orm/core-concepts/supported-databases/sqlite#using-driver-adapters).
