...
Deploying edge functions that use Prisma ORM on Cloudflare and Vercel is currently in [Preview](/docs/v7/orm/more/releases#preview).
...
We recommend using [Prisma Postgres](/docs/v7/postgres). It is fully supported on edge runtimes and does not require a specialized edge-compatible driver. For other databases, [Prisma Accelerate](/docs/v7/more/accelerate) extends edge compatibility so you can connect to _any_ database from _any_ edge function provider.
...
- [Prisma Postgres](/docs/v7/postgres) is used to access a PostgreSQL database built on bare-metal using unikernels. It is supported on both Cloudflare Workers and Vercel.
...
You can use all of these drivers with Prisma ORM using the respective [driver adapters](/docs/v7/orm/overview/databases/database-drivers).
...
- Cloudflare
  - [PostgreSQL (traditional)](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-cloudflare#postgresql-traditional)
  - [PlanetScale](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-cloudflare#planetscale)
  - [Neon](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-cloudflare#neon)
  - [Cloudflare D1](/docs/v7/guides/deployment/cloudflare-d1)
  - [Prisma Postgres](https://developers.cloudflare.com/workers/tutorials/using-prisma-postgres-with-workers)
- Vercel
  - [Vercel Postgres](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-vercel#vercel-postgres)
  - [Neon](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-vercel#neon)
  - [PlanetScale](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-vercel#planetscale)
  - [Prisma Postgres](/docs/v7/guides/frameworks/nextjs)

If you want to deploy an app using Turso, you can follow the instructions [here](/docs/v7/orm/overview/databases/turso).
