...
Then setup helper scripts to perform migrations and generate `PrismaClient` as [shown in this section](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-cloudflare#development).
...
When deploying a Cloudflare Worker that uses Prisma ORM, you need to use an [edge-compatible driver](/docs/v7/orm/prisma-client/deployment/edge/overview#edge-compatibility-of-database-drivers) and its respective [driver adapter](/docs/v7/orm/overview/databases/database-drivers#driver-adapters) for Prisma ORM.
...
- [Cloudflare D1](/docs/v7/orm/prisma-client/deployment/edge/deploy-to-cloudflare) is used to access D1 databases
...
- use the `@prisma/adapter-pg` database adapter (learn more [here](/docs/v7/orm/overview/databases/postgresql#using-the-node-postgres-driver))
...
- use the `@prisma/adapter-planetscale` database adapter (learn more [here](/docs/v7/orm/overview/databases/planetscale#how-to-use-the-planetscale-serverless-driver-with-prisma-orm-preview))
...
- use the `@prisma/adapter-neon` database adapter (learn more [here](/docs/v7/orm/overview/databases/neon#how-to-use-neons-serverless-driver-with-prisma-orm))
