...
If you use a **relational database connector**, [Prisma Client](/docs/v7/orm/prisma-client) respects your database collation. Options and recommendations for supporting **case-insensitive** filtering and sorting with Prisma Client depend on your [database provider](#options-for-case-insensitive-filtering).

If you use the MongoDB connector, [Prisma Client](/docs/v7/orm/prisma-client/queries) uses RegEx rules to enable case-insensitive filtering. The connector _does not_ use [MongoDB collation](https://www.mongodb.com/docs/manual/reference/collation/).
...
See also: [Filtering (Case-insensitive filtering)](/docs/v7/orm/prisma-client/queries/filtering-and-sorting#case-insensitive-filtering)
