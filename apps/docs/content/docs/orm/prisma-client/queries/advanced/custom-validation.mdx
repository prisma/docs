...
- [Prisma Client extensions](/docs/v7/orm/prisma-client/client-extensions)
- A custom function
...
- Learn how you can use [Prisma Client extensions](/docs/v7/orm/prisma-client/client-extensions) to add input validation for your queries — [example](https://github.com/prisma/prisma-client-extensions/tree/main/input-validation).
- Learn how you can organize your code better by moving the `signup` function into [a custom model](/docs/v7/orm/prisma-client/queries/custom-models).
