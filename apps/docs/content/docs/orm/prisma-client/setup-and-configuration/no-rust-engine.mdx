...
As of [v6.16.0](https://pris.ly/release/6.16.0), usage of Prisma ORM without [Rust engine](/docs/v7/orm/more/under-the-hood/engines) binaries on PostgreSQL, CockroachDB, Neon, MySQL, PlanetScale, SQLite, D1 & MS SQL Server databases has been [Generally Available](/docs/v7/orm/more/releases#generally-available-ga).
...
- required usage of [driver adapters](/docs/v7/orm/overview/databases/database-drivers#driver-adapters) for database connection management
...
>
  <Tab value="PostgreSQL">```npm npm install @prisma/adapter-pg ```</Tab>
  <Tab value="SQLite">```npm npm install @prisma/adapter-better-sqlite3 ```</Tab>
  <Tab value="D1">```npm npm install @prisma/adapter-d1 ```</Tab>
  <Tab value="MySQL/MariaDB">```npm npm install @prisma/adapter-mariadb ```</Tab>
  <Tab value="PlanetScale">```npm npm install @prisma/adapter-planetscale ```</Tab>
  <Tab value="MSSQL">```npm npm install @prisma/adapter-mssql ```</Tab>
  <Tab value="CockroachDB">```npm npm install @prisma/adapter-pg ```</Tab>
  <Tab value="Neon Serverless">```npm npm install @prisma/adapter-neon ```</Tab>
</Tabs>
...
<Tabs items={["PostgreSQL", "SQLite", "D1", "MySQL/MariaDB", "PlanetScale", "MSSQL", "CockroachDB", "Neon Serverless"]}>
...
When using the Rust-free version of Prisma ORM with [Prisma Accelerate](/docs/v7/more/accelerate) or [Prisma Postgres](/docs/v7/postgres), you **should not** use driver adapters. Instead, you can directly instantiate Prisma Client with the appropriate extension.
...
>
  ...
  <Tab value="MSSQL">```npm npm install @prisma/adapter-mssql ```</Tab>
  <Tab value="CockroachDB">```npm npm install @prisma/adapter-pg ```</Tab>
  <Tab value="Neon Serverles">```npm npm install @prisma/adapter-neon ```</Tab>
</Tabs>
