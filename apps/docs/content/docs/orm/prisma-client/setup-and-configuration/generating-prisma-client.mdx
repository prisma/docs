...
1. Ensure that you have [Prisma CLI installed on your machine](/docs/v7/orm/tools/prisma-cli#installation).
...
1. You can now [instantiate Prisma Client](/docs/v7/orm/prisma-client/setup-and-configuration/instantiate-prisma-client) in your code:
...
Prisma Client is generated from your Prisma schema and is unique to your project. Each time you change the schema (for example, by performing a [schema migration](/docs/v7/orm/prisma-migrate)) and run `prisma generate`, Prisma Client's code changes:
