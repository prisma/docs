...
url: /docs/orm/prisma-client/client-extensions/type-utilities
...
[Prisma Client type utilities](/docs/orm/prisma-client/type-safety) are utilities available within your application and Prisma Client extensions and provide useful ways of constructing safe and extendable types for your extension.
