...
You can use the `model` [Prisma Client extensions](/docs/v7/orm/prisma-client/client-extensions) component type to add custom methods to your models.
...
You can improve the type-safety of `model` components in your shared extensions with [type utilities](/docs/v7/orm/prisma-client/client-extensions/type-utilities).
