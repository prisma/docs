...
url: /docs/orm/prisma-client/client-extensions/model
...
You can use the `model` [Prisma Client extensions](/docs/orm/prisma-client/client-extensions) component type to add custom methods to your models.
...
You can improve the type-safety of `model` components in your shared extensions with [type utilities](/docs/orm/prisma-client/client-extensions/type-utilities).
