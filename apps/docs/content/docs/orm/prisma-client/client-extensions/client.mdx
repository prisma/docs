...
url: /docs/orm/prisma-client/client-extensions/client
...
You can use the `client` [Prisma Client extensions](/docs/orm/prisma-client/client-extensions) component to add top-level methods to Prisma Client.
