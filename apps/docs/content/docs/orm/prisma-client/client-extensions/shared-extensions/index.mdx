...
You can share your [Prisma Client extensions](/docs/v7/orm/prisma-client/client-extensions) with other users, either as packages or as modules, and import extensions that other users create into your project.
...
To explore examples of Prisma's official Client extensions and those made by the community, visit [this](/docs/v7/orm/prisma-client/client-extensions/extension-examples) page.
...
2. Use one of the methods that begin with the `$all` prefix such as [`$allModels`](/docs/v7/orm/prisma-client/client-extensions/model#add-a-custom-method-to-all-models-in-your-schema) or [`$allOperations`](/docs/v7/orm/prisma-client/client-extensions/query#modify-all-prisma-client-operations)
...
You do not need to use the `$all` prefix with the [`client`](/docs/v7/orm/prisma-client/client-extensions/client) component, because the `client` component always applies to the client instance.
...
- [Modify all Prisma Client operations](/docs/v7/orm/prisma-client/client-extensions/query#modify-all-prisma-client-operations)
- [Modify a specific operation in all models of your schema](/docs/v7/orm/prisma-client/client-extensions/query#modify-a-specific-operation-in-all-models-of-your-schema)
- [Modify all operations in all models of your schema](/docs/v7/orm/prisma-client/client-extensions/query#modify-all-operations-in-all-models-of-your-schema)
...
If you trigger the extension from inside a [transaction](/docs/v7/orm/prisma-client/queries/transactions) (interactive or batched), the extension code will issue the queries in a new connection and ignore the current transaction context.
...
- When you want to use a [client-level method](/docs/v7/orm/reference/prisma-client-reference#client-methods), such as `$queryRaw`, in your packaged extension.
...
You can improve the type-safety of your shared extensions using [type utilities](/docs/v7/orm/prisma-client/client-extensions/type-utilities).
