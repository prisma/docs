...
preview: false
url: /docs/orm/prisma-client/special-fields-and-types/null-and-undefined
...
This example shows how an `undefined` parameter impacts the results returned by a query that uses the [`OR`](/docs/orm/reference/prisma-client-reference#or) operator.
...
This is in contrast to the [`AND`](/docs/orm/reference/prisma-client-reference#and) and [`NOT`](/docs/orm/reference/prisma-client-reference) operators, which will both return all the users
