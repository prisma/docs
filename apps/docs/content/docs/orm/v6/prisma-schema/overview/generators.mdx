...
The `prisma-client` generator gives you control over where Prisma Client is generated and how it is bundled across different JavaScript environments (such as ESM, Bun, Deno, ...).
