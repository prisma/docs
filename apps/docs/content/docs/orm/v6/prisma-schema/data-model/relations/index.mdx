...
![A one-to-many relationship between a user and posts table.](/docs/orm/v6/prisma-schema/data-model/relations/one-to-many.png)
...
![The sample schema as an entity relationship diagram](/docs/orm/v6/prisma-schema/data-model/relations/sample-schema.png)
