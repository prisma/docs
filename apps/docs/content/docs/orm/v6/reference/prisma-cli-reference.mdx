...
### `platform` ([Early Access](https://www.prisma.io/docs/platform/maturity-levels))
...
You can find the complete list of available commands with the arguments [here](/cli/console/platform).
