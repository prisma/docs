...
url: /orm/v6/more/upgrades/to-v7
metaTitle: To v7
...
If you complete the Prisma 7 upgrade before removing Accelerate, you can keep the Accelerate URL and extension temporarily. Do **not** pass the Accelerate URL to a driver adapter—`PrismaPg` expects a direct database connection string and will fail with `prisma://` or `prisma+postgres://`.
