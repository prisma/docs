...
url: /orm/v6/more/upgrades/from-v1
metaTitle: From v1
...
- Allow connecting to any existing database via introspection
...
3. Open an issue on [GitHub](https://github.com/prisma/orm/issues) for bugs
