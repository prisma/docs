...
url: /orm/v6/more/comparisons/prisma-and-typeorm
...
While Prisma Client operates at a higher level of abstraction, it exposes the capabilities of the underlying database, allowing you to drop down to [raw SQL](/orm/v6/prisma-client/using-raw-sql/raw-queries) at any time if your use case requires it.
...
- type-safe querying of nested data without writing JOINs ([docs](/orm/v6/prisma-client/queries/relation-queries#nested-reads))
...
Prisma ORM's DSL for data modeling is declarative and short. When modeling data in VS Code, the Prisma VS Code extension adds autocompletion, quick fixes, and jump to definition.
...
Prisma ORM generates many [additional filters](/orm/v6/prisma-client/queries/filtering-and-sorting) that are commonly used in application development.
