---
title: Editor setup
description: Learn how to configure your editor and IDE for syntax highlighting, linting, and formatting with Prisma ORM.
url: /orm/v6/more/dev-environment/editor-setup
metaTitle: Editor and IDE setup
metaDescription: Learn how to configure your editor and IDE for syntax highlighting, linting, and formatting with Prisma ORM.
---

This page describes how to configure your editor for syntax highlighting, linting, formatting, and autocompletion when working with Prisma ORM.
