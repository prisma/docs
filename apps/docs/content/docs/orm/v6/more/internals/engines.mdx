...
![Prisma engine](/docs/orm/v6/more/internals/typical-flow-query-engine-at-runtime.png)
...
![Diagram showing the query engine and Node.js at runtime](/docs/orm/v6/more/internals/query-engine-node-js-at-runtime.png)
...
![Typical flow of the query engine at run time](/docs/orm/v6/more/internals/typical-flow-query-engine-at-runtime.png)
