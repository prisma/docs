...
If you previously used `Prisma.validator`, read this [blog post](https://www.prisma.io/blog/satisfies-operator-ur8ys8ccq7zb) to learn how to use the `satisfies` keyword in its place.  
 :::

## Creating a typed query statement

Imagine that you created a new `userEmail` object that you wanted to re-use in different queries throughout your application. It's typed and can be safely used in queries.
