...
## How Prisma ORM's type system works

Prisma ORM uses _types_ to define the kind of data that a field can hold. To get you started, Prisma ORM provides a small number of core [scalar types](/orm/v6/reference/prisma-schema-reference#model-field-scalar-types) that should cover most default use cases. For example, take the following blog post model:
