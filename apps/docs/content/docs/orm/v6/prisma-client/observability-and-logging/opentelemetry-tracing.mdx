...
![Example Prisma Client trace structure showing parent and child spans for a database operation (serialization, query engine, database query).](/docs/orm/v6/prisma-client/observability-and-logging/trace-diagram.png)
...
![Jaeger UI](/docs/orm/v6/prisma-client/observability-and-logging/jaeger.png)
