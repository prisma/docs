...
url: /orm/v6/prisma-client/client-extensions/extension-examples
...
| [`prisma-extension-bark`](https://github.com/adamjkb/bark)                                     | Implements the Materialized Path pattern for creating and working with tree structures in Prisma |
