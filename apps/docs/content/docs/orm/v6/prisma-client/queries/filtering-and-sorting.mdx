...
In [2.19.0](https://github.com/prisma/orm/releases/2.19.0) and later, you can sort by the **count of related records**.
...
> **Note**: It is not currently possible to [return the count of a relation](https://github.com/prisma/orm/issues/5079).
