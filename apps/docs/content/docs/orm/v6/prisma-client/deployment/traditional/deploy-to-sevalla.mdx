...
![Sevalla app creation interface](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-app-creation.png)
...
![Choose repository interface in Sevalla](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-choose-repository.png)
...
![Name application interface in Sevalla](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-name-application.png)
...
![Create database interface in Sevalla](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-create-database.png)
...
![App internal connection interface in Sevalla](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-app-internal-connection.png)
...
![Sevalla web terminal interface](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-web-terminal.png)
...
![Sevalla database studio interface](/docs/orm/v6/prisma-client/deployment/traditional/images/sevalla-database-studio.png)
