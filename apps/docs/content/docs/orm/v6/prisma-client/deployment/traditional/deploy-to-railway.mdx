...
![Railway deploying application](/docs/orm/v6/prisma-client/deployment/traditional/images/railway-deploying.png)
...
![Railway environment variables setup](/docs/orm/v6/prisma-client/deployment/traditional/images/railway-env-vars.png)
...
![Railway networking settings](/docs/orm/v6/prisma-client/deployment/traditional/images/railway-networking.png)
...
![Railway deployed application](/docs/orm/v6/prisma-client/deployment/traditional/images/railway-final-product.png)
