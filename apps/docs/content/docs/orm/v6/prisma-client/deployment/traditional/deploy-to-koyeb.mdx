...
![Koyeb deployment architecture diagram showing a Node.js backend with Prisma Client, static frontend, and PostgreSQL database.](/docs/orm/v6/prisma-client/deployment/traditional/images/koyeb-architecture.png)
...
![Koyeb app creation interface showing environment variables configuration and Create App button.](/docs/orm/v6/prisma-client/deployment/traditional/images/koyeb-app-creation.png)
...
![Deployed Prisma app frontend in browser showing Check API status, Seed data, and Load feed buttons.](/docs/orm/v6/prisma-client/deployment/traditional/images/koyeb-deployed.png)
