...
2. Click **Site settings**:
   ![Netlify admin UI](/docs/orm/v6/prisma-client/deployment/serverless/images/500-06-deploy-to-netlify-site-settings.png)
...
4. Click **Edit variables** and create a variable with the key `DATABASE_URL` and set its value to your database connection string.
   ![Netlify environment variables](/docs/orm/v6/prisma-client/deployment/serverless/images/500-07-deploy-to-netlify-environment-variables-settings.png)
5. Click **Save**.
