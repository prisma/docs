...
3. Add an environment variable with a key of `DATABASE_URL` and select only the **Preview** environment option:
   ...
   ![Add an environment variable for the preview environment](/docs/orm/v6/prisma-client/deployment/serverless/images/300-60-deploy-to-vercel-preview-environment-variable.png)
