...
If you don't want to run your own pooler, [Prisma Accelerate](https://www.prisma.io/accelerate?utm_source=docs&utm_campaign=pgbouncer-help) provides managed connection pooling for all databases supported by Prisma ORM. To set it up, start in the [Prisma Console](https://console.prisma.io?utm_source=docs&utm_campaign=pgbouncer-help).
