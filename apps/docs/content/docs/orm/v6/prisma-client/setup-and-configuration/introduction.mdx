...
[🚀 Set up a new project from scratch](/v7/prisma-orm/quickstart/postgresql)

[➕ Add Prisma to an existing project](/v7/prisma-orm/add-to-existing-project/postgresql)
