...
![Graphical illustration of the typical workflow for generation of Prisma Client](/docs/orm/v6/prisma-client/setup-and-configuration/prisma-client-generation-workflow.png)
...
![The .prisma and @prisma folders](/docs/orm/v6/prisma-client/setup-and-configuration/prisma-client-node-module.png)
