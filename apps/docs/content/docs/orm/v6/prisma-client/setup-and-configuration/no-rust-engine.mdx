...
Hosted Accelerate connections will be retired on December 1, 2026. Existing Prisma Postgres applications using `prisma+postgres://accelerate.prisma-data.net` should follow [Switch Prisma Postgres from Accelerate](/postgres/database/switch-from-accelerate). For other databases, follow [Keep your existing database](/accelerate/keep-your-database).
