...
As of Prisma ORM v7, [driver adapters](/orm/v6/overview/databases/database-drivers) are the default for relational databases. Learn more [here](/orm/v6/prisma-client/setup-and-configuration/no-rust-engine).
