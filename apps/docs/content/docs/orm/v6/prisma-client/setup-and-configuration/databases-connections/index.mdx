...
![An AWS Lambda function connecting to a database.](/docs/orm/v6/prisma-client/setup-and-configuration/databases-connections/serverless-connections.png)
...
![Three AWS Lambda function connecting to a database.](/docs/orm/v6/prisma-client/setup-and-configuration/databases-connections/serverless-connections-2.png)
...
[Prisma Accelerate](/accelerate) is a managed external connection pooler built by Prisma that is integrated in the [Prisma Data Platform](https://console.prisma.io) and handles connection pooling for you.
