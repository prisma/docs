...
url: /orm/v6/tools/prisma-studio
metaTitle: Prisma Studio
metaDescription: Prisma Studio is a visual database editor.
---

Prisma Studio is a standalone visual database editor that lets you view and manipulate data directly in your browser. Prisma 7 introduces a new standalone Studio that works with or without Prisma ORM.
