...
![Model-first migration flow](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/entity-first-migration-flow.png)
...
![Database-first migration flow](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/database-first-migration-flow.png)
...
![Prisma Migrate workflow](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-lifecycle.png)
...
![Prisma Migrate "state management"](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-state-mgt.png)
...
![Prisma Migrate dev flow](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-dev-flow.png)
...
![A cartoon that shows how the shadow database works.](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/shadow-database.png)
...
![Revert database schema with `migrate diff`](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-diff-flow.png)
...
![prisma db push development flow](/docs/orm/v6/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/db-push-flow.png)
...
![Workflow of Prisma Migrate](/docs/orm/v6/prisma-migrate/workflows/deploy-db.png)
