...
You can [use `db push` and Prisma Migrate together in your development workflow](/orm/v6/prisma-migrate/workflows/prototyping-your-schema) . For example, you can:
