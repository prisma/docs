...
In Prisma ORM v6 and earlier, Prisma Migrate also runs your seed command for you. Seeding is triggered automatically when Prisma Migrate resets the development database.
