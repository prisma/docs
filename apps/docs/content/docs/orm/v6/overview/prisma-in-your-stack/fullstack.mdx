...
url: /orm/v6/overview/prisma-in-your-stack/fullstack
...
If you want to learn how to build an app with Next.js and Prisma ORM, check out this [video tutorial](https://www.youtube.com/watch?v=QXxy8Uv1LnQ&ab_channel=ByteGrad).
