...
url: /orm/v6/overview/prisma-in-your-stack/is-prisma-an-orm
...
Here is how that looks with a TypeORM migration:
...
Prisma ORM is a **next-generation ORM** for application developers. It consists of the following tools:
...
- [**Prisma Studio**](/orm/v6/tools/prisma-studio): A GUI for browsing and managing data in your database.
...
Prisma ORM provides _type safety_, auto-completion, and an API for fetching relations without writing JOINs.
...
The next section shows how the Prisma schema works in practice.
