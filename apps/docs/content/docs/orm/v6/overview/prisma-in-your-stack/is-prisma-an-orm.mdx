...
![Database User table schema with id, first_name, last_name, and email columns.](/docs/orm/v6/overview/introduction/user-table.png)
...
![1-n relation between User and Post](/docs/orm/v6/overview/introduction/user-post-relation-1-n.png)
