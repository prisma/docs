...
![Query flow from the user application to the database with Prisma Client](/docs/orm/v6/overview/databases/images/drivers/qe-query-execution-flow.png)
...
![Query flow from the user application to the database using Prisma Client and driver adapters](/docs/orm/v6/overview/databases/images/drivers/qe-query-engine-adapter.png)
