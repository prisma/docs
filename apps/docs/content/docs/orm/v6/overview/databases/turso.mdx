...
url: /orm/v6/overview/databases/turso
metaTitle: Turso
...
![Embedded Replica: First remote read](/docs/orm/v6/overview/databases/images/embedded-replica-remote-read.png)
...
![Embedded Replica: Remote DB Copy](/docs/orm/v6/overview/databases/images/embedded-replica-create-replica.png)
...
![Embedded Replica: Local DB reads](/docs/orm/v6/overview/databases/images/embedded-replica-read.png)
...
![Embedded Replica: Write operation propagation](/docs/orm/v6/overview/databases/images/embedded-replica-write-propagation.png)
