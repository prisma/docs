...
url: /orm/v6/overview/databases/sql-server
...
Prisma Migrate is supported in [2.13.0](https://github.com/prisma/orm/releases/tag/2.13.0) and later with the following caveats:
