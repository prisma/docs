...
url: /orm/v6/overview/databases/cockroachdb
...
- **Built-in scaling:** CockroachDB comes with automated replication, failover and repair capabilities to allow horizontal scaling of your application
...
- [Start from scratch](/v7/prisma-orm/quickstart/cockroachdb)
- [Add to existing project](/v7/prisma-orm/add-to-existing-project/cockroachdb)
