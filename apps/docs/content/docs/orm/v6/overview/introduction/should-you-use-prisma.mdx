...
url: /orm/v6/overview/introduction/should-you-use-prisma
...
We build abstractions for the database tasks that are complex, error-prone, and time-consuming when performed by hand, such as writing migrations, typing query results, and constructing nested queries.

Whether you are new to SQL or experienced with it, Prisma ORM shortens the most common database workflows.
...
- build editor extensions (e.g. for [VS Code](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma))
- go the extra mile to achieve full type-safety

### ... you are working in a team

Prisma ORM is designed for collaborative environments.
...
Development of Prisma ORM's open source tools is happening in the open. Most of it happens directly on GitHub in the main [`prisma/prisma`](https://github.com/prisma/orm) repo:

- issues and PRs in our repos are triaged and prioritized (usually within 1-2 days)
- new [releases](https://github.com/prisma/orm/releases) with new features and improvements are issued every three weeks
- we have a dedicated support team that responds to questions in [GitHub Discussions](https://github.com/prisma/orm/discussions)
...
> **Note**: If you can work around a certain limitation but still would like to see an improvement in the way how Prisma ORM handles the situation, we encourage you to create a [feature request](https://github.com/prisma/orm/issues/new?assignees=&labels=&template=feature_request.md&title=")" on GitHub so that our Product and Engineering teams can look into it.
