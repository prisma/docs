...
url: /orm/v6/overview/introduction/what-is-prisma
metaTitle: What is Prisma ORM? (Prisma 6 overview)
...
Prisma ORM is an [open-source](https://github.com/prisma/orm) next-generation ORM. It consists of the following parts:
...
Every project that uses a tool from the Prisma ORM toolkit starts with a [Prisma schema](/orm/v6/prisma-schema/overview). The Prisma schema allows developers to define their _application models_ in a declarative data modeling language. It also contains the connection to a database and defines a _generator_:
