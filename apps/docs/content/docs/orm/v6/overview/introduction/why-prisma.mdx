...
url: /orm/v6/overview/introduction/why-prisma
...
![Productivity vs Control in ORMs, SQL query builders, and SQL](/docs/orm/v6/overview/introduction/node-js-db-tools-tradeoffs.png)
...
![Prisma ORM makes developers productive](/docs/orm/v6/overview/introduction/prisma-makes-devs-productive.png)
