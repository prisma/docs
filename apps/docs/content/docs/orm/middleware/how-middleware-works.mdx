...
Three middleware ship with Prisma 8 today. The table is generated from the [extension directory](https://www.prisma.io/extensions), where community middleware is listed too:
