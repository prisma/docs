...
url: /orm/v7/prisma-migrate/workflows/baselining
...
Baselining is part of [adding Prisma Migrate to a project with an existing database](/orm/v7/prisma-migrate/getting-started#adding-to-an-existing-project).
