...
url: /orm/v7/more/troubleshooting/typescript-performance
metaTitle: Optimizing TypeScript performance with large Prisma schemas
metaDescription: Learn how to improve TypeScript compilation performance when working with large Prisma schemas using type optimization strategies
---
...
When working with large Prisma schemas, prefer `typeof` type queries over direct references to `PrismaClient`. The 78% compilation time reduction shown here grows as the schema gets larger.
