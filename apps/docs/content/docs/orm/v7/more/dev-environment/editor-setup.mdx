---
title: Editor setup
description: Learn how to configure your editor and IDEs for syntax highlighting, autocompletion, and formatting with Prisma ORM
url: /orm/v7/more/dev-environment/editor-setup
metaTitle: Editor and IDE setup
metaDescription: Learn how to configure your editor and IDEs for syntax highlighting, autocompletion, and formatting with Prisma ORM.
---

This page describes how to configure your editor for syntax highlighting, autocompletion, and formatting of Prisma schema files.

If you don't see your editor here, please [open a feature request](https://github.com/prisma/orm/issues/new?assignees=&labels=&template=feature_request.md&title=")" and ask for dedicated support for your editor (e.g. for syntax highlighting and auto-formatting).
