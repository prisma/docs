...
url: /orm/v7/reference/supported-databases
...
> See also: [System requirements](/orm/v7/reference/system-requirements).
...
&sup1; This does not include support for [Data API for Aurora Serverless](https://github.com/prisma/orm/issues/1964).
