...
url: /orm/v7/prisma-schema/postgresql-extensions
...
Run the following command to create an empty migration that you can [customize](/orm/v7/prisma-migrate/workflows/customizing-migrations):
