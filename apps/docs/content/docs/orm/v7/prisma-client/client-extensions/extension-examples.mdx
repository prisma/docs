...
url: /orm/v7/prisma-client/client-extensions/extension-examples
...
The following is a list of extensions created by the community. If you want to create your own package, refer to the [Shared Prisma Client extensions](/orm/v7/prisma-client/client-extensions/shared-extensions) documentation.
...
- Learn more about [Prisma Client extensions](/orm/v7/prisma-client/client-extensions).
