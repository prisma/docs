...
url: /orm/v7/prisma-client/client-extensions
...
- `model`: [add custom methods or fields to your models](/orm/v7/prisma-client/client-extensions/model)
- `client`: [add client-level methods to Prisma Client](/orm/v7/prisma-client/client-extensions/client)
- `query`: [create custom Prisma Client queries](/orm/v7/prisma-client/client-extensions/query)
- `result`: [add custom fields to your query results](/orm/v7/prisma-client/client-extensions/result)
...
You can [share your Prisma Client extensions](/orm/v7/prisma-client/client-extensions/shared-extensions) with other Prisma ORM users, and [import Prisma Client extensions developed by other users](/orm/v7/prisma-client/client-extensions/shared-extensions#install-a-shared-packaged-extension) into your Prisma ORM project.
...
- Use the client-level [`$extends`](/orm/v7/reference/prisma-client-reference#client-methods) method
...
The above examples use the [`model` extension component](/orm/v7/prisma-client/client-extensions/model) to extend the `User` model.

In your `$extends` method, use the appropriate extension component or components ([`model`](/orm/v7/prisma-client/client-extensions/model), [`client`](/orm/v7/prisma-client/client-extensions/client), [`result`](/orm/v7/prisma-client/client-extensions/result) or [`query`](/orm/v7/prisma-client/client-extensions/query)).
...
Chain [`query`](/orm/v7/prisma-client/client-extensions/query) extensions to compose middleware. Extensions execute in the order they are declared, first in, first out:
...
[Client-level methods](/orm/v7/reference/prisma-client-reference#client-methods) do not necessarily exist on extended clients. For these clients you will need to first check for existence before using.
