...
url: /orm/v7/prisma-client/client-extensions/type-utilities
...
[Prisma Client type utilities](/orm/v7/prisma-client/type-safety) are utilities available within your application and Prisma Client extensions and provide useful ways of constructing safe and extendable types for your extension.
...
This example is conceptual. You must implement and operate the cache used by the extension.
