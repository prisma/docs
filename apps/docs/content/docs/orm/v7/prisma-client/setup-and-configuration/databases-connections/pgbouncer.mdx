...
url: /orm/v7/prisma-client/setup-and-configuration/databases-connections/pgbouncer
...
If you don't want to run your own pooler, [Prisma Accelerate](https://www.prisma.io/accelerate?utm_source=docs&utm_campaign=pgbouncer-help) provides connection pooling for all databases supported by Prisma ORM with little setup. To get started, open the [Prisma Console](https://console.prisma.io?utm_source=docs&utm_campaign=pgbouncer-help).
...
:::warning
We recommend **not** setting `pgbouncer=true` in the database connection string if you're using [PgBouncer `1.21.0`](https://github.com/prisma/orm/issues/21531#issuecomment-1919059472) or later.
:::
...
- [Connecting directly to a PostgreSQL database hosted on Digital Ocean](https://github.com/prisma/orm/issues/6157)
- [Connecting directly to a PostgreSQL database hosted on ScaleGrid](https://github.com/prisma/orm/issues/6701#issuecomment-824387959)
