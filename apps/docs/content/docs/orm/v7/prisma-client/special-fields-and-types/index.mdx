...
url: /orm/v7/prisma-client/special-fields-and-types
...
The use of the `Decimal` field [is not currently supported in MongoDB](https://github.com/prisma/orm/issues/12637).
...
When creating records that have fields of type [`DateTime`](/orm/v7/reference/prisma-schema-reference#datetime), Prisma Client accepts values as [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) objects adhering to the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
