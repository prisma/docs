...
url: /orm/v7/prisma-client/deployment/edge/deploy-to-deno-deploy
---
...
- Explore [Prisma Client extensions](/orm/v7/prisma-client/client-extensions) for custom functionality
- Set up [Prisma Migrate](/orm/v7/prisma-migrate) for schema versioning in production
