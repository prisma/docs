...
url: /orm/v7/prisma-client/deployment/traditional/deploy-to-sevalla
...
Sevalla is a developer-focused PaaS that hosts applications, databases, object storage, and static sites.
...
On your Sevalla dashboard, click **Databases** \> **Add database**. Select **PostgreSQL** (or your preferred configured database type), and then provide a database name, username, and password, or use the default generated details.
...
You have deployed a Node.js application using Prisma ORM to Sevalla, with the app and database connected over private networking.
