...
url: /orm/v7/prisma-client/debugging-and-troubleshooting/handling-exceptions-and-errors
...
Use the `Prisma` namespace to access the error type. The [error code](/orm/v7/reference/error-reference#error-codes) can then be checked and a message can be printed.
...
See [Errors reference](/orm/v7/reference/error-reference) for a detailed breakdown of the different error types and their codes.
