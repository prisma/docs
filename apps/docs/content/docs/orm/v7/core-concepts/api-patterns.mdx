...
url: /orm/v7/core-concepts/api-patterns
...
Fullstack frameworks blur server/client boundaries. Use Prisma Client in the server-side portion of your application.
