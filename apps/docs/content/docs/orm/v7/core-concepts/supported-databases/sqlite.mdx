...
url: /orm/v7/core-concepts/supported-databases/sqlite
...
Instead of Prisma's built-in driver, you can use JavaScript database drivers via [driver adapters](/orm/v7/core-concepts/supported-databases/database-drivers#driver-adapters):
...
- Suited to development and small applications
