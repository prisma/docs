...
url: /docs/orm/prisma-schema/overview/generators
...
A Prisma schema can have one or more generators, represented by the [`generator`](/docs/orm/reference/prisma-schema-reference#generator) block:
...
Update your [`generator`](/docs/orm/prisma-schema/overview/generators) block:
...
- `previewFeatures`: [Preview features](/docs/orm/reference/preview-features/client-preview-features) to include
...
Existing generators or new ones should not be affected if you are using a [multi-file Prisma schema](/docs/orm/prisma-schema/overview/location#multi-file-prisma-schema), unless a generator reads the schema manually.
