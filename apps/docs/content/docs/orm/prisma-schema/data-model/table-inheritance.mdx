...
You can use [Prisma Client extensions](/docs/v7/orm/prisma-client/client-extensions) to create a more convenient API for the table structures in your database.
