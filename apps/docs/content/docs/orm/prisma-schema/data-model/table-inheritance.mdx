...
url: /docs/orm/prisma-schema/data-model/table-inheritance
...
You can use [Prisma Client extensions](/docs/orm/prisma-client/client-extensions) to create a more convenient API for the table structures in your database.
