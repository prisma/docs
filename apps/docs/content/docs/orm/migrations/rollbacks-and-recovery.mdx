...
- **The migration applied, but the change was wrong.** In this case, you need to revert the database *back* to an earlier state. This is a **rollback**; in Prisma 8 it's one more migration.
