...
url: /docs/orm/more/comparisons/prisma-and-mongoose
metaTitle: Prisma ORM vs Mongoose
metaDescription: Learn how Prisma ORM compares to Mongoose.
---

This page compares the Prisma ORM and [Mongoose](https://mongoosejs.com/docs/guide.html) APIs. If you want to learn how to migrate from Mongoose to Prisma, check out this [guide](/docs/guides/switch-to-prisma-orm/from-mongoose).
