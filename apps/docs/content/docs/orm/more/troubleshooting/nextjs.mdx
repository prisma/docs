...
url: /docs/orm/more/troubleshooting/nextjs
...
- **Use a custom output directory for generated client**: Define a [custom output directory](/docs/orm/reference/prisma-schema-reference#fields-for-prisma-client-provider) for the generated Prisma Client to maintain consistency across packages.
