...
<Tabs items={["Before (with graphql-import)", "After (with Prisma 2)"]}>
<Tab value="Before (with graphql-import)">
...
const server = new GraphQLServer({
  ...
  context: (req) => ({
    ...
    prisma: new Prisma({
      // [!code --]
      typeDefs: "src/generated/prisma.graphql", // [!code --]
      endpoint: "http://localhost:4466", // [!code --]
    }), // [!code --]
    prisma: new PrismaClient(), // [!code ++]
  }),
});
```
...
const resolvers = {
  ...
  Post: {
    ...
    author: (parent, args, context) => {
      // [!code ++]
      return context.prisma.post // [!code ++]
        .findUnique({
          // [!code ++]
          where: { id: parent.id }, // [!code ++]
        }) // [!code ++]
...
const resolvers = {
  ...
  Profile: {
    ...
    user: (parent, args, context) => {
      // [!code ++]
      return context.prisma.profile // [!code ++]
        .findUnique({
          // [!code ++]
          where: { id: parent.id }, // [!code ++]
        }) // [!code ++]
    ...
    posts: (_, args, context) => {
      ...
      return context.prisma.post.findMany({
        ...
        where: {
          ...
          OR: [
            // [!code highlight]
            { title: { contains: args.searchString } }, // [!code highlight]
            { content: { contains: args.searchString } }, // [!code highlight]
          ], // [!code highlight]
        }, // [!code highlight]
      }); // [!code highlight]
    },
  ...
  Query: {
    user: (_, args, context) => {
      ...
      return context.prisma.user.findUnique({
        // [!code highlight]
        where: args.userUniqueInput, // [!code highlight]
      }); // [!code highlight]
    }, // [!code highlight]
    // ... other resolvers
  },
      ...
      return context.prisma.post.create({
        ...
        data: {
          ...
          author: {
            ...
            connect: {
              // [!code highlight]
              id: args.authorId, // [!code highlight]
            }, // [!code highlight]
          }, // [!code highlight]
        }, // [!code highlight]
      }); // [!code highlight]
    ...
    updateBio: (_, args, context, info) => {
      ...
      return context.prisma.user.update({
        ...
        data: {
          ...
          profile: {
            // [!code highlight]
            update: { bio: args.bio }, // [!code highlight]
          }, // [!code highlight]
        }, // [!code highlight]
        where: args.userUniqueInput, // [!code highlight]
      }); // [!code highlight]
...
const resolvers = {
  Mutation: {
    addPostToCategories: (_, args, context, info) => {
      // [!code highlight]
      const ids = args.categoryIds.map((id) => ({ id })); // [!code highlight]
