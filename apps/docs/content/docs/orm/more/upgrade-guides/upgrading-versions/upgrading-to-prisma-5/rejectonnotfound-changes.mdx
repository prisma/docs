...
You will need to update your method usage to `...OrThrow` and then use a [Client Extension](/docs/v7/orm/prisma-client/client-extensions) in order to get the same behavior.
