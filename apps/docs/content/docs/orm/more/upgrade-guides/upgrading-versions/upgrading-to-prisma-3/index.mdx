...
### [Referential actions](/docs/v7/orm/prisma-schema/data-model/relations/referential-actions)
...
See [Referential action upgrade path](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-3/referential-actions) to understand how to proceed.

### [Named constraints](/docs/v7/orm/prisma-schema/data-model/database-mapping)
...
You can check out the [Named constraints upgrade path](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-3/named-constraints) for more information on how to proceed.

### [$queryRaw](/docs/v7/orm/prisma-client/using-raw-sql/raw-queries)
...
You can learn more about the new `$queryRaw` and `$queryRawUnsafe` methods in the [Raw database access](/docs/v7/orm/prisma-client/using-raw-sql/raw-queries) section of the docs.

### [Json Null Equality](/docs/v7/orm/prisma-client/special-fields-and-types/working-with-json-fields#filtering-by-null-values)
