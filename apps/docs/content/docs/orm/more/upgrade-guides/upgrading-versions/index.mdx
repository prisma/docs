...
[codemods](/docs/v7/orm/more/upgrade-guides/upgrading-versions/codemods) help you refactor your code to account for breaking changes - for example, the 2.12.0 codemod automatically renames `findOne` to `findUnique`.
...
- [Upgrade to Prisma ORM 7](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-7)
- [Upgrade to Prisma ORM 6](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-6)
- [Upgrade to Prisma ORM 5](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-5)
- [Upgrade to Prisma ORM 4](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-4)
- [Upgrade to Prisma ORM 3](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-3)

### Prisma 1

- [Upgrade from Prisma 1](/docs/v7/orm/more/upgrade-guides/upgrade-from-prisma-1)
