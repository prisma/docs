...
- [Enable Prisma Client and schema preview features](/docs/v7/orm/reference/preview-features/client-preview-features)
- [Enable Prisma CLI preview features](/docs/v7/orm/reference/preview-features/cli-preview-features)
