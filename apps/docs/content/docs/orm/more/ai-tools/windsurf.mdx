...
You can also add the Prisma MCP server manually. Learn more about how you can add the MCP server manually to Windsurf [here](/docs/v7/guides/postgres/mcp-server#windsurf).
