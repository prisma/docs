...
From version 4.3.0, you do not need to use raw queries to compare columns in the same table. You can use the `<model>.fields` property to [compare the columns](/docs/v7/orm/reference/prisma-client-reference#compare-columns-in-the-same-table).
...
Comparing values from two columns in the same table can be achieved by using [raw queries](/docs/v7/orm/prisma-client/using-raw-sql/raw-queries).

### Comparing numeric values

:::info

From version 4.3.0, you do not need to use raw queries to compare columns in the same table. You can use the `<model>.fields` property to compare the columns. [Learn more](/docs/v7/orm/reference/prisma-client-reference#compare-columns-in-the-same-table)
