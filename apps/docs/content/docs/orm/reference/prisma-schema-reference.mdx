...
Defines a [data source](/docs/orm/prisma-schema/overview/data-sources) in the Prisma schema.
...
| `relationMode` | No       | String (`foreignKeys`, `prisma`)                                                | Sets whether [referential integrity](/docs/orm/prisma-schema/data-model/relations/relation-mode) is enforced by foreign keys or by Prisma.   |
| `schemas`      | No       | Array of strings                                                                | List of database schemas to include ([multi-schema](/docs/orm/prisma-schema/data-model/multi-schema) support, PostgreSQL and SQL Server).    |
| `extensions`   | No       | Array of extension names                                                        | [PostgreSQL extensions](/docs/orm/prisma-schema/postgresql-extensions) to enable.                                                             |

Connection URLs (`url`, `directUrl`, `shadowDatabaseUrl`) are configured in [`prisma.config.ts`](/docs/orm/reference/prisma-config-reference#datasourceurl), not in the schema file.
...
- [`sqlserver`](/docs/orm/core-concepts/supported-databases/sql-server)
- [`mongodb`](/docs/orm/core-concepts/supported-databases/mongodb)
- [`cockroachdb`](/docs/orm/core-concepts/supported-databases/postgresql#cockroachdb)
...
Learn more about PostgreSQL connection strings [here](/docs/orm/core-concepts/supported-databases/postgresql).
...
Learn more about [MySQL connection URLs](/docs/orm/core-concepts/supported-databases/mysql).
...
Learn more about [MongoDB connection URLs](/docs/orm/core-concepts/supported-databases/mongodb).
...
Learn more about [SQLite connection URLs](/docs/orm/core-concepts/supported-databases/sqlite).
...
CockroachDB uses the same connection URL format as PostgreSQL. Learn more about [PostgreSQL connection URLs](/docs/orm/core-concepts/supported-databases/postgresql).
...
Defines a [generator](/docs/orm/prisma-schema/overview/generators) in the Prisma schema.

### Fields for `prisma-client-js` provider

This is the default generator for Prisma ORM 6.x and earlier versions. Learn more about [generators](/docs/orm/prisma-schema/overview/generators#prisma-client-js-deprecated).

A `generator` block accepts the following fields:

| Name              | Required | Type                         | Description                                                                                                                                                                                                |
| :---------------- | :------- | :--------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `provider`        | **Yes**  | `prisma-client-js`           | Describes which [generator](/docs/orm/prisma-schema/overview/generators) to use. This can point to a file that implements a generator or specify a built-in generator directly.                                 |
| `output`          | No       | String (file path)           | Determines the location for the generated client, [learn more](/docs/orm/reference/prisma-schema-reference#fields-for-prisma-client-provider). **Default**: `node_modules/.prisma/client` |
...
The ESM-first client generator that offers greater control and flexibility across different JavaScript environments. It generates plain TypeScript code into a custom directory, providing full visibility over the generated code. Learn more about the new [`prisma-client`](/docs/orm/prisma-schema/overview/generators#prisma-client) generator.
...
| Name                     | Required | Type                                                                                                               | Description                                                                                                                                                                                                                               |
| :----------------------- | :------- | :----------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  |
| `provider`               | **Yes**  | `prisma-client`                                                                                                    | Describes which [generator](/docs/orm/prisma-schema/overview/generators) to use. This can point to a file that implements a generator or specify a built-in generator directly.                                                                |
| `output`                 | **Yes**  | String (file path)                                                                                                 | Determines the location for the generated client, [learn more](/docs/orm/reference/prisma-schema-reference#fields-for-prisma-client-provider).                                                                           |
| `previewFeatures`        | No       | List of Enums                                                                                                      | Use intellisense to see list of currently available Preview features (`Ctrl+Space` in Visual Studio Code) **Default**: none                                                                                                               |
...
Defines a Prisma [model](/docs/orm/prisma-schema/data-model/models#defining-models) .
...
[Fields](/docs/orm/prisma-schema/data-model/models#defining-fields) are properties of models.
...
> **Note**: You can use the [`@map` attribute](#map) to [map a field name to a column](/docs/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) with a different name that does not match field naming conventions: e.g. `myField @map("my_field")`.
...
Prisma models also have [model field types](/docs/orm/prisma-schema/data-model/relations) that define relations between models.
...
| `xml`                | `@db.Xml`                      |
| `inet`               | `@db.Inet`                     |
| `citext`             | `@db.Citext`                   | Only available if [Citext extension is enabled](/docs/orm/prisma-schema/data-model/unsupported-database-features#enable-postgresql-extensions-for-native-database-functions). |
...
| :--------------- | :-------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------- |
| Prisma Client JS | [`BigInt`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/BigInt) | See [examples of working with `BigInt`](/docs/orm/prisma-client/special-fields-and-types#working-with-bigint) |
...
| Client           | Type                                               | Description                                                                                                |
| :--------------- | :------------------------------------------------- | :--------------------------------------------------------------------------------------------------------- |
| Prisma Client JS | [`Decimal`](https://mikemcl.github.io/decimal.js/) | See [examples of working with `Decimal`](/docs/orm/prisma-client/special-fields-and-types#working-with-decimal) |
...
You can find more info and examples in this section: [Working with `DateTime`](/docs/orm/prisma-client/special-fields-and-types#working-with-datetime).
...
| Client                                                        | Type                                                                                                        | Description                                                                                            |
| :------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------- |
| Prisma Client JS                                              | [`Uint8Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) | See [examples of working with `Bytes`](/docs/orm/prisma-client/special-fields-and-types#working-with-bytes) |
| Prisma Client JS ([before v6](/docs/guides/upgrade-prisma-orm/v6)) | [`Buffer`](https://nodejs.org/api/buffer.html)                                                              | See [examples of working with `Bytes`](/docs/orm/prisma-client/special-fields-and-types#working-with-bytes) |
...
The [MongoDB connector](/docs/orm/core-concepts/supported-databases/mongodb) does not support the `Unsupported` type.
...
In this scenario, you cannot create a `Profile` only - you must use Prisma Client's [nested writes](/docs/orm/prisma-client/queries/relation-queries#nested-writes) create a `User` **or** connect the profile to an existing user.
...
**Not supported by MongoDB** <br />
The [MongoDB connector](/docs/orm/core-concepts/supported-databases/mongodb) does not support composite IDs.
...
Defines a [default value for a field](/docs/orm/prisma-schema/data-model/models#defining-a-default-value).

#### Remarks

- Default values that cannot yet be represented in the Prisma schema are represented by the [`dbgenerated()` function](#dbgenerated) when you use [introspection](/docs/orm/prisma-schema/introspection).
...
- Default values can be used with [scalar lists](/docs/orm/prisma-client/special-fields-and-types/working-with-scalar-lists-arrays) in databases that natively support them.
...
Defines a compound [unique constraint](/docs/orm/prisma-schema/data-model/models#defining-a-unique-field) for the specified fields.
...
Defines meta information about the relation. [Learn more](/docs/orm/prisma-schema/data-model/relations#the-relation-attribute).
...
| `fields`     | `FieldReference[]`                                                                                                                             | On [annotated](/docs/orm/prisma-schema/data-model/relations#relation-fields) relation fields | A list of [fields](/docs/orm/prisma-schema/data-model/models#defining-fields) of the _current_ model                                                                            | `["authorId"]`, `["authorFirstName, authorLastName"]` |
| `references` | `FieldReference[]`                                                                                                                             | On [annotated](/docs/orm/prisma-schema/data-model/relations#relation-fields) relation fields | A list of [fields](/docs/orm/prisma-schema/data-model/models#defining-fields) of the model on _the other side of the relation_                                                  | `["id"]`, `["firstName, lastName"]`                   |
| `map`        | `String`                                                                                                                                       | No                                                                                      | Defines a [custom name](/docs/orm/prisma-schema/data-model/database-mapping#constraint-and-index-names) for the foreign key in the database.                                    | `["id"]`, `["firstName, lastName"]`                   |
| `onUpdate`   | Enum. See [Types of referential actions](/docs/orm/prisma-schema/data-model/relations/referential-actions#types-of-referential-actions) for values. | No                                                                                      | Defines the [referential action](/docs/orm/prisma-schema/data-model/relations/referential-actions) to perform when a referenced entry in the referenced model is being updated. | `Cascade`, `NoAction`                                 |
...
See: [The `@relation` attribute](/docs/orm/prisma-schema/data-model/relations#the-relation-attribute).
...
> See [Using custom model and field names](/docs/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) to see how `@map` and `@@map` changes the generated Prisma Client.
...
In versions before [4.4.0](https://github.com/prisma/prisma/releases/tag/4.4.0), if you're also using [`now()`](/docs/orm/reference/prisma-schema-reference#now), the time might differ from the `@updatedAt` values if your database and app have different time zones. This happens because `@updatedAt` operates at the Prisma ORM level, while `now()` operates at the database level.
...
Add `@@schema` to a model to specify which schema in your database should contain the table associated with that model. Learn more about [adding multiple schema's here](/docs/orm/prisma-schema/data-model/multi-schema).

:::note

[Multiple database schema](/docs/orm/prisma-schema/data-model/multi-schema) support is only available with the PostgreSQL, CockroachDB, and SQL Server connectors.
...
For more information about using the `multiSchema` feature, refer to [this guide](/docs/orm/prisma-schema/data-model/multi-schema).
...
**Not supported by MongoDB** <br />
The [MongoDB connector](/docs/orm/core-concepts/supported-databases/mongodb) does not support the `autoincrement()` function.
...
The sequence function is only supported by [CockroachDB connector](/docs/orm/core-concepts/supported-databases/postgresql#cockroachdb).
...
- Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `cuid()` when using [introspection](/docs/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/docs/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and generating Prisma Client, in that case the values will be generated by Prisma ORM.
...
- Compatible with `String`.
- Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `uuid()` when using [introspection](/docs/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/docs/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and generating Prisma Client, in that case the values will be generated by Prisma ORM.
...
- Compatible with `String`.
- Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `uuid()` when using [introspection](/docs/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/docs/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and [generating Prisma Client](/docs/orm/reference/prisma-schema-reference#fields-for-prisma-client-provider), in that case the values will be generated by Prisma ORM.
...
[`gen_random_uuid()` is a PostgreSQL function](https://www.postgresql.org/docs/13/functions-uuid.html). To use it in PostgreSQL versions 12.13 and earlier, you must enable the `pgcrypto` extension. See [PostgreSQL extensions](/docs/orm/prisma-schema/postgresql-extensions) for how to install extensions.
...
The [Microsoft SQL Server connector](/docs/orm/core-concepts/supported-databases/sql-server) does not support the `enum` type.

:::

Defines an [enum](/docs/orm/prisma-schema/data-model/models#defining-enums) .
...
Defines a [composite type](/docs/orm/prisma-schema/data-model/models#defining-composite-types-mongodb).
