...
Defines a [data source](/docs/v7/orm/prisma-schema/overview/data-sources) in the Prisma schema.
...
| `url`               | **Yes**  | String (URL)                                                                    | **Deprecated in Prisma ORM v7.** Configure the connection URL in Prisma Config instead: see [`datasource.url`](/docs/v7/orm/reference/prisma-config-reference#datasourceurl). Existing schemas continue to work, but you should migrate to Prisma Config.                                                                                            |
| `shadowDatabaseUrl` | No       | String (URL)                                                                    | **Deprecated in Prisma ORM v7.** Configure the shadow database URL in Prisma Config instead: see [`datasource.shadowDatabaseUrl`](/docs/v7/orm/reference/prisma-config-reference#datasourceshadowdatabaseurl).                                                                                                                                       |
| `directUrl`         | No       | String (URL)                                                                    | **Deprecated in Prisma ORM v7.** Configure the direct connection URL in Prisma Config instead: see [`datasource.directUrl`](/docs/v7/orm/reference/prisma-config-reference#datasourcedirecturl-removed).                                                                                                                                             |
| `relationMode`      | No       | String (`foreignKeys`, `prisma`)                                                | Sets whether [referential integrity](/docs/v7/orm/prisma-schema/data-model/relations/relation-mode) is enforced by foreign keys in the database or emulated in the Prisma Client.<br /><br />In preview in versions 3.1.1 and later. The field is named `relationMode` in versions 4.5.0 and later, and was previously named `referentialIntegrity`. |
| `extensions`        | No       | List of strings (PostgreSQL extension names)                                    | Allows you to [represent PostgreSQL extensions in your schema](/docs/v7/orm/prisma-schema/postgresql-extensions). Available in preview for PostgreSQL only in Prisma ORM versions 4.5.0 and later.                                                                                                                                                   |

::::note
As of Prisma ORM v7, the `url`, `directUrl`, and `shadowDatabaseUrl` fields in the Prisma schema `datasource` block are deprecated. Configure these fields in [Prisma Config](/docs/v7/orm/reference/prisma-config-reference) instead.
::::

The following providers are available:

- [`sqlite`](/docs/v7/orm/overview/databases/sqlite)
- [`postgresql`](/docs/v7/orm/overview/databases/postgresql)
- [`mysql`](/docs/v7/orm/overview/databases/mysql)
- [`sqlserver`](/docs/v7/orm/overview/databases/sql-server)
- [`mongodb`](/docs/v7/orm/overview/databases/mongodb)
- [`cockroachdb`](/docs/v7/orm/overview/databases/cockroachdb)
...
Learn more about PostgreSQL connection strings [here](/docs/v7/orm/overview/databases/postgresql).
...
Learn more about MySQL connection strings [here](/docs/v7/orm/overview/databases/mysql).
...
Learn more about MongoDB connection strings [here](/docs/v7/orm/overview/databases/mongodb).
...
Learn more about SQLite connection strings [here](/docs/v7/orm/overview/databases/sqlite).
...
The format for connection strings is the same as for PostgreSQL. Learn more about PostgreSQL connection strings [here](/docs/v7/orm/overview/databases/postgresql).

## `generator`

Defines a [generator](/docs/v7/orm/prisma-schema/overview/generators) in the Prisma schema.

### Fields for `prisma-client-js` provider

This is the default generator for Prisma ORM 6.x and earlier versions. Learn more about [generators](/docs/v7/orm/prisma-schema/overview/generators#prisma-client-js-deprecated).

A `generator` block accepts the following fields:

| Name              | Required | Type                         | Description                                                                                                                                                                                                        |
| :---------------- | :------- | :--------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `provider`        | **Yes**  | `prisma-client-js`           | Describes which [generator](/docs/v7/orm/prisma-schema/overview/generators) to use. This can point to a file that implements a generator or specify a built-in generator directly.                                 |
| `output`          | No       | String (file path)           | Determines the location for the generated client, [learn more](/docs/v7/orm/prisma-client/setup-and-configuration/generating-prisma-client#using-a-custom-output-path). **Default**: `node_modules/.prisma/client` |
...
| `engineType`      | No       | Enum (`library` or `binary`) | Defines the [query engine](/docs/v7/orm/more/under-the-hood/engines) type to download and use. **Default**: `library`                                                                                              |
| `binaryTargets`   | No       | List of Enums (see below)    | Specify the OS on which the Prisma Client will run to ensure compatibility of the [query engine](/docs/v7/orm/more/under-the-hood/engines). **Default**: `native`                                                  |
...
The ESM-first client generator that offers greater control and flexibility across different JavaScript environments. It generates plain TypeScript code into a custom directory, providing full visibility over the generated code. Learn more about the new [`prisma-client`](/docs/v7/orm/prisma-schema/overview/generators#prisma-client) generator.
...
| Name                     | Required | Type                                                                                                               | Description                                                                                                                                                                                                                 |
| :----------------------- | :------- | :----------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `provider`               | **Yes**  | `prisma-client`                                                                                                    | Describes which [generator](/docs/v7/orm/prisma-schema/overview/generators) to use. This can point to a file that implements a generator or specify a built-in generator directly.                                          |
| `output`                 | **Yes**  | String (file path)                                                                                                 | Determines the location for the generated client, [learn more](/docs/v7/orm/prisma-client/setup-and-configuration/generating-prisma-client#using-a-custom-output-path).                                                     |
| `previewFeatures`        | No       | List of Enums                                                                                                      | Use intellisense to see list of currently available Preview features (`Ctrl+Space` in Visual Studio Code) **Default**: none                                                                                                 |
...
The following tables list all supported operating systems with the name of platform to specify in [`binaryTargets`](/docs/v7/orm/prisma-schema/overview/generators#binary-targets).
...
Defines a Prisma [model](/docs/v7/orm/prisma-schema/data-model/models#defining-models) .
...
[Fields](/docs/v7/orm/prisma-schema/data-model/models#defining-fields) are properties of models.
...
> **Note**: You can use the [`@map` attribute](#map) to [map a field name to a column](/docs/v7/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) with a different name that does not match field naming conventions: e.g. `myField @map("my_field")`.
...
Prisma models also have [model field types](/docs/v7/orm/prisma-schema/data-model/relations) that define relations between models.
...
| `xml`                | `@db.Xml`                      |
| `inet`               | `@db.Inet`                     |
| `citext`             | `@db.Citext`                   | Only available if [Citext extension is enabled](/docs/v7/orm/prisma-schema/data-model/unsupported-database-features#enable-postgresql-extensions-for-native-database-functions). |
...
| :--------------- | :-------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------- |
| Prisma Client JS | [`BigInt`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/BigInt) | See [examples of working with `BigInt`](/docs/v7/orm/prisma-client/special-fields-and-types#working-with-bigint) |
...
| Client           | Type                                               | Description                                                                                                        |
| :--------------- | :------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| Prisma Client JS | [`Decimal`](https://mikemcl.github.io/decimal.js/) | See [examples of working with `Decimal`](/docs/v7/orm/prisma-client/special-fields-and-types#working-with-decimal) |
...
You can find more info and examples in this section: [Working with `DateTime`](/docs/v7/orm/prisma-client/special-fields-and-types#working-with-datetime).
...
| Client                                                                                                    | Type                                                                                                        | Description                                                                                                    |
| :-------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------- |
| Prisma Client JS                                                                                          | [`Uint8Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) | See [examples of working with `Bytes`](/docs/v7/orm/prisma-client/special-fields-and-types#working-with-bytes) |
| Prisma Client JS ([before v6](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-6)) | [`Buffer`](https://nodejs.org/api/buffer.html)                                                              | See [examples of working with `Bytes`](/docs/v7/orm/prisma-client/special-fields-and-types#working-with-bytes) |
...
The [MongoDB connector](/docs/v7/orm/overview/databases/mongodb) does not support the `Unsupported` type.
...
In this scenario, you cannot create a `Profile` only - you must use Prisma Client's [nested writes](/docs/v7/orm/prisma-client/queries/relation-queries#nested-writes) create a `User` **or** connect the profile to an existing user.
...
**Not supported by MongoDB** <br />
The [MongoDB connector](/docs/v7/orm/overview/databases/mongodb) does not support composite IDs.
...
Defines a [default value for a field](/docs/v7/orm/prisma-schema/data-model/models#defining-a-default-value).

#### Remarks

- Default values that cannot yet be represented in the Prisma schema are represented by the [`dbgenerated()` function](#dbgenerated) when you use [introspection](/docs/v7/orm/prisma-schema/introspection).
...
- Default values can be used with [scalar lists](/docs/v7/orm/prisma-client/special-fields-and-types/working-with-scalar-lists-arrays) in databases that natively support them.
...
<Tab value="MongoDB" className="empty-code-tab">
...
Defines a compound [unique constraint](/docs/v7/orm/prisma-schema/data-model/models#defining-a-unique-field) for the specified fields.
...
- In version `3.12.0` and later, you can define an index on a field of a [composite type](/docs/v7/orm/prisma-schema/data-model/models#defining-composite-types) using the syntax `@@index([compositeType.field])`. See [Defining composite type indexes](/docs/v7/orm/prisma-schema/data-model/models#defining-composite-type-indexes) for more details.
...
Defines meta information about the relation. [Learn more](/docs/v7/orm/prisma-schema/data-model/relations#the-relation-attribute).
...
| `fields`     | `FieldReference[]`                                                                                                                                     | On [annotated](/docs/v7/orm/prisma-schema/data-model/relations#relation-fields) relation fields | A list of [fields](/docs/v7/orm/prisma-schema/data-model/models#defining-fields) of the _current_ model                                                                            | `["authorId"]`, `["authorFirstName, authorLastName"]` |
| `references` | `FieldReference[]`                                                                                                                                     | On [annotated](/docs/v7/orm/prisma-schema/data-model/relations#relation-fields) relation fields | A list of [fields](/docs/v7/orm/prisma-schema/data-model/models#defining-fields) of the model on _the other side of the relation_                                                  | `["id"]`, `["firstName, lastName"]`                   |
| `map`        | `String`                                                                                                                                               | No                                                                                              | Defines a [custom name](/docs/v7/orm/prisma-schema/data-model/database-mapping#constraint-and-index-names) for the foreign key in the database.                                    | `["id"]`, `["firstName, lastName"]`                   |
| `onUpdate`   | Enum. See [Types of referential actions](/docs/v7/orm/prisma-schema/data-model/relations/referential-actions#types-of-referential-actions) for values. | No                                                                                              | Defines the [referential action](/docs/v7/orm/prisma-schema/data-model/relations/referential-actions) to perform when a referenced entry in the referenced model is being updated. | `Cascade`, `NoAction`                                 |
...
See: [The `@relation` attribute](/docs/v7/orm/prisma-schema/data-model/relations#the-relation-attribute).
...
> See [Using custom model and field names](/docs/v7/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) to see how `@map` and `@@map` changes the generated Prisma Client.
...
There is currently a known bug in Prisma ORM v7 where using mapped enum values with Prisma Client operations causes runtime errors. See the [Prisma 7 upgrade guide](/docs/v7/orm/more/upgrade-guides/upgrading-versions/upgrading-to-prisma-7#mapped-enum-values-in-generated-typescript) for workarounds and details.
...
In versions before [4.4.0](https://github.com/prisma/prisma/releases/tag/4.4.0), if you're also using [`now()`](/docs/v7/orm/reference/prisma-schema-reference#now), the time might differ from the `@updatedAt` values if your database and app have different time zones. This happens because `@updatedAt` operates at the Prisma ORM level, while `now()` operates at the database level.
...
Add `@@schema` to a model to specify which schema in your database should contain the table associated with that model. Learn more about [adding multiple schema's here](/docs/v7/orm/prisma-schema/data-model/multi-schema).

:::note

[Multiple database schema](/docs/v7/orm/prisma-schema/data-model/multi-schema) support is only available with the PostgreSQL, CockroachDB, and SQL Server connectors.
...
For more information about using the `multiSchema` feature, refer to [this guide](/docs/v7/orm/prisma-schema/data-model/multi-schema).
...
**Not supported by MongoDB** <br />
The [MongoDB connector](/docs/v7/orm/overview/databases/mongodb) does not support the `autoincrement()` function.
...
The sequence function is only supported by [CockroachDB connector](/docs/v7/orm/overview/databases/cockroachdb).
...
- Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `cuid()` when using [introspection](/docs/v7/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/docs/v7/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and [generating Prisma Client](/docs/v7/orm/prisma-client/setup-and-configuration/generating-prisma-client), in that case the values will be generated by Prisma's [query engine](/docs/v7/orm/more/under-the-hood/engines).
...
- Compatible with `String`.
- Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `uuid()` when using [introspection](/docs/v7/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/docs/v7/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and [generating Prisma Client](/docs/v7/orm/prisma-client/setup-and-configuration/generating-prisma-client), in that case the values will be generated by Prisma ORM's [query engine](/docs/v7/orm/more/under-the-hood/engines).
...
[`gen_random_uuid()` is a PostgreSQL function](https://www.postgresql.org/docs/13/functions-uuid.html). To use it in PostgreSQL versions 12.13 and earlier, you must enable the `pgcrypto` extension.<br /><br />In Prisma ORM versions 4.5.0 and later, you can declare the `pgcrypto` extension in your Prisma schema with the [`postgresqlExtensions` preview feature](/docs/v7/orm/prisma-schema/postgresql-extensions).
...
The [Microsoft SQL Server connector](/docs/v7/orm/overview/databases/sql-server) does not support the `enum` type.

:::

Defines an [enum](/docs/v7/orm/prisma-schema/data-model/models#defining-enums) .
...
Defines a [composite type](/docs/v7/orm/prisma-schema/data-model/models#defining-composite-types) .
