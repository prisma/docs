...
- use [Prisma Client](/docs/v7/orm/prisma-client) in your application to talk to the database server at Turso
...
It could be also implemented as a [Prisma Client extension](/docs/v7/orm/prisma-client/client-extensions). The below example shows auto-syncing after create, update or delete operation is performed.
