...
- [**Prisma Client**](/docs/orm/prisma-client/setup-and-configuration/introduction): Auto-generated, type-safe **ORM interface**
- [**Prisma Migrate**](/docs/orm/prisma-migrate): Database migration system
...
The [Prisma schema](/docs/orm/prisma-schema/overview) defines your data models and database connection:
...
Use [Prisma Migrate](/docs/orm/prisma-migrate) to create and apply migrations:

```bash
npx prisma migrate dev
```

Or [introspect](/docs/orm/prisma-schema/introspection) an existing database:
...
- [**Prisma schema**](/docs/orm/prisma-schema/overview) - Learn the schema language
- [**Prisma Client**](/docs/orm/prisma-client/setup-and-configuration/introduction) - Explore the query API
