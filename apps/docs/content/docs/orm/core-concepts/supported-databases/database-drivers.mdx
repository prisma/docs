...
url: /docs/orm/core-concepts/supported-databases/database-drivers
...
> **Note**: Driver adapters enable [edge deployments](/docs/orm/prisma-client/deployment/edge/overview) of applications that use Prisma ORM.
...
- PostgreSQL
  - [`pg`](/docs/orm/core-concepts/supported-databases/postgresql#using-driver-adapters)
- Prisma Postgres
  - [`@prisma/adapter-ppg`](/docs/postgres/database/serverless-driver#use-with-prisma-orm)
- MySQL/MariaDB
  - [`mariadb`](/docs/orm/core-concepts/supported-databases/mysql#using-driver-adapters)
- SQLite
  - [`better-sqlite3`](/docs/orm/core-concepts/supported-databases/sqlite#using-driver-adapters)
  - [`libSQL`](/docs/orm/core-concepts/supported-databases/sqlite#using-driver-adapters) (Turso)
- MS SQL Server
  - [`node-mssql`](/docs/orm/core-concepts/supported-databases/sql-server#using-driver-adapters)
...
- [Prisma Postgres](/docs/postgres/database/serverless-driver#use-with-prisma-orm)
- [Neon](/docs/orm/core-concepts/supported-databases/postgresql#neon) (and Vercel Postgres)
- [PlanetScale](/docs/orm/core-concepts/supported-databases/mysql#planetscale)
- [Cloudflare D1](/docs/orm/core-concepts/supported-databases/sqlite#cloudflare-d1)
...
- [PostgreSQL](/docs/orm/core-concepts/supported-databases/postgresql#using-driver-adapters)
- [Prisma Postgres](/docs/postgres/database/serverless-driver#use-with-prisma-orm)
- [MySQL/MariaDB](/docs/orm/core-concepts/supported-databases/mysql#using-driver-adapters)
- [MS SQL Server](/docs/orm/core-concepts/supported-databases/sql-server#using-driver-adapters)
- [Neon](/docs/orm/core-concepts/supported-databases/postgresql#neon)
- [PlanetScale](/docs/orm/core-concepts/supported-databases/mysql#planetscale)
- [Turso](/docs/orm/core-concepts/supported-databases/sqlite#turso-libsql)
- [Cloudflare D1](/docs/orm/core-concepts/supported-databases/sqlite#cloudflare-d1)
...
In Prisma ORM 7, the database connection URL is configured in [`prisma.config.ts`](/docs/orm/reference/prisma-config-reference). However, when using a driver adapter, the connection string needs to be provided in your _application code_ when the driver adapter is set up initially.
...
See the [connection pool guide](/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool) for the Prisma ORM v7 driver adapter defaults and how they map from Prisma ORM v6 URL parameters.
...
[TypedSQL](/docs/orm/prisma-client/using-raw-sql/typedsql) lets you write fully type-safe SQL queries that integrate directly with Prisma Client. This feature is useful if you want the flexibility of writing SQL while still benefiting from Prisma's type-safety.
