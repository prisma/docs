...
url: /docs/orm/core-concepts/supported-databases/sqlite
...
Instead of Prisma's built-in driver, you can use JavaScript database drivers via [driver adapters](/docs/orm/core-concepts/supported-databases/database-drivers#driver-adapters):
