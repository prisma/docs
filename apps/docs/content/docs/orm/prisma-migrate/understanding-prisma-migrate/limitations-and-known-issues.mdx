...
url: /docs/orm/prisma-migrate/understanding-prisma-migrate/limitations-and-known-issues
...
:::info[Note]
For a simple and integrated way to re-create data when the database is reset, check out our [seeding guide](/docs/orm/prisma-migrate/workflows/seeding).
::: 
