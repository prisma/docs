...
> **Note**: For a simple and integrated way to re-create data when the database is reset, check out our [seeding guide](/docs/v7/orm/prisma-migrate/workflows/seeding).
