...
Baselining is part of [adding Prisma Migrate to a project with an existing database](/docs/v7/orm/prisma-migrate/getting-started#adding-prisma-migrate-to-an-existing-project).
