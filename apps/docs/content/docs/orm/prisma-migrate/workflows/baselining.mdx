...
url: /docs/orm/prisma-migrate/workflows/baselining
...
Baselining is part of [adding Prisma Migrate to a project with an existing database](/docs/orm/prisma-migrate/getting-started#adding-to-an-existing-project).
