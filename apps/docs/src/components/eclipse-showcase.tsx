  ...
  return (
    <div className="not-prose my-8 space-y-8">
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-foreground-neutral">Button Variants</h3>
      ...
      {/* Button Sizes */}
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-foreground-neutral">Button Sizes</h3>
      ...
      {/* Foreground Colors */}
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-foreground-neutral">Foreground Colors</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
          ...
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
            <span className="text-sm font-medium text-foreground-error">Error</span>
          </div>
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
            <span className="text-sm font-medium text-foreground-success">Success</span>
          </div>
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
            <span className="text-sm font-medium text-foreground-warning">Warning</span>
          </div>
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
            <span className="text-sm font-medium text-foreground-cyan">Cyan</span>
          </div>
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
            <span className="text-sm font-medium text-foreground-violet">Violet</span>
          </div>
          <div className="p-4 bg-background-neutral rounded-square border border-stroke-neutral">
            <span className="text-sm font-medium text-foreground-pink">Pink</span>
          </div>
        </div>
      </section>
      ...
      {/* Typography */}
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-foreground-neutral">Typography</h3>
        ...
        <div className="space-y-2 pt-4">
          ...
          <p className="font-semibold text-foreground-neutral">Semibold (600)</p>
          <p className="font-bold text-foreground-neutral">Bold (750)</p>
          <p className="font-ultra-bold text-foreground-neutral">Ultra Bold (900)</p>
        </div>
      </section>
      ...
      {/* Semantic Patterns */}
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-foreground-neutral">Semantic Patterns</h3>
        ...
        <div className="p-6 bg-background-error rounded-square-high border border-stroke-error">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-foreground-error">Error Message</h4>
        ...
        <div className="p-6 bg-background-success rounded-square-high border border-stroke-success">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-foreground-success">Success Message</h4>
        ...
        <div className="p-6 bg-background-warning rounded-square-high border border-stroke-warning">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-foreground-warning">Warning Message</h4>
      ...
      {/* Gradients */}
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-foreground-neutral">Gradients</h3>
        <div className="space-y-4">
          <div className="h-24 bg-gradient-orm rounded-square-high flex items-center justify-center">
            <span className="text-lg font-semibold text-foreground-orm-reverse">ORM Gradient</span>
          </div>
          <div className="h-24 bg-gradient-ppg rounded-square-high flex items-center justify-center">
            <span className="text-lg font-semibold text-foreground-ppg-reverse">PPG Gradient</span>
          </div>
        </div>
      </section>
    </div>
