...
import { TrackedTOCWrapper } from "../../../toc/tracked-wrapper";
...
export interface DocsPageProps {
  ...
  /**
   * Control the docs layout sidebar from this page. When `sidebar={{ enabled: false }}`,
   * the sidebar column and navbar toggles are hidden for this page only.
   */
