---
title: 'Importing and exporting data (MySQL)'
...
For example, if you want to export data from a MySQL database that has the following [connection string](../../../reference/database-connectors/mysql):
